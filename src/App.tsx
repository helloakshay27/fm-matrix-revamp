...
const AdminCompassRuleEngine = lazy(
  () => import("./pages/AdminCompass/RuleEngine")
);
const AdminCompassRuleEngineDataSource = lazy(
  () => import("./pages/AdminCompass/RuleEngineDataSource")
);
