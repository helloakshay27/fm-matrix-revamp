import { VI_APP_ID } from '../api/adoptionApi';
...
export function Footer() {
  return (
    <div className="footer">
      ...
      Analytics API, scoped to the Vi app (<code>app_id = {VI_APP_ID}</code>) plus the site,
      date and platform filters in the control bar. Tenant metadata (sites and companies) comes from the
