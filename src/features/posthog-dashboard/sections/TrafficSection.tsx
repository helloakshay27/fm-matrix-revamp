      ...
      <div className="phg-two-32" style={{ marginTop: 14 }}>
        ...
        >
          ...
          <div className="phg-legend">
            ...
            <span><i style={{ background: 'var(--phg-midgray)' }} /> Projected (partial day)</span>
          </div>
        </Card>
        ...
        <Card
          ...
          aiKey="chart.device"
          head={<CardHead cr="U7 · Device / platform split" ct="Web vs mobile usage" cd="Share of active users and sessions by device." />}
        >
