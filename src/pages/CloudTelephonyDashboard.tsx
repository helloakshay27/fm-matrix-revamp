...
const CloudTelephonyDashboard = () => {
  return (
    <div className="p-6 bg-[#fafafa] min-h-screen">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#1a1a1a] mb-2">Cloud Telephony</h1>
        <p className="text-gray-600">Manage voice communication and call routing</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-center h-64 text-gray-500">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium mb-2">No phone numbers configured</h3>
            <p className="text-sm">Add your first phone number to start using cloud telephony</p>
          </div>
        </div>
      </div>
    </div>
