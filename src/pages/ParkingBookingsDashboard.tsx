...
const ParkingBookingsDashboard = () => {
  ...
  return (
    <div className="p-6 space-y-6 min-h-screen bg-white">
      ...
      {/* Parking Slots Display - Inline instead of modal */}
      {showParkingSlots && parkingCategories.length > 0 && (
        <Card className="mx-auto">
          <CardContent className="p-6">
            <h3 className="text-lg font-semibold text-[#C72030] mb-4">Parking Slots Information</h3>
              ...
              <div key={categoryIndex} className="bg-gray-50 p-4 rounded-lg shadow-sm mb-4">
                ...
                <div className="grid grid-cols-6 sm:grid-cols-8 md:grid-cols-12 gap-3">
                  {category.parking_slots.map(slot => {
                    ...
                    let slotClass = "flex flex-col items-center justify-center p-2 rounded-md border";
                    ...
                    if (isBooked && entityColor) {
                      ...
                      slotClass += " bg-gray-100 text-black-700 border-gray-300";
                    }
