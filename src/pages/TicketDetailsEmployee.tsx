...
export const TicketDetailsEmployee = () => {
  ...
  const [activeSubTab, setActiveSubTab] = useState("details"); // Track sub-tab inside Analytics tab
  ...
  useEffect(() => {
    const fetchTicketDetails = async () => {
      ...
      try {
        setLoading(true);
        const data = await employeeTicketAPI.getTicketDetails(id);
        setTicketData(data);
  ...
  useEffect(() => {
    ...
    const fetchTatTimings = async () => {
      try {
        const resp = await employeeTicketAPI.getResponseTatTimings(String(ticketData.id || id));
      ...
      try {
        const res = await employeeTicketAPI.getResolutionTatTimings(String(ticketData.id || id));
 ...
 console.log("responce tat time ------------------",responseTatTimings)
  ...
  const handleCreateTask = async () => {
    ...
    try {
      ...
      const taskData = await employeeTicketAPI.getTicketDetails(id);
    ...
    <div className="p-4 sm:p-6 min-h-screen">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
        <Tabs
          ...
          className="w-full"
        >
          <TabsList className="w-full flex flex-wrap bg-gray-50 rounded-t-lg h-auto p-0 text-sm justify-stretch" style={{ display: 'none' }}>
            <TabsTrigger
              value="details"
          ...
          <TabsContent value="analytics" className="p-4 sm:p-6" style={{ display: 'none' }}>
            <Tabs 
  ...
  <div className="flex flex-col justify-center w-full">
    ...
    <span className="text-[#1A1A1A]" style={{ fontSize: 16 }}>
      ...
      peer-focus:text-sm`}
                ...
                <Card className="w-full bg-white rounded-lg shadow-sm border" style={{ display: 'none' }}>
                  {/* Header */}
                  <div className="flex items-center justify-between gap-3 bg-[#F6F4EE] py-3 px-4 border border-[#D9D9D9]">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full flex items-center justify-center bg-[#E5E0D3]">
      ...
      peer-focus:text-[rgb(25,118,210)]"
          ...
          <TabsContent value="details" className="space-y-8 p-6">
                    ...
                    <Card className="w-full">
                      ...
                      <div className="px-6 bg-[#dfd9cb]">
                        <div className="flex justify-between py-4 border-b border-[#dfd9cb]">
                          <div className='w-full '>
                            <div className="">
                              ...
                              <div className="flex justify-between items-center">
                                ...
                                <div className="bg-white p-4" style={{ width: '75%', borderRadius: '4px', display: 'none' }}>
                          ...
                          <div className="flex flex-col justify-around" style={{ textAlign: 'center', marginLeft: '20px', display: 'none' }}>
                            <button className='w-full py-1 bg-black rounded-full text-white mb-2 text-xs px-3'>
                              {ticketData.issue_status || '-'}
                            </button>
                            <div className='mb-2'>
                ...
                <div className="w-full bg-white rounded-lg shadow-sm border" style={{ display: 'none' }}>
                  <div className="flex items-center justify-between gap-3 bg-[#F6F4EE] py-3 px-4 border border-[#D9D9D9]">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full flex items-center justify-center bg-[#E5E0D3]">
                        <ClipboardList className="w-6 h-6 text-[#C72030]" />
