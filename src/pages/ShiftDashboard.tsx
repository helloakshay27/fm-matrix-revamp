...
import { Plus, Download, Filter, Upload, Printer, QrCode, Eye, Edit, Trash2, Clock, ChevronLeft, ChevronRight } from 'lucide-react';
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-[#f6f4ee]">
                ...
                <TableHead className="font-medium">Timings</TableHead>
                <TableHead className="font-medium">Total Hour</TableHead>
                <TableHead className="font-medium">Check In Margin</TableHead>
