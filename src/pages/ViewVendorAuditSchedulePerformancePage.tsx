...
export const ViewVendorAuditSchedulePerformancePage = () => {
    ...
    const selectionActions = [
        {
            ...
            icon: BarChart3,
            onClick: () => navigate(`/maintenance/audit/vendor/scheduled/view/${id}`, { state: { formCode: customFormCode } })
        },
    ];
    ...
    return (
        <div className="p-2 sm:p-4 lg:p-6">
                ...
                <CardContent>
                    {performanceTableData.length > 0 ? (
                        <EnhancedTable
                            ...
                            storageKey="vendor-audit-performance-table"
                            emptyMessage="No performance data available"
                            enableSearch={true}
                            enableExport={true}
                            handleExport={handlePerformanceExport}
                            searchPlaceholder="Search activities..."
                            exportFileName="vendor-audit-performance-data"
            ...
            <Dialog open={showFilterModal} onOpenChange={setShowFilterModal}>
                <DialogContent className="sm:max-w-md" id="vendor-audit-performance-filter-modal-root">
                    <DialogHeader>
                        ...
                        <div className="flex flex-col">
                            <FormControl variant="outlined" sx={{
                                ...
                                <Select
                                    ...
                                    MenuProps={{
                                        disablePortal: true,
                                        container: () => document.getElementById('vendor-audit-performance-filter-modal-root') || document.body
                                    }}
                                >
...
export default ViewVendorAuditSchedulePerformancePage;
