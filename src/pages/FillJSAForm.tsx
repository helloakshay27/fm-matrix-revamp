...
<td className="border border-gray-300 p-4 align-top min-w-[500px]">
...
>
  {/* Question */}
  <div className="text-sm text-gray-700 leading-relaxed mb-2 break-words">
    {measure}
  </div>
  ...
  >
    <div className="flex items-center">
      ...
      />
      <Label
        htmlFor={`${measure}-yes-${activity.id}`}
        className="text-sm"
      >
        Yes
      </Label>
    ...
    <div className="flex items-center">
      ...
      />
      <Label
        htmlFor={`${measure}-no-${activity.id}`}
        className="text-sm"
      >
        No
      </Label>
