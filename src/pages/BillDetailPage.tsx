...
export const BillDetailPage = () => {
    ...
    const [salesOrder, setBill] = useState<Bill>(mockBill);
    ...
    const handleClone = () => {
        ...
        navigate("/settings/bills/create");
    };
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Button variant="ghost" size="icon" onClick={() => navigate("/settings/bills")}>
                            <ArrowLeft className="h-5 w-5" />
                        </Button>
                        <div>
                            <h1 className="text-2xl font-bold flex items-center gap-3">
                                <ShoppingCart className="h-6 w-6 text-primary" />
                                Bill #{salesOrder.orderDetails.orderNumber}
                            </h1>
                            ...
                            <CardContent>
                                <div className="border border-border rounded-lg overflow-hidden">
                                    <Table>
                                        ...
                                        <TableBody>
                                            {salesOrder.items.map((item: BillItem) => (
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="space-y-2">
                                        {salesOrder.attachments.map((file: BillAttachment, index: number) => (
                                            <div
                                                key={index}
