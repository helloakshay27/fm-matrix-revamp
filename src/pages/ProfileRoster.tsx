...
import { Calendar, MapPin, Building2, Clock, Users, Eye } from 'lucide-react';
import { toast } from 'sonner';
import { API_CONFIG, getFullUrl, getAuthHeader } from '@/config/apiConfig';
import { departmentService, Department } from '@/services/departmentService';
import { RootState } from '@/store/store';

// Section component for consistent layout matching RosterDetailPage
    ...
    return (
        <div className="space-y-6 mt-4">
            ...
            <header className="flex items-center gap-3 mb-4">
                ...
                <div>
                    <h2 className="text-lg font-bold tracking-wide uppercase">Roster Details</h2>
