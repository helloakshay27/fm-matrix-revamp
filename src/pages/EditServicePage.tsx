  ...
  useEffect(() => {
    if (fetchedService) {
      ...
      setFormData(prev => ({
        ...
        groupId: fetchedService.group_id || fetchedService.pms_asset_group_id || null,
        subGroupId: fetchedService.sub_group_id || fetchedService.pms_asset_sub_group_id || null,
