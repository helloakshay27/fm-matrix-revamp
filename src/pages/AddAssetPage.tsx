...
const AddAssetPage = () => {
  ...
  return <div className="p-4 sm:p-6 max-w-full sm:max-w-7xl mx-auto min-h-screen bg-gray-50">
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        {/* Asset Details */}
        <div className="bg-white shadow-sm rounded-lg overflow-hidden">
          <div className="cursor-pointer bg-orange-50 border-l-4 border-l-[#C72030] p-4 sm:p-6 flex justify-between items-center" onClick={() => toggleSection('asset')}>
            <div className="flex items-center gap-2 text-[#C72030] text-sm sm:text-base font-semibold">
        ...
        {/* Warranty Details */}
        <div className="bg-white shadow-sm rounded-lg overflow-hidden">
          <div className="cursor-pointer bg-orange-50 border-l-4 border-l-[#C72030] p-4 sm:p-6 flex justify-between items-center" onClick={() => toggleSection('warranty')}>
            <div className="flex items-center gap-2 text-[#C72030] text-sm sm:text-base font-semibold">
        ...
        {/* Meter Category Type */}
        <div className="bg-white shadow-sm rounded-lg overflow-hidden">
          <div className="cursor-pointer bg-orange-50 border-l-4 border-l-[#C72030] p-4 sm:p-6 flex justify-between items-center" onClick={() => toggleSection('meterCategory')}>
            <div className="flex items-center gap-2 text-[#C72030] text-sm sm:text-base font-semibold">
        ...
        <div className="bg-white shadow-sm rounded-lg overflow-hidden">
          <div className="cursor-pointer bg-orange-50 border-l-4 border-l-[#C72030] p-4 sm:p-6 flex justify-between items-center" onClick={() => toggleSection('consumption')}>
            <div className="flex items-center gap-2 text-[#C72030] text-sm sm:text-base font-semibold">
        ...
        <div className="bg-white shadow-sm rounded-lg overflow-hidden">
          <div className="cursor-pointer bg-orange-50 border-l-4 border-l-[#C72030] p-4 sm:p-6 flex justify-between items-center" onClick={() => toggleSection('nonConsumption')}>
            <div className="flex items-center gap-2 text-[#C72030] text-sm sm:text-base font-semibold">
          ...
          {expandedSections.nonConsumption && <div className="p-4 sm:p-6">
              <div className="space-y-4 sm:space-y-6">
                ...
                <button onClick={addNonConsumptionMeasure} className="bg-[#C72030] text-white px-4 py-2 rounded-md hover:bg-[#a61b26] flex items-center text-sm sm:text-base">
                  <Plus className="w-4 h-4 mr-2" />
                  Add Measure
                </button>
              </div>
