...
import { Droplets, Plus, Search, Filter } from 'lucide-react';

const WaterDashboard = () => {
  return (
    <div className="p-6 bg-[#fafafa] min-h-screen">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#1a1a1a] mb-2">Water Management</h1>
        <p className="text-gray-600">Monitor and manage water consumption</p>
      </div>
      ...
      <div className="mb-6 flex gap-4 items-center">
        ...
        <div className="flex gap-2 ml-auto">
          <div className="relative">
            ...
            <input
              type="search"
              placeholder="Search water assets..."
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-center h-64 text-gray-500">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium mb-2">No water assets found</h3>
            <p className="text-sm">Start by adding your first water asset</p>
          </div>
        </div>
      </div>
    </div>
