                                    ...
                                    return (
                                        <div className="rounded-lg border border-gray-200 overflow-hidden">
                                            <EnhancedTable
                                                ...
                                                storageKey="view-training-schedule-time-setup-table"
                                                hideTableSearch
                                                hideTableExport
                                                hideColumnsButton
                                ...
                                {customForm?.sch_type === 'Service' ? (
                                    <div className="rounded-lg border border-gray-200 overflow-hidden">
                                        <EnhancedTable
                                            ...
                                            storageKey="view-training-schedule-association-service-table"
                                            hideTableSearch
                                            hideTableExport
                                            hideColumnsButton
                                    ...
                                    <div className="rounded-lg border border-gray-200 overflow-hidden">
                                        <EnhancedTable
                                            ...
                                            renderCell={(item, columnKey) => item[columnKey as keyof typeof item]}
                                            storageKey="view-training-schedule-association-asset-table"
                                            hideTableSearch
                                            hideTableExport
                                            hideColumnsButton
                            ...
                            <CardContent>
                                <div className="rounded-lg border border-gray-200 overflow-hidden">
                                    <EnhancedTable
                                        ...
                                        renderCell={(item, columnKey) => item[columnKey as keyof typeof item]}
                                        storageKey="view-training-schedule-email-rules-table"
                                        hideTableSearch
                                        hideTableExport
                                        hideColumnsButton
                            ...
                            <CardContent>
                                <div className="rounded-lg border border-gray-200 overflow-hidden">
                                    <EnhancedTable
                                        ...
                                        renderCell={(item, columnKey) => item[columnKey as keyof typeof item]}
                                        storageKey="view-training-schedule-asset-mapping-table"
                                        hideTableSearch
                                        hideTableExport
                                        hideColumnsButton
