...
`,
        ...
        if (columnKey === 'actions') {
            return (
                <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => navigate(`/maintenance/audit/training/scheduled/view/${item.id}`, {
    ...
    return (
        <div className="p-6">
            <div className="mb-6">
                <div>
                    <p className="text-[#1a1a1a] opacity-70 mb-2">Training &gt; Training Schedule List</p>
                    <h1 className="text-2xl font-bold text-[#1a1a1a]">TRAINING SCHEDULE LIST</h1>
                </div>
            </div>
