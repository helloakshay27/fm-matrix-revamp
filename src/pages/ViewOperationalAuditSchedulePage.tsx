            ...
            <div className="mb-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="text-sm text-gray-600">
                            Schedule #{assetTask?.id || id} • Last updated {formatDate(assetTask?.start_date || assetTask?.services?.[0]?.created_at)}
                        </div>
                    </div>
                                ...
                                <CardContent className="pt-0">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                                        ...
                                        <div className="flex items-start">
                                            <span className="text-gray-500 min-w-[140px]">Form Code</span>
                                            <span className="text-gray-500 mx-2">:</span>
                                            <span className="text-gray-900 font-medium">{customForm?.custom_form_code || 'N/A'}</span>
                                        </div>
                                        <div className="flex items-start">
                                            <span className="text-gray-500 min-w-[140px]">Create Ticket</span>
                                            <span className="text-gray-500 mx-2">:</span>
