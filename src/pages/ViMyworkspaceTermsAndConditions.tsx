import viLogo from '@/assets/vi-logo copy.jpeg';
    ...
    <div className="min-h-screen bg-white">
      <div className="w-full px-6 py-10">
        <header className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-4">Terms &amp; Conditions</h1>
        </header>
        ...
        >
          ...
          <p>Welcome to VI MyWorkSpace!</p>

          <p>
            These terms and conditions outline the rules and regulations for the use of Samshik Infoline’s
            Website, located at VI MyWorkSpace.
          </p>

          <p>
            By accessing this website we assume you accept these terms and conditions. Do not continue to
            use VI MyWorkSpace if you do not agree to take all of the terms and conditions stated on this
            page.
          </p>
          ...
          <p>
            We employ the use of cookies. By accessing VI MyWorkSpace, you agreed to use cookies in
            agreement with the Samshik Infoline Pvt. Ltd.’s Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, Samshik Infoline Pvt. Ltd. and/or its licensors own the intellectual
            property rights for all material on VI MyWorkSpace. All intellectual property rights are
            reserved. You may access this from VI MyWorkSpace for your own personal use subjected to
          ...
          <ul>
            <li>Republish material from VI MyWorkSpace</li>
            <li>Sell, rent or sub-license material from VI MyWorkSpace</li>
            <li>Reproduce, duplicate or copy material from VI MyWorkSpace</li>
            <li>Redistribute content from VI MyWorkSpace</li>
          </ul>
          ...
          <p>
            ...
            information in certain areas of the website. Samshik Infoline Pvt. Ltd. does not filter, edit,
            publish or review Comments prior to their presence on the website. Comments do not reflect the
            views and opinions of Samshik Infoline Pvt. Ltd., its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and opinions. To the extent permitted
            by applicable laws, Samshik Infoline Pvt. Ltd. shall not be liable for the Comments or for any
          ...
          <p>
            Samshik Infoline Pvt. Ltd. reserves the right to monitor all Comments and to remove any Comments
          ...
          <p>
            You hereby grant Samshik Infoline Pvt. Ltd. a non-exclusive license to use, reproduce, edit and
          ...
          <p>
            ...
            hyperlink compensates the absence of Samshik Infoline Pvt. Ltd.; and (d) the link is in the
          ...
          <p>
            ...
            our website, you must inform us by sending an e-mail to Samshik Infoline Pvt. Ltd.. Please
          ...
          <p>No use of Samshik Infoline Pvt. Ltd.’s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
...
export default ViMyworkspaceTermsAndConditions;
