    ...
    return (
      <div className="flex gap-2">
        ...
        <Button
          ...
          variant="ghost"
          className="p-1"
          onClick={() => navigate(`/pulse/pulse-privilege/plus-service/edit/${item.id}`)}
        >
  ...
  const leftActions = (
    <>
      <Button
        ...
        onClick={() => navigate("/pulse/pulse-privilege/plus-service/create")}
      >
...
export default PlusServiceDashboard;
