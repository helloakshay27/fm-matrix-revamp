...
const groupsData = [
  ...
  { id: 29, srNo: 29, groupName: 'BB Eelectrical', status: true },
...
const subGroupsData = [
  ...
  { id: 25, srNo: 25, groupName: 'cd', subGroupName: 'compact', status: true },
  ...
  { id: 34, srNo: 34, groupName: 'FAN', subGroupName: 'Oryental High Speed', status: true },
  ...
  { id: 44, srNo: 44, groupName: 'BB Eelectrical', subGroupName: 'UPS', status: true },
  { id: 45, srNo: 45, groupName: 'BB Eelectrical', subGroupName: 'DG', status: true },
  { id: 46, srNo: 46, groupName: 'BB Eelectrical', subGroupName: 'Lighting', status: true },
...
export const AssetGroupsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f6f4ee]" style={{ marginLeft: '256px', paddingTop: '64px' }}>
      <div className="p-6">
