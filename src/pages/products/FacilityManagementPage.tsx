...
const facilityManagementData: ProductData = {
  name: "Facility Management (FM Matrix)",
  description: "An enterprise FM platform for maintenance, utilities, security, space, finance, and people operations.",
  brief: "Unify multi-site facility management operations and reporting into one platform — eliminating the 5-12 disconnected tools most organisations rely on.",
  ...
  owner: "Abdul and Anjali", ownerImage: "",
  extendedContent: {
    featureSummary: (
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Facility Management (FM Matrix)" },
        ...
        { field: "Product Owner", detail: "Abdul and Anjali" },
      ],
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Commercial Real Estate, IT Park, Manufacturing, Hospitals, Co-working, Retail Chain, Malls, Education, Hospitality" },
      ],
    },
    detailedFeatures: [
...
const FacilityManagementPage: React.FC = () => <BaseProductPage productData={facilityManagementData} />;
