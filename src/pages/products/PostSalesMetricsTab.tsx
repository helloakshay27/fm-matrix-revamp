...
const PostSalesMetricsTab: React.FC = () => {
  ...
  const s13: React.CSSProperties = { borderBottom: '1px solid #cccccc', borderRight: '1px solid #cccccc', backgroundColor: '#eef2ff', textAlign: 'left', color: '#1a2744', fontFamily: 'Arial, sans-serif', fontSize: '9pt', verticalAlign: 'top', wordWrap: 'break-word', padding: '0px 3px' };
  ...
  const s18: React.CSSProperties = { borderBottom: '1px solid transparent', backgroundColor: '#2e4a7a', textAlign: 'left', fontWeight: 'bold', color: '#ffffff', fontFamily: 'Arial, sans-serif', fontSize: '10pt', verticalAlign: 'middle', whiteSpace: 'nowrap', padding: '0px 3px' };
  const s19: React.CSSProperties = { borderBottom: '1px solid #cccccc', backgroundColor: '#f5f5f5', textAlign: 'left', fontStyle: 'italic', color: '#666666', fontFamily: 'Arial, sans-serif', fontSize: '8pt', verticalAlign: 'middle', whiteSpace: 'nowrap', padding: '0px 3px' };
  const s20: React.CSSProperties = { borderBottom: '1px solid #cccccc', borderRight: '1px solid #cccccc', backgroundColor: '#1a2744', textAlign: 'center', fontWeight: 'bold', color: '#ffffff', fontFamily: 'Arial, sans-serif', fontSize: '8pt', verticalAlign: 'middle', wordWrap: 'break-word', padding: '0px 3px' };
  const s21: React.CSSProperties = { borderBottom: '1px solid #cccccc', borderRight: '1px solid #cccccc', backgroundColor: '#2e4a7a', textAlign: 'center', fontWeight: 'bold', color: '#ffffff', fontFamily: 'Arial, sans-serif', fontSize: '8pt', verticalAlign: 'middle', wordWrap: 'break-word', padding: '0px 3px' };
  ...
  const s30: React.CSSProperties = { borderBottom: '1px solid #cccccc', borderRight: '1px solid #cccccc', backgroundColor: '#f5f9ff', textAlign: 'left', color: '#1a1a1a', fontFamily: 'Arial, sans-serif', fontSize: '8pt', verticalAlign: 'top', wordWrap: 'break-word', padding: '0px 3px' };
