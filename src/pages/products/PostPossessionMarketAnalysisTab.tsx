          ...
          <table className="w-full text-left text-[11px] leading-relaxed border-collapse">
            <thead className="bg-[#bdd7ee] text-[#2C2C2C] font-bold uppercase text-[10px]">
              <tr>
                ...
                <th className="p-3 border border-[#E5E7EB] w-[10%]">Industry</th>
                <th className="p-3 border border-[#E5E7EB] w-[20%]">Pain Points (3 per segment)</th>
                <th className="p-3 border border-[#E5E7EB] w-[20%]">If NOT Solved (Risk/Cost)</th>
                <th className="p-3 border border-[#E5E7EB] w-[20%]">What 'Good Enough' Looks Like Today</th>
              </tr>
            </thead>
            <tbody>
              {[
                {
                  segment: "Large Indian Real Estate Developers (e.g., Godrej, Lodha, DLF, Sobha)",
                ...
                },
                {
                  ...
                  industry: "Residential Real Estate",
                  pains: "1. Post-possession relationship management is non-existent.\n2. Outsourced FM teams use paper checklists; no visibility.\n3. Low CAM collection rates (60–75%).",
                  notSolved: "1. Resident churn to competitors; no loyalty.\n2. CAM shortfall leads to maintenance crises.\n3. Brand perception suffers due to poor service quality.",
                  goodEnough: "Basic society apps (NoBrokerHood, Adda) + manual FM + phone reminders.",
                  tone: "bg-white"
                },
                {
                  segment: "GCC Real Estate Developers & Property Managers (UAE, Saudi Arabia, Qatar)",
                ...
                },
                {
                  ...
                  industry: "Multifamily / HOA",
                  pains: "1. HOA management is highly fragmented.\n2. Security relies on legacy software with no community layer.\n3. Resident engagement is a growing retention driver.",
                  notSolved: "1. HOA delinquency above 15% creates cash flow crises.\n2. Security incidents create legal liability.\n3. Class A renter churn costs $4,000–7,000 per unit.",
                  goodEnough: "AppFolio/Yardi (PM) + Smartwebs (HOA) + Verkada (security) + Slack; all disconnected.",
                  tone: "bg-white"
                }
              ].map((item, idx) => (
                <tr key={idx} className={item.tone}>
                  ...
                  <td className="p-3 border border-gray-200 whitespace-pre-line text-[#9b1c1c] font-medium">{item.notSolved}</td>
                  <td className="p-3 border border-gray-200 italic">{item.goodEnough}</td>
                </tr>
              ))}
            </tbody>
          </table>
          ...
          <table className="w-full text-left text-[11px] leading-relaxed border-collapse">
            <thead className="bg-[#bdd7ee] text-[#2C2C2C] font-bold uppercase text-[10px]">
              <tr>
                ...
                <th className="p-3 border border-[#E5E7EB] w-[12%]">Pricing Model</th>
                <th className="p-3 border border-[#E5E7EB] w-[12%]">Discovery Channel</th>
                <th className="p-3 border border-[#E5E7EB] w-[15%]">USPs</th>
                <th className="p-3 border border-[#E5E7EB] w-[12%]">Weaknesses</th>
                <th className="p-3 border border-[#E5E7EB] w-[15%]">Our Opportunity</th>
            ...
            <tbody>
              {[
                ...
                },
                {
                  ...
                  weakness: "No white-label; no developer module; FM ops absent; no computer vision",
                  opp: "Target developers who have moved beyond 'free but basic' and need accountability.",
                  threat: "Free model is a disruptor; rental services threaten referral revenue",
                  tone: "bg-white"
                },
                {
                  name: "Yardi / RENTCafé",
                ...
                },
                {
                  ...
                  discovery: "UK property conferences; partners (CBRE, Savills)",
                  usp: "Strong maintenance workflow; compliance tracking",
                  weakness: "No community engagement; no white-label; no visitor management",
                  opp: "Replace Fixflo + separate community apps with one platform including billing.",
                  threat: "Marketplace model connecting landlords to contractors",
                  tone: "bg-white"
                },
                {
                  ...
                  discovery: "US multifamily conferences; PropTech accelerators",
                ...
                },
                {
                  ...
                  weakness: "No white-label; no developer module; legacy UI; no computer vision",
                  opp: "Position as only white-label developer-branded platform for new gated communities.",
                  threat: "Low price point creates price anchoring for developers",
                  tone: "bg-white"
                }
              ].map((comp, i) => (
