...
const MetricsTab: React.FC<MetricsTabProps> = ({ productData }) => {
  const sheetSections = productData.extendedContent?.detailedMetrics?.sheet?.sections ?? [];
  ...
  return (
    <>
            {productData.excelLikeMetrics ? (
              <div className="bg-transparent p-3">
                <div className="w-full rounded-md border border-[#C4B89D] bg-white">
                  <div className="px-4 pt-4 pb-6">
                    <div className="bg-white text-gray-800 border border-[#D3D1C7] px-4 py-3 font-bold tracking-tight text-[16px] text-center font-poppins uppercase">
                    ...
                    {sheetSections.length ? (
                      <div className="mt-4 space-y-4">
                        {sheetSections.map((sec, sIdx) => {
                          const isInfoOnly = sec.columns.length === 0 && sec.rows.length === 0;
                          const hasTitle = sec.title.trim().length > 0;
                          const isSectionHeading = sec.title.startsWith("SECTION ");
                          const isNorthStarHeading = sec.title.startsWith("★ NORTH STAR METRIC");
                              ...
                              <div
                                ...
                                className={
                                  isSectionHeading || isNorthStarHeading
                                    ? "bg-white text-gray-800 border border-[#D3D1C7] px-4 py-2 text-[11px] font-semibold font-poppins"
                                    : isLegend
                          ...
                          return (
                            <div key={sIdx} className="bg-white border border-[#E5E7EB]">
                              {hasTitle && (
                                <div className="bg-white text-gray-800 border-b border-[#D3D1C7] px-4 py-2 text-[13px] font-semibold font-poppins">
                                  {sec.title}
                                </div>
                              )}
                              <table className="w-full table-fixed border-collapse text-[12px] leading-[1.55] font-poppins">
                                {sec.columns.some((column) => column.trim() !== "") && (
                                  <thead>
                                ...
                                <tbody>
                                  {sec.rows.map((row, rowIndex) => (
                                    <tr
                                      key={rowIndex}
                                      className={`align-top ${rowIndex % 2 === 0 ? "bg-white" : "bg-gray-50"}`}
                                    >
                                      {row.map((cell, cellIndex) => (
                                        <td
                                          key={cellIndex}
                                          className={`border border-[#E5E7EB] px-3 py-2 text-[#2C2C2C] font-medium align-top whitespace-pre-line break-words ${cellIndex === 0 ? "font-semibold text-gray-700" : ""}`}
                                        >
                                          {cell}
                                        </td>
                                      ))}
                      ...
                      <div className="space-y-6 p-4">
                        ...
                        <div className="rounded-xl border border-[#C4B89D] bg-white overflow-hidden ">
                          <div className="bg-white text-gray-800 border-b border-[#D3D1C7] px-4 py-3 text-sm font-semibold tracking-wide font-poppins">
                          ...
                          <table className="w-full border-collapse text-sm leading-relaxed font-poppins">
                            <thead>
                              <tr className="font-semibold text-[#2C2C2C]">
                                ...
                                <th className="border-b border-[#E5E7EB] bg-gray-50 px-4 py-3 w-[18%] text-center">
                                  Baseline (Traditional)
                                </th>
                                <th className="border-b border-[#E5E7EB] bg-gray-50 px-4 py-3 w-[18%] text-center">
                                  Digital Impact (Our System)
                                </th>
                                <th className="border-b border-[#E5E7EB] bg-gray-50 px-4 py-3 text-left">
                                  Primary Claim
                                </th>
                              </tr>
                            </thead>
                        ...
                        <div className="rounded-xl border border-[#C4B89D] bg-white overflow-hidden ">
                          ...
                          <table className="w-full border-collapse text-sm leading-relaxed font-poppins">
                            <thead>
                              <tr className="font-semibold text-[#2C2C2C] bg-gray-50">
                              ...
                              {productData.extendedContent.detailedMetrics.businessTargets?.map(
                                (t, i) => (
                                  ...
                                  >
                                    ...
                                    <td className="border-b border-[#E5E7EB] px-4 py-3 text-center text-gray-700 font-semibold bg-white">
                                      {t.d30Phase1}
                                    </td>
                                    <td className="border-b border-[#E5E7EB] px-4 py-3 text-center text-[#2C2C2C] font-semibold">
                                      {t.m3Current}
                                    </td>
                                    <td className="border-b border-[#E5E7EB] px-4 py-3 text-center text-gray-700 font-semibold bg-gray-100">
                                      {t.m3Phase1}
                                    </td>
              ...
              <>
                <div className="bg-white text-gray-900 border border-[#D3D1C7] p-5 rounded-xl mb-0 flex justify-between items-center">
                ...
                {productData.extendedContent?.detailedMetrics && (
                  <div className="space-y-8 mt-6">
                    <div className="space-y-4">
                      <div className="bg-white text-gray-800 border-y border-[#D3D1C7] px-4 py-2 font-semibold font-poppins text-sm uppercase">
                        Quantifiable Impact (Efficiency / Savings)
                      </div>
                      <div className="overflow-x-auto border border-[#C4B89D] rounded-xl ">
                        <table className="w-full border-collapse font-poppins text-sm leading-relaxed bg-white text-center">
                          <thead>
                            <tr className="bg-gray-50 font-semibold uppercase text-[#2C2C2C]">
                            ...
                            {productData.extendedContent?.detailedMetrics?.clientImpact?.map(
                              (metric, i) => (
                                ...
                                >
                                  ...
                                  <td className="border border-[#E5E7EB] p-3 text-[#108C72] font-semibold bg-gray-50">
                                    {metric.withSnag}
                                  </td>
                        ...
                        <table className="w-full border-collapse font-poppins text-sm leading-relaxed bg-white text-center">
                          <thead>
                            <tr className="bg-gray-50 font-semibold uppercase text-[#2C2C2C]">
                              ...
                              <th className="border border-[#D3D1C7] p-3 font-semibold text-gray-700 bg-white">
                                D30 Phase 1
                              </th>
                              <th className="border border-[#E5E7EB] p-3">
                                M3 Current
                            ...
                            {productData.extendedContent?.detailedMetrics?.businessTargets?.map(
                              (target, i) => (
                                ...
                                >
                                  ...
                                  <td className="border border-[#E5E7EB] p-3 text-gray-700 font-semibold bg-gray-50">
                                    {target.d30Phase1}
                                  </td>
                                  <td className="border border-[#E5E7EB] p-3 text-[#2C2C2C]/60 font-medium">
                                    {target.m3Current}
