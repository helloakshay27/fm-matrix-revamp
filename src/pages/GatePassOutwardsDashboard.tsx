...
export const GatePassOutwardsDashboard = () => {
  ...
  const columns: ColumnConfig[] = [
    ...
    { key: 'id', label: 'ID', sortable: true, hideable: false, draggable: true },
    ...
    { key: 'itemDetails', label: 'Item Details', sortable: true, hideable: true, draggable: true },
  ];
  ...
  // Render row data for EnhancedTable
  const renderRow = (entry: any) => ({
    ...
    itemDetails: (
      <div className="max-w-xs truncate" title={entry.itemDetails}>
        {entry.itemDetails}
      </div>
    ),
  });
