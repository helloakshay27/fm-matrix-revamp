...
const groupsData = [
  ...
  { id: 22, srNo: 22, groupName: 'SECSAF', status: true },
  { id: 23, srNo: 23, groupName: 'CUSCHA', status: true },
  { id: 24, srNo: 24, groupName: 'SMODET', status: true },
  { id: 25, srNo: 25, groupName: 'Alarm', status: true },
  { id: 26, srNo: 26, groupName: 'DG', status: true },
  { id: 27, srNo: 27, groupName: 'Nikon', status: true },
  { id: 28, srNo: 28, groupName: 'BB Electrical', status: true },
  { id: 29, srNo: 29, groupName: 'Plumbing', status: true },
  { id: 30, srNo: 30, groupName: 'Water Meter', status: true },
  { id: 31, srNo: 31, groupName: 'IT Assets', status: true },
  { id: 32, srNo: 32, groupName: 'laptop', status: true }
];
...
const subGroupsData = [
  ...
  { id: 27, srNo: 27, groupName: 'kitchen', subGroupName: 'oven', status: false },
  ...
  { id: 34, srNo: 34, groupName: 'FAN', subGroupName: 'Oriental High Speed', status: true },
  ...
  { id: 47, srNo: 47, groupName: 'Plumbing', subGroupName: 'EWTS', status: true },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6">
        {/* Breadcrumb */}
        <div className="mb-4">
          <span className="text-sm text-gray-600">Setup &gt; Asset Setup &gt; Asset Groups</span>
        </div>

        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-[#1a1a1a] mb-4">GROUPS</h1>
