...
export const CloneMaterialPRPage = () => {
  ...
  const handleSubmit = () => {
    console.log('Creating new Material PR from clone...');
    ...
    <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <Select value={supplierDetails.supplier} onValueChange={(value) => updateSupplierDetail('supplier', value)}>
              ...
              <SelectContent>
                <SelectItem value="ABC-jknknjkjnkenkfk-">ABC-jknknjkjnkenkfk-</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div>
            ...
            <Select value={supplierDetails.plantDetail} onValueChange={(value) => updateSupplierDetail('plantDetail', value)}>
              ...
              <SelectContent>
                <SelectItem value="121233234-Default Sale Org-Plant for Locktated Site 1">121233234-Default Sale Org-Plant for Locktated Site 1</SelectItem>
              </SelectContent>
            </Select>
          </div>
      ...
      <div className="bg-white rounded-lg border p-6 mb-6">
        ...
        <div className="mt-6 text-right">
          <div className="inline-block bg-[#C72030] text-white px-4 py-2 rounded">
            Total Amount: - 1000
          </div>
        </div>
      </div>
