...
export const ViewOperationalAuditSchedulePerformancePage = () => {
    ...
    const selectionActions = [
        {
            ...
            icon: BarChart3,
            onClick: () => navigate(`/maintenance/audit/operational/scheduled/view/${id}`, { state: { formCode: customFormCode } })
        },
    ];
        ...
        <div className="p-2 sm:p-4 lg:p-6">
            ...
            <div className="mb-4 sm:mb-6">
                ...
                >
                    ...
                    <span>Back to Schedule Details</span>
                </button>
                ...
                <CardContent>
                    {performanceTableData.length > 0 ? (
                        <EnhancedTable
                            ...
                            storageKey="operational-audit-performance-table"
                            emptyMessage="No performance data available"
                            enableSearch={true}
                            enableExport={true}
                            handleExport={handlePerformanceExport}
                            searchPlaceholder="Search activities..."
                            exportFileName="operational-audit-performance-data"
            ...
            <Dialog open={showFilterModal} onOpenChange={setShowFilterModal}>
                <DialogContent className="sm:max-w-md" id="operational-audit-performance-filter-modal-root">
                    <DialogHeader>
                        ...
                        <div className="flex flex-col">
                            <FormControl variant="outlined" sx={{
                                ...
                                <Select
                                    ...
                                    MenuProps={{
                                        disablePortal: true,
                                        container: () => document.getElementById('operational-audit-performance-filter-modal-root') || document.body
                                    }}
                                >
...
export default ViewOperationalAuditSchedulePerformancePage;
