...
const availableWidgets = [
    ...
    { id: "documents", name: "Recent Documents", icon: FileText, color: "orange" },
                    ...
                    <div className="space-y-2">
                        ...
                        {widgetId === "tickets" &&
                            mockData.tickets.map((ticket) => (
                                <div
                                    key={ticket.id}
                                    className="p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors cursor-pointer border border-gray-100"
                        ...
                        {widgetId === "documents" &&
                            mockData.documents.map((doc) => (
                                <div
                                    key={doc.id}
                                    className="flex items-center gap-3 p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors cursor-pointer border border-gray-100"
                ...
                <div className="mb-6 flex items-start justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 mb-1">
                            Good afternoon, {localStorage.getItem("firstName") || "Akshay Shinde"}
                        </h1>
                    </div>
                    ...
                    <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                        <DialogTrigger asChild>
                            <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors text-sm font-medium">
                                ✏️ Customise
                            </button>
                        </DialogTrigger>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-start justify-between mb-3">
                                                <Icon
                                                    className={`w-6 h-6 ${isSelected ? "text-green-600" : "text-gray-400"
                                                        }`}
                                                />
                                                <Checkbox
                                                    checked={isSelected}
                                            ...
                                            <p
                                                className={`font-medium text-sm ${isSelected ? "text-gray-900" : "text-gray-600"
                                                    }`}
                                            >
                                                {widget.name}
                                            </p>
