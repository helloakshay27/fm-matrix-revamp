...
const employeesData = [
  {
    ...
    firstName: "Test",
    lastName: "Bulk",
    email: "aaaaaaaaaaaaaaaaaaaa@gmail.com",
    mobile: "9774545411",
    userType: "User",
    deskExtension: "2189",
    department: "Tech",
    ...
    return (
      <div className="flex min-h-screen bg-gray-50 items-center justify-center">
        <div className="text-center">
          ...
          <Button
            onClick={() => navigate("/vas/space-management/setup/employees")}
          >
            Back to Employees
          </Button>
        </div>
      ...
      <div className="bg-white rounded-lg border p-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-sm">
              : {employee.deskExtension || "Not Assigned"}
            </p>
          </div>
          <div>
            <label className="block text-sm text-gray-600 mb-1">
          ...
          <div className="space-y-2 text-sm">
            <div>
              <span className="text-gray-600">
                Roster Group: {employee.rosterGroup}
              </span>
            </div>
            <div>
  ...
  const AttendanceTab = () => (
    <div className="bg-white rounded-lg border p-6">
      ...
      <div className="text-center py-8 text-gray-500">
        ...
        <p>
          No attendance records found for {employee.firstName}{" "}
          {employee.lastName}
        </p>
      </div>
    </div>
      ...
      <div className="flex-1 p-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <div className="text-sm text-gray-500 mb-1">
                Space &gt; Employees &gt; Employee Details
              </div>
        ...
        <Tabs defaultValue="basic-info" className="w-full">
          <TabsList className="grid w-full grid-cols-5">
            ...
            <TabsTrigger value="functional-details">
              Functional Details
            </TabsTrigger>
