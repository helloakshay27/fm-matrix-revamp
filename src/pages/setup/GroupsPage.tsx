...
const groupsData = [
  ...
  { id: 14, srNo: 14, groupName: 'B8 Washroom', status: true },
...
const subGroupsData = [
  ...
  { id: 21, srNo: 21, groupName: 'B8 Washroom', subGroupName: 'Ladies', status: true },
  { id: 22, srNo: 22, groupName: 'B8 Washroom', subGroupName: 'Gents', status: true }
];
    ...
    <SetupLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          <Button 
            className="bg-[#C72030] hover:bg-[#A01827] text-white"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
            <div className="p-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-[#1a1a1a]">Groups</h2>
            </div>
            <div className="overflow-x-auto max-h-96 overflow-y-auto">
              <Table>
                <TableHeader>
                  <TableRow className="bg-[#f6f4ee] hover:bg-[#f6f4ee]">
                    <TableHead className="text-center font-semibold text-[#1a1a1a]">Sr.No</TableHead>
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
            <div className="p-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-[#1a1a1a]">Sub Groups</h2>
            </div>
            <div className="overflow-x-auto max-h-96 overflow-y-auto">
              <Table>
                <TableHeader>
                  <TableRow className="bg-[#f6f4ee] hover:bg-[#f6f4ee]">
                    <TableHead className="text-center font-semibold text-[#1a1a1a]">Sr.No</TableHead>
                    <TableHead className="font-semibold text-[#1a1a1a]">Group Name</TableHead>
                    <TableHead className="font-semibold text-[#1a1a1a]">Sub Group Name</TableHead>
                    <TableHead className="text-center font-semibold text-[#1a1a1a]">Status</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {subGroups.map((subGroup) => (
                    <TableRow key={subGroup.id} className="hover:bg-gray-50 transition-colors">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">Powered by Phygital.work</p>
        </div>
      </div>
    </SetupLayout>
  );
