    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div className="flex">
            <div className="bg-[#C72030] text-white px-6 py-2 rounded-t-lg font-medium flex items-center gap-2">
              <BarChart3 className="w-4 h-4" />
              Analytics
            </div>
            <div className="bg-gray-100 text-gray-600 px-6 py-2 rounded-t-lg font-medium ml-1 flex items-center gap-2">
