...
const EmployeeBookingListDashboard = () => {
    ...
    useEffect(() => {
        ...
        dispatch(fetchFacilityBookingsData({ baseUrl, token, pageSize: 10, currentPage: pagination.current_page, userId: JSON.parse(localStorage.getItem('user') || '{}').id }))
    ...
    const handleAddBooking = () => {
        navigate('/bookings-overview/add');
    };
...
export default EmployeeBookingListDashboard;