...
const AmenityBookingListClubDashboard = () => {
  ...
  const handleAddBooking = () => {
    ...
    if (currentPath.includes("bookings")) {
      navigate('/bookings-club/add');
    } else {
      navigate('/vas/booking-club/add');
    }
  };
  ...
  const handleView = (id: number) => {
    navigate(`/club-management/amenities-booking-club/${id}`);
  };
...
export default AmenityBookingListClubDashboard;