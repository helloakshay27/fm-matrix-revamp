...
export const DebitNoteClubDetails = () => {
  ...
  const debitNotePdfRef = useRef<HTMLDivElement | null>(null);
  useEffect(() => {
    const fetchSalesOrder = async () => {
      ...
      try {
        ...
        const apiUrl = `https://${baseUrl}/lock_account_debit_notes/${id}.json?lock_account_id=${lock_account_id}&show=true`;
  ...
  const handleDownload = async () => {
    try {
      ...
      if (!debitNotePdfRef.current) {
        throw new Error("PDF preview is not ready yet");
      }

      const canvas = await html2canvas(debitNotePdfRef.current, {
        scale: 2,
        useCORS: true,
      ...
      pdf.save(`DebitNote-${salesOrder?.debit_note_number || id || "download"}.pdf`);
      sonnerToast.success("Debit note PDF downloaded successfully");
    } catch (error) {
  ...
  const debitNoteItems = Array.isArray(salesOrder?.item_details)
      ...
      <div className="w-full mx-auto space-y-6 px-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold flex items-center gap-3">
                ...
                Debit Note #{salesOrder?.debit_note_number}
        ...
        >
          ...
          >
            ...
            >
              {[
                { label: "Debit Note Details", value: "order-details" },
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-4 pb-4 border-b">
                      ...
                      <div className="flex-grow">
                        <p className="font-medium">Debit Note Created</p>
                        <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex gap-4 pb-4 border-b">
                      ...
                      <div className="flex-grow">
                        <p className="font-medium">Debit Note Updated</p>
                        <p className="text-sm text-muted-foreground">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="overflow-auto rounded-lg border bg-muted/30 p-4">
                    <div className="mx-auto bg-white" ref={activeTab === "pdf" ? debitNotePdfRef : null}>
                      <AccountingDocumentPdf
                        documentTitle="DEBIT NOTE"
                        documentType="debit_note"
                        documentNumber={salesOrder.debit_note_number}
                        documentDate={salesOrder.date || salesOrder.debit_note_date}
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this debit note? This action
              cannot be undone.
            </DialogDescription>
          </DialogHeader>
