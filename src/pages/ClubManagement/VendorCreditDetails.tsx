    ...
    useEffect(() => {
        const fetchSalesOrder = async () => {
            ...
            try {
                ...
                const apiUrl = `https://${baseUrl}/lock_account_supplier_credits/${id}.json?lock_account_id=${lock_account_id}&show=true`;
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Button variant="ghost" size="icon" onClick={() => navigate("/accounting/vendor-credits")}>
                            <ArrowLeft className="h-5 w-5" />
                        </Button>
                        <div>
                            <h1 className="text-2xl font-bold flex items-center gap-3">
                                <ShoppingCart className="h-6 w-6 text-primary" />
                                Vendor Credit #{salesOrder?.credit_note_number}
                                {/* Created on {new Date(salesOrder.created_at).toLocaleDateString()} */}
                            </h1>
                            <p className="text-sm text-muted-foreground mt-1">
                                Created on {new Date(salesOrder.created_at).toLocaleDateString("en-IN")}
                            </p>
                        </div>
                    </div>
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    <TabsList className="grid grid-cols-3 w-full max-w-md">
                        <TabsTrigger value="order-details">Credit Note Details</TabsTrigger>
                            ...
                            <CardContent>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <p className="text-base font-semibold mt-1">{salesOrder?.supplier_name}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm font-medium text-muted-foreground">Vendor Credit Note Number</p>
                                        <p className="text-base font-semibold mt-1">{salesOrder?.credit_note_number}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm font-medium text-muted-foreground">Order Number</p>
                                        <p className="text-base font-semibold mt-1">{salesOrder?.order_number}</p>
                                    </div>

                                    <div>
                                        <p className="text-sm font-medium text-muted-foreground">Vendor Credit Date</p>
                                    ...
                                    {/* <div>
                                        ...
                                        <p className="text-base font-semibold mt-1">
                                            {new Date(salesOrder?.due_date).toLocaleDateString("en-IN")}
                                        </p>
                                    </div> */}
                                    {/* <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-semibold mt-1">{salesOrder?.subject}</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                                ...
                                <div className="space-y-4">
                                    <div className="flex gap-4 pb-4 border-b">
                                        ...
                                        <div className="flex-grow">
                                            <p className="font-medium">Vendor Credit Created</p>
                                            <p className="text-sm text-muted-foreground">
                                                {new Date(salesOrder?.created_at).toLocaleString("en-IN")}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 pb-4 border-b">
                                        ...
                                        <div className="flex-grow">
                                            <p className="font-medium">Vendor Credit Updated</p>
                                            <p className="text-sm text-muted-foreground">
                                                {new Date(salesOrder?.updated_at).toLocaleString("en-IN")}
                                            </p>
                                        </div>
                                    </div>
                                </div>
