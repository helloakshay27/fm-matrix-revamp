    ...
    return (
        <div className="p-6 space-y-6 relative">
            ...
            <header className="mb-4">
                <button type="button" onClick={() => navigate('/club-management/credit-note')} className="flex items-center gap-2 text-black font-medium mb-2">
            ...
            <div className="flex items-center gap-3 justify-center pt-2">
                ...
                <Button onClick={() => navigate('/club-management/credit-note')} disabled={isSubmitting} variant="outline" className="fm-button-fix px-8 py-2">
                    Cancel
                </Button>
            </div>
...
export default CreditNoteClubEditPage;
