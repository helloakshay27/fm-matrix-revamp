...
export const CreditNoteClubDetails = () => {
    ...
    // totals.subtotal, since credit_note line_items have no "amount" field and total_amount is tax-inclusive.
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-base font-semibold mt-1 break-all">{creditNoteData?.subject || "-"}</p>
                            </div>
                            <div>
                            ...
                            <div className="mt-4">
                                ...
                                <p className="text-sm mt-1 whitespace-pre-wrap break-all">{creditNoteData?.customer_notes || "-"}</p>
                            </div>
                            <div className="mt-4">
