    ...
    useEffect(() => {
        const fetchSalesOrder = async () => {
            ...
            try {
                ...
                const apiUrl = `https://${baseUrl}/lock_account_bills/${id}.json?lock_account_id=1&show=true`;
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    <TabsList className="grid grid-cols-3 w-full max-w-md">
                        <TabsTrigger value="order-details">Bill Details</TabsTrigger>
                        <TabsTrigger value="customer-info">Vendor Info</TabsTrigger>
                            ...
                            <CardContent>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <p className="text-base font-semibold mt-1">{salesOrder?.vendor_name}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm font-medium text-muted-foreground">Bill Number</p>
                                        <p className="text-base font-semibold mt-1">{salesOrder?.bill_number}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-base font-semibold mt-1">
                                            {new Date(salesOrder?.bill_date).toLocaleDateString("en-IN")}
                                        </p>
                                    </div>
                                    <div>
