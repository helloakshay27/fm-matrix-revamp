...
const GroupsDashboard = () => {
  return (
    <div className="p-6 bg-[#fafafa] min-h-screen">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#1a1a1a] mb-2">Groups Management</h1>
        <p className="text-gray-600">Organize and manage user groups</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-center h-64 text-gray-500">
          <div className="text-center">
            ...
            <p className="text-sm">Start by creating your first group</p>
          </div>
        </div>
      </div>
    </div>
