...
const EnergyDashboard = () => {
  return (
    <div className="p-6 bg-[#fafafa] min-h-screen">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#1a1a1a] mb-2">Energy Management</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-center h-64 text-gray-500">
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium mb-2">No energy assets found</h3>
            <p className="text-sm">Start by adding your first energy asset</p>
          </div>
        </div>
      </div>
    </div>
