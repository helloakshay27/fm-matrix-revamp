...
//               {approvalStatus.all_level_approved
//                 ? "Approved"
//                 : approvalStatus.all_level_approved === false
//                   ? "Rejected"
//                   : "Pending"}
//             </span>
//           </div>
...
//                 <th className="border border-gray-300 px-3 py-2 text-sm text-left font-semibold">
//                   S.No.
//                 </th>
//                 <th className="border border-gray-300 px-3 py-2 text-sm text-left font-semibold">
//                   Inventory
...
//             </thead>
//             <tbody>
//               {grnDetails.debit_notes?.length ? (
//                 grnDetails.debit_notes.map((note: any) => (
//                   <tr key={note.id}>
//                     <td className="border border-gray-300 px-3 py-2 text-sm">
//                       {note.id}
//                     </td>
...
//             </thead>
//             <tbody>
//               {grnDetails.payment_details?.length ? (
//                 grnDetails.payment_details.map((pay: any, idx: number) => (
//                   <tr key={idx}>
//                     <td className="border border-gray-300 px-3 py-2 text-sm">
//                       {pay.action}
//                     </td>
...
//             </thead>
//             <tbody>
//               {grnDetails.retention_payment_details?.length ? (
//                 grnDetails.retention_payment_details.map(
//                   (ret: any, idx: number) => (
//                     <tr key={idx}>
//                       <td className="border border-gray-300 px-3 py-2 text-sm">
//                         {ret.action}
...
//             </thead>
//             <tbody>
//               {grnDetails.qc_payment_details?.length ? (
//                 grnDetails.qc_payment_details.map((qc: any, idx: number) => (
//                   <tr key={idx}>
//                     <td className="border border-gray-300 px-3 py-2 text-sm">
//                       {qc.amount}
//                     </td>
...
import { Button } from "@/components/ui/button";
import { useLocation, useNavigate, useParams } from "react-router-dom";
import { Eye, Printer, Rss } from "lucide-react";
import { toast } from "sonner";
import { useAppDispatch } from "@/store/hooks";
import { fetchSingleGRN, approveGRN, rejectGrn } from "@/store/slices/grnSlice";
import {
