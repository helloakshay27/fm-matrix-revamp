                        ...
                        <div className="flex flex-col lg:flex-row gap-10">
                          ...
                          <div className="flex-1 flex gap-16">
                            {[colA, colB].map((col, ci) => (
                              <div key={ci} className="flex flex-col gap-4 min-w-[320px]">
                                {col.map((field) => (
                                  <div key={field.label} className="flex text-[14px] leading-snug">
                                    <div className="w-[200px] text-[#6B6B6B] font-medium">
                                      {field.label}
                                    </div>
                                    <div className="flex-1 text-[14px] font-semibold text-[#1A1A1A] break-words">
                                      {field.value}
                                    </div>
                                  </div>
                                ))}
        ...
        <MenuItem key={template.id} value={template.id}>
          {template.identifier_action}
                                ...
                                <div className="mt-2 space-y-2" style={{ fontSize: '14px', fontWeight: 'medium' }}>
                                  {(() => {
                                    ...
                                    return selectedValues.map((value, index) => {
                                      ...
                                      return (
                                        <div key={index} className="text-[14px] font-medium text-[#000000] leading-[16px] max-h-32 pr-1">
                            ...
                            <div className="flex flex-col">
                              ...
                              <div className="text-[14px] font-medium text-[#000000] leading-[16px] max-h-32 pr-1">
                                {ticketData.notes ||
                                  ticketData.heading ||
                                  ticketData.text ||
                      ...
                      <div className="bg-[#f2efea] border border-[#f2efea] p-4">
                        <FormControl fullWidth variant="outlined" sx={fieldStyles}>
                          ...
                          <Select
                            ...
                            onChange={(e) => handlePreventiveActionChange(e.target.value as string)}
                          >
                            <MenuItem value="">
                      ...
                      <div className="bg-[#f2efea] border border-[#f2efea] p-4">
                        <FormControl fullWidth variant="outlined" sx={fieldStyles}>
                          ...
                          <Select
                            ...
                            onChange={(e) => handleShortTermImpactChange(e.target.value as string)}
                          >
                            <MenuItem value="">
                      ...
                      <div className="bg-[#f2efea] border border-[#f2efea] p-4">
                        <FormControl fullWidth variant="outlined" sx={fieldStyles}>
                          ...
                          <Select
                            ...
                            onChange={(e) => handleCorrectiveActionChange(e.target.value as string)}
                          >
                            <MenuItem value="">
                      ...
                      <div className="bg-[#f2efea] border border-[#f2efea] p-4">
                        <FormControl fullWidth variant="outlined" sx={fieldStyles}>
                          ...
                          <Select
                            ...
                            onChange={(e) => handleLongTermImpactChange(e.target.value as string)}
                          >
                            <MenuItem value="">
                      ...
                      <div>
                        <FormControl fullWidth variant="outlined" sx={fieldStyles}>
                          ...
                          <Select
                            ...
                            onChange={(e) => handleResponsiblePersonChange(e.target.value as string)}
