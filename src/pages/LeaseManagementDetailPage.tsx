...
import { ArrowLeft, Star, Download, Share2, Building } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { InstallModal } from '@/components/InstallModal';

const LeaseManagementDetailPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#C72030]">
        ...
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center">
              <Building className="w-8 h-8 text-[#C72030]" />
            </div>
            <div>
              <h1 className="text-2xl font-bold">Lease Management</h1>
              <p className="text-white/80">Comprehensive lease management system</p>
        ...
        <div className="max-w-6xl mx-auto p-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Boost your business with the Lease Management solution. It combines data and finance modules to deliver both finance 
                  and operational excellence. The system enables you to efficiently manage your lease portfolio and integrate with 
                  various business systems for comprehensive lease management.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-600">
                  <li>• Reduce the potential for data leakages and finance solutions, enhancing operational procedures, and allowing growth</li>
                  <li>• Streamline contract management - one active lease is a complete contract, not just a collection of amendments</li>
                  <li>• Keep your business by year, critical business development with standardized enrichment rules for Zoho CRM</li>
                  <li>• Drive fresh value from your lease management systems and seamlessly integration with other systems</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="bg-[#C72030] text-white px-3 py-1 rounded text-sm">Real Estate</span>
                  <span className="bg-[#C72030] text-white px-3 py-1 rounded text-sm">Management</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="font-semibold mb-3">For Support Requests</h3>
                <p className="text-sm text-gray-600 mb-3">
                  Please contact directly at support@fmsolutions.com
                </p>
              </div>
      ...
      <InstallModal 
        ...
        appName="Lease Management"
      />
    </div>
  );
};

export default LeaseManagementDetailPage;
