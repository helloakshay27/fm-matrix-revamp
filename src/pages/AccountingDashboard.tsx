...
export const AccountingDashboard = () => {
  const [currentView, setCurrentView] = useState<'form' | 'details' | 'edit' | 'marketplace'>('marketplace');
  ...
  // Marketplace form (Default view for Market Place > Accounting)
  ...
  // Initial form (Image 1) - This should show after marketplace form submission
  if (currentView === 'form') {
    return (
      <div className="p-6">
        {/* Breadcrumb */}
