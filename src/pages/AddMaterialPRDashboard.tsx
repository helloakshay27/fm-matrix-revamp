...
export const AddMaterialPRDashboard = () => {
  ...
  SUPPLIER DETAILS
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              mt: 1
                ...
                <MuiSelect label="Supplier*" displayEmpty sx={fieldStyles}>
              ...
              mt: 1
                ...
                <MuiSelect label="Billing Address*" displayEmpty sx={fieldStyles}>
              ...
              mt: 1
                ...
                <MuiSelect label="Delivery Address*" displayEmpty sx={fieldStyles}>
              ...
              <TextField label="Advance Amount" placeholder="Enter Number" fullWidth variant="outlined" InputLabelProps={{
              shrink: true
            }} InputProps={{
              sx: fieldStyles
            }} sx={{
  ...
  ITEM DETAILS
            ...
            <CardContent className="space-y-4">
              {items.map(item => <div key={item.id} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 border rounded-lg relative">
                  {items.length > 1 && <Button onClick={() => removeItem(item.id)} size="sm" variant="ghost" className="absolute top-2 right-2 p-1 h-8 w-8">
                      <X className="w-4 h-4" />
                    </Button>}
                ...
                mt: 1
                    ...
                    <MuiSelect label="Item Details*" displayEmpty sx={fieldStyles}>
                      <MenuItem value=""><em>Select Inventory</em></MenuItem>
                      <MenuItem value="item1">Item 1</MenuItem>
                    </MuiSelect>
                  </FormControl>
                  
                  <TextField label="SAC/HSN Code" placeholder="Enter Code" fullWidth variant="outlined" InputLabelProps={{
                shrink: true
              }} InputProps={{
                sx: fieldStyles
              }} sx={{
                mt: 1
                  ...
                  <TextField label="Product Description*" placeholder="Product Description" fullWidth variant="outlined" InputLabelProps={{
                shrink: true
              }} InputProps={{
                sx: fieldStyles
              }} sx={{
                mt: 1
                  ...
                  <TextField label="Each" placeholder="Enter Number" fullWidth variant="outlined" InputLabelProps={{
                shrink: true
              }} InputProps={{
                sx: fieldStyles
              }} sx={{
                mt: 1
                  ...
                  <TextField label="Quantity*" placeholder="Enter Number" fullWidth variant="outlined" InputLabelProps={{
                shrink: true
              }} InputProps={{
                sx: fieldStyles
              }} sx={{
                mt: 1
                  ...
                  <TextField label="Expected Date*" type="date" defaultValue="2025-06-14" fullWidth variant="outlined" InputLabelProps={{
                shrink: true
              }} InputProps={{
                sx: fieldStyles
              }} sx={{
                mt: 1
                  ...
                  <TextField label="Amount*" placeholder="Enter Number" fullWidth variant="outlined" InputLabelProps={{
                shrink: true
              }} InputProps={{
                sx: fieldStyles
              }} sx={{
  ...
  ATTACHMENTS
        ...
        <div className="space-y-4">
          ...
          <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white" onClick={() => navigate('/finance/material-pr')}>
            Submit
          </Button>
        </div>
      </div>
