...
const mapLockPayment = (lp: LockPaymentAPI): PaymentReceived => {
  ...
  return {
    id: lp.id,
    payment_number: Number(
      lp.payment_number || lp.receipt_number || lp.order_number || lp.id
    ),
    date,
          ...
          <div>
            {sidebarList?.map((item) => (
              <button
                key={item.id}
                onClick={() =>
                  navigate(`/accounting/payments-received/${item.id}`)
                }
          ...
          <div className="bg-white shadow-sm border rounded">
            ...
            <div className="relative">
              <div className="absolute -top-3 left-0">
                <div className="bg-green-500 text-white px-3 py-1 rotate-[-45deg] transform origin-left shadow">
                  Paid
                </div>
              </div>
              <div className="p-10">
