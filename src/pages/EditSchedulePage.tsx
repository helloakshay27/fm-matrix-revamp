...
export const EditSchedulePage = () => {
  ...
  const handleUpdateTask = (sectionId: number, taskId: number, field: string, value: any) => {
    setSections(sections.map(section => section.id === sectionId ? {
      ...section,
      tasks: section.tasks.map(task => task.id === taskId ? {
        ...task,
        [field]: value
      } : task)
    } : section));
    ...
    return <div className="space-y-6">
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            <input type="radio" id="specific-minute" name="minute-type" checked={specificMinute} onChange={() => setSpecificMinute(true)} className="text-blue-600" />
            <Label htmlFor="specific-minute" className="font-medium text-blue-600">Specific minute (choose one or many)</Label>
          </div>
          
          {specificMinute && <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="grid grid-cols-10 gap-2">
                {minutes.map(minute => <div key={minute} className="flex items-center space-x-1">
                    <Checkbox id={`minute-${minute}`} checked={selectedMinutes.includes(minute)} onChange={e => {
                if (e.target.checked) {
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            <input type="radio" id="every-minute" name="minute-type" checked={!specificMinute} onChange={() => setSpecificMinute(false)} className="text-blue-600" />
            <Label htmlFor="every-minute" className="font-medium">Every minute between minute</Label>
            <FormControl size="small" sx={{
            minWidth: 80
          }}>
              <Select value="00" displayEmpty sx={{
              height: {
                xs: '36px',
                md: '45px'
              },
  ...
  const renderCronHours = () => {
    ...
    return <div className="space-y-6">
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            <input type="radio" id="specific-hour" name="hour-type" checked={specificHour} onChange={() => setSpecificHour(true)} className="text-blue-600" />
            <Label htmlFor="specific-hour" className="font-medium text-blue-600">Specific hour (choose one or many)</Label>
          </div>
          
          {specificHour && <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="grid grid-cols-12 gap-2">
                {hours.map(hour => <div key={hour} className="flex items-center space-x-1">
                    <Checkbox id={`hour-${hour}`} checked={selectedHours.includes(hour)} onChange={e => {
                if (e.target.checked) {
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            <input type="radio" id="every-hour" name="hour-type" checked={!specificHour} onChange={() => setSpecificHour(false)} className="text-blue-600" />
            ...
            minWidth: 80
              ...
              <Select value="23" displayEmpty sx={{
              height: {
                xs: '36px',
                md: '45px'
              },
  ...
  const renderCronDay = () => {
    ...
    return <div className="space-y-6">
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            <input type="radio" id="specific-day" name="day-type" checked={specificDay} onChange={() => setSpecificDay(true)} className="text-blue-600" />
            <Label htmlFor="specific-day" className="font-medium text-blue-600">Specific day (choose one or many)</Label>
          </div>
          
          {specificDay && <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="grid grid-cols-10 gap-2">
                {days.map(day => <div key={day} className="flex items-center space-x-1">
                    <Checkbox id={`day-${day}`} checked={selectedDays.includes(day)} onChange={e => {
                if (e.target.checked) {
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            <input type="radio" id="every-day" name="day-type" checked={!specificDay} onChange={() => setSpecificDay(false)} className="text-blue-600" />
            <Label htmlFor="every-day" className="font-medium">Every day between day</Label>
            <FormControl size="small" sx={{
            minWidth: 80
          }}>
              <Select value="1" displayEmpty sx={{
              height: {
                xs: '36px',
                md: '45px'
              },
            ...
            minWidth: 80
              ...
              <Select value="31" displayEmpty sx={{
              height: {
                xs: '36px',
                md: '45px'
              },
  ...
  const renderCronMonth = () => {
    ...
    return <div className="space-y-6">
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            <input type="radio" id="specific-month" name="month-type" checked={specificMonth} onChange={() => setSpecificMonth(true)} className="text-blue-600" />
            <Label htmlFor="specific-month" className="font-medium text-blue-600">Specific month (choose one or many)</Label>
          </div>
          
          {specificMonth && <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="grid grid-cols-3 gap-2">
                {months.map(month => <div key={month.value} className="flex items-center space-x-2">
                    <Checkbox id={`month-${month.value}`} checked={selectedMonths.includes(month.value)} onChange={e => {
                if (e.target.checked) {
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            <input type="radio" id="every-month" name="month-type" checked={!specificMonth} onChange={() => setSpecificMonth(false)} className="text-blue-600" />
            ...
            minWidth: 128
              ...
              <Select value="12" displayEmpty sx={{
              height: {
                xs: '36px',
                md: '45px'
              },
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-8 mb-4">
          <div className="flex items-center gap-3">
            ...
            <Switch id="create-ticket" checked={createTicket} onCheckedChange={setCreateTicket} className="bg-green-600 hover:bg-green-500" />
          </div>
        ...
        {createTicket && <div className="mb-4 space-y-3">
            ...
            minWidth: 256
                ...
                <Select value={selectedCategory} label="Select Category" onChange={e => setSelectedCategory(e.target.value)} sx={muiFieldStyles}>
      ...
      <div className="space-y-6">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-3">
                ...
                <RadioGroup value={type} onChange={e => setType(e.target.value)} row sx={{
                gap: 3,
                flexWrap: 'wrap'
              }}>
                  <FormControlLabel value="PPM" control={<Radio sx={{
                  color: '#C72030',
                  '&.Mui-checked': {
                    color: '#C72030'
                  }
                }} />} label="PPM" />
                  <FormControlLabel value="AMC" control={<Radio sx={{
                  color: '#C72030',
                  '&.Mui-checked': {
                    color: '#C72030'
                  }
                }} />} label="AMC" />
                  <FormControlLabel value="Preparedness" control={<Radio sx={{
                  color: '#C72030',
                  '&.Mui-checked': {
                    color: '#C72030'
                  }
                }} />} label="Preparedness" />
                  <FormControlLabel value="Hoto" control={<Radio sx={{
                  color: '#C72030',
                  '&.Mui-checked': {
                    color: '#C72030'
                  }
                }} />} label="Hoto" />
                  <FormControlLabel value="Routine" control={<Radio sx={{
                  color: '#C72030',
                  '&.Mui-checked': {
                    color: '#C72030'
                  }
                }} />} label="Routine" />
                  <FormControlLabel value="Audit" control={<Radio sx={{
                  color: '#C72030',
                  '&.Mui-checked': {
                    color: '#C72030'
                  }
              ...
              <div className="space-y-3">
                ...
                flexWrap: 'wrap'
                  ...
                  <FormControlLabel value="Vendor" control={<Radio sx={{
                  color: '#C72030',
                  '&.Mui-checked': {
                    color: '#C72030'
                  }
                }} />} label="Vendor" />
                  <FormControlLabel value="Training" control={<Radio sx={{
                  color: '#C72030',
                  '&.Mui-checked': {
                    color: '#C72030'
                  }
            ...
            <div className="space-y-2">
              <TextField label="Activity Name" value={activityName} onChange={e => setActivityName(e.target.value)} placeholder="Enter Activity Name" fullWidth variant="outlined" sx={muiFieldStyles} />
            </div>
            <div className="space-y-2">
              <TextField label="Description" value={description} onChange={e => setDescription(e.target.value)} placeholder="Enter Description" multiline rows={4} fullWidth variant="outlined" sx={multilineFieldStyles} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            }} className="text-white" onClick={handleAddSection}>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={group} label="Select Group" onChange={e => setGroup(e.target.value)} sx={muiFieldStyles}>
              ...
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={subGroup} label="Select Sub Group" onChange={e => setSubGroup(e.target.value)} sx={muiFieldStyles}>
            ...
            {/* Sections */}
            <div className="space-y-4">
              {sections.map(section => <div key={section.id} className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <TextField value={section.name} onChange={e => {
                    ...
                    <div className="flex items-center gap-2">
                      <Button variant="outline" onClick={() => handleAddQuestion(section.id)} className="border-[#C72030] text-[#C72030]">
                        <Plus className="w-4 h-4 mr-2" />
                        Add Question
                      </Button>
                      {sections.length > 1 && <Button variant="outline" size="icon" onClick={() => handleRemoveSection(section.id)} className="border-red-500 text-red-500 hover:bg-red-50">
                          <X className="w-4 h-4" />
                        </Button>}
                    </div>
                  </div>
                  ...
                  {section.tasks.length > 0 && <Table>
                      ...
                      <TableBody>
                        {section.tasks.map(task => <TableRow key={task.id}>
                            <TableCell>
                              <TextField value={task.task} onChange={e => handleUpdateTask(section.id, task.id, 'task', e.target.value)} size="small" sx={muiFieldStyles} />
                            </TableCell>
                            <TableCell>
                              <FormControl size="small" sx={{
                        minWidth: 120
                      }}>
                                <Select value={task.inputType} onChange={e => handleUpdateTask(section.id, task.id, 'inputType', e.target.value)} sx={muiFieldStyles}>
                            ...
                            <TableCell>
                              <Checkbox checked={task.mandatory} onChange={e => handleUpdateTask(section.id, task.id, 'mandatory', e.target.checked)} sx={{
                        color: '#C72030',
                        '&.Mui-checked': {
                          color: '#C72030'
                        }
                            ...
                            <TableCell>
                              <Checkbox checked={task.reading} onChange={e => handleUpdateTask(section.id, task.id, 'reading', e.target.checked)} sx={{
                        color: '#C72030',
                        '&.Mui-checked': {
                          color: '#C72030'
                        }
                            ...
                            <TableCell>
                              <Checkbox checked={task.helpText} onChange={e => handleUpdateTask(section.id, task.id, 'helpText', e.target.checked)} sx={{
                        color: '#C72030',
                        '&.Mui-checked': {
                          color: '#C72030'
                        }
                            ...
                            <TableCell>
                              <Button variant="outline" size="icon" onClick={() => handleRemoveQuestion(section.id, task.id)} className="border-red-500 text-red-500 hover:bg-red-50">
                                <X className="w-4 h-4" />
                              </Button>
                            </TableCell>
                          </TableRow>)}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={assignTo} label="Assign To" onChange={e => setAssignTo(e.target.value)} sx={muiFieldStyles}>
              ...
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={scanType} label="Scan Type" onChange={e => setScanType(e.target.value)} sx={muiFieldStyles}>
              ...
              <div className="space-y-2">
                <div className="flex gap-2">
                  ...
                  width: '100%'
                    ...
                    <Select value={planDuration} label="Duration" onChange={e => setPlanDuration(e.target.value)} sx={muiFieldStyles}>
                      <MenuItem value="Day">Day</MenuItem>
                      <MenuItem value="Hour">Hour</MenuItem>
                      <MenuItem value="Week">Week</MenuItem>
                    </Select>
                  </FormControl>
                  <TextField label="Value" value={planDurationField} onChange={e => setPlanDurationField(e.target.value)} sx={{
                  width: 80,
                  ...muiFieldStyles
                }} />
                </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={priority} label="Priority" onChange={e => setPriority(e.target.value)} sx={muiFieldStyles}>
              ...
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={emailTriggerRule} label="Email Trigger Rule" onChange={e => setEmailTriggerRule(e.target.value)} sx={muiFieldStyles}>
              ...
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={supervisors} label="Supervisors" onChange={e => setSupervisors(e.target.value)} sx={muiFieldStyles}>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={category} label="Category" onChange={e => setCategory(e.target.value)} sx={muiFieldStyles}>
                    <MenuItem value="Technical">Technical</MenuItem>
                    <MenuItem value="Non Technical">Non Technical</MenuItem>
                  </Select>
                </FormControl>
              ...
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={submissionTime} label="Submission Time" onChange={e => setSubmissionTime(e.target.value)} sx={muiFieldStyles}>
              ...
              <div className="space-y-2">
                <TextField label="Submission Time Field" value={submissionTimeField} onChange={e => setSubmissionTimeField(e.target.value)} fullWidth variant="outlined" sx={muiFieldStyles} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <div className="flex gap-2">
                  ...
                  width: '100%'
                    ...
                    <Select value={graceTime} label="Grace Time" onChange={e => setGraceTime(e.target.value)} sx={muiFieldStyles}>
                      <MenuItem value="Day">Day</MenuItem>
                      <MenuItem value="Hour">Hour</MenuItem>
                      <MenuItem value="Week">Week</MenuItem>
                    </Select>
                  </FormControl>
                  <TextField label="Value" value={graceTimeField} onChange={e => setGraceTimeField(e.target.value)} sx={{
                  width: 80,
                  ...muiFieldStyles
                }} />
                </div>
              ...
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={lockOverdueTask} label="Lock Overdue Task" onChange={e => setLockOverdueTask(e.target.value)} sx={muiFieldStyles}>
              ...
              <div className="space-y-2">
                <FormControl fullWidth variant="outlined">
                  ...
                  <Select value={frequency} label="Frequency" onChange={e => setFrequency(e.target.value)} sx={muiFieldStyles}>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <TextField label="Cron Expression" value={cronExpression} onChange={e => setCronExpression(e.target.value)} fullWidth variant="outlined" sx={muiFieldStyles} />
              </div>
              <div className="space-y-2">
                <TextField label="Start From" type="date" value={startFrom} onChange={e => setStartFrom(e.target.value)} fullWidth variant="outlined" InputLabelProps={{
                shrink: true
              }} sx={muiFieldStyles} />
              </div>
              <div className="space-y-2">
                <TextField label="End At" type="date" value={endAt} onChange={e => setEndAt(e.target.value)} fullWidth variant="outlined" InputLabelProps={{
                shrink: true
              }} sx={muiFieldStyles} />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <FormControl fullWidth variant="outlined">
                ...
                <Select value={selectSupplier} label="Select Supplier" onChange={e => setSelectSupplier(e.target.value)} sx={muiFieldStyles}>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Checkbox id="edit-timings" checked={editTimings} onChange={e => setEditTimings(e.target.checked)} sx={{
                color: '#C72030',
                '&.Mui-checked': {
                  color: '#C72030'
                }
          ...
          {editTimings && <CardContent className="space-y-6">
              ...
              <div className="border-b border-gray-200">
                <div className="flex space-x-0">
                  {['Minutes', 'Hours', 'Day', 'Month'].map(tab => <button key={tab} onClick={() => setCronTab(tab)} className={`px-6 py-3 font-medium text-sm border-b-2 transition-colors ${cronTab === tab ? 'border-blue-500 text-blue-600 bg-blue-50' : 'border-transparent text-gray-500 hover:text-gray-700 hover:bg-gray-50'}`}>
                      {tab}
                    </button>)}
                </div>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                {associationsData.map((item, index) => <TableRow key={index}>
        ...
        <div className="flex gap-3 pt-6">
          <Button onClick={() => navigate('/maintenance/schedule')} variant="outline" className="px-8">
            Cancel
          </Button>
