...
const EmployeeBookingCalenderView = () => {
    ...
    const handleSlotClick = (facilityId, slotId, isBooked, facilityBookingId, slot) => {
        if (isBooked && facilityBookingId) {
            ...
            navigate(`/bookings-overview/${facilityBookingId}`);
        } else if (!isBooked) {
            ...
            navigate(`/bookings-overview/add?${queryParams}`);
        }
    };
...
export default EmployeeBookingCalenderView;