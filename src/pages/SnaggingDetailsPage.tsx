...
export const SnaggingDetailsPage = () => {
  ...
  // Get item data from navigation state or use default
  ...
  return (
    <div className="p-6 bg-white min-h-screen">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-xl font-semibold mb-2">{item.tower} {item.floor} {item.flat}</h1>
        <h2 className="text-lg font-medium">Checklist {item.checklistName}</h2>
      </div>
