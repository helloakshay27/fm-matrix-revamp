...
export interface HostWiseGuestResponse {
  success: number;
  message: string;
...
export const hostWiseGuestAPI = {
  getHostWiseGuestCount: async (
    fromDate: string, 
    toDate: string
  ): Promise<HostWiseGuestResponse> => {
...
export default hostWiseGuestAPI;