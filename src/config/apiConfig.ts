...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    ROLES: `${window.location.hostname==="localhost" ? "/roles.json":"/lock_roles.json"}`,
    ROLES_WITH_MODULES: `${window.location.hostname==="localhost" ? "/roles_with_modules.json":"/lock_roles_with_modules.json"}`,
    ...
    RESPONSE_ESCALATION: "/pms/admin/response_escalation.json",
    RESOLUTION_ESCALATION: "/pms/admin/resolution_escalation.json",
    ...
    MODIFY_HELPDESK_SUB_CATEGORY:
      "/pms/admin/modify_helpdesk_sub_category.json",
    ...
    TICKET_AGING_MATRIX_DOWNLOAD:
      "/pms/admin/complaints/ticket_ageing_matrix_downloads.json",
    TICKET_UNIT_CATEGORYWISE_DOWNLOAD:
      "/pms/admin/complaints/chart_unit_categorywise_downloads.json",
    TICKET_RESOLUTION_TAT_DOWNLOAD:
      "/pms/admin/complaints/chart_resolution_tat_downloads.json",
    TICKET_RESPONSE_TAT_DOWNLOAD:
      "/pms/admin/complaints/chart_response_tat_downloads.json",
    COST_APPROVALS_CREATE: "/pms/create_muliple_cost_Approvals.json",
    COST_APPROVALS_CREATE_MULTIPLE:
