...
const AddSprintsModal = ({ id, deleteSprints }) => {
  ...
  return(
            <div className="flex flex-col  relative justify-start gap-4 w-full bottom-0 py-3 bg-white my-10 ">
                         <DeleteOutlinedIcon onClick={()=>deleteSprints(id)} className="absolute top-3 right-3 text-red-600 cursor-pointer "/>
                        <div className="mt-4 space-y-2">
                            ...
                            />
                                ...
                                <div className="w-1/2 flex flex-col justify-between">
                                   ...
                                   <CustomDropdown options={options} value={"Sprint Owner"} />
                                </div>
...
<div
                    ...
                    >
                        ...
                        <div className="relative">
                            <label onClick={handleAddSprints} className="absolute text-[12px] text-[red] top-2 right-2 mt-2 cursor-pointer">Add Sprints</label>
                        </div>

                        {
                          sprints.map(sprints=><AddSprintsModal id={sprints.id} deleteSprints={handleDeleteSprints}/>)
                        }
