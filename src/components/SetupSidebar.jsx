...
//         >
//             <div
//                 className={`flex items-center ${isSidebarOpen ? "justify-end" : "justify-center"
//                     } px-5 py-6`}
//             >
//                 {isSidebarOpen ? (
//                     <ChevronLeft
...
//                         <li
//                             className={`sidebar-link cursor-pointer ${!isSidebarOpen ? "justify-center" : ""
//                                 } ${isSubMenuOpen ? "bg-[#c72030] text-white" : ""}`}
