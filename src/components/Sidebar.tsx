...
import { 
  ...
  Archive, TreePine, FlaskConical, Recycle
} from 'lucide-react';
...
const modulesByPackage = {
  ...
  'Settings': [
    ...
    { 
      ...
      subItems: [
        { name: 'Checklist Group and Sub Group', href: '/settings/checklist-setup/groups', color: 'text-[#1a1a1a]' },
    ...
    { 
      ...
      subItems: [
        ...
        { 
          name: 'Incident', 
          href: '/settings/safety/incident', 
          color: 'text-[#1a1a1a]',
          subItems: [
            { name: 'Setup', href: '/settings/safety/incident/setup', color: 'text-[#1a1a1a]' }
          ]
        }
      ]
    },
