        ...
        <Dialog open={openDialog} onClose={handleCloseDialog} TransitionComponent={Transition}>
            ...
            >
                ...
                <Tabs defaultValue="details" className="w-full h-full">
                    ...
                    <TabsContent value="details" className="h-screen overflow-y-auto mb-10">
                        <form className="h-full" onSubmit={handleSubmit}>
                            <div className="max-w-[90%] mx-auto h-full pr-3">
                                <div className="mt-4 space-y-2">
                                    <TextField
                                        label="Project Title"
                                        name="title"
                    ...
                    <TabsContent value="milestone" className="h-screen">
                        <h1 className="text-2xl font-bold text-center mt-8">Milestone Content</h1>
                    </TabsContent>
                </Tabs>
            </DialogContent>
        </Dialog >
