...
import { fetchOrganizations } from "../../../redux/slices/organizationSlice";
import { createCompany, editCompany, fetchCompany, resetCreateSuccess, resetEditSuccess } from "../../../redux/slices/companySlice";
...
const CompanyModal = ({ open, setOpenModal, editData }) => {
    ...
    const handleSubmit = () => {
        ...
        if (editData) {
            dispatch(editCompany({ token, payload, id: editData.id }));
        } else {
