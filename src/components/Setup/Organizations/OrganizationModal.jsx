...
// const OrganizationModal = ({ open, setOpenModal, editData }) => {
...
//         if (editData) {
//             dispatch(editOrganization({ token, payload: formData, id: editData.id }));
//         } else {
//             dispatch(createOrganization({ token, payload: formData }));
//         }
//     };
...
const OrganizationModal = ({ open, setOpenModal, editData, onEditSubmit }) => {
    ...
    const handleSubmit = () => {
        ...
        if (editData) {
            onEditSubmit(formData, editData.id); // Use onEditSubmit prop
        } else {
            dispatch(createOrganization({ token, payload: formData }));
        }
    };
