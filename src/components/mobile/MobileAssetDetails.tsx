...
const assetOptions = [
  ...
  { key: 'asset-movement', label: 'Asset Movement', icon: Move },
        ...
        return (
          <div className="space-y-2 text-sm">
            <div className="p-2 border rounded">
              ...
              <p className="text-gray-500 text-xs">Due: 2025-01-30</p>
            </div>
            <div className="p-2 border rounded">
              <p className="font-medium">Monthly Inspection</p>
              <p className="text-gray-500 text-xs">Due: 2025-02-01</p>
            </div>
          </div>
        );
      case 'asset-movement':
        return (
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span>{asset.siteName || 'Main Site'}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Last Moved:</span>
        ...
        return (
          <div className="space-y-2 text-sm">
            <div className="p-2 border rounded">
              ...
              <p className="text-gray-500 text-xs">Status: Open</p>
            </div>
            <div className="p-2 border rounded">
              <p className="font-medium">Repair Ticket #002</p>
              <p className="text-gray-500 text-xs">Status: Closed</p>
            </div>
          </div>
        );
      case 'amc-details':
