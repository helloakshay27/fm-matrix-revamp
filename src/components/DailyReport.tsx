...
const DailyReport: React.FC = () => {
    ...
    const Card = ({ title, value }: { title: string; value: React.ReactNode }) => (
        ...
        >
            <div className="text-lg sm:text-lg font-medium text-[#1a1a1a] mb-1 print:text-[12px]">{title}</div>
    ...
    return (
        <div className=" print:p-0">
            ...
            <div className="w-full" style={{ backgroundColor: ACCENT }}>
                <div className="w-full h-20 flex items-center ml-5 justify-start print:h-12">
                    <svg
                        width="409"
                        height="74"
                        viewBox="0 0 409 74"
                        ...
                        className="h-12 w-auto print:h-7"
