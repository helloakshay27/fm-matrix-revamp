  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-0 rounded-none shadow-none"
        ),
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-none border-0 shadow-none hover:bg-gray-100"
        ),
        day_range_end: "day-range-end",
        day_selected: "bg-[#C72030] text-white hover:bg-[#C72030] hover:text-white focus:bg-[#C72030] focus:text-white rounded-none",
