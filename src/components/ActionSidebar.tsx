...
const actionIconMap: Record<string, any> = {
    ...
    maintenance_design_insight_setup_setup: Settings,
    finance: Calculator,
        ...
        return (
            <div key={func.function_id}>
                <button
                    ...
                    className={`flex items-center justify-between gap-3 w-full px-3 py-2 rounded-lg text-sm font-medium transition-colors hover:bg-[#DBC2A9] relative ${isActive
