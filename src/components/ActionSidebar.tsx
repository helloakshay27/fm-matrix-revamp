...
const actionIconMap: Record<string, any> = {
  ...
  // Settings Module (from API response)
  ...
  report_setup: FileText,
  notification_setup: Bell,
  shift: Clock,
  roster: Calendar,
  lock_module: Shield,
  lock_function: Shield,
  lock_sub_function: Shield,
  department: Building,
  role: UserCog,
  approval_matrix: CheckSquare,
  ticket_management: Ticket,
  ticket_setup: Settings,
  escalation_matrix: AlertTriangle,
  cost_approval: Calculator,
  fm_groups: Users,
  amenity_settings: Star,
  amenity_setup: Settings,
  category_setup: Layers,
  accessories_setup: Boxes,
  ...
  room: Building,
  fm_users: UserPlus,
  occupant_users: Users,
  template: FileText,
  communication_template: MessageSquare,
  root_cause_analysis: FileSearch,
  preventive_action: ShieldCheck,
  short_term_impact: TrendingUp,
  long_term_impact: TrendingUp,
  corrective_action: Wrench,
  document: Folder,
  document_category: Folder,

  // Pulse Privilege Module (from API response)
  banners: Image,
  stepathon: TrendingUp,
  food_court: Utensils,
  community: Users,
  amenity: Star,
  carpool: Car,
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            ...
            <span className="flex items-center gap-2">
              {func.function_name}
              {func.react_link === "/finance/pending-approvals" &&
                pendingApprovalsCount !== null &&
                pendingApprovalsCount > 0 && (
                  <span className="min-w-[20px] h-5 px-1 rounded-full bg-[#C72030] text-white text-[10px] font-bold flex items-center justify-center">
