              ...
              <Button
                onClick={() => {
                  if (handleExport) {
                    ...
                    exportToExcel(filteredData, visibleColumns, exportFileName);
                  }
                }}
                variant="outline"
                className="border-[#C72030] text-[#C72030] hover:bg-[#C72030] hover:text-white"
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1 max-w-md">
              ...
              <Input
                ...
                className="pl-10 bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#C72030] focus:border-[#C72030]"
              />
              {searchInput && (
                <button
