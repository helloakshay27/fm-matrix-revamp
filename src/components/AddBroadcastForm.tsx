...
export const AddBroadcastForm: React.FC<AddBroadcastFormProps> = ({ onBack }) => {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">NEW BROADCAST (#3423)</h1>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-lg font-semibold text-orange-500">COMMUNICATION INFORMATION</h2>
          </div>
        ...
        <div className="mb-8">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-lg font-semibold text-orange-500">Share with</h2>
          </div>
