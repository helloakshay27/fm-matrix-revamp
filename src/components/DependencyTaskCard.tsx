...
interface DependencyTaskCardProps {
    task: any;
    draggable?: boolean;
    toggleSubCard?: () => void;
    handleLink?: () => void;
        ...
        >
            ...
            >
                ...
                <div className="flex items-start gap-1">
                    ...
                    <span className="text-[10px] truncate">
                        {task?.responsible_person?.name || task?.responsible_person?.full_name || (typeof task?.responsible_person === "string" ? task.responsible_person : "N/A")}
                    </span>
                </div>
                <div className="flex items-start gap-1">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <span className="h-5 w-5 flex items-center justify-center bg-green-600 text-white rounded-full text-[7px] font-light">
                        {getInitials(task?.responsible_person?.name || task?.responsible_person?.full_name || (typeof task?.responsible_person === "string" ? task.responsible_person : ""))}
                    </span>
                </div>
            </div>
        </div>
...
export default DependencyTaskCard;
