...
export const AttachmentsTab = () => {
  ...
  const attachmentTypes = [
    { name: 'Manuals Upload', count: 10, active: true },
    { name: 'Insurance Details', count: 5, active: false },
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {fileData.map((file, index) => (
            <div key={index} className="flex flex-col items-center p-4 border rounded-lg hover:shadow-md transition-shadow bg-white">
              {/* File Preview */}
