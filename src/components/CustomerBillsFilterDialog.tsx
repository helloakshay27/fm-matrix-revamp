...
interface CustomerBillsFilterDialogProps {
  open: boolean;
...
export const CustomerBillsFilterDialog: React.FC<CustomerBillsFilterDialogProps> = ({
  open,
  onOpenChange,
  onApply,
}) => {
  ...
  const handleApply = () => {
    console.log('Applying Customer Bills filters:', filters);
    onApply(filters);
    onOpenChange(false);
  };
