...
const EventApprovedList = () => {
    ...
    const fetchRegisteredUsers = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`https://${baseUrl}/pms/admin/events/${eventId}/registered_users.json?q[status_eq]=approved`, {
                headers: {
...
export default EventApprovedList;