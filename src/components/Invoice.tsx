            ...
            {/* {showButton && (
                <div className="mb-6 flex gap-3 justify-center flex-wrap">
                    <button
                        ...
                        className="px-6 py-2 bg-[#7C2D12] text-[#ffffff] font-bold rounded hover:bg-[#92400e] transition"
                    >
                        Download PDF
                    </button>
                    {onClose && (
                        <button
                            onClick={onClose}
                            className="px-6 py-2 bg-gray-600 text-[#ffffff] font-bold rounded hover:bg-gray-700 transition"
                        >
                            Close Preview
                        </button>
                    )}
