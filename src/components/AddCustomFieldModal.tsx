      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input id="fieldName" value={fieldName} onChange={e => setFieldName(e.target.value)} placeholder="New Field Name" className="mt-1" />
          </div>
          ...
          {isItAsset && <div>
            ...
            minWidth: 120
                ...
                <MuiSelect labelId="section-select-label" label="Section" value={selectedSection} onChange={handleSectionChange} sx={fieldStyles}>
