          ...
          <form className="pt-2 pb-12 h-full">
                    ...
                    >
                        ...
                        <div className="flex justify-between my-4" >
                            <div>
                                <input type="checkbox" id="channel" className="mx-2 my-0.5" />
                                <label for="channel">Create a Channel</label>
                            </div>
                            <div >
                                <input type="checkbox" id="tempelate" className="mx-2 my-0.5" />
                                <label for="tempelate">Create a Tempelate</label>
                            </div>
                        </div>
                        ...
                        <div className="mt-4 space-y-2 h-[100px]">
                            ...
                            <div className="w-1/2 flex flex-col justify-between">
                                   ...
                                   <CustomDropdown options={options} value={"Tempelate"}/>
                                </div>
                        </div>
