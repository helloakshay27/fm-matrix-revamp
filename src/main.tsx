...
if (!posthogToken || posthogToken === "phc_replace_me") {
  ...
  // query needs to tell them apart; registering them as super-properties stamps them on
  // $pageview and on every per-module event helper without each one having to remember.
  // See utils/posthogContext.ts.
