...
var ln = Object.freeze(Object.defineProperty({ __proto__: null, addClassName: Ct, closest: ht, getActiveElement: ye, getChildNodes: an, getClassName: Q, getClosestSizedElement: rn, getFocusableNodes: Pt, getNodePosition: Y, getRelativeEventPosition: rt, getRelativeNodePosition: sn, getRootNode: yt, getScrollSize: tn, getTargetNode: xt, hasClass: function(t, n) {
  ...
  return !!yt(t);
}, insertNode: en, isChildOf: K, isShadowDomSupported: on, locateAttribute: it, locateClassName: vt, removeClassName: Jt, removeNode: nn, toNode: De }, Symbol.toStringTag, { value: "Module" }));
var tt = typeof window < "u" ? window : global;
var Hn = class {
  constructor(t) {
    this._mouseDown = false, this._touchStarts = false, this._touchActive = false, this._longTapTimer = false, this._gantt = t, this._domEvents = t._createDomEventScope();
  }
  attach(t, n, e) {
    ...
    s.registerProvider("clickDrag", () => ({ autoscroll: false }));
    let r = null;
    const o = () => {
      r && (this._mouseDown = true, t.setStart(i.copy(r)), t.setPosition(i.copy(r)), t.setEnd(i.copy(r)), r = null);
    };
    ...
    this._domEvents.attach(l, "mouseup", (f) => {
      ...
      this._touchStarts = true, this._longTapTimer = setTimeout(() => {
        this._touchStarts && (u(d(f)), this._touchStarts = false, this._touchActive = true);
      }, this._gantt.config.touch_drag);
    }), this._domEvents.attach(l, "touchend", (f) => {
      this._touchStarts = false, this._touchActive = false, clearTimeout(this._longTapTimer), h(d(f));
    }), this._domEvents.attach(a, "touchmove", (f) => {
      if (this._touchActive) {
        let y = c();
        if (y && i.utils.dom.closest(f.target, y)) return;
        _(d(f)), f.preventDefault();
      } else this._touchStarts = false, clearTimeout(this._longTapTimer);
    });
    const c = () => {
      ...
      r = null;
      let y = c();
      y && i.utils.dom.closest(f.target, y) || (s.registerProvider("clickDrag", () => ({ autoscroll: this._mouseDown })), n && f[n] !== true || (r = this._getCoordinates(f, t)));
    }, h = (f) => {
      if (r = null, (!n || f[n] === true) && this._mouseDown === true) {
        this._mouseDown = false;
        const y = this._getCoordinates(f, t);
        t.dragEnd(y);
      }
    }, _ = (f) => {
      if (n && f[n] !== true) return;
      ...
      this._mouseDown === true && (b = this._getCoordinates(f, t), t.setEnd(b), t.render());
    };
  }
  detach() {
    const t = this._gantt;
...
function Wt(t, n) {
  ...
  for (var e = 0; e < t.length; e++) if (t[e] === n) return true;
  return false;
}
function be(t) {
...
function xe(t, n) {
  ...
  return i.$pending = false, i.$cancelTimeout = function() {
    clearTimeout(e), i.$pending = false;
  }, i.$execute = function() {
    var a = Array.prototype.slice.call(arguments);
...
var Kt = class _Kt {
  constructor(n) {
    this._mouseDown = false, this._calculateDirectionVector = () => {
      ...
      if (this._trace = [], i.$root.classList.remove("gantt_noselect"), this._originalReadonly !== void 0 && this._mouseDown && (i.config.readonly = this._originalReadonly, i.config.drag_timeline && i.config.drag_timeline.render && i.render()), this._originAutoscroll !== void 0 && (i.config.autoscroll = this._originAutoscroll), i.config.drag_timeline) {
        ...
        if (a && e[a] !== true) return;
      }
      this._mouseDown = false, se = false;
    }, this._startDrag = (e) => {
      const i = this._gantt;
      this._originAutoscroll = i.config.autoscroll, i.config.autoscroll = false, se = true, i.$root.classList.add("gantt_noselect"), this._originalReadonly = i.config.readonly, i.config.readonly = true, i.config.drag_timeline && i.config.drag_timeline.render && i.render(), this._trace = [], this._mouseDown = true;
  ...
  attach(n) {
    ...
    this._domEvents.attach(n.$task, "mousedown", (i) => {
      ...
      s !== void 0 && (o = s instanceof Array ? s.join(", ") : s), o && e.utils.dom.closest(i.target, o) || a && i[a] !== true || this._startDrag(i);
      ...
      if ((!s || !r || a || !i[r]) && this._mouseDown === true) {
...
var jn = Object.freeze(Object.defineProperty({ __proto__: null, bind: B, copy: X, defined: q, event: cn, eventRemove: un, mixin: R, uid: ot }, Symbol.toStringTag, { value: "Module" }));
function Xt(t) {
  var n = t.date;
  return t.$services, { getSum: function(e, i, a) {
    ...
    e.trace_indexes = {}, e.trace_index_transition = {}, e.rtl = true;
    ...
    if (t.config.skip_off_time) {
      for (var a = true, s = e, r = 0; r < i.step; r++) r && (s = n.add(e, r, i.unit)), a = a && !this.isWorkTime(s, i.unit);
      return a;
    }
    return false;
...
var Fn = class {
  ...
  _showAtCoordinates(n, e) {
    this.hide(true), this._quickInfoBoxId = 0, this._quickInfoTask = null, this._quickInfoBox || (this._createQuickInfoElement(), this.setContent()), this._appendAtCoordinates(n, e), this._gantt.callEvent("onQuickInfo", [null]);
  }
  _showForTask(n) {
    const e = this._gantt;
  ...
  _init_quick_info(n) {
    ...
    return typeof this._quickInfoReadonly == "boolean" && e.isReadonly(i) !== this._quickInfoReadonly && (this.hide(true), this._quickInfoBox = null), this._quickInfoReadonly = e.isReadonly(i), this._quickInfoBox || (this._quickInfoBox = this._createQuickInfoElement()), this._quickInfoBox;
  }
  ...
  _fill_quick_data(n) {
    ...
    if (this._quickInfoReadonly) {
      const s = e.config.quickinfo_buttons, r = { icon_delete: true, icon_edit: true };
...
function ae(t, n) {
  ...
  var e = [], i = { attach: function(a, s, r, o) {
    ...
    for (var a = e.slice(), s = 0; s < a.length; s++) {
      var r = a[s];
      i.detach(r.element, r.event, r.callback, r.capture), i.detach(r.element, r.event, r.callback, void 0), i.detach(r.element, r.event, r.callback, false), i.detach(r.element, r.event, r.callback, true);
    }
    e.splice(0, e.length);
  }, extend: function() {
...
var Un = class {
  ...
  _initDelayedFunctions() {
    ...
    this.delayShow && this.delayShow.$cancelTimeout(), this.delayHide && this.delayHide.$cancelTimeout(), this.tooltip.hide(), this.delayShow = xe((e, i) => {
      n.callEvent("onBeforeTooltip", [e]) === false ? this.tooltip.hide() : (this.tooltip.setContent(i), this.tooltip.show(e));
...
var Le = { onBeforeUndo: "onAfterUndo", onBeforeRedo: "onAfterRedo" };
var Re = ["onTaskDragStart", "onAfterTaskUpdate", "onAfterParentExpand", "onAfterTaskDelete", "onBeforeBatchUpdate"];
var qn = class {
  constructor(n, e) {
    this._batchAction = null, this._batchMode = false, this._ignore = false, this._ignoreMoveEvents = false, this._initialTasks = {}, this._initialLinks = {}, this._nestedTasks = {}, this._nestedLinks = {}, this._undo = n, this._gantt = e, this._attachEvents();
  }
  store(n, e, i = false) {
  ...
  toggleIgnoreMoveEvents(n) {
    this._ignoreMoveEvents = n || false;
  }
  startIgnore() {
    this._ignore = true;
  }
  ...
  stopBatchAction() {
    ...
    const n = this._undo;
    this._batchAction && n.logAction(this._batchAction), this._batchMode = false, this._batchAction = null;
  }
  onTaskAdded(n) {
  ...
  setNestedTasks(n, e) {
    ...
    const o = {};
    for (let d = 0; d < r.length; d++) o[r[d]] = true;
    const l = [];
  ...
  _attachEvents() {
    ...
    for (const l in Le) e.attachEvent(l, () => (this.startIgnore(), true)), e.attachEvent(Le[l], () => (this.stopIgnore(), true));
    for (let l = 0; l < Re.length; l++) e.attachEvent(Re[l], () => (this.startBatchAction(), true));
    ...
    }), e.attachEvent("onRowDragEnd", (l, d) => (this.onTaskMoved(a(l)), this.toggleIgnoreMoveEvents(), true)), e.attachEvent("onBeforeTaskDelete", (l) => {
      this.store(l, e.config.undo_types.task);
      const d = [];
      return i(), e.eachTask((c) => {
        d.push(c.id);
      }, l), this.setNestedTasks(l, d), true;
    });
    const s = e.getDatastore("task");
    s.attachEvent("onBeforeItemMove", (l, d, c) => (this.isMoveEventsIgnored() || i(), true)), s.attachEvent("onAfterItemMove", (l, d, c) => (this.isMoveEventsIgnored() || this.onTaskMoved(a(l)), true)), e.attachEvent("onRowDragStart", (l, d, c) => (this.toggleIgnoreMoveEvents(true), i(), true));
    let r = null, o = false;
    if (e.attachEvent("onBeforeTaskDrag", (l) => {
      if (r = e.getState().drag_id, r === l) {
        const d = e.getTask(l);
        e.isSummaryTask(d) && e.config.drag_project && (o = true);
      }
      if (e.plugins().multiselect) {
        const d = e.getSelectedTasks();
        d.length > 1 && d.forEach((c) => {
          this.store(c, e.config.undo_types.task, true);
        });
      }
      return this.store(l, e.config.undo_types.task);
    }), e.attachEvent("onAfterTaskDrag", (l) => {
      (o || e.plugins().multiselect && e.getSelectedTasks().length > 1) && r === l && (o = false, r = null, this.stopBatchAction()), this.store(l, e.config.undo_types.task, true);
    }), e.attachEvent("onLightbox", (l) => this.store(l, e.config.undo_types.task)), e.attachEvent("onBeforeTaskAutoSchedule", (l) => (this.store(l.id, e.config.undo_types.task, true), true)), e.ext.inlineEditors) {
      let l = null, d = null;
      e.attachEvent("onGanttLayoutReady", () => {
        l && e.ext.inlineEditors.detachEvent(l), d && e.ext.inlineEditors.detachEvent(d), d = e.ext.inlineEditors.attachEvent("onEditStart", (c) => {
          e.$data.tempAssignmentsStore && e._lightbox_id || this.store(c.id, e.config.undo_types.task);
        }), l = e.ext.inlineEditors.attachEvent("onBeforeEditStart", (c) => (this.stopBatchAction(), true));
      });
    }
  }
  _storeCommand(n) {
  ...
  _storeTask(n, e = false) {
    const i = this._gantt;
    return this.setInitialTask(n, e), i.eachTask((a) => {
      this.setInitialTask(a.id);
    }, n), true;
  }
  _storeLink(n, e = false) {
    return this.setInitialLink(n, e), true;
  }
};
var Gn = class {
  constructor(n) {
    this.maxSteps = 100, this.undoEnabled = true, this.redoEnabled = true, this.action = { create: (e) => ({ commands: e ? e.slice() : [] }), invert: (e) => {
      ...
      return i;
    } }, this.command = { entity: null, type: null, create: (e, i, a, s) => {
      const r = this._gantt;
      return { entity: s, type: a, value: r.copy(e), oldValue: r.copy(i || e) };
    }, invert: (e) => {
      ...
      switch (e) {
        ...
        case a.move:
          return a.move;
        default:
          return i.assert(false, "Invalid command " + e), null;
      }
  ...
  undo() {
    ...
    if (e && this._reorderCommands(e), n.callEvent("onBeforeUndo", [e]) !== false && e) return this._applyAction(this.action.invert(e)), this._push(this._redoStack, n.copy(e)), void n.callEvent("onAfterUndo", [e]);
  ...
  redo() {
    ...
    if (e && this._reorderCommands(e), n.callEvent("onBeforeRedo", [e]) !== false && e) return this._applyAction(e), this._push(this._undoStack, n.copy(e)), void n.callEvent("onAfterRedo", [e]);
  ...
  _push(n, e) {
    ...
    if (i.callEvent(a, [e]) !== false && e.commands.length) {
  ...
  _reorderCommands(n) {
    ...
    n.commands.sort(function(a, s) {
      if (a.entity === "task" && s.entity === "task") return a.type !== s.type ? (i[s.type] || 0) - (i[a.type] || 0) : a.type === "move" && a.oldValue && s.oldValue && s.oldValue.parent === a.oldValue.parent ? a.oldValue.$index - s.oldValue.$index : 0;
      {
  ...
  _applyAction(n) {
    let e = null;
    const i = this.command.entity, a = this.command.type, s = this._gantt, r = {};
    r[i.task] = { add: "addTask", get: "getTask", update: "updateTask", remove: "deleteTask", move: "moveTask", isExists: "isTaskExists" }, r[i.link] = { add: "addLink", get: "getLink", update: "updateLink", remove: "deleteLink", isExists: "isLinkExists" }, s.batchUpdate(function() {
      for (let o = 0; o < n.commands.length; o++) {
        e = n.commands[o];
        const l = r[e.entity][e.type], d = r[e.entity].get, c = r[e.entity].isExists;
        if (e.type === a.add) s[l](e.oldValue, e.oldValue.parent, e.oldValue.$local_index);
        else if (e.type === a.remove) s[c](e.value.id) && s[l](e.value.id);
        else if (e.type === a.update) {
          const u = s[d](e.value.id);
          for (const h in e.value) {
            let _ = !(h.startsWith("$") || h.startsWith("_"));
            ["$open"].indexOf(h) > -1 && (_ = true), _ && (u[h] = e.value[h]);
          }
          s[l](e.value.id);
...
var Yn = { click_drag: function(t) {
  t.ext || (t.ext = {});
  const n = { className: "gantt_click_drag_rect", useRequestAnimationFrame: true, callback: void 0, singleRow: false };
  function e() {
    const i = { viewPort: t.$task_data, ...n };
    t.ext.clickDrag && t.ext.clickDrag.destructor(), t.ext.clickDrag = new Hn(t);
    ...
    const s = t.$ui.getView("timeline"), r = new Bn(i, t, s);
  ...
  t.ext || (t.ext = {}), t.ext.dragTimeline = { create: () => Kt.create(t), _isDragInProgress: () => Kt._isDragInProgress }, t.config.drag_timeline = { enabled: true, render: false };
  ...
  function l() {
    ...
    let c;
    n() ? o && (c = "onExpand", function() {
      const u = t.ext.fullscreen.getFullscreenElement(), h = document.body;
      r(u.style, a), i = { overflow: h.style.overflow, padding: h.style.padding ? h.style.padding : null, paddingTop: h.style.paddingTop ? h.style.paddingTop : null, paddingRight: h.style.paddingRight ? h.style.paddingRight : null, paddingBottom: h.style.paddingBottom ? h.style.paddingBottom : null, paddingLeft: h.style.paddingLeft ? h.style.paddingLeft : null }, h.style.padding && (h.style.padding = "0"), h.style.paddingTop && (h.style.paddingTop = "0"), h.style.paddingRight && (h.style.paddingRight = "0"), h.style.paddingBottom && (h.style.paddingBottom = "0"), h.style.paddingLeft && (h.style.paddingLeft = "0"), h.style.overflow = "hidden", u.style.width = "100vw", u.style.height = "100vh", u.style.top = "0px", u.style.left = "0px", u.style.position = "absolute", u.style.zIndex = 1, a.modified = true, s = function(_) {
        let f = _.parentNode;
        const y = [];
      ...
      const u = t.ext.fullscreen.getFullscreenElement(), h = document.body;
      a.modified && (i.padding && (h.style.padding = i.padding), i.paddingTop && (h.style.paddingTop = i.paddingTop), i.paddingRight && (h.style.paddingRight = i.paddingRight), i.paddingBottom && (h.style.paddingBottom = i.paddingBottom), i.paddingLeft && (h.style.paddingLeft = i.paddingLeft), h.style.overflow = i.overflow, i = { overflow: null, padding: null, paddingTop: null, paddingRight: null, paddingBottom: null, paddingLeft: null }, r(a, u.style), a.modified = false), s.forEach((_) => {
  ...
  function d() {
    return !t.$container || !t.ext.fullscreen.getFullscreenElement() ? true : e() ? false : ((console.warning || console.log)("The `fullscreen` feature not being allowed, or full-screen mode not being supported"), true);
  }
  ...
  (function(n) {
    n.config.keyboard_navigation = true, n.config.keyboard_navigation_cells = false, n.$keyboardNavigation = {}, n._compose = function() {
      for (var e = Array.prototype.slice.call(arguments, 0), i = {}, a = 0; a < e.length; a++) {
        var s = e[a];
        for (var r in typeof s == "function" && (s = new s()), s) i[r] = s[r];
      }
      return i;
    }, function(e) {
      e.$keyboardNavigation.shortcuts = { createCommand: function() {
        ...
        for (var a = [], s = this.getExpressions(this.trim(i)), r = 0; r < s.length; r++) {
          for (var o = this.getWords(s[r]), l = this.createCommand(), d = 0; d < o.length; d++) this.commandKeys[o[d]] ? l.modifiers[o[d]] = true : this.specialKeys[o[d]] ? l.keyCode = this.specialKeys[o[d]] : l.keyCode = o[d].charCodeAt(0);
          a.push(l);
        }
        return a;
        ...
        var a = [];
        for (var s in i.modifiers) i.modifiers[s] && a.push(s);
      ...
      e.$keyboardNavigation.EventHandler = { _handlers: null, findHandler: function(i) {
        ...
        if (s) {
          if (e.$keyboardNavigation.facade.callEvent("onBeforeAction", [i, a]) === false) return;
          s.call(this, a), a.preventDefault ? a.preventDefault() : a.returnValue = false;
        }
      }, bind: function(i, a) {
        this._handlers || (this._handlers = {});
        for (var s = e.$keyboardNavigation.shortcuts, r = s.parse(i), o = 0; o < r.length; o++) this._handlers[s.getHash(r[o])] = a;
      }, unbind: function(i) {
        for (var a = e.$keyboardNavigation.shortcuts, s = a.parse(i), r = 0; r < s.length; r++) this._handlers[a.getHash(s[r])] && delete this._handlers[a.getHash(s[r])];
      }, bindAll: function(i) {
      ...
      e.$keyboardNavigation.getFocusableNodes = Pt, e.$keyboardNavigation.trapFocus = function(i, a) {
        if (a.keyCode != 9) return false;
        for (var s = e.$keyboardNavigation.getFocusableNodes(i), r = ye(), o = -1, l = 0; l < s.length; l++) if (s[l] == r) {
          o = l;
          break;
        }
        if (a.shiftKey) {
      ...
      e.$keyboardNavigation.GanttNode = function() {
        ...
        var a = e.dateFromPos(e.getScrollState().x), s = e.getScale(), r = i < 0 ? -s.step : s.step;
      ...
      e.$keyboardNavigation.KeyNavNode = function() {
        ...
        for (var a in this) {
          ...
          var s = !(!this[a] || !this[a].toString), r = !(!i[a] || !i[a].toString);
          if (r != s) return false;
          if (r && s) {
        ...
        if (i) {
          ...
          a.callEvent("onBeforeFocus", [i]) !== false && i && (i.setAttribute("tabindex", "-1"), i.$eventAttached || (i.$eventAttached = true, e.event(i, "focus", function(s) {
            return s.preventDefault(), false;
          }, false)), e.utils.dom.isChildOf(document.activeElement, i) && (i = document.activeElement), i.focus && i.focus(), a.callEvent("onFocus", [this.getNode()]));
        }
      }, blur: function() {
        var i = this.getNode();
      ...
      e.$keyboardNavigation.HeaderCell = function(i) {
        ...
        var a = vt(i, "gantt_grid_head_cell");
        if (a) {
      ...
      e.$keyboardNavigation.TaskRow = function(i) {
        ...
        if (!e.isReadonly(this)) {
          ...
          e.isTaskExists(i) && !e.isChildOf(this.taskId, i) && (e.getTask(i).$open = true, e.moveTask(this.taskId, -1, i) !== false && e.updateTask(this.taskId));
        }
      }, "shift+left": function() {
        if (!e.isReadonly(this)) {
          var i = e.getParent(this.taskId);
          e.isTaskExists(i) && e.moveTask(this.taskId, e.getTaskIndex(i) + 1, e.getParent(i)) !== false && e.updateTask(this.taskId);
        }
      }, space: function(i) {
      ...
      e.$keyboardNavigation.TaskCell = function(i, a) {
        ...
        var a = e.locate(i);
        if (e.isTaskExists(a)) {
          var s = 0, r = it(i, "data-column-index");
      ...
      e.$keyboardNavigation.dispatcher = { isActive: false, activeNode: null, globalNode: new e.$keyboardNavigation.GanttNode(), enable: function() {
        ...
        if (!e.$keyboardNavigation.isModal() && this.isEnabled() && !i.defaultPrevented) {
          var a = this.globalNode, s = e.$keyboardNavigation.shortcuts.getCommandFromEvent(i), r = this.getActiveNode();
          e.$keyboardNavigation.facade.callEvent("onKeyDown", [s, i]) !== false && (r ? r.findHandler(s) ? r.doAction(s, i) : a.findHandler(s) && a.doAction(s, i) : this.setDefaultNode());
        }
      ...
      var i = function(v) {
        if (n.config.keyboard_navigation && (n.config.keyboard_navigation_cells || !r(v)) && !o(v) && !function(b) {
          return !!ht(b.target, ".gantt_cal_light");
        }(v)) return e.keyDownHandler(v);
      }, a = function(v) {
        if (e.$preventDefault) return v.preventDefault(), n.$container.blur(), false;
        e.awaitsFocus() || e.focusGlobalNode();
      }, s = function() {
        if (!e.isEnabled()) return;
        const v = !K(document.activeElement, n.$container) && document.activeElement.localName != "body";
        var b = e.getActiveNode();
        if (b && !v) {
          var m, g, p = b.getNode();
          p && p.parentNode && (m = p.parentNode.scrollTop, g = p.parentNode.scrollLeft), b.focus(true), p && p.parentNode && (p.parentNode.scrollTop = m, p.parentNode.scrollLeft = g);
        }
      };
      function r(v) {
        return !!ht(v.target, ".gantt_grid_editor_placeholder");
      }
      function o(v) {
        return !!ht(v.target, ".no_keyboard_navigation");
      }
      function l(v) {
        if (!n.config.keyboard_navigation || !n.config.keyboard_navigation_cells && r(v)) return true;
        if (!o(v)) {
          var b, m = e.fromDomElement(v);
          if (m && (e.activeNode instanceof n.$keyboardNavigation.TaskCell && K(v.target, n.$task) && (m = new n.$keyboardNavigation.TaskCell(m.taskId, e.activeNode.columnIndex)), b = m, n.config.show_grid && n.$ui.getView("grid") && n.config.keyboard_navigation_cells)) {
            const g = v.target.classList.contains("gantt_row"), p = v.target.closest(".gantt_task_line"), k = n.utils.dom.getNodePosition(n.$grid).x, x = k + n.$grid.offsetWidth, w = n.utils.dom.getNodePosition(document.activeElement).x;
            if (g || p && (w < k || x < w)) {
              let $ = n.$grid.scrollLeft;
              const T = $ + n.$grid.offsetWidth;
              let S = 0;
              g && ($ = n.utils.dom.getRelativeEventPosition(v, n.$grid).x);
              for (let C = 0; C < n.config.columns.length; C++) {
                const E = n.config.columns[C];
                if (!E.hide && (S += E.width, $ < S)) {
          ...
          b ? e.isEnabled() ? e.delay(function() {
            e.setActiveNode(b);
          }) : e.activeNode = b : (e.$preventDefault = true, setTimeout(function() {
      ...
      var d = n.attachEvent("onGanttReady", function() {
        if (n.detachEvent(d), n.$data.tasksStore.attachEvent("onStoreUpdated", function(b) {
          if (n.config.keyboard_navigation && e.isEnabled()) {
            ...
            const p = g.getItemTop(b), k = g.$grid_data.scrollTop, x = k + g.$grid_data.getBoundingClientRect().height;
            m && m.taskId == b && k <= p && x >= p && s();
          }
        }), n._smart_render) {
          ...
          n._smart_render._redrawTasks = function(b, m) {
            if (n.config.keyboard_navigation && e.isEnabled()) {
              ...
              if (g && g.taskId !== void 0) {
                for (var p = false, k = 0; k < m.length; k++) if (m[k].id == g.taskId && m[k].start_date) {
                  p = true;
                  break;
                }
      ...
      n.attachEvent("onTaskCreated", function(v) {
        ...
        if (!n.config.keyboard_navigation) return true;
        if (e.isEnabled()) {
          if (v == c && (u = true, setTimeout(() => {
            u = false, c = null;
          })), u && b.type == n.config.types.placeholder) return;
          ...
          b.type == n.config.types.placeholder && n.config.placeholder_task.focusOnCreate === false || e.setActiveNode(new p(v, m));
        }
      }), n.attachEvent("onTaskIdChange", function(v, b) {
        if (!n.config.keyboard_navigation) return true;
        var m = e.activeNode;
        return e.isTaskFocused(v) && (m.taskId = b), true;
      });
      ...
      function f(v) {
        for (var b = n.getGridColumns(), m = 0; m < b.length; m++) if (b[m].name == v) return m;
        return 0;
      }
      ...
      var y = {};
      lt(y), n.mixin(y, { addShortcut: function(v, b, m) {
        var g = _(m);
        g && g.prototype.bind(v, b);
      }, getShortcutHandler: function(v, b) {
        var m = n.$keyboardNavigation.shortcuts.parse(v);
        if (m.length) return y.getCommandHandler(m[0], b);
      }, getCommandHandler: function(v, b) {
        var m = _(b);
        if (m && v) return m.prototype.findHandler(v);
      }, removeShortcut: function(v, b) {
        var m = _(b);
        m && m.prototype.unbind(v);
      }, focus: function(v) {
        var b, m = v ? v.type : null, g = _(m);
        switch (m) {
          case "taskCell":
            b = new g(v.id, f(v.column));
            break;
          case "taskRow":
            b = new g(v.id);
            break;
        ...
        if (e.isEnabled()) {
          var v = e.getActiveNode(), b = (g = v) instanceof n.$keyboardNavigation.GanttNode ? "gantt" : g instanceof n.$keyboardNavigation.HeaderCell ? "headerCell" : g instanceof n.$keyboardNavigation.TaskRow ? "taskRow" : g instanceof n.$keyboardNavigation.TaskCell ? "taskCell" : null, m = n.getGridColumns();
          switch (b) {
            case "taskCell":
              return { type: "taskCell", id: v.taskId, column: m[v.columnIndex].name };
            case "taskRow":
              return { type: "taskRow", id: v.taskId };
            case "headerCell":
              return { type: "headerCell", column: m[v.index].name };
          }
        }
        var g;
        return null;
      } }), n.$keyboardNavigation.facade = y, n.ext.keyboardNavigation = y, n.focus = function() {
        y.focus();
      }, n.addShortcut = y.addShortcut, n.getShortcutHandler = y.getShortcutHandler, n.removeShortcut = y.removeShortcut;
    }();
  })(t);
}, quick_info: function(t) {
  t.ext || (t.ext = {}), t.ext.quickInfo = new Fn(t), t.config.quickinfo_buttons = ["icon_edit", "icon_delete"], t.config.quick_info_detached = true, t.config.show_quick_info = true, t.templates.quick_info_title = function(a, s, r) {
  ...
  t.attachEvent("onEmptyClick", function(a) {
    ...
    r && t.utils.dom.isChildOf(a.target, r) && (s = false), s && e();
  ...
  function o(c, u, h) {
    r(c.value, u, h), r(c.oldValue, u, h);
  }
  function l(c, u, h) {
    const _ = n;
    for (let f = 0; f < c.length; f++) {
      const y = c[f];
      for (let v = 0; v < y.commands.length; v++) y.commands[v].entity === _.command.entity.task ? s(y.commands[v], u, h) : y.commands[v].entity === _.command.entity.link && o(y.commands[v], u, h);
    }
  }
  function d(c, u, h) {
    const _ = n;
  ...
  t.config.undo = true, t.config.redo = true, t.config.undo_types = { link: "link", task: "task" }, t.config.undo_actions = { update: "update", remove: "remove", add: "add", move: "move" }, t.ext || (t.ext = {}), t.ext.undo = { undo: () => n.undo(), redo: () => n.redo(), getUndoStack: () => n.getUndoStack(), setUndoStack: (c) => n.setUndoStack(c), getRedoStack: () => n.getRedoStack(), setRedoStack: (c) => n.setRedoStack(c), clearUndoStack: () => n.clearUndoStack(), clearRedoStack: () => n.clearRedoStack(), saveState: (c, u) => e.store(c, u, true), getInitialState: (c, u) => u === t.config.undo_types.link ? e.getInitialLink(c) : e.getInitialTask(c) }, t.undo = t.ext.undo.undo, t.redo = t.ext.undo.redo, t.getUndoStack = t.ext.undo.getUndoStack, t.getRedoStack = t.ext.undo.getRedoStack, t.clearUndoStack = t.ext.undo.clearUndoStack, t.clearRedoStack = t.ext.undo.clearRedoStack, t.attachEvent("onTaskIdChange", (c, u) => {
    const h = n;
  ...
  function n(i) {
    ...
    var r = "gantt_marker";
    t.templates.marker_class && (r += " " + t.templates.marker_class(i)), i.css && (r += " " + i.css), t.templates.marker_class && (r += " " + t.templates.marker_class(i)), i.title && (s.title = i.title), s.className = r;
    var o = t.posFromDate(i.start_date);
    s.style.left = o + "px";
    let l = Math.max(t.getRowTop(t.getVisibleTaskCount()), 0) + "px";
    if (t.config.timeline_placeholder && t.$task_data && (l = t.$task_data.scrollHeight + "px"), s.style.height = l, i.end_date) {
      var d = t.posFromDate(i.end_date);
      s.style.width = Math.max(d - o, 0) + "px";
    }
    if (i.text) {
      let c = null;
      c = typeof i.text == "function" ? i.text(i) : i.text, c && (t.config.external_render && t.config.external_render.isElement(c) ? (s.innerHTML = "<div class='gantt_marker_content' ></div>", t.config.external_render.renderElement(c, s.querySelector(".gantt_marker_content"))) : s.innerHTML = "<div class='gantt_marker_content' >" + i.text + "</div>");
    }
    return s;
  }
  function e() {
  ...
  t.config.multiselect = true, t.config.multiselect_one_level = false, t._multiselect = { _selected: {}, _one_level: false, _active: true, _first_selected_when_shift: null, getDefaultSelected: function() {
    ...
    return !!(n && t.callEvent("onBeforeTaskMultiSelect", [n, true, e]) && t.callEvent("onBeforeTaskSelected", [n])) && (this._selected[n] = true, this.setLastSelected(n), this.afterSelect(n), t.callEvent("onTaskMultiSelect", [n, true, e]), t.callEvent("onTaskSelected", [n]), true);
  }, toggle: function(n, e) {
    this._selected[n] ? this.unselect(n, e) : this.select(n, e);
  }, unselect: function(n, e) {
    n && t.callEvent("onBeforeTaskMultiSelect", [n, false, e]) && (this._selected[n] = false, this.getLastSelected() == n && this.setLastSelected(this.getDefaultSelected()), this.afterSelect(n), t.callEvent("onTaskMultiSelect", [n, false, e]), t.callEvent("onTaskUnselected", [n]));
  }, isSelected: function(n) {
    return !(!t.isTaskExists(n) || !this._selected[n]);
  }, getSelected: function() {
    var n = [];
    for (var e in this._selected) this._selected[e] && t.isTaskExists(e) ? n.push(e) : this._selected[e] = false;
    ...
    if (!this.isActive() || t._is_icon_open_click(n)) return false;
    var e = t.locate(n);
    if (!e || !t.callEvent("onBeforeMultiSelect", [n])) return false;
    var i = this.getSelected(), a = this.getFirstSelected(), s = false, r = this.getLastSelected(), o = t.config.multiselect, l = (function() {
      const c = t.ext.inlineEditors;
      if (c && c.getState) {
        const h = c.getState(), _ = c.locateCell(n.target);
      ...
      for (var u = 0; u < i.length; u++) i[u] !== e && this.unselect(i[u], n);
    }).bind(this), d = (function() {
      if (r) {
        if (e) {
          var c = t.getGlobalTaskIndex(this.getFirstSelected()), u = t.getGlobalTaskIndex(e), h = t.getGlobalTaskIndex(r);
          c != -1 && h != -1 || (c = u, this.reset());
          for (var _ = r; t.getGlobalTaskIndex(_) !== c; ) this.unselect(_, n), _ = c > h ? t.getNext(_) : t.getPrev(_);
          for (_ = e; t.getGlobalTaskIndex(_) !== c; ) this.select(_, n) && !s && (s = true, a = _), _ = c > u ? t.getNext(_) : t.getPrev(_);
        }
      } else r = e;
    }).bind(this);
    ...
    t.selectTask = function(i) {
      if (!(i = st(i, this.config.root_id))) return false;
      var a = t._multiselect, s = i;
      return a.isActive() ? (a.select(i, null) && a.setLastSelected(i), a.setFirstSelected(a.getLastSelected())) : s = n.call(this, i), s;
    };
    var e = t.unselectTask;
    t.unselectTask = function(i) {
      var a = t._multiselect, s = a.isActive();
      (i = i || a.getLastSelected()) && s && (a.unselect(i, null), i == a.getLastSelected() && a.setLastSelected(null), t.refreshTask(i), a.setFirstSelected(a.getLastSelected()));
      var r = i;
      return s || (r = e.call(this, i)), r;
    ...
    var i = t._multiselect;
    if (!i.isActive()) return true;
    i._selected[n] && (i._selected[n] = false, i.setLastSelected(i.getDefaultSelected())), i.forSelected(function(a) {
    ...
    if (e && a.isActive()) {
      ...
      s && (r = t.getTask(s));
      let o = t.getTask(n), l = false;
      if (r && r.$level != o.$level && (l = true), t.config.multiselect_one_level && l && !i.ctrlKey && !i.shiftKey) return true;
      if (a._one_level) return a.isSameLevel(n);
    }
    return true;
  }), t.attachEvent("onTaskClick", function(n, e) {
    return t._multiselect.doSelection(e) && t.callEvent("onMultiSelect", [e]), true;
  });
  ...
  return t.ext = t.ext || {}, t.ext.export_api = t.ext.export_api || { _apiUrl: "https://export.dhtmlx.com/gantt", _preparePDFConfigRaw(n, e) {
    ...
    if (n.visual === "base-colors" && (t.config.smart_rendering = false), n.start || n.end) {
      i = t.getState(), s = [t.config.start_date, t.config.end_date], a = t.getScrollState();
      const o = t.date.str_to_date(t.config.date_format);
      e = t.eachTask, n.start && (t.config.start_date = o(n.start)), n.end && (t.config.end_date = o(n.end)), t.render(), t.config.smart_rendering = r, t.eachTask = t.ext.export_api._eachTaskTimed(t.config.start_date, t.config.end_date);
    } else n.visual === "base-colors" && (t.render(), t.config.smart_rendering = r);
    (n = t.mixin(n, { name: "gantt.xlsx", title: "Tasks", data: t.ext.export_api._serializeTimeline(n), columns: t.ext.export_api._serializeGrid({ raw: n.raw, rawDates: true }), version: t.version })).visual && (n.scales = t.ext.export_api._serializeScales(n)), t.ext.export_api._sendToExport(n, "excel"), (n.start || n.end) && (t.config.start_date = i.min_date, t.config.end_date = i.max_date, t.eachTask = e, t.render(), t.scrollTo(a.x, a.y), t.config.start_date = s[0], t.config.end_date = s[1]);
  }, exportToJSON(n) {
    ...
    const e = t.templates.xml_format, i = t.templates.format_date, a = t.config.xml_date, s = t.config.date_format, r = "%d-%m-%Y %H:%i:%s";
    ...
    if (e) for (let i = 0; i < e.length; i++) e[i].template && (e[i].$template = true);
  }, _sendImportAjaxExcel(n) {
    const e = n.server || t.ext.export_api._apiUrl, i = n.store || 0, a = n.data, s = n.callback;
    ...
    r.onreadystatechange = function(o) {
      ...
      s && s(o);
    }, r.open("POST", e, true), r.setRequestHeader("X-Requested-With", "XMLHttpRequest"), r.send(a);
  }, _ajaxToExport(n, e, i) {
    delete n.callback;
    const a = n.server || t.ext.export_api._apiUrl, s = "type=" + e + "&store=1&data=" + encodeURIComponent(JSON.stringify(n));
    ...
    const n = { hours: [0, 24], minutes: null, dates: { 0: true, 1: true, 2: true, 3: true, 4: true, 5: true, 6: true } };
    let e;
    ...
    if (r) for (let o = 0; o < r.length; o++) {
      const l = t._pull[r[o]];
      (!n || l.end_date > n) && (!e || l.start_date < e) && i.call(s, l), t.hasChild(l.id) && t.eachTask(i, l.id, s);
    }
    ...
    const n = t.getState(), e = function(s) {
      var r = new Xt(s);
      return r.processIgnores = function(o) {
        var l = o.count;
        if (o.ignore_x = {}, s.ignore_time || s.config.skip_off_time) {
          var d = s.ignore_time || function() {
            return false;
          };
          l = 0;
          for (var c = 0; c < o.trace_x.length; c++) d.call(s, o.trace_x[c]) || this._ignore_time_config.call(s, o.trace_x[c], o) ? (o.ignore_x[o.trace_x[c].valueOf()] = true, o.ignored_colls = true) : l++;
        }
        o.display_count = l;
      }, r;
    }(t), i = [e.primaryScale(t.config)].concat(e.getSubScales(t.config)), a = e.prepareConfigs(i, t.config.min_column_width, 1e3, t.config.scale_height - 1, n.min_date, n.max_date, t.config.rtl);
    ...
    if (i[+e]) return i[+e];
    {
      i = n.trace_x;
      const a = t.getState();
      return +e <= a.min_date ? t.config.rtl ? i.length : 0 : +e >= a.max_date ? t.config.rtl ? 0 : i.length : Tt(i, +e);
    }
    ...
    if (t.ext.export_api._generatedScales) {
      ...
      a = h[h.length - 1], i.$start = t.ext.export_api._getDayIndex(a, s), i.$end = t.ext.export_api._getDayIndex(a, r);
    } else a = t.getScale(), i.$start = o.call(t, s), i.$end = o.call(t, r);
    let l = 0;
    const d = a.width;
    if (d.indexOf(0) > -1) {
      let h = 0;
    ...
    const c = t.templates;
    i.$text = c.task_text(n.start, n.end_date, n), i.$left = c.leftside_text ? c.leftside_text(n.start, n.end_date, n) : "", i.$right = c.rightside_text ? c.rightside_text(n.start, n.end_date, n) : "";
    const u = t.getTaskNode && t.getTaskNode(n.id);
    if (u && u.firstChild) {
      let h = u;
      e.visual !== "base-colors" && (h = u.querySelector(".gantt_task_progress"));
      let _ = t.ext.export_api._getColor(h, "backgroundColor");
      _ === "363636" && (_ = t.ext.export_api._getColor(u, "backgroundColor")), i.$color = _;
    ...
    for (let i = 0; i < t.config.columns.length; i++) {
      ...
      if (a) {
        let s = a(n);
        s instanceof Date && (s = t.templates.date_grid(s, n)), e["_" + i] = s;
      }
    }
    return e;
  }, _copyObjectAll(n) {
    ...
    (n || e) && (t.config.smart_rendering = false, t.config.smart_scales = false, t.render());
    ...
    t.templates.xml_format = t.date.date_to_str("%Y%m%dT%H%i%s", true), t.templates.format_date = t.date.date_to_str("%Y%m%dT%H%i%s", true), t.json._copyObject = t.ext.export_api._copyObjectPlainICal;
    ...
    if (n && t.config.show_chart) {
      ...
      const i = t.getState(), a = n._getScales(), s = t.config.min_column_width, r = t.config.scale_height - 1, o = t.config.rtl;
    ...
    let e;
    t.ext.export_api._generatedScales = null, n.visual && (e = t.ext.export_api._getRaw(n.start, n.end)), n.data && (n.custom_dataset = true);
      ...
      if (n.visual) if (a.render == "split") {
        ...
        for (let l = 0; l < r.length; l++) {
          ...
          for (let c = 0; c < r.length; c++) {
            const u = r[c];
            if (d.id == u.id || o[u.id]) continue;
            const h = +d.original_start_date < +u.original_start_date && +u.original_start_date <= +d.original_end_date, _ = +u.original_start_date <= +d.original_start_date && +d.original_end_date <= +u.original_end_date;
            if (h && (d.original_end_date = u.original_start_date, d.end_date = u.start_date, d.$end = u.$start), _) {
              o[d.id] = true;
              break;
            }
          }
        ...
        i[s] = a;
      } else a.$split_subtask || (i[s] = t.ext.export_api._copyObjectColors(a, n));
      else i[s] = t.ext.export_api._copyObjectTable(a);
    }), n.raw && !n.data) {
      ...
      if (a) {
        ...
        for (let r = 0; r < i.length; r++) {
          ...
          for (let l = 0; l < s.length; l++) {
            const d = a(o, s[l]);
            d && i[r].styles.push({ index: l, styles: t.ext.export_api._getStyles(d) });
          }
        }
      }
    }
    ...
    let a = 1 / 0, s = 0;
    for (let r = 0; r < i.length; r++) a = Math.min(a, i[r].col_width);
    for (let r = 0; r < i.length; r++) {
      let o = 0, l = 0;
      const d = [];
      e.push(d);
      const c = i[r];
      s = Math.max(s, c.trace_x.length);
      const u = c.format || c.template || t.date.date_to_str(c.date);
    ...
    let a = 0;
    for (let s = 0; s < i.length; s++) i[s].name !== "add" && i[s].name !== "buttons" && (n && n.raw && i[s].hide || (e[a] = { id: i[s].template ? "_" + s : i[s].name, header: i[s].label || t.locale.labels["column_" + i[s].name], width: i[s].width ? Math.floor(i[s].width / 4) : "", tree: i[s].tree || false }, i[s].name === "duration" && (e[a].type = "number"), i[s].name !== "start_date" && i[s].name !== "end_date" || (e[a].type = "date", n && n.rawDates && (e[a].id = i[s].name)), a++));
    return t.exportMode = false, e;
  }, _exportSerialize() {
    t.exportMode = true;
    const n = t.templates.xml_format, e = t.templates.format_date;
    t.templates.xml_format = t.templates.format_date = t.date.date_to_str(t.config.date_format || t.config.xml_date);
    const i = t.serialize();
    return t.templates.xml_format = n, t.templates.format_date = e, t.exportMode = false, i;
  }, _setLevel(n) {
    ...
    const e = {};
    for (let s = 0; s < n.data.length; s++) e[n.data[s].id] = n.data[s];
    const i = {};
    for (let s = 0; s < n.links.length; s++) {
      const r = n.links[s];
      t.isTaskExists(r.source) && t.isTaskExists(r.target) && e[r.source] && e[r.target] && (i[r.id] = r);
    }
    for (const s in i) t.ext.export_api._makeLinksSameLevel(i[s], e);
    const a = {};
    for (const s in e) t.ext.export_api._clearCircDependencies(e[s], i, e, {}, a, null);
    Object.keys(i) && t.ext.export_api._clearLinksSameLevel(i, e);
    for (let s = 0; s < n.links.length; s++) i[n.links[s].id] || (n.links.splice(s, 1), s--);
    t.ext.export_api._clearLevel(n.data);
  }, _clearCircDependencies(n, e, i, a, s, r) {
    const o = n.$_source;
    if (!o) return;
    a[n.id] && t.ext.export_api._onCircDependencyFind(r, e, a, s), a[n.id] = true;
    const l = {};
    for (let d = 0; d < o.length; d++) {
      if (s[o[d]]) continue;
      const c = e[o[d]], u = i[c._target];
      l[u.id] && t.ext.export_api._onCircDependencyFind(c, e, a, s), l[u.id] = true, t.ext.export_api._clearCircDependencies(u, e, i, a, s, c);
    }
    a[n.id] = false;
  }, _onCircDependencyFind(n, e, i, a) {
    n && (t.callEvent("onExportCircularDependency", [n.id, n]) && delete e[n.id], delete i[n._source], delete i[n._target], a[n.id] = true);
  }, _makeLinksSameLevel(n, e) {
    let i, a;
    const s = { target: e[n.target], source: e[n.source] };
    if (s.target._lvl != s.source._lvl) {
      s.target._lvl < s.source._lvl ? (i = "source", a = s.target._lvl) : (i = "target", a = s.source._lvl);
      do {
    ...
    n._target = s.target.id, n._source = s.source.id, s.target.$_target || (s.target.$_target = []), s.target.$_target.push(n.id), s.source.$_source || (s.source.$_source = []), s.source.$_source.push(n.id);
    ...
    const r = !!t._getAutoSchedulingConfig().enabled, o = { callback: e.callback || null, config: t.config, data: n, manual: r, name: i, worktime: a };
    for (const l in e) o[l] = e[l];
    return o;
  }, _sendImportAjaxMSP(n) {
    const e = n.server || t.ext.export_api._apiUrl, i = n.store || 0, a = n.data, s = n.callback, r = { durationUnit: n.durationUnit || void 0, projectProperties: n.projectProperties || void 0, taskProperties: n.taskProperties || void 0 };
    a.append("type", n.type || "msproject-parse"), a.append("data", JSON.stringify(r)), i && a.append("store", i);
    ...
    o.onreadystatechange = function(l) {
      ...
      s && s(l);
    }, o.open("POST", e, true), o.setRequestHeader("X-Requested-With", "XMLHttpRequest"), o.send(a);
...
var Jn = { KEY_CODES: { UP: 38, DOWN: 40, LEFT: 37, RIGHT: 39, SPACE: 32, ENTER: 13, DELETE: 46, ESC: 27, TAB: 9 } };
var Kn = class {
  constructor(n) {
...
var gt = typeof window < "u";
var dt = typeof navigator < "u" ? navigator : { userAgent: "" };
var kt = { isIE: gt && (dt.userAgent.indexOf("MSIE") >= 0 || dt.userAgent.indexOf("Trident") >= 0), isOpera: gt && (dt.userAgent.indexOf("Opera") >= 0 || dt.userAgent.indexOf("OPR") >= 0), isChrome: gt && dt.userAgent.indexOf("Chrome") >= 0, isSafari: gt && (dt.userAgent.indexOf("Safari") >= 0 || dt.userAgent.indexOf("Konqueror") >= 0), isFF: gt && dt.userAgent.indexOf("Firefox") >= 0, isIPad: gt && dt.userAgent.search(/iPad/gi) >= 0, isEdge: gt && dt.userAgent.indexOf("Edge") != -1, isNode: !gt || typeof navigator > "u" || false, isSalesforce: gt && (!!tt.Sfdc || !!tt.$A || tt.Aura) };
function Pe(t) {
...
function wt(t, n) {
  ...
  if (n.length === 1) return typeof n[0] == "string" ? (e.url = n[0], e.async = true) : (e.url = n[0].url, e.async = n[0].async || true, e.callback = n[0].callback, e.headers = n[0].headers), n[0].data ? typeof n[0].data != "string" ? e.data = Pe(n[0].data) : e.data = n[0].data : e.data = "", e;
  switch (e.url = n[0], t) {
    case "GET":
    case "DELETE":
    ...
    case "POST":
    case "PUT":
      n[1] ? typeof n[1] != "string" ? e.data = Pe(n[1]) : e.data = n[1] : e.data = "", e.callback = n[2], e.headers = n[3];
  }
  return e;
}
var He = { date_to_str: (t, n, e) => {
...
var Oe = { date_to_str: (t, n, e) => (i) => t.replace(/%[a-zA-Z]/g, (a) => {
  switch (a) {
    case "%d":
  ...
  const a = [0, 0, 1, 0, 0, 0], s = i.match(/[a-zA-Z]+|[0-9]+/g), r = t.match(/%[a-zA-Z]/g);
...
function Xn(t) {
  ...
  var i = { init: function() {
    ...
    var r = He;
    return e() && (r = Oe), r.date_to_str(a, s, t);
  }, str_to_date: function(a, s) {
    var r = He;
    return e() && (r = Oe), r.str_to_date(a, s, t);
...
var hn = class {
  ...
  connect() {
    ...
    }, n.close()), this._mode = 2, this._socket = function(e, i, a, s) {
      let r = i;
      r[0] === "/" && (r = document.location.protocol + "//" + document.location.host + i), r = r.replace(/^http(s|):/, "ws$1:");
      const o = r.indexOf("?") != -1 ? "&" : "?";
      r = `${r}${o}token=${a}&ws=1`;
  ...
  _wrapper(n) {
    return (function() {
      ...
      const a = new Promise((s, r) => {
        i = { data: { id: this._uid(), name: n, args: e }, status: 1, resolve: s, reject: r }, this._queue.push(i);
      });
  ...
  result(n, e) {
    ...
    for (let a = this._queue.length - 1; a >= 0; a--) {
      const s = this._queue[a], r = i[s.data.id];
  ...
  on(n, e) {
    ...
    const s = !!a;
    return s || (a = this._events[n] = []), a.push({ id: i, handler: e }), s || this._mode != 3 || this._socket.send(JSON.stringify({ action: "subscribe", name: n })), { name: n, id: i };
  }
  _resubscribe() {
  ...
  detach(n) {
    ...
    if (a) {
      ...
      s.length ? this._events[i] = s : (delete this._events[i], this._mode == 3 && this._socket.send(JSON.stringify({ action: "unsubscribe", name: i })));
    }
  }
  fire(n, e) {
...
var Zn = function(t, n) {
  const e = new hn({ url: t, token: n });
  e.fetch = function(i, a) {
    const s = { headers: this.headers() };
    return a && (s.method = "POST", s.body = a), fetch(i, s).then((r) => r.json());
  }, this._ready = e.load().then((i) => this._remote = i), this.ready = function() {
    return this._ready;
  }, this.on = function(i, a) {
    this.ready().then((s) => {
      if (typeof i == "string") s.on(i, a);
      else for (const r in i) s.on(r, i[r]);
    });
  };
};
function _n(t, n) {
...
var Qn = function() {
  ...
  return { getState: function(n) {
    ...
    var e = {};
    for (var i in t) t[i].internal || R(e, t[i].method(), true);
    return e;
...
function Ot(t, n, e, i) {
  return (i = n ? n.config : i) && i.placeholder_task && e.exists(t) ? e.getItem(t).type === i.types.placeholder : false;
}
var at = function(t) {
  return this.pull = {}, this.$initItem = t.initItem, this.visibleOrder = nt.$create(), this.fullOrder = nt.$create(), this._skip_refresh = false, this._filterRule = null, this._searchVisibleOrder = {}, this._indexRangeCache = {}, this._getItemsCache = null, this.$config = t, lt(this), this._attachDataChange(function() {
    return this._indexRangeCache = {}, this._getItemsCache = null, true;
  }), this;
};
at.prototype = { _attachDataChange: function(t) {
  ...
  if (q(n) || (n = this.getItem(t)), !this.isSilent() && this.callEvent("onBeforeUpdate", [n.id, n]) === false) return false;
  R(this.pull[t], n, true), this.isSilent() || (this.callEvent("onAfterUpdate", [n.id, n]), this.callEvent("onStoreUpdated", [n.id, n, "update"]));
  ...
  if (!this.isSilent() && this.callEvent("onBeforeDelete", [n.id, n]) === false) return false;
  ...
  if (this.exists(t.id)) this.silent(function() {
    ...
    (!q(n) || n < 0) && (n = i), n > i && (n = Math.min(e.length, n));
  }
  ...
  return q(t.id) || (t.id = ot()), this.$initItem && (t = this.$initItem(t)), !(!this.isSilent() && this.callEvent("onBeforeAdd", [t.id, t]) === false) && (this._addItemInner(t, n), this.isSilent() ? this.sync_link && this.sync_link(t) : (this.callEvent("onAfterAdd", [t.id, t]), this.callEvent("onStoreUpdated", [t.id, t, "add"])), t.id);
  ...
  this.$destroyed || (this.silent(function() {
    this.unselect();
  }), this.pull = {}, this.visibleOrder = nt.$create(), this.fullOrder = nt.$create(), this.isSilent() || (this.callEvent("onClearAll", []), this.refresh()));
}, silent: function(t, n) {
  var e = false;
  this.isSilent() && (e = true), this._skip_refresh = true, t.call(n || this), e || (this._skip_refresh = false);
}, isSilent: function() {
  return !!this._skip_refresh;
}, arraysEqual: function(t, n) {
  if (t.length !== n.length) return false;
  for (var e = 0; e < t.length; e++) if (t[e] !== n[e]) return false;
  return true;
}, refresh: function(t, n) {
  var e, i;
  if (!this.$destroyed && !this.isSilent() && (t && (e = this.getItem(t)), i = t ? [t, e, "paint"] : [null, null, null], this.callEvent("onBeforeStoreUpdate", i) !== false)) {
  ...
  this.eachItem(function(a) {
    this.callEvent("onFilterItem", [a.id, a]) && (Ot(a.id, null, this, this._ganttConfig) ? e.push(a.id) : n.push(a.id));
  });
  ...
  for (var s = [], r = i; r <= e; r++) s.push(this.getItem(this.visibleOrder[r]));
...
var gn = function(t) {
  var n;
  at.apply(this, [t]), this._branches = {}, this._splitTaskHelper = new ei(this), this.pull = {}, this.$initItem = function(o) {
    var l = o;
    t.initItem && (l = t.initItem(l));
    var d = this.getItem(o.id);
    return d && !ct(d.parent, l.parent) && this.move(l.id, l.$index || -1, l.parent || this._ganttConfig.root_id), l;
  }, this.$parentProperty = t.parentProperty || "parent", typeof t.rootId != "function" ? this.$getRootId = (n = t.rootId || 0, function() {
    return n;
  }) : this.$getRootId = t.rootId, this.$openInitially = t.openInitially, this.visibleOrder = nt.$create(), this.fullOrder = nt.$create(), this._searchVisibleOrder = {}, this._indexRangeCache = {}, this._eachItemMainRangeCache = null, this._getItemsCache = null, this._skip_refresh = false, this._ganttConfig = null, t.getConfig && (this._ganttConfig = t.getConfig());
  var e = {}, i = {}, a = {}, s = {}, r = false;
  return this._attachDataChange(function() {
    ...
    this._indexRangeCache = {}, this._eachItemMainRangeCache = null, e = {}, i = {}, a = {}, s = {}, r = false, this.eachItem(function(o) {
      var l = this.getParent(o.id);
      o.$open && a[l] !== false ? a[o.id] = true : a[o.id] = false, this._isSplitItem(o) && (r = true, e[o.id] = true, i[o.id] = true), r && i[l] && (this._isDefaultItem(o) || this._isInlineChildItem(o)) && (i[o.id] = true), a[l] || a[l] === void 0 || this._isInlineChildItem(o) ? s[o.id] = true : s[o.id] = false;
    });
  }), this.attachEvent("onFilterItem", function(o, l) {
    var d = false;
    this._ganttConfig && (d = this._ganttConfig.open_split_tasks);
    var c = s[l.id];
    return r && (c && i[l.id] && !e[l.id] && (c = !!d), i[l.id] && !e[l.id] && (this._isSplitChildItem(l) || (l.$split_subtask = true))), l.$expanded_branch = !!s[l.id], this._isInlineChildItem(l) && (c = false), !!c;
...
gn.prototype = R({ _buildTree: function(t) {
  for (var n = null, e = this.$getRootId(), i = 0, a = t.length; i < a; i++) n = t[i], this.setParent(n, st(this.getParent(n), e) || e);
  for (i = 0, a = t.length; i < a; i++) n = t[i], this._add_branch(n), n.$level = this.calculateItemLevel(n), n.$local_index = this.getBranchIndex(n.id), q(n.$open) || (n.$open = q(n.open) ? n.open : this.$openInitially());
  this._updateOrder();
  ...
  q(e) || (e = this.$getRootId(), this.setParent(t, e));
  var i = this.getIndexById(e) + Math.min(Math.max(n, 0), this.visibleOrder.length);
  1 * i !== i && (i = void 0), at.prototype._addItemInner.call(this, t, i), this.setParent(t, e), t.hasOwnProperty("$rendered_parent") && this._move_branch(t, t.$rendered_parent), this._add_branch(t, n);
}, _changeIdInner: function(t, n) {
  var e = this.getChildren(t), i = this._searchVisibleOrder[t];
  at.prototype._changeIdInner.call(this, t, n);
  ...
  this.fullOrder = nt.$create(), this._traverseBranches(function(n) {
    this.fullOrder.push(n);
  }), t && at.prototype._updateOrder.call(this, t);
}, _removeItemInner: function(t) {
  var n = [];
  this.eachItem(function(i) {
    n.push(i);
  }, t), n.push(this.getItem(t));
  for (var e = 0; e < n.length; e++) this._move_branch(n[e], this.getParent(n[e]), null), at.prototype._removeItemInner.call(this, n[e].id), this._move_branch(n[e], this.getParent(n[e]), null);
}, move: function(t, n, e) {
  ...
  if (!ct(t, e)) {
    q(e) || (e = this.$getRootId());
    var s = this.getItem(t), r = this.getParent(s.id), o = this.getChildren(e);
    if (n == -1 && (n = o.length + 1), ct(r, e) && this.getBranchIndex(t) == n) return;
    if (this.callEvent("onBeforeItemMove", [t, e, n]) === false) return false;
    for (var l = [], d = 0; d < o.length; d++) Ot(o[d], null, this, this._ganttConfig) && (l.push(o[d]), o.splice(d, 1), d--);
    this._replace_branch_child(r, t);
    var c = (o = this.getChildren(e))[n];
    (c = st(c, a)) ? o = o.slice(0, n).concat([t]).concat(o.slice(n)) : o.push(t), l.length && (o = o.concat(l)), ct(s.$rendered_parent, r) || ct(r, e) || (s.$rendered_parent = r), this.setParent(s, e), this._branches[e] = o;
    var u = this.calculateItemLevel(s) - s.$level;
    s.$level += u, this.eachItem(function(h) {
      h.$level += u;
    }, s.id, this), this._moveInner(this.getIndexById(t), this.getIndexById(e) + n), this.callEvent("onAfterItemMove", [t, e, n]), this.refresh();
  }
  ...
  if (n === this.$getRootId()) return true;
  if (!this.hasChild(n)) return false;
  var e = this.getItem(t), i = this.getParent(t);
  if (this.getItem(n).$level >= e.$level) return false;
  for (; e && this.exists(i); ) {
    if ((e = this.getItem(i)) && ct(e.id, n)) return true;
    i = this.getParent(e);
  }
  return false;
}, getSiblings: function(t) {
  if (!this.exists(t)) return nt.$create();
  var n = this.getParent(t);
  return this.getChildren(n);
}, getNextSibling: function(t) {
  for (var n = this.getSiblings(t), e = 0, i = n.length; e < i; e++) if (ct(n[e], t)) {
    var a = n[e + 1];
  ...
  this._branches = {}, at.prototype.clearAll.call(this);
  ...
  for (i.length && (i = i.slice().reverse()); i.length; ) {
    var a = i.pop(), s = this.getItem(a);
    if (t.call(this, s), e && e.push(s), this.hasChild(s.id)) for (var r = this.getChildren(s.id), o = r.length - 1; o >= 0; o--) i.push(r[o]);
  }
}, eachItem: function(t, n) {
  var e = this.$getRootId();
  q(n) || (n = e);
  var i = st(n, e) || e, a = false, s = false, r = null;
  i === e && (this._eachItemMainRangeCache ? (a = true, r = this._eachItemMainRangeCache) : (s = true, r = this._eachItemMainRangeCache = [])), a ? this._eachItemCached(t, r) : this._eachItemIterate(t, i, s ? r : null);
  ...
  for (var e = {}, i = n, a = this.getParent(i); this.exists(a); ) {
    ...
    e[a] = true, i = this.getItem(a), t.call(this, i), a = this.getParent(i);
  }
}, _add_branch: function(t, n, e) {
  var i = e === void 0 ? this.getParent(t) : e;
  this.hasChild(i) || (this._branches[i] = nt.$create());
  ...
  this._eachItemMainRangeCache = null, this._replace_branch_child(n, t.id), this.exists(e) || ct(e, this.$getRootId()) ? this._add_branch(t, void 0, e) : delete this._branches[t.id], t.$level = this.calculateItemLevel(t), this.eachItem(function(i) {
  ...
  if (i && t !== void 0) {
    var a = nt.$create();
    let s = i.indexOf(n + "");
    s != -1 || isNaN(+n) || (s = i.indexOf(+n)), s > -1 && (e ? i.splice(s, 1, e) : i.splice(s, 1)), a = i, this._branches[t] = a;
  }
}, sort: function(t, n, e) {
  this.exists(e) || (e = this.$getRootId()), t || (t = "order");
  var i = typeof t == "string" ? function(l, d) {
    return l[t] == d[t] || et(l[t]) && et(d[t]) && l[t].valueOf() == d[t].valueOf() ? 0 : l[t] > d[t] ? 1 : -1;
  } : t;
  if (n) {
    var a = i;
    i = function(l, d) {
  ...
  if (s) {
    ...
    for (r.sort(i), o = 0; o < r.length; o++) s[o] = r[o].id, this.sort(t, n, s[o]);
  }
}, filter: function(t) {
  for (let n in this.pull) {
    const e = this.pull[n].$rendered_parent, i = this.getParent(this.pull[n]);
    ct(e, i) || this._move_branch(this.pull[n], e, i);
  }
  return at.prototype.filter.apply(this, arguments);
}, open: function(t) {
  ...
  at.prototype.destructor.call(this), this._branches = null, this._indexRangeCache = {}, this._eachItemMainRangeCache = null;
} }, at.prototype);
var ni = function(t, n) {
  const e = n.getDatastore(t), i = function(o, l) {
    const d = l.getLayers(), c = e.getItem(o);
    if (c && e.isVisible(o)) for (let u = 0; u < d.length; u++) d[u].render_item(c);
  }, a = function(o) {
    const l = o.getLayers();
    ...
    for (let _ = 0; _ < l.length; _++) {
      ...
      if (f.get_visible_range) {
        ...
        if (u.start !== void 0 && u.end !== void 0) {
          var h = u.start + " - " + u.end;
          c[h] ? y = c[h] : (y = e.getIndexRange(u.start, u.end), c[h] = y);
        } else {
  ...
  e.attachEvent("onStoreUpdated", function(o, l, d) {
    ...
    r(n) || (o && d != "move" && d != "delete" ? (e.callEvent("onBeforeRefreshItem", [l.id]), e.callEvent("onAfterRefreshItem", [l.id])) : (e.callEvent("onBeforeRefreshAll", []), e.callEvent("onAfterRefreshAll", [])));
    ...
    if (G(n)) return true;
    if (e.callEvent("onBeforeIdChange", [o, l]), !r(n) && !e.isSilent()) {
...
var ii = { create: function() {
  var t = R({}, { createDatastore: function(n) {
    var e = (n.type || "").toLowerCase() == "treedatastore" ? gn : at;
    if (n) {
      var i = this;
    ...
    if (this.mixin(a, function(o) {
      ...
      r ? r.indexOf(n.name) < 0 && r.push(n.name) : (r = [], this.$services.setService("datastores", function() {
        return r;
      }), r.push(n.name)), ni(n.name, this);
    }
    return a;
  }, getDatastore: function(n) {
    return this.$services.getService("datastore:" + n);
  }, _getDatastores: oe, refreshData: function() {
    var n;
    G(this) || (n = this.getScrollState()), this.callEvent("onBeforeDataRender", []);
    for (var e = oe.call(this), i = 0; i < e.length; i++) e[i].refresh();
    this.config.preserve_scroll && !G(this) && ((n.x || n.y) && this.scrollTo(n.x, n.y), this.$layout.getScrollbarsInfo().forEach((a) => {
    ...
    if (i && this.isTaskVisible(n)) this.$data.tasksStore.refresh(n, !!this.getState("tasksDnd").drag_id || e === false), s();
    ...
    for (var n = oe.call(this), e = 0; e < n.length; e++) n[e].silent(function() {
      n[e].clearAll();
    });
    ...
    if (n = st(n, this.config.root_id)) {
      let i = this.getSelectedId();
      e._skipResourceRepaint = true, e.select(n), e._skipResourceRepaint = false, i && e.pull[i].$split_subtask && i != n && this.refreshTask(i), e.pull[n].$split_subtask && i != n && this.refreshTask(n);
    }
  ...
  return R(t, { getTask: function(n) {
    n = st(n, this.config.root_id), this.assert(n, "Invalid argument for gantt.getTask");
    ...
    q(e) || (e = this.getTask(n)), this.$data.tasksStore.updateItem(n, e), this.isTaskExists(n) && this.refreshTask(n);
  }, addTask: function(n, e, i) {
    if (q(n.id) || (n.id = ot()), this.isTaskExists(n.id) && this.getTask(n.id).$index != n.$index) return n.start_date && typeof n.start_date == "string" && (n.start_date = this.date.parseDate(n.start_date, "parse_date")), n.end_date && typeof n.end_date == "string" && (n.end_date = this.date.parseDate(n.end_date, "parse_date")), this.$data.tasksStore.updateItem(n.id, n);
    if (q(e) || (e = this.getParent(n) || 0), this.isTaskExists(e) || (e = this.config.root_id), this.setParent(n, e), this.getState().lightbox && this.isTaskExists(e)) {
      var a = this.getTask(e);
      this.callEvent("onAfterParentExpand", [e, a]);
    }
    return this.$data.tasksStore.addItem(n, i, e);
  }, deleteTask: function(n) {
    return n = st(n, this.config.root_id), this.$data.tasksStore.removeItem(n);
    ...
    return n = st(n, this.config.root_id), this.assert(n, "Invalid argument"), this.$data.tasksStore.getIndexById(n);
  }, eachTask: function(n, e, i) {
    return this.$data.tasksStore.eachItem(B(n, i || this), e);
  }, eachParent: function(n, e, i) {
    return this.$data.tasksStore.eachParent(B(n, i || this), e);
    ...
    for (var s = 0; s < a.length; s++) {
      ...
      r.source == n && (r.source = e), r.target == n && (r.target = e);
    }
    ...
    return i = st(i, this.config.root_id), this.$data.tasksStore.move.apply(this.$data.tasksStore, arguments);
  }, sort: function(n, e, i, a) {
    var s = !a;
    this.$data.tasksStore.sort(n, e, i), this.callEvent("onAfterSort", [n, e, i]), s && this.render();
    ...
    q(e) || (e = this.getLink(n)), this.$data.linksStore.updateItem(n, e);
...
function ai(t) {
  var n = function(c) {
    const u = new Xt(c).primaryScale();
    let h = u.unit, _ = u.step;
    if (c.config.scale_offset_minimal) {
      const f = new Xt(c), y = [f.primaryScale()].concat(f.getAdditionalScales());
      f.sortScales(y), h = y[y.length - 1].unit, _ = y[y.length - 1].step || 1;
    }
    return { unit: h, step: _ };
  }(t), e = n.unit, i = n.step, a = function(c, u) {
    ...
    if (u.config.start_date && u.config.end_date) {
      ...
      var _ = new Date(u.config.end_date), f = u.date[c + "_start"](new Date(_));
      _ = +_ != +f ? u.date.add(f, 1, c) : f, h.end_date = _;
    }
    return h;
  }(e, t);
  if (!a.start_date || !a.end_date) {
    for (var s = true, r = t.getTaskByTime(), o = 0; o < r.length; o++)
...
function $e(t) {
  ai(t), function(n) {
    if (n.config.fit_tasks) {
      ...
      if (+n._min_date != e || +n._max_date != i) return n.render(), n.callEvent("onScaleAdjusted", []), true;
    }
  }(t);
}
function Be(t, n, e) {
...
function ze(t, n, e) {
  Be(t, n.$source, e), Be(t, n.$target, e);
}
var we = { getSubtreeLinks: function(t, n) {
  var e = {};
  return t.isTaskExists(n) && ze(t, t.getTask(n), e), t.eachTask(function(i) {
    ze(t, i, e);
  }, n), e;
...
var si = class {
  ...
  attach() {
    ...
    this._dataProcessorHandlers.push(e.attachEvent("onAfterTaskAdd", function(o, l) {
      e.isTaskExists(o) && (n.setGanttMode("tasks"), n.setUpdated(o, true, "inserted"));
    })), this._dataProcessorHandlers.push(e.attachEvent("onAfterTaskUpdate", function(o, l) {
      e.isTaskExists(o) && (n.setGanttMode("tasks"), n.setUpdated(o, true), e._sendTaskOrder && e._sendTaskOrder(o, l));
    })), this._dataProcessorHandlers.push(e.attachEvent("onBeforeTaskDelete", function(o, l) {
      return e.config.cascade_delete && (i[o] = { tasks: we.getSubtreeTasks(e, o), links: we.getSubtreeLinks(e, o) }), !n.deleteAfterConfirmation || (n.setGanttMode("tasks"), n.setUpdated(o, true, "deleted"), false);
    })), this._dataProcessorHandlers.push(e.attachEvent("onAfterTaskDelete", function(o, l) {
      n.setGanttMode("tasks");
      const d = !a(o), c = e.config.cascade_delete && i[o];
      if (d || c) {
        if (c) {
          const u = n.updateMode;
          n.setUpdateMode("off");
          const h = i[o];
          for (const _ in h.tasks) a(_) || (n.storeItem(h.tasks[_]), n.setUpdated(_, true, "deleted"));
          n.setGanttMode("links");
          for (const _ in h.links) a(_) || (n.storeItem(h.links[_]), n.setUpdated(_, true, "deleted"));
          i[o] = null, u !== "off" && n.sendAllData(), n.setGanttMode("tasks"), n.setUpdateMode(u);
        }
        d && (n.storeItem(l), n.deleteAfterConfirmation || n.setUpdated(o, true, "deleted")), n.updateMode === "off" || n._tSend || n.sendAllData();
      }
    })), this._dataProcessorHandlers.push(e.attachEvent("onAfterLinkUpdate", function(o, l) {
      e.isLinkExists(o) && (n.setGanttMode("links"), n.setUpdated(o, true));
    })), this._dataProcessorHandlers.push(e.attachEvent("onAfterLinkAdd", function(o, l) {
      e.isLinkExists(o) && (n.setGanttMode("links"), n.setUpdated(o, true, "inserted"));
    })), this._dataProcessorHandlers.push(e.attachEvent("onAfterLinkDelete", function(o, l) {
      n.setGanttMode("links"), !a(o) && (n.storeItem(l), n.setUpdated(o, true, "deleted"));
    ...
    this._dataProcessorHandlers.push(e.attachEvent("onTaskIdChange", function(o, l) {
      ...
      const u = o.data || e.xml._xmlNodeToJSON(o.firstChild), h = { add: e.addTask, isExist: e.isTaskExists };
      c === "links" && (h.add = e.addLink, h.isExist = e.isLinkExists), h.isExist.call(e, l) || (u.id = l, h.add.call(e, u));
      ...
      for (const u in d) {
        ...
        switch (u) {
          ...
          case "end_date":
            ...
            break;
          case "duration":
            c.end_date = e.calculateEndDate({ start_date: c.start_date, duration: h, task: c });
        }
        c[u] = h;
      }
      ...
      c === "links" ? (u.delete = e.deleteLink, u.isExist = e.isLinkExists) : c === "assignment" && (u.delete = function(h) {
  ...
  clientSideDelete(n, e, i) {
    ...
    let s = false;
    i.getUserData(n, "!nativeeditor_status", e._ganttMode) === "true_deleted" && (s = true, e.setUpdated(n, false));
    for (let r = 0; r < a.length && !e._in_progress[n]; r++) a[r] === n && (i.getUserData(n, "!nativeeditor_status", e._ganttMode) === "inserted" && (s = true), e.setUpdated(n, false));
    return s;
  }
  handleResourceAssignmentCRUD(n, e) {
    if (!e.config.resources || e.config.resources.dataprocessor_assignments !== true) return;
    const i = e.getDatastore(e.config.resource_assignment_store), a = {}, s = {};
    function r(o) {
      const l = o.id;
      i.exists(l) && (n.setGanttMode("assignment"), n.setUpdated(l, true, "inserted")), delete s[l];
    }
    e.attachEvent("onBeforeTaskAdd", function(o, l) {
      ...
      a[l.task_id] ? function(d) {
        s[d.id] = d, a[d.task_id] = true;
      }(l) : r(l);
    }), i.attachEvent("onAfterUpdate", (o, l) => {
      i.exists(o) && (s[o] ? r(l) : (n.setGanttMode("assignment"), n.setUpdated(o, true)));
    }), i.attachEvent("onAfterDelete", (o, l) => {
      n.setGanttMode("assignment"), !this.clientSideDelete(o, n, e) && (n.storeItem(l), n.setUpdated(o, true, "deleted"));
    });
  }
  handleResourceCRUD(n, e) {
    if (!e.config.resources || e.config.resources.dataprocessor_resources !== true) return;
    const i = e.getDatastore(e.config.resource_store);
    i.attachEvent("onAfterAdd", (a, s) => {
      (function(r) {
        const o = r.id;
        i.exists(o) && (n.setGanttMode("resource"), n.setUpdated(o, true, "inserted"));
      })(s);
    }), i.attachEvent("onAfterUpdate", (a, s) => {
      i.exists(a) && (n.setGanttMode("resource"), n.setUpdated(a, true));
    }), i.attachEvent("onAfterDelete", (a, s) => {
      n.setGanttMode("resource"), !this.clientSideDelete(a, n, e) && (n.storeItem(s), n.setUpdated(a, true, "deleted"));
    });
  }
  handleBaselineCRUD(n, e) {
    if (!e.config.baselines || e.config.baselines.dataprocessor_baselines !== true) return;
    const i = e.getDatastore(e.config.baselines.datastore);
    i.attachEvent("onAfterAdd", (a, s) => {
      (function(r) {
        const o = r.id;
        i.exists(o) && (n.setGanttMode("baseline"), n.setUpdated(o, true, "inserted"));
      })(s);
    }), i.attachEvent("onAfterUpdate", (a, s) => {
      i.exists(a) && (n.setGanttMode("baseline"), n.setUpdated(a, true));
    }), i.attachEvent("onAfterDelete", (a, s) => {
      n.setGanttMode("baseline"), !this.clientSideDelete(a, n, e) && (n.storeItem(s), n.setUpdated(a, true, "deleted"));
    });
  }
  detach() {
    bt(this._dataProcessorHandlers, (n) => {
...
var fn = class {
  ...
  setTransactionMode(t, n) {
    typeof t == "object" ? (this._tMode = t.mode || this._tMode, q(t.headers) && (this._headers = t.headers), q(t.payload) && (this._payload = t.payload), this._tSend = !!n) : (this._tMode = t, this._tSend = n), this._tMode === "REST" && (this._tSend = false), this._tMode === "JSON" || this._tMode === "REST-JSON" ? (this._tSend = false, this._serializeAsJson = true, this._headers = this._headers || {}, this._headers["Content-Type"] = "application/json") : this._headers && !this._headers["Content-Type"] && (this._headers["Content-Type"] = "application/x-www-form-urlencoded"), this._tMode === "CUSTOM" && (this._tSend = false, this._router = t.router);
  }
  escape(t) {
  ...
  ignore(t, n) {
    this._silent_mode = true, t.call(n || tt), this._silent_mode = false;
  }
  setUpdated(t, n, e) {
    ...
    a && e === "updated" && (e = a), n ? (this.set_invalid(t, false), this.updatedRows[i] = t, this.$gantt.setUserData(t, this.action_param, e, this._ganttMode), this._in_progress[t] && (this._in_progress[t] = "wait")) : this.is_invalid(t) || (this.updatedRows.splice(i, 1), this.$gantt.setUserData(t, this.action_param, "", this._ganttMode)), this.markRow(t, n, e), n && this.autoUpdate && this.sendData(t);
  }
  markRow(t, n, e) {
    let i = "";
    const a = this.is_invalid(t);
    if (a && (i = this.styles[a], n = true), this.callEvent("onRowMark", [t, n, e, a]) && (i = this.styles[n ? e : "clear"] + " " + i, this.$gantt[this._methods[0]](t, i), a && a.details)) {
      i += this.styles[a + "_cell"];
      for (let s = 0; s < a.details.length; s++) a.details[s] && this.$gantt[this._methods[1]](t, s, i);
    }
  }
  getActionByState(t) {
  ...
  afterUpdateCallback(t, n, e, i, a) {
    ...
    if (r || this.set_invalid(t, e), this._uActions && this._uActions[e] && !this._uActions[e](i)) return delete this._in_progress[s];
    this._in_progress[s] !== "wait" && this.setUpdated(t, false);
    const o = t;
    switch (e) {
      case "inserted":
      case "insert":
        n != t && (this.setUpdated(t, false), this.$gantt[this._methods[2]](t, n), t = n);
        break;
      case "delete":
      case "deleted":
        ...
        return this.$gantt.setUserData(t, this.action_param, "true_deleted", this._ganttMode), this.$gantt[this._methods[3]](t), delete this._in_progress[s], this.callEvent("onAfterUpdate", [t, e, n, i]);
    }
    this._in_progress[s] !== "wait" ? (r && this.$gantt.setUserData(t, this.action_param, "", this._ganttMode), delete this._in_progress[s]) : (delete this._in_progress[s], this.setUpdated(n, true, this.$gantt.getUserData(t, this.action_param, this._ganttMode))), this.callEvent("onAfterUpdate", [o, e, n, i]);
  }
  afterUpdate(t, n, e) {
    let i;
    ...
    const l = (u) => {
      const h = o.action || this.getState(u) || "updated", _ = o.sid || u[0], f = o.tid || u[0];
      t.afterUpdateCallback(_, f, h, o, a);
    };
    if (o) return Array.isArray(e) && e.length > 1 ? e.forEach((u) => l(u)) : l(e), t.finalizeUpdate(), void this.setGanttMode(a);
    const d = r.xmltop("data", n.xmlDoc);
    if (!d) return this.cleanUpdate(e);
    const c = r.xpath("//data/action", d);
    if (!c.length) return this.cleanUpdate(e);
    for (let u = 0; u < c.length; u++) {
      const h = c[u], _ = h.getAttribute("type"), f = h.getAttribute("sid"), y = h.getAttribute("tid");
  ...
  init(t) {
    ...
    this.$gantt = t, this.$gantt._dp_init && this.$gantt._dp_init(this), this._setDefaultTransactionMode(), this.styles = { updated: "gantt_updated", order: "gantt_updated", inserted: "gantt_inserted", deleted: "gantt_deleted", delete_confirmation: "gantt_deleted", invalid: "gantt_invalid", error: "gantt_error", clear: "" }, this._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"], function(e, i) {
      e.getUserData = function(a, s, r) {
        ...
        s.$drop_target && (this._dp.setGanttMode("task"), this.getTask(a).target = s.$drop_target, this._dp.setUpdated(a, true, "order"), delete this.getTask(a).$drop_target);
      }, e.setDp = function() {
        this._dp = i;
      }, e.setDp();
    }(this.$gantt, this);
    const n = new si(this.$gantt, this);
  ...
  setAutoUpdate(t, n) {
    t = t || 2e3, this._user = n || (/* @__PURE__ */ new Date()).valueOf(), this._needUpdate = false, this._updateBusy = false, this.attachEvent("onAfterUpdate", this.afterAutoUpdate), this.attachEvent("onFullSync", this.fullSync), setInterval(() => {
      this.loadUpdate();
    }, t);
  }
  afterAutoUpdate(t, n, e, i) {
    return n !== "collision" || (this._needUpdate = true, false);
  }
  fullSync() {
  ...
  getUpdates(t, n) {
    ...
    this._updateBusy = true, e.get(t, n);
  }
  loadUpdate() {
  ...
  _beforeSendData(t, n) {
    if (!this.callEvent("onBeforeUpdate", [n, this.getState(n), t])) return false;
    this._sendData(t, n);
  }
  _serializeAsJSON(t) {
    if (typeof t == "string") return t;
  ...
  _sendData(t, n) {
    if (!t) return;
    if (!this.callEvent("onBeforeDataSending", n ? [n, this.getState(n), t] : [null, null, t])) return false;
    ...
    if (this._tMode === "CUSTOM") {
      ...
      const c = this.getGanttMode(), u = (_) => {
        let f = l || "updated", y = n, v = n;
        _ && (f = _.action || l, y = _.sid || y, v = _.id || _.tid || v), this.afterUpdateCallback(y, v, f, _, c);
      };
      let h;
      ...
      else if (this._router[c] instanceof Function) h = this._router[c](d, t, n);
      else {
...
See https://docs.dhtmlx.com/gantt/desktop__server_side.html#customrouting and https://docs.dhtmlx.com/gantt/api__gantt_createdataprocessor.html for details.`;
        if (!this._router[c]) throw new Error(`${_}: router for the **${c}** entity is not defined. ${f}`);
        switch (l) {
          case "inserted":
            if (!this._router[c].create) throw new Error(`${_}: **create** action for the **${c}** entity is not defined. ${f}`);
            h = this._router[c].create(t);
            break;
          case "deleted":
            if (!this._router[c].delete) throw new Error(`${_}: **delete** action for the **${c}** entity is not defined. ${f}`);
            h = this._router[c].delete(n);
            break;
          default:
            if (!this._router[c].update) throw new Error(`${_}: **update**" action for the **${c}** entity is not defined. ${f}`);
    ...
    switch (this._tMode) {
      case "GET":
        r = this._cleanupArgumentsBeforeSend(t), i.url = o + e.urlSeparator(o) + this.serialize(r, n), i.method = "GET";
        break;
      case "POST":
        r = this._cleanupArgumentsBeforeSend(t), i.url = o, i.method = "POST", i.data = this.serialize(r, n);
        break;
      case "JSON":
        r = {};
        const l = this._cleanupItemBeforeSend(t);
        for (const d in l) d !== this.action_param && d !== "id" && d !== "gr_id" && (r[d] = l[d]);
        i.url = o, i.method = "POST", i.data = JSON.stringify({ id: n, action: t[this.action_param], data: r });
        break;
      case "REST":
      case "REST-JSON":
        switch (o = s.replace(/(&|\?)editing=true/, ""), r = "", this.getState(n)) {
          case "inserted":
  ...
  _getAllData() {
    ...
    return this._forEachUpdatedRow(function(e) {
      ...
      this.callEvent("onBeforeUpdate", [e, this.getState(e), i]) && (t[e] = i, n = true, this._in_progress[e] = (/* @__PURE__ */ new Date()).valueOf());
    }), n ? t : null;
  }
  _prepareDate(t) {
  ...
  _prepareArray(t, n) {
    return n.push(t), t.map((e) => et(e) ? this._prepareDate(e) : Array.isArray(e) && !Wt(n, e) ? this._prepareArray(e, n) : e && typeof e == "object" && !Wt(n, e) ? this._prepareObject(e, n) : e);
  }
  _prepareObject(t, n) {
    const e = {};
    n.push(t);
    for (const i in t) {
      ...
      const a = t[i];
      et(a) ? e[i] = this._prepareDate(a) : a === null ? e[i] = "" : Array.isArray(a) && !Wt(n, a) ? e[i] = this._prepareArray(a, n) : a && typeof a == "object" && !Wt(n, a) ? e[i] = this._prepareObject(a, n) : e[i] = a;
    }
    return e;
  }
  _prepareDataItem(t) {
...
function li(t) {
  ...
  return t.$services.getService("state").registerProvider("batchUpdate", function() {
    ...
    if (e) o(l);
      ...
      var h = {}, _ = { render: true, refreshData: true, refreshTask: true, refreshLink: true, resetProjectDates: function(y) {
        h[y.id] = y;
      } };
      for (var f in s.call(this, _), e = true, this.callEvent("onBeforeBatchUpdate", []), o(l), this.callEvent("onAfterBatchUpdate", []), r.call(this), h) this.resetProjectDates(h[f]);
      e = false, d || this.render(), u && (this._dp.setUpdateMode(c), this._dp.setGanttMode("task"), this._dp.sendData(), this._dp.setGanttMode("link"), this._dp.sendData());
    }
  };
}
function di(t) {
...
function ci(t) {
  const n = /* @__PURE__ */ function(i) {
    return { _needRecalc: true, reset: function() {
      ...
      let s = a.split("."), r = i.config.root_id;
      ...
      i.eachTask(function(s) {
        if (s.type == i.config.types.placeholder) return;
        if (a) return a = false, void this._setWBSCode(s, "1");
      ...
      }, i.config.root_id, this), this._needRecalc = false;
...
function ui(t) {
  ...
  function r(l, d, c) {
    var u, h = s(d, l, JSON.stringify(c)), _ = {};
    return bt(d, function(f) {
      _[a(f)] = true;
    }), n[h] ? u = n[h] : (u = n[h] = [], t.eachTask(function(f) {
      if (c) {
        if (!c[t.getTaskType(f)]) return;
      } else if (f.type == t.config.types.project) return;
      l in f && bt(be(f[l]) ? f[l] : [f[l]], function(y) {
  ...
  function o(l, d, c) {
    ...
    Array.isArray(h) || (h = [h]);
    for (var f = 0; f < h.length; f++) h[f].resource_id == l && c.push({ task_id: _.id, resource_id: h[f].resource_id, value: h[f].value });
  }
  return { getTaskBy: function(l, d, c) {
    return typeof l == "function" ? (u = l, h = [], t.eachTask(function(_) {
      u(_) && h.push(_);
    }), h) : be(d) ? r(l, d, c) : r(l, [d], c);
    var u, h;
...
function hi(t) {
  const n = { renderEditableLabel: function(e, i, a, s, r) {
    ...
    return s.$role === "task" ? i = t.getResourceAssignments(s.$resource_id, s.$task_id) : (i = t.getResourceAssignments(e), a.eachItem && a.eachItem(function(r) {
      r.$role !== "task" && (i = i.concat(t.getResourceAssignments(r.id)));
    }, e)), i;
  }, initEditableDiagram: function() {
    t.config.resource_render_empty_cells = true, function() {
      let a = null;
      function s() {
      ...
      }, { once: true }), t.attachEvent("onGanttLayoutReady", function() {
    ...
    function i(a, s) {
      ...
      if (r) {
        ...
        o == "-" && (o = "0");
        let l = Number(o), d = r.getAttribute("data-row-id"), c = r.getAttribute("data-assignment-id"), u = r.getAttribute("data-task"), h = r.getAttribute("data-resource-id"), _ = t.templates.parse_date(r.getAttribute("data-start-date")), f = t.templates.parse_date(r.getAttribute("data-end-date"));
        const y = t.getDatastore(t.config.resource_assignment_store);
        if (isNaN(l)) t.getDatastore(t.config.resource_store).refresh(d);
        else {
          const v = t.getTask(u);
          if (c) {
            t.plugins().undo && t.ext.undo.saveState(u, "task");
            const b = y.getItem(c);
            if (!b || l === b.value) return;
            if (b.start_date.valueOf() === _.valueOf() && b.end_date.valueOf() === f.valueOf()) b.value = l, l ? y.updateItem(b.id) : y.removeItem(b.id);
            else {
              if (b.end_date.valueOf() > f.valueOf()) {
                const m = t.copy(b);
                m.id = t.uid(), m.start_date = f, m.duration = t.calculateDuration({ start_date: m.start_date, end_date: m.end_date, task: v }), m.delay = t.calculateDuration({ start_date: v.start_date, end_date: m.start_date, task: v }), m.mode = b.mode || "default", m.duration !== 0 && y.addItem(m);
              }
              b.start_date.valueOf() < _.valueOf() ? (b.end_date = _, b.duration = t.calculateDuration({ start_date: b.start_date, end_date: b.end_date, task: v }), b.mode = "fixedDuration", b.duration === 0 ? y.removeItem(b.id) : y.updateItem(b.id)) : y.removeItem(b.id), l && y.addItem({ task_id: b.task_id, resource_id: b.resource_id, value: l, start_date: _, end_date: f, duration: t.calculateDuration({ start_date: _, end_date: f, task: v }), delay: t.calculateDuration({ start_date: v.start_date, end_date: _, task: v }), mode: "fixedDuration" });
            }
            t.updateTaskAssignments(v.id), t.updateTask(v.id);
          } else if (l) {
            let b = { task_id: u, resource_id: h, value: l, start_date: _, end_date: f, duration: t.calculateDuration({ start_date: _, end_date: f, task: v }), delay: t.calculateDuration({ start_date: v.start_date, end_date: _, task: v }), mode: "fixedDuration" };
            y.addItem(b), t.updateTaskAssignments(v.id), t.updateTask(v.id);
          }
        }
      }
    }
    t.attachEvent("onGanttReady", function() {
      ...
      t.event(t.$container, "keypress", function(s) {
        ...
        r && (s.keyCode !== 13 && s.keyCode !== 27 || (r.blur(), i(s)), a = s.target);
      }), t.event(t.$container, "keydown", function(s) {
        s.key === "Tab" && (e = Pt(t.$container).indexOf(document.activeElement), i(s), setTimeout(function() {
          var l;
          const o = Pt(t.$container);
          e > -1 && ((l = o[e + 1]) == null || l.focus());
        }, 300));
      }), t.event(t.$container, "click", function(s) {
        if (a && (i(s, a), a = null, s.target.hasAttribute("data-assignment-id"))) {
          ...
          setTimeout(() => {
            const l = t.$container.querySelectorAll("[contenteditable='true']"), d = Array.from(l).find((c) => c.getAttribute("data-start-date") == o.getAttribute("data-start-date") && c.getAttribute("data-row-id") == o.getAttribute("data-row-id"));
            d && d.focus();
          }, 400);
        }
      });
...
function _i(t) {
  var n = ui(t);
  t.ext.resources = hi(t), t.config.resources = { dataprocessor_assignments: false, dataprocessor_resources: false, editable_resource_diagram: false, resource_store: { type: "treeDataStore", fetchTasks: false, initItem: function(a) {
    ...
    t.config.resources && t.config.resources.editable_resource_diagram && (s = true);
    let r = function(l) {
  ...
  }), t.getTaskBy = n.getTaskBy, t.getResourceAssignments = n.getResourceAssignments, t.config.resource_property = "owner_id", t.config.resource_store = "resource", t.config.resource_render_empty_cells = false, t.templates.histogram_cell_class = function(a, s, r, o, l) {
...
function gi(t) {
  ...
  var e = "auto", i = "singleValue", a = "valueArray", s = "resourceValueArray", r = "assignmentsArray", o = e, l = "fixedDates", d = "fixedDuration", c = "default";
  function u(p, k) {
    ...
    var x = Number(p.delay), w = false;
    if (isNaN(x) ? (p.delay = 0, w = true) : p.delay = x, t.defined(p.value) || (p.value = null), !p.task_id || !p.resource_id) return false;
    if (p.mode = p.mode || c, p.mode === d && (isNaN(Number(p.duration)) && (k = k || t.getTask(p.task_id), p.duration = t.calculateDuration({ start_date: p.start_date, end_date: p.end_date, id: k })), w && (k = k || t.getTask(p.task_id), p.delay = t.calculateDuration({ start_date: k.start_date, end_date: p.start_date, id: k }))), p.mode !== l && (k || t.isTaskExists(p.task_id))) {
      var $ = _(p, k = k || t.getTask(p.task_id));
      p.start_date = $.start_date, p.end_date = $.end_date, p.duration = $.duration;
    }
  }
  ...
  function _(p, k) {
    ...
    return p.mode === d ? (x = t.calculateEndDate({ start_date: $, duration: p.duration, task: k }), w = p.duration) : (x = new Date(k.end_date), w = k.duration - p.delay), { start_date: $, end_date: x, duration: w };
  }
  function f(p) {
    ...
    let $ = o === e;
    if (t.defined(x) && x) {
      Array.isArray(x) || (x = [x], $ && (o = i, $ = false));
      const T = {};
      x.forEach(function(S) {
        S.resource_id || (S = { resource_id: S }, $ && (o = a, $ = false)), $ && (S.id && S.resource_id ? (o = r, $ = false) : (o = s, $ = false));
        let C, E = c;
        S.mode || (S.start_date && S.end_date || S.start_date && S.duration) && (E = d), C = S.id || !S.$id || T[S.$id] ? S.id && !T[S.id] ? S.id : t.uid() : S.$id, T[C] = true;
        ...
        Object.keys(S).forEach((A) => {
          A != "$id" && (D[A] = S[A]);
        }), D.start_date && D.start_date.getMonth && D.end_date && D.end_date.getMonth && typeof D.duration == "number" || u(D, p), w.push(D);
      });
    }
    return w;
  }
  ...
  function v(p, k) {
    k.sort(function(x, w) {
      return x.start_date && w.start_date && x.start_date.valueOf() != w.start_date.valueOf() ? x.start_date - w.start_date : 0;
  ...
  function m(p, k) {
    var x = function(w, $) {
      ...
      if (o == i) {
        var S = w[0], C = S ? S.resource_id : null, E = false;
        $.forEach(function(I) {
          I.resource_id != C ? T.inStoreNotInTask.push(I) : I.resource_id == C && (T.inBoth.push({ store: I, task: S }), E = true);
        ...
        w.forEach(function(I) {
          ...
          A[I.resource_id] = I;
        }), w.concat($).forEach(function(I) {
          if (!M[I.resource_id]) {
            M[I.resource_id] = true;
            var N = D[I.resource_id], L = A[I.resource_id];
            N && L ? T.inBoth.push({ store: L, task: N }) : N && !L ? T.inTaskNotInStore.push(N) : !N && L && T.inStoreNotInTask.push(L);
          }
        });
      } else o != r && o != s || (D = {}, A = {}, M = {}, w.forEach(function(I) {
        D[I.id || I.$id] = I;
      }), $.forEach(function(I) {
        A[I.id] = I;
      }), w.concat($).forEach(function(I) {
        ...
        if (!M[N]) {
          M[N] = true;
          var L = D[N], O = A[N];
          L && O ? T.inBoth.push({ store: O, task: L }) : L && !O ? T.inTaskNotInStore.push(L) : !L && O && T.inStoreNotInTask.push(O);
        }
      }));
      return T;
    }(f(p), k);
    x.inStoreNotInTask.forEach(function(w) {
      h.removeItem(w.id);
    }), x.inTaskNotInStore.forEach(function(w) {
      h.addItem(w);
    }), x.inBoth.forEach(function(w) {
      if (function(T, S) {
        var C = { id: true };
        for (var E in T) if (!C[E] && String(T[E]) !== String(S[E])) return true;
        return false;
      }(w.task, w.store)) (function(T, S) {
        var C = { id: true };
        for (var E in T) C[E] || (S[E] = T[E]);
      })(w.task, w.store), h.updateItem(w.store.id);
      else if (w.task.start_date && w.task.end_date && w.task.mode !== l) {
        var $ = _(w.store, p);
        w.store.start_date.valueOf() == $.start_date.valueOf() && w.store.end_date.valueOf() == $.end_date.valueOf() || (w.store.start_date = $.start_date, w.store.end_date = $.end_date, w.store.duration = $.duration, h.updateItem(w.store.id));
      }
    }), y(p.id);
  }
  function g(p) {
    ...
    if (t.config.process_resource_assignments) {
      ...
      t.attachEvent("onBeforeBatchUpdate", function() {
        ...
        if (k) {
          ...
          for (var E in t.config.process_resource_assignments && o === "resourceValueArray" && (S = null), x) m(x[E], C[E]);
        }
        k = false, p = false, x = {};
      }), t.attachEvent("onTaskCreated", function(C) {
        var E = b(C);
        return h.parse(E), v(C, E), true;
      }), t.attachEvent("onAfterTaskUpdate", function(C, E) {
        p ? (k = true, x[C] = E) : E.unscheduled || g(E);
        ...
        return $ = null, T = null, S = null, h.clearAll(), true;
      ...
      var $ = null, T = null, S = null;
      h.attachEvent("onStoreUpdated", function() {
        return p && !w || ($ = null, T = null, S = null), true;
      }), t.getResourceAssignments = function(C, E) {
        var D = t.defined(E) && E !== null;
        return $ === null && ($ = {}, T = {}, h.eachItem(function(A) {
          $[A.resource_id] || ($[A.resource_id] = []), $[A.resource_id].push(A);
          var M = A.resource_id + "-" + A.task_id;
          T[M] || (T[M] = []), T[M].push(A);
        })), D ? (T[C + "-" + E] || []).slice() : ($[C] || []).slice();
        ...
        const E = t.getDatastore("resource"), D = t.getTaskAssignments(C), A = {};
        D.forEach(function(I) {
          A[I.resource_id] || (A[I.resource_id] = I.resource_id);
        });
        const M = [];
        for (const I in A) {
          const N = E.getItem(A[I]);
          N && M.push(N);
        }
        return M;
...
function fi(t) {
  ...
  t.config.types.placeholder = "placeholder", t.attachEvent("onDataProcessorReady", n(function(o) {
    o && !o._silencedPlaceholder && (o._silencedPlaceholder = true, o.attachEvent("onBeforeUpdate", n(function(l, d, c) {
  ...
  t.attachEvent("onGanttReady", function() {
    a || (a = true, t.attachEvent("onAfterTaskUpdate", n(i)), t.attachEvent("onAfterTaskAdd", n(function(o, l) {
...
function pi(t) {
  ...
  function e(c, u) {
    var h = t.getTask(c), _ = s(h);
    _ !== false && t.getTaskType(h) !== _ && (u.$needsUpdate = true, u[h.id] = { task: h, type: _ });
  }
  function i(c) {
  ...
  var a;
  function s(c) {
    var u = t.config.types, h = t.hasChild(c.id), _ = t.getTaskType(c.type);
...
var ie = class ie2 {
  constructor(n) {
    this.format = (e) => this._getWBSCode(e.source), this.canParse = (e) => this._linkReg.test(e), this.parse = (e) => {
      ...
      if (i.exec(e)) {
        const a = i.exec(e)[0], s = this._gantt.getTaskByWBSCode(a);
        if (s) return s.id;
      }
      return null;
...
ie.create = (n = null, e) => new ie(e);
var Se = ie;
function mi(t) {
  t.ext.formatters = { durationFormatter: function(n) {
    return n || (n = {}), n.store || (n.store = t.config.duration_unit), n.enter || (n.enter = t.config.duration_unit), Ht.create(n, t);
  }, linkFormatter: function(n) {
    return Se.create(n, t);
  } };
}
function vi(t) {
  t.ext = t.ext || {}, t.config.show_empty_state = false, t.ext.emptyStateElement = t.ext.emptyStateElement || { isEnabled: () => t.config.show_empty_state === true, isGanttEmpty: () => !t.getTaskByTime().length, renderContent(n) {
...
function ki(t) {
  ...
  const n = t.createDatastore({ name: t.config.baselines.datastore, initItem: function(a) {
    return a.id || (a.id = t.uid()), function(s) {
      if (!s.task_id || !s.start_date && !s.end_date) return false;
  ...
  t.$data.baselineStore = n, t.adjustTaskHeightForBaselines = function(a) {
    ...
    if (d && t.config.show_chart) switch (t.config.baselines.render_mode) {
      ...
      default:
        ...
        break;
      case "separateRow":
        s = d.getBarHeight(a.id), o ? (a.bar_height = a.bar_height || s, a.bar_height > s && (s = a.bar_height), a.row_height = s + l) : a.bar_height && (a.row_height = a.bar_height + 4), i(a);
        break;
      case "individualRow":
        s = d.getBarHeight(a.id), o ? (a.bar_height = a.bar_height || s, a.bar_height > s && (s = a.bar_height), r = l * o, a.row_height = s + r + 2) : a.bar_height && (a.row_height = a.bar_height + 4), i(a);
    }
  }, t.attachEvent("onGanttReady", function() {
    t.config.baselines && (t.attachEvent("onParse", function() {
      n.eachItem(function(a) {
        ...
        if (t.isTaskExists(s)) {
          ...
          o && r.baselines.push(a), G(t) || (St(r) ? e(r) : t.adjustTaskHeightForBaselines(r));
        }
      });
    }), t.attachEvent("onBeforeTaskUpdate", function(a, s) {
      return function(r) {
        let o = false;
        const l = {}, d = r.baselines || [], c = t.getTaskBaselines(r.id);
        d.length != c.length && (o = true), d.forEach(function(u) {
          l[u.id] = true;
          const h = n.getItem(u.id);
          if (h) {
            const _ = +h.start_date != +u.start_date, f = +h.end_date != +u.end_date;
            (_ || f) && n.updateItem(u.id, u);
          } else n.addItem(u);
        }), c.forEach(function(u) {
          l[u.id] || n.removeItem(u.id);
        }), o && (St(r) ? e(r) : t.adjustTaskHeightForBaselines(r), t.render());
      }(s), true;
      ...
      if (pn && s.parent && t.isTaskExists(s.parent)) {
      ...
      return n.clearAll(), true;
    }), t.attachEvent("onTaskIdChange", function(a, s) {
      n.find(function(r) {
        return r.task_id == a;
      }).forEach(function(r) {
        r.task_id = s, n.updateItem(r.id);
      });
    }));
  }, { once: true });
}
...
function bi(t) {
  ...
  function i(o) {
    var u, h;
    if (!o || !o.type || !((u = o.task) != null && u.id) && !((h = o.link) != null && h.id)) return void console.error("Invalid message format:", o);
    const { type: l, task: d, link: c } = o;
    if (!(d && t._dp._in_progress[d.id] || c && t._dp._in_progress[c.id])) {
      if (l === "add-task") {
  ...
  function s(o) {
    ...
    switch (l) {
      case "add-task":
        (function(u) {
          if (t.isTaskExists(u.id)) return void console.warn(`Task with ID ${u.id} already exists. Skipping add.`);
          u.start_date = t.templates.parse_date(u.start_date), u.end_date && (u.end_date = t.templates.parse_date(u.end_date)), r(() => {
            t.addTask(u);
          });
        })(d);
        break;
      case "update-task":
        (function(u) {
          ...
          r(() => {
            const y = _(u);
            for (let v in y) f[v] = y[v];
            y.end_date || (f.end_date = t.calculateEndDate(f)), t.updateTask(h), h !== u.id && t.changeTaskId(h, u.id);
          });
        })(d);
        break;
      case "delete-task":
        (function(u) {
          const h = u.id;
          t.isTaskExists(h) && r(() => {
            t.getTask(h) && (t.getState().lightbox_id == h && (u.id = this._lightbox_id, t.getTask(this._lightbox_id)), t.deleteTask(h, true));
          });
        })(d);
        break;
      case "add-link":
        (function(u) {
          if (t.isLinkExists(u.id)) return void console.warn(`Link with ID ${u.id} already exists. Skipping add.`);
          r(() => {
            t.addLink(u);
          });
        })(c);
      ...
      case "update-link":
        (function(u) {
          ...
          const _ = t.getLink(h);
          r(() => {
            Object.assign(_, u), t.updateLink(h), h !== u.id && t.changeLinkId(h, u.id);
          });
        })(c);
        break;
      case "delete-link":
        (function(u) {
          const h = u.id;
          t.getLink(h) && r(() => {
            t.getLink(h) && (t.getState().lightbox_id == h && (u.id = this._lightbox_id, t.getLink(this._lightbox_id)), t.deleteLink(h, true));
          });
        })(c);
    }
  }
...
function xi(t) {
  t.ext || (t.ext = {}), t.ext.liveUpdates = { RemoteEvents: yi, remoteUpdates: bi(t) };
}
function $i(t) {
  function n(e) {
    throw t.assert(false, "Can't parse data: incorrect value of gantt.parse or gantt.load method. Actual argument value: " + JSON.stringify(e)), new Error("Invalid argument for gantt.parse or gantt.load. An object or a JSON string of format https://docs.dhtmlx.com/gantt/desktop__supported_data_formats.html#json is expected. Actual argument value: " + JSON.stringify(e));
  }
  t.load = function() {
    ...
    if (e.xmlDoc && e.xmlDoc.status === 404) this.assert(false, "Failed to load the data from <a href='" + e.xmlDoc.responseURL + "' target='_blank'>" + e.xmlDoc.responseURL + "</a>, server returns 404");
    else if (!t.$destroyed) {
      this.callEvent("onBeforeParse", []), i || (i = "json"), this.assert(this[i], "Invalid data type:'" + i + "'");
      var a = e.xmlDoc.responseText, s = this[i].parse(a, e);
    ...
    var i = {};
    for (var a in e) a.charAt(0) != "$" && (i[a] = e[a], et(i[a]) && (i[a] = t.defined(t.templates.xml_format) ? t.templates.xml_format(i[a]) : t.templates.format_date(i[a])));
    return i;
  }, serialize: function() {
    var e = [], i = [];
    let a = [];
    ...
    for (var s = t.getLinks(), r = 0; r < s.length; r++) i.push(this.serializeLink(s[r]));
    ...
    for (var i = {}, a = t.ajax.xpath("//coll_options", e), s = 0; s < a.length; s++) for (var r = i[a[s].getAttribute("for")] = [], o = t.ajax.xpath(".//item", a[s]), l = 0; l < o.length; l++) {
    ...
    i = this._getXML(e, i);
    for (var a = {}, s = a.data = [], r = t.ajax.xpath("//task", i), o = 0; o < r.length; o++) s[o] = this._xmlNodeToJSON(r[o]);
    ...
    for (var e = [], i = [], a = t.json.serialize(), s = 0, r = a.data.length; s < r; s++) e.push(this._copyObject(a.data[s]));
    for (s = 0, r = a.links.length; s < r; s++) i.push(this._copyLink(a.links[s]));
    ...
    for (var a = { collections: { links: [] } }, s = a.data = [], r = t.ajax.xpath("//task", i), o = 0; o < r.length; o++) {
    ...
    for (r = t.ajax.xpath("//project", i), o = 0; o < r.length; o++)
      (d = t.xml._xmlNodeToJSON(r[o], true)).id = "project-" + d.id, s.push(d);
...
function de(t, n, e, i, a) {
  return this.date = t, this.unit = n, this.task = e, this.id = i, this.calendar = a, this;
}
function ce(t, n, e, i, a, s) {
  return this.date = t, this.dir = n, this.unit = e, this.task = i, this.id = a, this.calendar = s, this;
}
function ue(t, n, e, i, a, s, r) {
  return this.start_date = t, this.duration = n, this.unit = e, this.step = i, this.task = a, this.id = s, this.calendar = r, this;
}
function wi(t, n, e, i) {
...
var mn = function(t) {
  return { getWorkHoursArguments: function() {
    var n = arguments[0];
    if (!$t((n = et(n) ? { date: n } : R({}, n)).date)) throw t.assert(false, "Invalid date argument for getWorkHours method"), new Error("Invalid date argument for getWorkHours method");
    return n;
    ...
    if ((n = e.date ? new de(e.date, e.unit, e.task, null, e.calendar) : new de(arguments[0], arguments[1], arguments[2], null, arguments[3])).unit = n.unit || t.config.duration_unit, !$t(n.date)) throw t.assert(false, "Invalid date argument for isWorkTime method"), new Error("Invalid date argument for isWorkTime method");
    return n;
  }, getClosestWorkTimeArguments: function(n) {
    var e, i = arguments[0];
    if (i instanceof ce) return i;
    if (e = et(i) ? new ce(i) : new ce(i.date, i.dir, i.unit, i.task, null, i.calendar), i.id && (e.task = i), e.dir = i.dir || "any", e.unit = i.unit || t.config.duration_unit, !$t(e.date)) throw t.assert(false, "Invalid date argument for getClosestWorkTime method"), new Error("Invalid date argument for getClosestWorkTime method");
    return e;
  }, _getStartEndConfig: function(n) {
    var e, i = wi;
    if (n instanceof i) return n;
    if (et(n) ? e = new i(arguments[0], arguments[1], arguments[2], arguments[3]) : (e = new i(n.start_date, n.end_date, n.task), n.id !== null && n.id !== void 0 && (e.task = n)), e.unit = e.unit || t.config.duration_unit, e.step = e.step || t.config.duration_step, e.start_date = e.start_date || e.start || e.date, !$t(e.start_date)) throw t.assert(false, "Invalid start_date argument for getDuration method"), new Error("Invalid start_date argument for getDuration method");
    if (!$t(e.end_date)) throw t.assert(false, "Invalid end_date argument for getDuration method"), new Error("Invalid end_date argument for getDuration method");
    return e;
...
vn.prototype = { _getIntervals: function(t) {
  ...
  for (var s = 0; s < i.length; s++) for (var r = i[s], o = 0; o < a.length; o++) {
    var l = a[o];
  ...
  const e = X(t.getConfig()), i = X(n.getConfig()), a = e.parsed, s = i.parsed;
  a.customWeeks = e.customWeeks, s.customWeeks = i.customWeeks;
  var r = { hours: this._toHoursArray(this._mergeHoursConfig(a.hours, s.hours)), dates: {}, customWeeks: {} };
  const o = (d, c) => {
    for (let u in d.dates) {
      const h = d.dates[u];
      +u > 1e3 && (r.dates[u] = false);
      for (const _ in c.dates) {
        const f = c.dates[_];
        if (_ == u && (r.dates[u] = !(!h || !f)), Array.isArray(h)) {
          const y = Array.isArray(f) ? f : c.hours;
          r.dates[u] = this._toHoursArray(this._mergeHoursConfig(h, y));
        }
      }
    }
  };
...
var Si = class {
  ...
  setItem(n, e, i, a) {
    ...
    let o;
    s.has(n) ? o = s.get(n) : (o = [], s.set(n, o));
    let l = o[r];
    l || (l = o[r] = /* @__PURE__ */ new Map()), l.set(e, i);
  }
  clear() {
...
var Ci = class {
  constructor(n) {
    this.getMinutesPerWeek = (e) => {
      ...
      return this._weekCache.set(i, r), r;
      ...
      return this._monthCache.set(i, r), r;
    }, this.clear = () => {
...
var Ei = class {
  ...
  getEndDate(n, e, i, a, s) {
    const r = this._getCacheObject(n, i, a), o = n.valueOf(), l = this._endDateCacheKey(o, e);
    let d;
    if (r.endDates[l] === void 0) {
      const c = s(), u = c.valueOf();
      r.endDates[l] = u, r.durations[this._durationCacheKey(o, u)] = e, d = c;
    } else d = new Date(r.endDates[l]);
    return d;
  }
  getDuration(n, e, i, a, s) {
    const r = this._getCacheObject(n, i, a), o = n.valueOf(), l = e.valueOf(), d = this._durationCacheKey(o, l);
    let c;
    if (r.durations[d] === void 0) {
      const u = s();
      r.durations[d] = u.valueOf(), c = u;
    } else c = r.durations[d];
    return c;
  }
  clear() {
    this._cache = {};
...
function Te(t, n) {
  this.argumentsHelper = n, this.$gantt = t, this._workingUnitsCache = typeof Map < "u" ? new Si() : new Ti(), this._largeUnitsCache = new Ci(this), this._dateDurationCache = new Ei(), this._worktime = null, this._cached_timestamps = {}, this._cached_timestamps_count = 0;
}
Te.prototype = { units: ["year", "month", "week", "day", "hour", "minute"], _clearCaches: function() {
  ...
  for (var n = this._getWorkHours(t), e = t.getHours(), i = 0; i < n.length; i++) if (e >= n[i].startHour && e < n[i].endHour) return true;
  return false;
}, _getTimeOfDayStamp: function(t, n) {
  var e = t.getHours();
  return t.getHours() || t.getMinutes() || !n || (e = 24), 60 * e * 60 + 60 * t.getMinutes();
}, _is_work_minute: function(t) {
  for (var n = this._getWorkHours(t), e = this._getTimeOfDayStamp(t), i = 0; i < n.length; i++) if (e >= n[i].start && e < n[i].end) return true;
  return false;
}, _nextDate: function(t, n, e) {
  return this.$gantt.date.add(t, e, n);
}, _getWorkUnitsBetweenGeneric: function(t, n, e, i) {
  var a = this.$gantt.date, s = new Date(t), r = new Date(n);
  i = i || 1;
  var o, l, d = 0, c = null, u = false;
  (o = a[e + "_start"](new Date(s))).valueOf() != s.valueOf() && (u = true);
  var h = false;
  (l = a[e + "_start"](new Date(n))).valueOf() != n.valueOf() && (h = true);
  for (var _ = false; s.valueOf() < r.valueOf(); ) {
    if (_ = (c = this._nextDate(s, e, i)).valueOf() > r.valueOf(), this._isWorkTime(s, e)) (u || h && _) && (o = a[e + "_start"](new Date(s)), l = a.add(o, i, e)), u ? (u = false, c = this._nextDate(o, e, i), d += (l.valueOf() - s.valueOf()) / (l.valueOf() - o.valueOf())) : h && _ ? (h = false, d += (r.valueOf() - s.valueOf()) / (l.valueOf() - o.valueOf())) : d++;
    else {
      var f = this._getUnitOrder(e), y = this.units[f - 1];
      y && !this._isWorkTime(s, y) && (c = this._getClosestWorkTimeFuture(s, y));
    }
    s = c;
  }
  return d;
  ...
  for (var i = this._getWorkHours(t), a = 0; a < i.length; a++) {
    var s = i[a];
    if (n >= s.start && e <= s.end) return 60;
    if (n < s.end && e > s.start) return (Math.min(e, s.end) - Math.max(n, s.start)) / 60;
  }
  return 0;
  ...
  for (a = B(e == "minute" ? this._getMinutesPerDay : this.getHoursPerDay, this); r.valueOf() < o.valueOf(); ) if (o - r > 27648e5 && r.getDate() === 0) {
  ...
  var a = new Date(t), s = new Date(n);
  i = i || 1;
  var r = new Date(a), o = this.$gantt.date.add(this.$gantt.date.day_start(new Date(a)), 1, "day");
  if (s.valueOf() <= o.valueOf()) return this._getMinutesBetweenSingleDay(t, n);
  var l = this.$gantt.date.day_start(new Date(s)), d = s, c = this._getMinutesBetweenSingleDay(r, o), u = this._getMinutesBetweenSingleDay(l, d);
  return c + this._getWorkUnitsForRange(o, l, e, i) + u;
}, _getHoursBetween: function(t, n, e, i) {
  var a = new Date(t), s = new Date(n);
  i = i || 1;
  var r = new Date(a), o = this.$gantt.date.add(this.$gantt.date.day_start(new Date(a)), 1, "day");
  if (s.valueOf() <= o.valueOf()) return Math.round(this._getMinutesBetweenSingleDay(t, n) / 60);
  var l = this.$gantt.date.day_start(new Date(s)), d = s, c = this._getMinutesBetweenSingleDay(r, o, e, i) / 60, u = this._getMinutesBetweenSingleDay(l, d, e, i) / 60, h = c + this._getWorkUnitsForRange(o, l, e, i) + u;
  return Math.round(h);
}, getConfig: function() {
  ...
  for (var n in t.parsed = { dates: {}, hours: null, haveCustomWeeks: false, customWeeks: {}, customWeeksRangeStart: null, customWeeksRangeEnd: null, customWeeksBoundaries: [] }, t.parsed.hours = this._parseHours(t.hours), t.dates) t.parsed.dates[n] = this._parseHours(t.dates[n]);
  if (t.customWeeks) {
    var e = null, i = null;
    for (var n in t.customWeeks) {
      ...
      if (a.from && a.to) {
        var s = a.from, r = a.to;
        (!e || e > s.valueOf()) && (e = s.valueOf()), (!i || i < r.valueOf()) && (i = r.valueOf()), t.parsed.customWeeksBoundaries.push({ from: s.valueOf(), fromReadable: new Date(s), to: r.valueOf(), toReadable: new Date(r), name: n }), t.parsed.haveCustomWeeks = true;
  ...
  return t(), !!this.hasWorkTime() || (this._setConfig(JSON.parse(n)), this._clearCaches(), false);
  ...
  if (!this._arraysEqual(t.hours, n.hours)) return false;
  var e = Object.keys(t.dates), i = Object.keys(n.dates);
  if (e.sort(), i.sort(), !this._arraysEqual(e, i)) return false;
  for (var a = 0; a < e.length; a++) {
    var s = e[a], r = t.dates[s], o = t.dates[s];
    if (r !== o && !(Array.isArray(r) && Array.isArray(o) && this._arraysEqual(r, o))) return false;
  }
  return true;
}, equals: function(t) {
  if (!(t instanceof Te)) return false;
  var n = this.getConfig(), e = t.getConfig();
  if (!this._compareSettings(n, e)) return false;
  if (n.parsed.haveCustomWeeks && e.parsed.haveCustomWeeks) {
    if (n.parsed.customWeeksBoundaries.length != e.parsed.customWeeksBoundaries.length) return false;
    for (var i in n.parsed.customWeeks) {
      var a = n.parsed.customWeeks[i], s = e.parsed.customWeeks[i];
      if (!s || !this._compareSettings(a, s)) return false;
    }
  } else if (n.parse.haveCustomWeeks !== e.parsed.haveCustomWeeks) return false;
  return true;
  ...
  if (n !== false && (e = e.parsed), !t) return e.hours;
  ...
  var r = true;
  return e.dates[a] !== void 0 ? r = e.dates[a] : e.dates[t.getDay()] !== void 0 && (r = e.dates[t.getDay()]), r === true ? e.hours : r || [];
  ...
  return this._tryChangeCalendarSettings(B(function() {
  ...
  return a = e == "hour" && i == 1 ? this._getHoursBetween(t, n, e, i) : e == "minute" && i == 1 ? this._getMinutesBetween(t, n, e, i) : this._getWorkUnitsBetweenGeneric(t, n, e, i), s * Math.round(a);
  ...
  if (!i) return false;
  var s = new Date(n), r = new Date(e);
  for (a = a || 1; s.valueOf() < r.valueOf(); ) {
    if (this._isWorkTime(s, i)) return true;
  ...
  for (var s = 0, r = t, o = false; s < n && (!a || !a(r)); ) {
    var l = this._nextDate(r, e, i);
    e == "day" && (o = o || !r.getHours() && l.getHours()) && (l.setHours(0), l.getHours() || (o = false));
    var d = new Date(l.valueOf() + 1);
    i > 0 && (d = new Date(l.valueOf() - 1)), this._isWorkTime(d, e) && !o && s++, r = l;
  }
  ...
  for (var e = this.$gantt.date.add(this.$gantt.date.day_start(new Date(t)), 1, "day"), i = 0, a = n, s = this._getIntervalTimestamp(t, e), r = this._getWorkHours(t), o = 0; o < r.length && i < n; o++) {
    ...
    if (s.end >= l.start && s.start <= l.end) {
      var d = Math.max(l.start, s.start), c = Math.min(l.end, s.end), u = (c - d) / 3600;
      u > a && (u = a, c = d + 60 * a * 60);
  ...
  for (var e = this.$gantt.date.add(this.$gantt.date.hour_start(new Date(t)), 1, "hour"), i = 0, a = n, s = this._getIntervalTimestamp(t, e), r = this._getWorkHours(t), o = 0; o < r.length && i < n; o++) {
    var l = r[o];
    if (s.end >= l.start && s.start <= l.end) {
      var d = Math.max(l.start, s.start), c = Math.min(l.end, s.end), u = (c - d) / 60;
      u > a && (u = a, c = d + 60 * a);
  ...
  for (var e = this.$gantt.date.hour_start(new Date(t)), i = 0, a = n, s = 60 * e.getHours() * 60 + 60 * e.getMinutes() + e.getSeconds(), r = 60 * t.getHours() * 60 + 60 * t.getMinutes() + t.getSeconds(), o = this._getWorkHours(t), l = o.length - 1; l >= 0 && i < n; l--) {
    ...
    if (r > d.start && s <= d.end) {
      var c = Math.min(r, d.end), u = Math.max(s, d.start), h = (c - u) / 60;
      h > a && (h = a, u = c - 60 * a);
  ...
  var f = e;
  return i === n && (f = new Date(t.getFullYear(), t.getMonth(), t.getDate(), 0, 0, r)), { added: i, end: f };
  ...
  for (var o = 0, l = [], d = 0; a < n; ) {
    ...
    var _ = n - a, f = this._getTimeOfDayStamp(i, u);
    if (l.length && d) if (l[l.length - 1].end <= f && _ > d) a += d, i = this.$gantt.date.add(i, -1, "day");
    else {
      for (var y = false, v = null, b = null, m = l.length - 1; m >= 0; m--) if (l[m].start < f - 1 && l[m].end >= f - 1) {
        y = true, v = l[m], b = l[m - 1];
        break;
      }
      if (y) if (f === v.end && _ >= v.durationMinutes) a += v.durationMinutes, i = this.$gantt.date.add(i, -v.durationMinutes, "minute");
      else if (!s && _ <= f / 60 - v.startMinute) a += _, i = this.$gantt.date.add(i, -_, "minute");
      else if (s) _ <= f / 60 - v.startMinute ? (a += _, i = this.$gantt.date.add(i, -_, "minute")) : (a += f / 60 - v.startMinute, i = b ? new Date(i.getFullYear(), i.getMonth(), i.getDate(), 0, 0, b.end) : this.$gantt.date.day_start(i));
      else {
        var g = this._getMinutesPerHour(i);
        g <= _ ? (a += g, i = this._nextDate(i, "hour", e)) : (r = this._subtractMinutesUntilHourStart(i, _), a += r.added, i = r.end);
      }
  ...
  if (a < n) {
    var w = n - a;
    r = this._subtractMinutesUntilHourStart(i, w), a += r.added, i = r.end;
  }
  return i;
  ...
  for (var r = 0, o = [], l = 0, d = this._isMinutePrecision(i); a < n; ) {
    ...
    c !== r && (o = this._getWorkHours(i), l = this._getMinutesPerDay(i), r = c);
    var u = n - a, h = this._getTimeOfDayStamp(i);
    if (o.length && l) if (o[0].start >= h && u >= l) {
      ...
      for (var _ = false, f = null, y = 0; y < o.length; y++) if (o[y].start <= h && o[y].end > h) {
        _ = true, f = o[y];
        break;
      }
      if (_) if (h === f.start && u >= f.durationMinutes) a += f.durationMinutes, i = this.$gantt.date.add(i, f.durationMinutes, "minute");
      else if (u <= f.endMinute - h / 60) a += u, i = this.$gantt.date.add(i, u, "minute");
      else {
        var v = this._getMinutesPerHour(i);
        v <= u ? (a += v, i = d ? this.$gantt.date.add(i, v, "minute") : this._nextDate(i, "hour", e)) : (a += (s = this._addMinutesUntilHourEnd(i, u)).added, i = s.end);
      }
  ...
  if (a < n) {
    var b = n - a;
    a += (s = this._addMinutesUntilHourEnd(i, b)).added, i = s.end;
  }
  return i;
  ...
  if (i = this.$gantt.date[n + "_start"](i), e != "any" && e) i = e == "past" ? this._getClosestWorkTimePast(i, n) : this._getClosestWorkTimeFuture(i, n);
    ...
    var a = this._getClosestWorkTimeFuture(i, n), s = this._getClosestWorkTimePast(i, n);
  ...
  var i = new Date(t), a = null, s = false;
  this._getWorkHours(i).length || (i = this._getClosestWorkTime(i, "day", n < 0 ? "past" : "future"), n < 0 && (i = new Date(i.valueOf() - 1), s = true), e = this._getWorkHours(i));
  var r = this._getTimeOfDayStamp(i);
  if (s && (r = this._getTimeOfDayStamp(new Date(i.valueOf() + 1), s)), n > 0) {
  ...
  var i = new Date(t), a = this._getWorkHours(i), s = this._findClosestTimeInDay(i, e, a);
  return s || (e > 0 ? (i = this.calculateEndDate(i, e, n), i = this.$gantt.date.day_start(i)) : (i = this.calculateEndDate(i, e, "day"), i = this.$gantt.date.day_start(i), i = this.$gantt.date.add(i, 1, "day"), i = new Date(i.valueOf() - 1)), a = this._getWorkHours(i), s = this._findClosestTimeInDay(i, e, a)), e < 0 && (s = this.$gantt.date.add(s, -1, n)), s;
}, _getClosestWorkTimeGeneric: function(t, n, e) {
  if (n === "hour" || n === "minute") return this._getClosestWorkMinute(t, n, e);
  for (var i = this._getUnitOrder(n), a = this.units[i - 1], s = t, r = 0; !this._isWorkTime(s, n) && (!a || this._isWorkTime(s, a) || (s = e > 0 ? this._getClosestWorkTimeFuture(s, a) : this._getClosestWorkTimePast(s, a), !this._isWorkTime(s, n))); ) {
    if (++r > 3e3) return this.$gantt.assert(false, "Invalid working time check"), false;
    var o = s.getTimezoneOffset();
    s = this.$gantt.date.add(s, e, n), s = this.$gantt._correct_dst_change(s, o, e, n), this.$gantt.date[n + "_start"] && (s = this.$gantt.date[n + "_start"](s));
  }
  return s;
  ...
  return [0, 1, 2, 3, 4, 5, 6].forEach((function(s) {
    if (!a) {
      var r = n[s];
      r === true ? a = i : Array.isArray(r) && (a = this._checkWorkHours(r));
    }
  }).bind(this)), a;
}, _checkWorkHours: function(t) {
  if (t.length === 0) return false;
  for (var n = false, e = 0; e < t.length; e += 2) t[e] !== t[e + 1] && (n = true);
  return n;
}, _isMinutePrecision: function(t) {
  let n = false;
  return this._getWorkHours(t).forEach(function(e) {
    (e.startMinute % 60 || e.endMinute % 60) && (n = true);
  }), n;
} };
var Nt = { isLegacyResourceCalendarFormat: function(t) {
  if (!t) return false;
  for (var n in t) if (t[n] && typeof t[n] == "object") return true;
  return false;
...
var Di = (Ft = {}, { getCalendarIdFromMultipleResources: function(t, n) {
  var e = function(a) {
...
function kn(t) {
  this.$gantt = t, this._calendars = {}, this._legacyConfig = void 0, this.$gantt.attachEvent("onGanttReady", (function() {
    this.$gantt.config.resource_calendars && (this._isLegacyConfig = Nt.isLegacyResourceCalendarFormat(this.$gantt.config.resource_calendars));
...
function yn(t) {
  this.$gantt = t.$gantt, this.argumentsHelper = mn(this.$gantt), this.calendarManager = t, this.$disabledCalendar = new Ce(this.$gantt, this.argumentsHelper);
}
kn.prototype = { _calendars: {}, _convertWorkTimeSettings: function(t) {
  const n = t.days;
  ...
  var n = new Te(this.$gantt, mn(this.$gantt));
  n.id = String(ot());
  ...
  if (n.resource_calendars) {
    var e;
    if (e = this._legacyConfig === false ? n.resource_property : Nt.getResourceProperty(n), Array.isArray(t[e]) && t[e].length) n.dynamic_resource_calendars ? i = Di.getCalendarIdFromMultipleResources(t[e], this) : a = this.getResourceCalendar(t[e]);
    else if (this._legacyConfig === void 0 && (this._legacyConfig = Nt.isLegacyResourceCalendarFormat(n.resource_calendars)), this._legacyConfig) var i = Nt.getCalendarIdFromLegacyConfig(t, n.resource_calendars);
  ...
  if (Array.isArray(t) && t.length === 1 && (n = typeof t[0] == "object" ? t[0].resource_id : t[0]), i) {
    if (this._legacyConfig === void 0 && (this._legacyConfig = Nt.isLegacyResourceCalendarFormat(e.resource_calendars)), this._legacyConfig) {
  ...
  if (!i && e.config.inherit_calendar && e.isTaskExists(n.parent)) {
    for (var s = n; e.isTaskExists(s.parent) && (s = e.getTask(s.parent), !e.isSummaryTask(s) || !(i = this._getOwnCalendar(s))); ) ;
  ...
  if (t._tryChangeCalendarSettings(function() {
    ...
    return t.id = t.id || ot(), this._calendars[t.id] = t, e.worktimes || (e.worktimes = {}), e.worktimes[t.id] = t.getConfig(), t.id;
  }
  ...
  var n = this.$gantt.config;
  return !!t && !!this._calendars[t] && (delete this._calendars[t], n.worktimes && n.worktimes[t] && delete n.worktimes[t], true);
...
} }, Ce.prototype = { getWorkHours: function() {
  return [0, 24];
  ...
  if (s[e]) r = Math.round((n - t) / (i * s[e]));
  else {
    for (var o = new Date(t), l = new Date(n); o.valueOf() < l.valueOf(); ) r += 1, o = a.add(o, i, e);
...
var Ai = function(t, n) {
  ...
  }, mergeCalendars: B(t.mergeCalendars, t), createCalendar: B(t.createCalendar, t), addCalendar: B(t.addCalendar, t), getCalendar: B(t.getCalendar, t), getCalendars: B(t.getCalendars, t), getResourceCalendar: B(t.getResourceCalendar, t), getTaskCalendar: B(t.getTaskCalendar, t), deleteCalendar: B(t.deleteCalendar, t) };
};
function Ii(t) {
  t.isUnscheduledTask = function(r) {
    ...
    if (!this.isTaskExists(r)) return false;
  ...
  var n = function(r, o) {
    ...
    if (l) if (t._getAutoSchedulingConfig().schedule_from_end) d = t.calculateEndDate({ start_date: l.end_date, duration: -t.config.duration_step, task: r });
      ...
      d = c ? c.start_date ? c.start_date : c.end_date ? t.calculateEndDate({ start_date: c.end_date, duration: -t.config.duration_step, task: r }) : u : u;
    }
    return t.assert(d, "Invalid dates"), new Date(d);
  };
  t._set_default_task_timing = function(r) {
    r.start_date = r.start_date || n(r, t.getParent(r)), r.duration = r.duration || t.config.duration_step, r.end_date = r.end_date || t.calculateEndDate(r);
  }, t.createTask = function(r, o, l) {
    if (r = r || {}, t.defined(r.id) || (r.id = t.uid()), r.start_date || (r.start_date = n(r, o)), r.text === void 0 && (r.text = t.locale.labels.new_task), r.duration === void 0 && (r.duration = 1), this.isTaskExists(o)) {
      this.setParent(r, o, true);
      var d = this.getTask(o);
      d.$open = true, this.config.details_on_create || this.callEvent("onAfterParentExpand", [o, d]);
    }
    return this.callEvent("onTaskCreated", [r]) ? (this.config.details_on_create ? (t.isTaskExists(r.id) ? t.getTask(r.id).$index != r.$index && (r.start_date && typeof r.start_date == "string" && (r.start_date = this.date.parseDate(r.start_date, "parse_date")), r.end_date && typeof r.end_date == "string" && (r.end_date = this.date.parseDate(r.end_date, "parse_date")), this.$data.tasksStore.updateItem(r.id, r)) : (r.$new = true, this.silent(function() {
  ...
  var e = function(r, o) {
    var l = t.getTaskType(r.type), d = { type: l, $no_start: false, $no_end: false, scheduled_summary: false };
    return l === t.config.types.project && r.auto_scheduling === false && (d.scheduled_summary = true), o || l != r.$rendered_type ? (l == t.config.types.project ? d.$no_end = d.$no_start = true : l != t.config.types.milestone && (d.$no_end = !(r.end_date || r.duration), d.$no_start = !r.start_date, t._isAllowedUnscheduledTask(r) && (d.$no_end = d.$no_start = false)), d) : (d.$no_start = r.$no_start, d.$no_end = r.$no_end, d);
  };
  function i(r) {
  ...
  function a(r, o, l, d) {
    ...
    let h;
    h = r.type === t.config.types.project && r.auto_scheduling === false ? u : c, o.$no_start && (r[h.start] = l ? new Date(l) : n(r, this.getParent(r))), o.$no_end && (r[h.end] = d ? new Date(d) : this.calculateEndDate({ start_date: r[h.start], duration: this.config.duration_step, task: r })), (o.$no_start || o.$no_end) && this._init_task_timing(r);
  }
  function s(r) {
    ...
    return t.isTaskExists(d) && (h = t.getTask(d)), t.eachTask(function(_) {
      const f = t.getTaskType(_.type) == t.config.types.project && _.auto_scheduling === false;
      t.getTaskType(_.type) == t.config.types.project && !f || t.isUnscheduledTask(_) || (_.rollup && c.push(_.id), !_.start_date || _.$no_start && !f || o && !(o > _.start_date.valueOf()) || (o = _.start_date.valueOf()), !_.end_date || _.$no_end && !f || l && !(l < _.end_date.valueOf()) || (l = _.end_date.valueOf()), h && h.render == "split" && (_.split_placement === "inline" ? u.push(_) : _.split_placement === "subrow" || h.$open && t.config.open_split_tasks || u.push(_)));
    }, d), { start_date: o ? new Date(o) : null, end_date: l ? new Date(l) : null, rollup: c, splitItems: u };
  }
  t._init_task_timing = function(r) {
    var o = e(r, true), l = r.$rendered_type != o.type, d = o.type;
    l && (r.$no_start = o.$no_start, r.$no_end = o.$no_end, r.$rendered_type = o.type), l && d != this.config.types.milestone && d == this.config.types.project && (this._set_default_task_timing(r), r.$calculate_duration = false), d == this.config.types.milestone && (r.end_date = r.start_date), r.start_date && r.end_date && r.$calculate_duration !== false && (r.duration = this.calculateDuration(r)), r.$calculate_duration || (r.$calculate_duration = true), r.end_date || (r.end_date = r.start_date), r.duration = r.duration || 0, this.config.min_duration === 0 && r.duration === 0 && (r.$no_end = false, r.type === t.config.types.project && t.hasChild(r.id) && (r.$no_end = true));
    var c = this.getTaskCalendar(r);
    r.$effective_calendar && r.$effective_calendar !== c.id && (i(r), this.config.inherit_calendar && this.isSummaryTask(r) && this.eachTask(function(u) {
      i(u);
    }, r.id)), r.$effective_calendar = c.id;
    ...
    if (r) {
      ...
      d.rollup && (l = true);
      var c = this.getParent(d), u = e(d), h = true;
      if (l || d.start_date && d.end_date && (u.$no_start || u.$no_end)) {
        ...
        var _ = d[y].valueOf(), f = d[v].valueOf();
        t.resetProjectDates(d), l || _ != d[y].valueOf() || f != d[v].valueOf() || (h = false), h && !o && this.refreshTask(d.id, true), u.scheduled_summary && (h = true);
      }
      h && c && this.isTaskExists(c) && this._update_parents(c, o, l);
    }
  }, t.roundDate = function(r) {
    var o = t.getScale();
    et(r) && (r = { date: r, unit: o ? o.unit : t.config.duration_unit, step: o ? o.step : t.config.duration_step });
    var l, d, c, u = r.date, h = r.step, _ = r.unit;
    if (!o) return u;
    if (_ == o.unit && h == o.step && +u >= +o.min_date && +u <= +o.max_date) c = Math.floor(t.columnIndexByDate(u)), o.trace_x[c] || (c -= 1, o.rtl && (c = 0)), d = new Date(o.trace_x[c]), l = t.date.add(d, h, _);
    else {
      for (c = Math.floor(t.columnIndexByDate(u)), l = t.date[_ + "_start"](new Date(o.min_date)), o.trace_x[c] && (l = t.date[_ + "_start"](o.trace_x[c])); +l < +u; ) {
    ...
    return r.dir && r.dir == "future" ? l : r.dir && r.dir == "past" || Math.abs(u - d) < Math.abs(l - u) ? d : l;
    ...
    return t._init_task_timing(t.getTask(r)), true;
  });
}
function je(t, n) {
  ...
  function l() {
    t.$root.offsetHeight == r && t.$root.offsetWidth == o || s(), r = t.$root.offsetHeight, o = t.$root.offsetWidth, setTimeout(l, i);
  }
}
function We(t) {
...
function Mi(t) {
  t.assert = /* @__PURE__ */ function(s) {
    return function(r, o) {
      r || s.config.show_errors && s.callEvent("onError", [o]) !== false && (s.message ? s.message({ type: "error", text: o, expire: -1 }) : console.log(o));
    };
  }(t);
  ...
  function e(s) {
    ...
    throw t.assert(false, n), new Error(n);
  }
  t.init = function(s, r, o) {
    ...
    for (var r = this._getDatastores.call(this), o = 0; o < r.length; o++) r[o]._quick_refresh = true;
    for (s(), o = 0; o < r.length; o++) r[o]._quick_refresh = false;
  };
  var i = (function() {
    ...
    G(t) || (this.$root.innerHTML = "", this.$root.gantt = this, $e(this), this.config.layout.id = "main", this.$layout = this.$ui.createView("layout", this.$root, this.config.layout), this.$layout.attachEvent("onBeforeResize", function() {
      for (var s = t.$services.getService("datastores"), r = 0; r < s.length; r++) t.getDatastore(s[r]).filter(), t.$data.tasksStore._skipTaskRecalculation ? t.$data.tasksStore._skipTaskRecalculation != "lightbox" && (t.$data.tasksStore._skipTaskRecalculation = false) : t.getDatastore(s[r]).callEvent("onBeforeRefreshAll", []);
      ...
      r.className = "gantt_container_resize_watcher", r.tabIndex = -1, s.config.wai_aria_attributes && (r.setAttribute("role", "none"), r.setAttribute("aria-hidden", true)), s.env.isSalesforce && (s.config.container_resize_method = "timeout"), s.$root.appendChild(r), r.contentWindow ? je(s, r.contentWindow) : (s.$root.removeChild(r), je(s, window));
    }(this));
  }).bind(t);
  t.resetLayout = function() {
    i(), a(), this.render();
  }, t._reinit = function(s) {
    this.callEvent("onBeforeGanttReady", []), this._update_flags(), this.$services.getService("templateLoader").initTemplates(this), i(), this.$root = null, s && (this.$root = De(s), a(), this.$mouseEvents.reset(this.$root), function(r) {
...
https://docs.dhtmlx.com/gantt/faq.html#theganttchartisntrenderedcorrectly`);
    ...
    if (!t.isReadonly(r)) {
      ...
      t._delete_task_confirm({ task: r, message: o, title: l, callback: function() {
        t.isTaskExists(s) && (r.$new ? (t.$data.tasksStore._skipTaskRecalculation = "lightbox", t.silent(function() {
          t.deleteTask(s, true);
        }), t.$data.tasksStore._skipTaskRecalculation = false, t.refreshData()) : (t.$data.tasksStore._skipTaskRecalculation = true, t.deleteTask(s))), t.hideLightbox();
      } });
    }
  } } }, t.render = function() {
    var s;
    if (this.callEvent("onBeforeGanttRender", []), !G(t)) {
    ...
    if ($e(this), G(t)) t.refreshData();
    else {
      this.$layout.$config.autosize = this.config.autosize;
      var l = this.config.preserve_scroll;
      if (this.config.preserve_scroll = false, this.$layout.resize(), this.config.preserve_scroll = l, this.config.preserve_scroll && r) {
        const u = t.ext.zoom._initialized;
        if ((o || r.y) && !u) {
          var d = t.getScrollState();
          if (+s != +t.dateFromPos(d.x) || d.y != r.y) {
            o = null;
            var c = null;
            s && (o = Math.max(t.posFromDate(s) - t.config.task_scroll_offset, 0)), r.y && (c = r.y), t.scrollTo(o, c);
          }
        }
        this.$layout.getScrollbarsInfo().forEach((h) => {
          ...
          h.boundViews.forEach((y) => {
            const v = t.$ui.getView(y);
            h.y && h.y != r.y && v && !f && v.scrollTo(void 0, 0), h.x_pos && h.x_pos != r.x && v && f && v.scrollTo(h.x_pos, void 0);
          });
        });
      }
    }
    ...
    if (this.getLightboxType() == s) return true;
    ...
    var d = null;
    if (!(d = typeof s == "object" ? s : { source: s, target: r, type: this._get_link_type(o, l) }) || !(d.source && d.target && d.type) || d.source == d.target) return false;
    var c = true;
    return this.checkEvent("onLinkValidation") && (c = this.callEvent("onLinkValidation", [d])), c;
  }, t._correct_dst_change = function(s, r, o, l) {
    var d = qt(l) * o;
    if (d > 3600 && d < 86400) {
      var c = s.getTimezoneOffset() - r;
      c && (s = t.date.add(s, c, "minute"));
    }
    return s;
...
function _a(t) {
  ...
  n.plugins = function(l) {
    ...
    return { cache: true, method: "get", parse: function(d) {
      ...
      if (c.nodeName || (c = c.responseXML || c), kt.isIE) return c.selectNodes(d) || [];
      for (var u, h = [], _ = (c.ownerDocument || c).evaluate(d, c, null, XPathResult.ANY_TYPE, null); u = _.iterateNext(); ) h.push(u);
      return h;
    }, query: function(d) {
      return this._call(d.method || "GET", d.url, d.data || "", d.async || true, d.callback, d.headers);
    }, get: function(d, c, u) {
      var h = wt("GET", arguments);
      return this.query(h);
    }, getSync: function(d, c) {
      var u = wt("GET", arguments);
      return u.async = false, this.query(u);
    }, put: function(d, c, u, h) {
      var _ = wt("PUT", arguments);
      return this.query(_);
    }, del: function(d, c, u) {
      var h = wt("DELETE", arguments);
      return this.query(h);
    }, post: function(d, c, u, h) {
      arguments.length == 1 ? c = "" : arguments.length == 2 && typeof c == "function" && (u = c, c = "");
      var _ = wt("POST", arguments);
      return this.query(_);
    }, postSync: function(d, c, u) {
      c = c === null ? "" : String(c);
      var h = wt("POST", arguments);
      ...
      return new l.Promise(function(y, v) {
        ...
        h && (b.onreadystatechange = function() {
          if (b.readyState == 4 || m && b.readyState == 3) {
            ...
            setTimeout(function() {
              typeof _ == "function" && _.apply(tt, [{ xmlDoc: b, filePath: c }]), y(b), typeof _ == "function" && (_ = null, b = null);
            }, 0);
          }
        });
        var g = !this || !this.cache;
        if (d == "GET" && g && (c += (c.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (/* @__PURE__ */ new Date()).getTime() + "=1"), b.open(d, c, h), f) for (var p in f) b.setRequestHeader(p, f[p]);
  ...
  }(n), n.date = Xn(n), n.RemoteEvents = Zn;
  var a = function(l) {
    function d(u) {
    ...
    function c(u, h) {
      this._obj = u, this._settings = h || {}, lt(this);
      var _ = this.getInputMethods();
      this._drag_start_timer = null, l.attachEvent("onGanttScroll", B(function(v, b) {
        this.clearDragTimer();
      }, this));
      for (var f = { passive: false }, y = 0; y < _.length; y++) B(function(v) {
        l.event(u, v.down, B(function(m) {
          v.accessor(m) && (m.button !== void 0 && m.button !== 0 || (h.preventDefault && h.selector && ht(m.target, h.selector) && m.preventDefault(), l.config.touch && m.timeStamp && m.timeStamp - 0 < 300 || (this._settings.original_target = d(m), this._settings.original_element_sizes = { ...rt(m, rn(u)), width: m.target.offsetWidth, height: m.target.offsetHeight }, l.config.touch ? (this.clearDragTimer(), this._drag_start_timer = setTimeout(B(function() {
            l.getState().lightbox || this.dragStart(u, m, v);
          }, this), l.config.touch_drag)) : this.dragStart(u, m, v))));
        }, this), f);
        var b = document.body;
        l.event(b, v.up, B(function(m) {
          v.accessor(m) && this.clearDragTimer();
        }, this), f);
      }, this)(_[y]);
    }
    return c.prototype = { traceDragEvents: function(u, h) {
      var _ = B(function(g) {
        return this.dragMove(u, g, h.accessor);
      }, this);
      B(function(g) {
        return this.dragScroll(u, g);
      }, this);
      var f = B(function(g) {
        if (!this.config.started || !q(this.config.updates_per_second) || _n(this, this.config.updates_per_second)) {
          var p = _(g);
          if (p) try {
      ...
      }, this), y = yt(l.$root), v = this.config.mousemoveContainer || yt(l.$root), b = { passive: false }, m = B(function(g) {
        return l.eventRemove(v, h.move, f), l.eventRemove(y, h.up, m, b), this.dragEnd(u);
      }, this);
      l.event(v, h.move, f, b), l.event(y, h.up, m, b);
      ...
      if (l.config.touch) {
        var _ = h(u), f = _.target || _.srcElement, y = f.cloneNode(true);
        this.config.original_target = d(_), this.config.original_target.target = y, this.config.backup_element = f, f.parentNode.appendChild(y), f.style.display = "none", (this.config.mousemoveContainer || document.body).appendChild(f);
      }
    }, getInputMethods: function() {
      var u = [];
      return u.push({ move: "mousemove", down: "mousedown", up: "mouseup", accessor: function(h) {
        return h;
      } }), l.config.touch && (!l.env.isIE || tt.maxTouchPoints ? u.push({ move: "touchmove", down: "touchstart", up: "touchend", accessor: function(h) {
      ...
      } }) : tt.PointerEvent && u.push({ move: "pointermove", down: "pointerdown", up: "pointerup", accessor: function(h) {
      ...
      this.config && this.config.started || (this.config = { obj: u, marker: null, started: false, pos: this.getPosition(h), sensitivity: 4 }, this._settings && R(this.config, this._settings, true), this.traceDragEvents(u, _), l._prevent_touch_scroll = true, h.target.closest(".gantt_row") && !l.config.order_branch && (l._prevent_touch_scroll = false), document.body.classList.add("gantt_noselect"), l.config.touch && this.dragMove(u, h, _.accessor));
  ...
  var s = /* @__PURE__ */ function(l) {
    ...
    function c(u, h, _) {
      ...
      l.config[u] && d[_] != f[u] && (h && y[_] || (y[_] = l.date.date_to_str(f[u]), d[_] = f[u]));
    }
    return { initTemplates: function() {
      var u = l.date, h = u.date_to_str, _ = l.config, f = h(_.xml_date || _.date_format, _.server_utc), y = u.str_to_date(_.xml_date || _.date_format, _.server_utc);
      c("date_scale", true, void 0, l.config, l.templates), c("date_grid", true, "grid_date_format", l.config, l.templates), c("task_date", true, void 0, l.config, l.templates), l.mixin(l.templates, { xml_format: void 0, format_date: f, xml_date: void 0, parse_date: y, progress_text: function(v, b, m) {
        return "";
      }, grid_header_class: function(v, b) {
        return "";
      }, task_text: function(v, b, m) {
        return m.text;
      }, task_class: function(v, b, m) {
        return "";
      }, task_end_date: function(v) {
        return l.templates.task_date(v);
      }, grid_row_class: function(v, b, m) {
        return "";
      }, task_row_class: function(v, b, m) {
        return "";
      ...
      }, date_grid: function(v, b, m) {
        return b && l.isUnscheduledTask(b) && l.config.show_unscheduled ? l.templates.task_unscheduled_time(b) : l.templates.grid_date_format(v, m);
      }, task_time: function(v, b, m) {
        return l.isUnscheduledTask(m) && l.config.show_unscheduled ? l.templates.task_unscheduled_time(m) : l.templates.task_date(v) + " - " + l.templates.task_end_date(b);
      }, task_unscheduled_time: function(v) {
        return "";
      }, time_picker: h(_.time_picker), link_class: function(v) {
        return "";
      }, link_description: function(v) {
        var b = l.getTask(v.source), m = l.getTask(v.target);
        return "<b>" + b.text + "</b> &ndash;  <b>" + m.text + "</b>";
      }, drag_link: function(v, b, m, g) {
        v = l.getTask(v);
        var p = l.locale.labels, k = "<b>" + v.text + "</b> " + (b ? p.link_start : p.link_end) + "<br/>";
        return m && (k += "<b> " + (m = l.getTask(m)).text + "</b> " + (g ? p.link_start : p.link_end) + "<br/>"), k;
      }, drag_link_class: function(v, b, m, g) {
        var p = "";
        return v && m && (p = " " + (l.isLinkAllowed(v, m, b, g) ? "gantt_link_allow" : "gantt_link_deny")), "gantt_link_tooltip" + p;
      }, tooltip_date_format: u.date_to_str("%Y-%m-%d"), tooltip_text: function(v, b, m) {
  ...
  r.registerProvider("global", function() {
  ...
  }), n.getState = r.getState, n.$services.setService("state", function() {
    return r;
  }), R(n, jn), n.Promise = ti, n.env = kt, function(l) {
    var d = ii.create();
    R(l, d);
    var c, u = l.createDatastore({ name: "task", type: "treeDatastore", rootId: function() {
      return l.config.root_id;
    }, initItem: B(function(m) {
      ...
      var g = null;
      (m.duration || m.duration === 0) && (m.duration = g = 1 * m.duration), g && (m.start_date && !m.end_date ? m.end_date = this.calculateEndDate(m) : !m.start_date && m.end_date && (m.start_date = this.calculateEndDate({ start_date: m.end_date, duration: -m.duration, task: m }))), l.config.deadlines !== false && m.deadline && (m.deadline = l.date.parseDate(m.deadline, "parse_date")), m.progress = Number(m.progress) || 0, this._isAllowedUnscheduledTask(m) && this._set_default_task_timing(m), this._init_task_timing(m), m.start_date && m.end_date && this.correctTaskWorkTime(m), m.$source = [], m.$target = [];
      var p = this.$data.tasksStore.getItem(m.id);
      return p && !q(m.open) && (m.$open = p.$open), m.parent === void 0 && (m.parent = this.config.root_id), m.open && (m.$open = true), m;
    }, l), getConfig: function() {
      return l.config;
    } }), h = l.createDatastore({ name: "link", initItem: B(function(m) {
    ...
    function _(m) {
      ...
      if (!g && l.isTaskExists(m)) {
        var p = l.getParent(m);
        l.isTaskExists(p) && l.isTaskVisible(p) && (p = l.getTask(p), l.isSplitTask(p) && (g = true));
      }
      return g;
    }
    function f(m, g) {
    ...
    function y(m) {
      ...
      if (l.isTaskExists(m.target)) {
        ...
        for (p = 0; p < k.$target.length; p++) if (k.$target[p] == m.id) {
          k.$target.splice(p, 1);
          break;
        }
      }
    ...
    function v() {
      for (var m = null, g = l.$data.tasksStore.getItems(), p = 0, k = g.length; p < k; p++) (m = g[p]).$source = [], m.$target = [];
    ...
    function b(m) {
      ...
      for (var k in m.events) (function(x, w) {
        g.attachEvent(x, function() {
    ...
    l.attachEvent("onDestroy", function() {
      ...
      if (l.isLinkExists(m.id) || m.id === "predecessor_generated") return true;
      for (var g = l.getTask(m.source).$source, p = 0; p < g.length; p++) {
        var k = l.getLink(g[p]), x = m.source == k.source, w = m.target == k.target, $ = m.type == k.type;
        if (x && w && $) return false;
      }
      return true;
    }), u.attachEvent("onBeforeRefreshAll", function() {
      if (!u._skipTaskRecalculation) for (var m = u.getVisibleItems(), g = 0; g < m.length; g++) {
        var p = m[g];
        p.$index = g, p.$local_index = l.getTaskIndex(p.id), l.resetProjectDates(p);
      }
    }), u.attachEvent("onFilterItem", function(m, g) {
      if (l.config.show_tasks_outside_timescale) return true;
      var p = null, k = null;
      if (l.config.start_date && l.config.end_date) {
        if (l._isAllowedUnscheduledTask(g)) return true;
        if (p = l.config.start_date.valueOf(), k = l.config.end_date.valueOf(), +g.start_date > k || +g.end_date < +p) return false;
      }
      return true;
    }), u.attachEvent("onIdChange", function(m, g) {
      l._update_flags(m, g);
      var p = l.getTask(g);
      ...
      if (l._update_parents(m), l.getState("batchUpdate").batch_update) return true;
      var g = u.getItem(m);
      g.$source || (g.$source = []);
      for (var p = 0; p < g.$source.length; p++) h.refresh(g.$source[p]);
      for (g.$target || (g.$target = []), p = 0; p < g.$target.length; p++) h.refresh(g.$target[p]);
    }), u.attachEvent("onBeforeItemMove", function(m, g, p) {
      return !Ot(m, l, u) || (console.log("The placeholder task cannot be moved to another position."), false);
    }), u.attachEvent("onAfterItemMove", function(m, g, p) {
      var k = l.getTask(m);
      this.getNextSibling(m) !== null ? k.$drop_target = this.getNextSibling(m) : this.getPrevSibling(m) !== null ? k.$drop_target = "next:" + this.getPrevSibling(m) : k.$drop_target = "next:null";
    }), u.attachEvent("onStoreUpdated", function(m, g, p) {
      if (p == "delete" && l._update_flags(m, null), !l.$services.getService("state").getState("batchUpdate").batch_update) {
        if (l.config.fit_tasks && p !== "paint") {
          ...
          $e(l);
          var x = l.getState();
          if (+k.min_date != +x.min_date || +k.max_date != +x.max_date) return l.render(), l.callEvent("onScaleAdjusted", []), true;
        }
        p == "add" || p == "move" || p == "delete" ? l.$layout && (this.$config.name != "task" || p != "add" && p != "delete" || this._skipTaskRecalculation != "lightbox" && (this._skipTaskRecalculation = true), l.$layout.resize()) : m || h.refresh();
      }
      ...
      y(l.mixin({ id: m }, l.$data.linksStore.getItem(g))), h.sync_link(l.$data.linksStore.getItem(g));
    }), h.attachEvent("onFilterItem", function(m, g) {
      if (!l.config.show_links) return false;
      var p = _(g.source), k = _(g.target);
      return !(!p || !k || l._isAllowedUnscheduledTask(l.getTask(g.source)) || l._isAllowedUnscheduledTask(l.getTask(g.target))) && l.callEvent("onBeforeLinkDisplay", [m, g]);
    }), c = {}, l.attachEvent("onBeforeTaskDelete", function(m, g) {
      return c[m] = we.getSubtreeLinks(l, m), true;
    }), l.attachEvent("onAfterTaskDelete", function(m, g) {
      c[m] && l.$data.linksStore.silent(function() {
        for (var p in c[m]) l.isLinkExists(p) && l.$data.linksStore.removeItem(p), y(c[m][p]);
        c[m] = null;
      });
  ...
  }(n), n.dataProcessor = ri, n.createDataProcessor = oi, function(l) {
    l.ext || (l.ext = {});
    for (var d = [di, ci, _i, gi, fi, pi, mi, vi, ki, xi], c = 0; c < d.length; c++) d[c] && d[c](l);
    const { getAutoSchedulingConfig: u } = /* @__PURE__ */ function(h) {
      function _() {
      ...
      return { getDefaultAutoSchedulingConfig: _, getAutoSchedulingConfig: function() {
        const f = h.config;
        if (typeof f.auto_scheduling == "object") {
          const y = { enabled: false, apply_constraints: false, gap_behavior: "preserve", descendant_links: false, schedule_on_parse: true, move_projects: true, use_progress: false, schedule_from_end: false, project_constraint: false, show_constraints: false, ...f.auto_scheduling };
          return y.mode && (y.apply_constraints = y.mode === "constraints", delete y.mode), y.strict !== void 0 && (y.gap_behavior = y.strict ? "compress" : "preserve", delete y.strict), y.move_asap_tasks !== void 0 && (y.gap_behavior = y.move_asap_tasks ? "compress" : "preserve", delete y.move_asap_tasks), y;
        }
        return { enabled: false, apply_constraints: false, gap_behavior: "preserve", descendant_links: false, schedule_on_parse: true, move_projects: true, use_progress: false, schedule_from_end: false, project_constraint: false, show_constraints: false, enabled: !!f.auto_scheduling, apply_constraints: f.auto_scheduling_compatibility ?? false, gap_behavior: f.auto_scheduling_strict !== true ? "preserve" : "compress", descendant_links: f.auto_scheduling_descendant_links ?? false, schedule_on_parse: f.auto_scheduling_initial ?? true, move_projects: f.auto_scheduling_move_projects ?? true, use_progress: f.auto_scheduling_use_progress ?? false, schedule_from_end: f.schedule_from_end ?? false, project_constraint: f.auto_scheduling_project_constraint ?? false, show_constraints: false };
      } };
    }(l);
    l._getAutoSchedulingConfig = u;
  }(n), function(l) {
    ...
    l._cached_functions = { cache: {}, mode: false, critical_path_mode: false, wrap_methods: function(u, h) {
      ...
      if (_) {
        ...
        h._prefetch_originals[u] = _, h[u] = function() {
          ...
          if (f.active) {
            var m = f.get_arguments_hash(Array.prototype.slice.call(y));
            f.cache[u] || (f.cache[u] = {});
            var g = f.cache[u];
      ...
      this.mode == "auto" ? u.config.highlight_critical_path && (h = _) : this.mode === true && (h = _), this.wrap_methods(h, u);
  ...
  var o = new Qi({ en: ji, ar: Ni, be: Li, ca: Ri, cn: Pi, cs: Hi, da: Oi, de: Bi, el: zi, es: Wi, fa: Fi, fi: Vi, fr: Ui, he: qi, hr: Gi, hu: Yi, id: Ji, it: Ki, jp: Xi, kr: Zi, nb: ta, nl: ea, no: na, pl: ia, pt: aa, ro: sa, ru: ra, si: oa, sk: la, sv: da, tr: ca, ua });
  return n.i18n = { addLocale: o.addLocale, setLocale: function(l) {
    if (typeof l == "string") {
      var d = o.getLocale(l);
      d || (d = o.getLocale("en")), n.locale = d;
    } else if (l) if (n.locale) for (var c in l) l[c] && typeof l[c] == "object" ? (n.locale[c] || (n.locale[c] = {}), n.mixin(n.locale[c], l[c], true)) : n.locale[c] = l[c];
    else n.locale = l;
...
function ga(t) {
  ...
  function i(m, g) {
    var p = m.callback;
    y.hide(m.box), e = m.box = null, p && p(g);
  }
  function a(m) {
    if (e) {
      var g = m.which || m.keyCode, p = false;
      if (v.keyboard) {
        if (g == 13 || g == 32) {
          var k = m.target || m.srcElement;
          Q(k).indexOf("gantt_popup_button") > -1 && k.click ? k.click() : (i(e, true), p = true);
        }
        g == 27 && (i(e, false), p = true);
      }
      return p ? (m.preventDefault && m.preventDefault(), !(m.cancelBubble = true)) : void 0;
    }
  }
  var s = yt(t.$root) || document;
  function r(m) {
    r.cover || (r.cover = document.createElement("div"), r.cover.onkeydown = a, r.cover.className = "dhx_modal_cover", document.body.appendChild(r.cover)), r.cover.style.display = m ? "inline-block" : "none";
  }
  function o(m, g, p) {
  ...
  function d(m, g, p) {
    var k = m.tagName ? m : function($, T, S) {
      var C = document.createElement("div"), E = ot();
      t._waiAria.messageModalAttr(C, E), C.className = " gantt_modal_box gantt-" + $.type, C.setAttribute(n, 1);
      var D = "";
      if ($.width && (C.style.width = $.width), $.height && (C.style.height = $.height), $.title && (D += '<div class="gantt_popup_title">' + $.title + "</div>"), D += '<div class="gantt_popup_text" id="' + E + '"><span>' + ($.content ? "" : $.text) + '</span></div><div  class="gantt_popup_controls">', T && (D += o(l($.ok, t.locale.labels.message_ok, "OK"), "ok", true)), S && (D += o(l($.cancel, t.locale.labels.message_cancel, "Cancel"), "cancel", false)), $.buttons) for (var A = 0; A < $.buttons.length; A++) {
        var M = $.buttons[A];
        D += typeof M == "object" ? o(M.label, M.css || "gantt_" + M.label.toLowerCase() + "_button", M.value || A) : o(M, M, A);
      }
      if (D += "</div>", C.innerHTML = D, $.content) {
        var I = $.content;
        typeof I == "string" && (I = document.getElementById(I)), I.style.display == "none" && (I.style.display = ""), C.childNodes[$.title ? 1 : 0].appendChild(I);
      }
      return C.onclick = function(N) {
        var L = N.target || N.srcElement;
        if (L.className || (L = L.parentNode), ht(L, ".gantt_popup_button")) {
          var O = L.getAttribute("data-result");
          i($, O = O == "true" || O != "false" && O);
        }
      }, $.box = C, (T || S) && (e = $), C;
    }(m, g, p);
    m.hidden || r(true), document.body.appendChild(k);
    var x = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - k.offsetWidth) / 2)), w = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - k.offsetHeight) / 2));
    return m.position == "top" ? k.style.top = "-3px" : k.style.top = w + "px", k.style.left = x + "px", k.onkeydown = a, y.focus(k), m.hidden && y.hide(k), t.callEvent("onMessagePopup", [k]), k;
  }
  function c(m) {
    return d(m, true, false);
  }
  function u(m) {
    return d(m, true, true);
  }
  function h(m) {
    return d(m);
  }
  ...
  function f(m, g, p, k) {
    return typeof m != "object" && (m = { text: m, type: g, expire: p, id: k }), m.id = m.id || ot(), m.expire = m.expire || v.expire, m;
  }
  t.event(s, "keydown", a, true);
  var y = function() {
  ...
  y.hide = function(m) {
    ...
    m && (m.parentNode.removeChild(m), r(false), t.callEvent("onAfterMessagePopup", [m]));
  }, y.focus = function(m) {
    setTimeout(function() {
      var g = Pt(m);
  ...
  var v = function(m, g, p, k) {
    switch ((m = f.apply(this, arguments)).type = m.type || "info", m.type.split("-")[0]) {
      ...
      default:
        return function(x) {
          v.area || (v.area = document.createElement("div"), v.area.className = "gantt_message_area", v.area.style[v.position] = "5px"), K(v.area, document.body) || document.body.appendChild(v.area), v.hide(x.id);
          var w = document.createElement("div");
          return w.innerHTML = "<div>" + x.text + "</div>", w.className = "gantt-info gantt-" + x.type, w.onclick = function() {
            v.hide(x.id), x = null;
          }, t._waiAria.messageInfoAttr(w), v.position == "bottom" && v.area.firstChild ? v.area.insertBefore(w, v.area.firstChild) : v.area.appendChild(w), x.expire > 0 && (v.timers[x.id] = window.setTimeout(function() {
            v && v.hide(x.id);
          }, x.expire)), v.pull[x.id] = w, w = null, x.id;
        }(m);
    }
  };
  v.seed = (/* @__PURE__ */ new Date()).valueOf(), v.uid = ot, v.expire = 4e3, v.keyboard = true, v.position = "top", v.pull = {}, v.timers = {}, v.hideAll = function() {
    for (var m in v.pull) v.hide(m);
  }, v.hide = function(m) {
    var g = v.pull[m];
    g && g.parentNode && (window.setTimeout(function() {
      g.parentNode.removeChild(g), g = null;
    }, 2e3), g.className += " hidden", v.timers[m] && window.clearTimeout(v.timers[m]), delete v.pull[m]);
  };
  var b = [];
  return t.attachEvent("onMessagePopup", function(m) {
    ...
    var m = _.apply(this, arguments);
    return m.type = m.type || "confirm", c(m);
  }, confirm: function() {
    var m = _.apply(this, arguments);
    return m.type = m.type || "alert", u(m);
  }, message: v, modalbox: y };
}
function Fe(t, n) {
  var e = this.$config[t];
  return e ? (e.$extendedConfig || (e.$extendedConfig = true, Object.setPrototypeOf(e, n)), e) : n;
}
function fa(t, n) {
  var e, i, a;
  R(t, (e = n, { $getConfig: function() {
    return i || (i = e ? e.$getConfig() : this.$gantt.config), this.$config.config ? Fe.call(this, "config", i) : i;
  }, $getTemplates: function() {
    return a || (a = e ? e.$getTemplates() : this.$gantt.templates), this.$config.templates ? Fe.call(this, "templates", a) : a;
  } }));
}
var pa = function(t) {
  var n = {}, e = {};
  function i(a, s, r, o) {
    ...
    a != "resizer" || r.mode || (o.$config.cols ? r.mode = "x" : r.mode = "y"), a != "viewcell" || r.view != "scrollbar" || r.scroll || (o.$config.cols ? r.scroll = "y" : r.scroll = "x"), (r = X(r)).id || e[r.view] || (r.id = r.view), r.id && !r.css && (r.css = r.id + "_cell");
    var d = new l.create(s, r, this, t);
    return l.configure && l.configure(d), fa(d, o), d.$id || (d.$id = r.id || t.uid()), d.$parent || typeof s != "object" || (d.$parent = s), d.$config || (d.$config = r), e[d.$id] && (d.$id = t.uid()), e[d.$id] = d, d;
  }
  return { initUI: function(a, s) {
    var r = "cell";
    return a.view ? r = "viewcell" : a.resizer ? r = "resizer" : a.rows || a.cols ? r = "layout" : a.views && (r = "multiview"), i.call(this, r, null, a, s);
  }, reset: function() {
    e = {};
  }, registerView: function(a, s, r) {
    n[a] = { create: s, configure: r };
...
var ma = /* @__PURE__ */ function(t) {
  return function(n) {
    ...
    function a(h) {
      h = h || window.event;
      var _ = n.locate(h), f = r(h, e.click), y = true;
      if (_ !== null ? y = !n.checkEvent("onTaskClick") || n.callEvent("onTaskClick", [_, h]) : n.callEvent("onEmptyClick", [h]), y) {
        if (!o(f, h, _)) return;
    ...
    function s(h) {
      var _ = (h = h || window.event).target || h.srcElement, f = n.locate(_), y = n.locate(_, n.config.link_attribute), v = !n.checkEvent("onContextMenu") || n.callEvent("onContextMenu", [f, y, h]);
    ...
    function r(h, _) {
      for (var f = h.target || h.srcElement, y = []; f; ) {
        ...
        if (v) {
          v = v.split(" ");
          for (var b = 0; b < v.length; b++) if (v[b] && _[v[b]]) for (var m = _[v[b]], g = 0; g < m.length; g++) m[g].root && !t.isChildOf(f, m[g].root) || y.push(m[g].handler);
        }
        f = f.parentNode;
      }
      return y;
    ...
    function l(h) {
      h = h || window.event;
      var _ = n.locate(h), f = r(h, e.doubleclick), y = !n.checkEvent("onTaskDblClick") || _ === null || n.callEvent("onTaskDblClick", [_, h]);
      if (y) {
        if (!o(f, h, _)) return;
    ...
    function u(h) {
      c.detachAll(), h && (c.attach(h, "click", a), c.attach(h, "dblclick", l), c.attach(h, "mousemove", d), c.attach(h, "contextmenu", s));
    }
    return { reset: u, global: function(h, _, f) {
      i(h, _, f, null);
    }, delegate: i, detach: function(h, _, f, y) {
      if (e[h] && e[h][_]) {
        for (var v = e[h], b = v[_], m = 0; m < b.length; m++) b[m].root == y && (b.splice(m, 1), m--);
        b.length || delete v[_];
      }
...
function mt(t, n, e, i, a) {
  var s = n.getItemIndexByTopPosition(a.y) || 0, r = n.getItemIndexByTopPosition(a.y_end) || i.count(), o = Math.max(0, s - 1), l = Math.min(i.count(), r + 1);
  const d = [];
...
var ka = function(t) {
  var n = /* @__PURE__ */ function(e) {
    ...
    function r(o, l, d) {
      if (a[o]) return a[o];
      l.renderer || e.assert(false, "Invalid renderer call");
      var c = null, u = null, h = null, _ = null, f = null;
      typeof l.renderer == "function" ? (c = l.renderer, h = Qt) : (c = l.renderer.render, u = l.renderer.update, _ = l.renderer.onrender, l.renderer.isInViewPort ? f = l.renderer.isInViewPort : h = l.renderer.getRectangle, h || h === null || (h = Qt));
      var y = l.filter;
      return d && d.setAttribute(e.config.layer_attribute, true), a[o] = { render_item: function(v, b, m, g, p) {
        if (b = b || d, !y || y(v)) {
          var k = g || s(l), x = p || (k ? k.$getConfig() : null), w = m;
          !w && x && x.smart_rendering && (w = k.getViewPort());
          var $ = null;
          !Rt(e) && (h || f) && w ? (f ? f(v, w, k, x, e) : Ve(w, h(v, k, x, e))) && ($ = c.call(e, v, k, x, w)) : $ = c.call(e, v, k, x, w), this.append(v, $, b);
          var T = b.nodeType == 11;
          _ && !T && $ && _.call(e, v, $, k);
        ...
        var b, m, g = s(l), p = g ? g.$getConfig() : null;
        return p && p.smart_rendering && (b = g.getViewPort()), g && b && (typeof l.renderer == "function" ? m = mt(e, g, 0, v, b) : l.renderer && l.renderer.getVisibleRange && (m = l.renderer.getVisibleRange(e, g, p, v, b))), m || (m = { start: 0, end: v.count() }), m;
        ...
        this.clear(b);
        var g = null, p = s(l), k = p ? p.$getConfig() : null;
        k && k.smart_rendering && (g = p.getViewPort());
        for (var x = 0, w = v.length; x < w; x++) this.render_item(v[x], m, g, p, k);
        b.appendChild(m, b);
        var $ = {};
        ...
        if (_) {
          var S = {};
          for (var x in this.rendered) T[x] || (S[x] = this.rendered[x], _.call(e, $[x], this.rendered[x], p));
        }
      }, update_items: function(v, b) {
        var m = s(l), g = m ? m.$getConfig() : null;
        if (m && m.$getConfig().smart_rendering && !Rt(e) && this.rendered && (h || f)) {
          b = b || d;
          ...
          var w = {}, $ = {};
          for (var T in this.rendered) $[T] = true, w[T] = true;
          for (var S = {}, C = (T = 0, v.length); T < C; T++) {
            var E = v[T], D = this.rendered[E.id];
            $[E.id] = false, D && D.parentNode ? (f ? f(E, k, m, g, e) : Ve(k, h(E, m, g, e))) ? (u && u.call(e, E, D, m, g, k), this.restore(E, p)) : $[E.id] = true : (S[v[T].id] = true, this.render_item(v[T], p, k, m, g));
          }
          for (var T in $) $[T] && this.hide(T);
          if (p.childNodes.length && b.appendChild(p, b), _) {
            var A = {};
            for (var T in this.rendered) w[T] && !S[T] || (A[T] = this.rendered[T], _.call(e, x[T], this.rendered[T], m));
          }
        }
      }, append: function(v, b, m) {
        this.rendered && (b ? (this.rendered[v.id] && this.rendered[v.id].parentNode ? this.replace_item(v.id, b) : m.appendChild(b), this.rendered[v.id] = b) : this.rendered[v.id] && this.remove_item(v.id));
      }, replace_item: function(v, b) {
        var m = this.rendered[v];
        m && m.parentNode && m.parentNode.replaceChild(b, m), this.rendered[v] = b;
        ...
        var m = this.rendered[v.id];
        m ? m.parentNode || this.append(v, m, b || d) : this.render_item(v, b || d);
  ...
  return { createGroup: function(e, i, a, s) {
    var r = { tempCollection: [], renderers: {}, container: e, filters: [], getLayers: function() {
      ...
      o && (o.id = o.id || ot(), this.tempCollection.push(o));
      const l = this.container(), d = this.tempCollection;
      for (let c = 0; c < d.length; c++) {
        if (o = d[c], !(this.container() || o && o.container && o.container.isConnected)) continue;
        ...
        this.renderers[h] = n.getRenderer(h, o, u), s && s(o, t), this.tempCollection.splice(c, 1), c--;
      }
    }, addLayer: function(o) {
      if (o) {
        typeof o == "function" && (o = { renderer: o }), o.filter === void 0 ? o.filter = Ue(a || []) : o.filter instanceof Array && (o.filter.push(a), o.filter = Ue(o.filter)), o.container || (o.container = document.createElement("div"));
        var l = this;
        o.requestUpdate = function() {
          t.config.smart_rendering && !Rt(t) && l.renderers[o.id] && l.onUpdateRequest(l.renderers[o.id]);
        };
      }
...
function Ue(t) {
  return t instanceof Array || (t = Array.prototype.slice.call(arguments, 0)), function(n) {
    for (var e = true, i = 0, a = t.length; i < a; i++) {
      var s = t[i];
      s && (e = e && s(n.id, n) !== false);
    }
    return e;
  };
}
function qe(t, n, e) {
  ...
  var i = n.posFromDate(t.start_date, n._getPositioningContext ? n._getPositioningContext(t) : null), a = n.posFromDate(t.end_date, n._getPositioningContext ? n._getPositioningContext(t) : null), s = Math.min(i, a) - 200, r = Math.max(i, a) + 200;
  return { top: n.getItemTop(t.id), height: n.getItemHeight(t.id), left: s, width: r - s };
}
function bn() {
  var t = [], n = false;
  function e() {
  ...
  function i(s, r, o) {
    r.$getConfig(), s.getVisibleItems().forEach(function(l) {
      var d = function(c, u, h, _) {
        if (!_.isTaskExists(c.source) || !_.isTaskExists(c.target)) return null;
        var f = qe(_.getTask(c.source), u), y = qe(_.getTask(c.target), u);
        if (!f || !y) return null;
        var v = 100, b = Math.min(f.left, y.left) - v, m = Math.max(f.left + f.width, y.left + y.width) + v, g = Math.min(f.top, y.top) - v, p = Math.max(f.top + f.height, y.top + y.height) + v;
  ...
  return function(s, r, o, l, d) {
    (function(f) {
      a || (a = true, f.attachEvent("onPreFilter", e), f.attachEvent("onStoreUpdated", e), f.attachEvent("onClearAll", e), f.attachEvent("onBeforeStoreUpdate", e));
    })(l), n || i(l, r, s);
...
function xn(t, n, e, i, a) {
  var s = e.$gantt.getTask(t.source), r = e.$gantt.getTask(t.target), o = e.getItemTop(s.id), l = e.getItemHeight(s.id), d = e.getItemTop(r.id), c = e.getItemHeight(r.id);
  if (n.y > o + l && n.y > d + c || n.y_end < d && n.y_end < o) return false;
  var u = e.posFromDate(s.start_date, e._getPositioningContext ? e._getPositioningContext(t) : null), h = e.posFromDate(s.end_date, e._getPositioningContext ? e._getPositioningContext(t) : null), _ = e.posFromDate(r.start_date, e._getPositioningContext ? e._getPositioningContext(t) : null), f = e.posFromDate(r.end_date, e._getPositioningContext ? e._getPositioningContext(t) : null);
  if (u > h) {
    var y = h;
    h = u, u = y;
  }
  return _ > f && (y = f, f = _, _ = y), u += -100, h += 100, _ += -100, f += 100, !(n.x > h && n.x > f) && !(n.x_end < u && n.x_end < _);
}
function ya(t, n) {
  if (t.view) {
    var e = t.view;
...
var Bt = function() {
  function t(n, e, i, a) {
    n && (this.$container = De(n), this.$parent = n), this.$config = R(e, { headerHeight: 33 }), this.$gantt = a, this.$domEvents = a._createDomEventScope(), this.$id = e.id || "c" + ot(), this.$name = "cell", this.$factory = i, this.$externalComponent = null, lt(this);
  }
  return t.prototype.destructor = function() {
    ...
    n === false && (this.$preResize = true);
    var e = this.$container, i = e.offsetWidth, a = e.offsetHeight, s = this.getSize();
    e === document.body && (i = document.body.offsetWidth, a = document.body.offsetHeight), i < s.minWidth && (i = s.minWidth), i > s.maxWidth && (i = s.maxWidth), a < s.minHeight && (a = s.minHeight), a > s.maxHeight && (a = s.maxHeight), this.setSize(i, a), this.$preResize, this.$preResize = false;
  }, t.prototype.hide = function() {
    this._hide(true), this.resize();
  }, t.prototype.show = function(n) {
    this._hide(false), n && this.$parent && this.$parent.show(), this.resize();
  }, t.prototype._hide = function(n) {
    if (n === true && this.$view.parentNode) this.$view.parentNode.removeChild(this.$view);
    else if (n === false && !this.$view.parentNode) {
    ...
    if (i.raw) n = typeof i.raw == "string" ? i.raw : "";
      ...
      if (!n) {
        let s = null;
        s = typeof i.html == "function" ? i.html() : i.html, this.$gantt.config.external_render && this.$gantt.config.external_render.isElement(s) && (this.$externalComponent = s, s = null), n = "<div class='gantt_layout_content' " + (e ? " class='" + e + "' " : "") + " >" + (s || "") + "</div>";
      }
    ...
    this._headerClickHandler = function(e) {
      it(e, "data-cell-id") == n.$id && n.toggle();
    ...
    var i = this._getBorderSizes(), a = e - i.vertical, s = n - i.horizontal;
    this.$lastSize = { x: n, y: e, contentX: s, contentY: a }, this.$config.header ? this._sizeHeader() : this._sizeContent();
    ...
    e || (e = this);
    var i = e.$view;
    for (var a in this._borders) Jt(i, this._borders[a]);
    typeof n == "string" && (n = [n]);
    var s = {};
    for (a = 0; a < n.length; a++) Ct(i, n[a]), s[n[a]] = true;
    e._currentBorders = s;
    ...
    if (this.$config.collapsed) if (i.style.display = "none", a) {
      ...
      e.style.transform = "rotate(90deg) translate(" + s + "px, " + s + "px)", i.style.display = "none";
...
var $n = function(t) {
  function n(e, i, a) {
    ...
    return e && (s.$root = true), s._parseConfig(i), s.$name = "layout", s;
  }
  return F(n, t), n.prototype.destructor = function() {
    this.$container && this.$view && nn(this.$view);
    ...
    const o = [];
    function l(f) {
      f.$parent.show(), a = true, s.push(f);
    }
    function d(f) {
      f.$parent.hide(), a = true, r.push(f);
    }
    for (var c, u = 0; u < i.length; u++) e[(c = i[u]).$config.scroll] ? d(c) : c.shouldHide() ? o.push(c) : c.shouldShow() ? l(c) : c.isVisible() ? s.push(c) : r.push(c);
    var h = {};
    for (u = 0; u < s.length; u++) s[u].$config.group && (h[s[u].$config.group] = true);
    for (o.forEach(function(f) {
      f.$config.group && h[f.$config.group] || d(f);
    }), u = 0; u < r.length; u++) if ((c = r[u]).$config.group && h[c.$config.group]) {
      l(c);
      for (var _ = 0; _ < s.length; _++) if (s[_] == c) {
    ...
    return e.forEach((a) => {
      let s = {};
      const { visible: r, direction: o, size: l, scrollSize: d, position: c } = a.getScrollState();
      let u = a._getLinkedViews().map((h) => h.$config.id);
      s.id = a.$id, s.visible = r, s.boundViews = u, o === "x" ? (s.x = l, s.x_inner = d, s.x_pos = c || 0) : (s.y = l, s.y_inner = d, s.y_pos = c || 0), i.push(s);
    }), i;
    ...
    if (e.length) for (var a = e[0].$parent._xLayout ? "width" : "height", s = e[0].$parent.getNextSibling(e[0].$id) ? 1 : -1, r = i.value, o = i.isGravity, l = 0; l < e.length; l++) {
      var d = e[l].getSize(), c = s > 0 ? e[l].$parent.getNextSibling(e[l].$id) : e[l].$parent.getPrevSibling(e[l].$id);
      c.$name == "resizer" && (c = s > 0 ? c.$parent.getNextSibling(c.$id) : c.$parent.getPrevSibling(c.$id));
      var u = c.getSize();
      if (o) e[l].$config.gravity = r;
      else if (c[a]) {
        var h = d.gravity + u.gravity, _ = d[a] + u[a], f = h / _;
        e[l].$config.gravity = f * r, c.$config[a] = _ - r, c.$config.gravity = h - f * r;
      } else e[l].$config[a] = r;
    ...
    for (var i = e.rows || e.cols || e.views, a = 0; a < i.length; a++) {
      ...
      r ? (r.$parent = this, this.$cells.push(r)) : (i.splice(a, 1), a--);
    }
  }, n.prototype.getCells = function() {
    return this.$cells;
  }, n.prototype.render = function() {
    var e = en(this.$container, this.$toHTML());
    this.$fill(e, null);
    const i = this.$gantt;
    this._eachChild((a) => {
    ...
    for (var a = an(e, "gantt_layout_cell"), s = a.length - 1; s >= 0; s--) {
      var r = this.$cells[s];
    ...
    for (var i, a, s, r = 0, o = 0, l = 0; l < this.$cells.length; l++) (a = this.$cells[l]).$config.hidden || (i = a.getContentSize(e), a.$config.view === "scrollbar" && e[a.$config.scroll] && (i.height = 0, i.width = 0), a.$config.resizer && (this._xLayout ? i.height = 0 : i.width = 0), s = a._getBorderSizes(), this._xLayout ? (r += i.width + s.horizontal, o = Math.max(o, i.height + s.vertical)) : (r = Math.max(r, i.width + s.horizontal), o += i.height + s.vertical));
    ...
    var i = null, a = ["width", "height", "paddingTop", "paddingBottom", "paddingLeft", "paddingRight", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], s = { boxSizing: (i = window.getComputedStyle ? window.getComputedStyle(e, null) : { width: e.clientWidth, height: e.clientHeight }).boxSizing == "border-box" };
    i.MozBoxSizing && (s.boxSizing = i.MozBoxSizing == "border-box");
    for (var r = 0; r < a.length; r++) s[a[r]] = i[a[r]] ? this._cleanElSize(i[a[r]]) : 0;
    ...
    return e === "xy" ? i.x = i.y = true : e === "y" || e === true ? i.y = true : e === "x" && (i.x = true), i;
  }, n.prototype.autosize = function(e) {
    var i = this._getAutosizeMode(e), a = this._getBoxStyles(this.$container), s = this.getContentSize(e), r = this.$container;
    i.x && (a.borderBox && (s.width += a.horPaddings), r.style.width = s.width + "px"), i.y && (a.borderBox && (s.height += a.vertPaddings), r.style.height = s.height + "px");
  }, n.prototype.getSize = function() {
    this._sizes = [];
    for (var e = 0, i = 0, a = 1e11, s = 0, r = 1e11, o = 0, l = 0; l < this.$cells.length; l++) {
      var d = this._sizes[l] = this.$cells[l].getSize();
      this.$cells[l].$config.hidden || (this._xLayout ? (!d.width && d.minWidth ? e += d.minWidth : e += d.width, a += d.maxWidth, i += d.minWidth, s = Math.max(s, d.height), r = Math.min(r, d.maxHeight), o = Math.max(o, d.minHeight)) : (!d.height && d.minHeight ? s += d.minHeight : s += d.height, r += d.maxHeight, o += d.minHeight, e = Math.max(e, d.width), a = Math.min(a, d.maxWidth), i = Math.max(i, d.minWidth)));
    }
    var c = t.prototype.getSize.call(this);
    return c.maxWidth >= 1e5 && (c.maxWidth = a), c.maxHeight >= 1e5 && (c.maxHeight = r), c.minWidth = c.minWidth != c.minWidth ? 0 : c.minWidth, c.minHeight = c.minHeight != c.minHeight ? 0 : c.minHeight, this._xLayout ? (c.minWidth += this.$config.margin * this.$cells.length || 0, c.minWidth += 2 * this.$config.padding || 0, c.minHeight += 2 * this.$config.padding || 0) : (c.minHeight += this.$config.margin * this.$cells.length || 0, c.minHeight += 2 * this.$config.padding || 0), c;
  }, n.prototype._calcFreeSpace = function(e, i, a) {
    var s = a ? i.minWidth : i.minHeight, r = i.maxWidth, o = e;
    return o ? (o > r && (o = r), o < s && (o = s), this._free -= o) : ((o = Math.floor(this._free / this._gravity * i.gravity)) > r && (o = r, this._free -= o, this._gravity -= i.gravity), o < s && (o = s, this._free -= o, this._gravity -= i.gravity)), o;
  }, n.prototype._calcSize = function(e, i, a) {
    var s = e, r = a ? i.minWidth : i.minHeight, o = a ? i.maxWidth : i.maxHeight;
    return s || (s = Math.floor(this._free / this._gravity * i.gravity)), s > o && (s = o), s < r && (s = r), s;
    ...
    for (var e = this._xLayout ? this._borders.right : this._borders.bottom, i = this.$cells, a = i.length - 1, s = a; s >= 0; s--) if (!i[s].$config.hidden) {
      a = s;
      break;
    }
    for (s = 0; s < i.length; s++) if (!i[s].$config.hidden) {
      var r = s >= a, o = "";
      !r && i[s + 1] && i[s + 1].$config.view == "scrollbar" && (this._xLayout ? r = true : o = "gantt_layout_cell_border_transparent"), this._setBorders(r ? [] : [e, o], i[s]);
    }
  }, n.prototype._updateCellVisibility = function() {
    for (var e = this._visibleCells || {}, i = !this._visibleCells, a = {}, s = null, r = [], o = 0; o < this._sizes.length; o++) (s = this.$cells[o]).$config.hide_empty && r.push(s), !i && s.$config.hidden && e[s.$id] ? s._hide(true) : s.$config.hidden || e[s.$id] || s._hide(false), s.$config.hidden || (a[s.$id] = true);
    for (this._visibleCells = a, o = 0; o < r.length; o++) {
      var l = (s = r[o]).$cells, d = true;
    ...
    this.$view.style.padding = r + "px", this._gravity = 0, this._free = this._xLayout ? e : i, this._free -= 2 * r, this._updateCellVisibility();
    for (var o = 0; o < this._sizes.length; o++) if (!(a = this.$cells[o]).$config.hidden) {
      ...
      o !== this.$cells.length - 1 && (d.style[c] = l + "px", this._free -= l), s = this._sizes[o], this._xLayout ? s.width || (this._gravity += s.gravity) : s.height || (this._gravity += s.gravity);
    }
    for (o = 0; o < this._sizes.length; o++) if (!(a = this.$cells[o]).$config.hidden) {
      var u = (s = this._sizes[o]).width, h = s.height;
      this._xLayout ? this._calcFreeSpace(u, s, true) : this._calcFreeSpace(h, s, false);
    }
    for (o = 0; o < this.$cells.length; o++) if (!(a = this.$cells[o]).$config.hidden) {
      s = this._sizes[o];
      var _ = void 0, f = void 0;
      this._xLayout ? (_ = this._calcSize(s.width, s, true), f = i - 2 * r) : (_ = e - 2 * r, f = this._calcSize(s.height, s, false)), a.setSize(_, f);
    }
  }, n;
}(Bt);
var ba = function(t) {
  ...
  return F(n, t), n.prototype.cell = function(e) {
    ...
    var i = this.$view;
    this.$cell && (this.$cell.$config.hidden = true, i.removeChild(this.$cell.$view)), this.$cell = e, i.appendChild(e.$view);
  }, n.prototype.setSize = function(e, i) {
    Bt.prototype.setSize.call(this, e, i);
    ...
    if (this.$cell) {
      ...
      if (this.$config.byMaxSize) for (var a = 0; a < this.$cells.length; a++) {
        ...
        for (var r in i) i[r] = Math.max(i[r], s[r]);
      }
...
var xa = function(t) {
  function n(e, i, a) {
    ...
    if (i.view) {
      i.id && (this.$id = ot());
      var r = X(i);
      if (delete r.config, delete r.templates, this.$content = this.$factory.createView(i.view, this, r, this), !this.$content) return false;
    }
...
var $a = function(t) {
  ...
  function e(a, s, r, o) {
    ...
    this.$config = R(s, { scroll: "x" }), l._scrollHorizontalHandler = B(l._scrollHorizontalHandler, l), l._scrollVerticalHandler = B(l._scrollVerticalHandler, l), l._outerScrollVerticalHandler = B(l._outerScrollVerticalHandler, l), l._outerScrollHorizontalHandler = B(l._outerScrollHorizontalHandler, l), l._mouseWheelHandler = B(l._mouseWheelHandler, l), this.$config.hidden = true;
  ...
  function i(a, s) {
    if (s.push(a), a.$cells) for (var r = 0; r < a.$cells.length; r++) i(a.$cells[r], s);
  }
  return F(e, t), e.prototype.init = function(a) {
    ...
    for (var a = this._getLinkedViews(), s = this._isVertical() ? "gantt_layout_outer_scroll gantt_layout_outer_scroll_vertical" : "gantt_layout_outer_scroll gantt_layout_outer_scroll_horizontal", r = 0; r < a.length; r++) Ct(a[r].$view || a[r].getNode(), s);
    ...
    kt.isFF ? this.$domEvents.attach(this._getRootParent().$view, "wheel", this._mouseWheelHandler, { passive: false }) : this.$domEvents.attach(this._getRootParent().$view, "mousewheel", this._mouseWheelHandler, { passive: false });
    ...
    for (var a, s = 0, r = 0, o = this._isHorizontal(), l = this._getLinkedViews(), d = o ? "scrollWidth" : "scrollHeight", c = o ? "contentX" : "contentY", u = o ? "x" : "y", h = this._getScrollOffset(), _ = 0; _ < l.length; _++) if ((a = l[_]) && a.$content && a.$content.getSize && !a.$config.hidden) {
      var f, y = a.$content.getSize();
      if (f = y.hasOwnProperty(d) ? y[d] : y[c], h) y[c] > y[u] && y[c] > s && f > y[u] - h + 2 && (s = f + (o ? 0 : 2), r = y[u]);
      else {
        var v = Math.max(y[c] - f, 0);
        (f += v) > Math.max(y[u] - v, 0) && f > s && (s = f, r = y[u]);
      }
    }
    ...
    if (this._checkWheelTarget(s)) {
      ...
      var d = kt.isFF, c = d ? a.deltaX : a.wheelDeltaX, u = d ? a.deltaY : a.wheelDelta, h = -20;
      if (d) {
        const k = parseInt(navigator.userAgent.split("Firefox/")[1]);
        h = k <= 87 ? a.deltaMode !== 0 ? -40 : -10 : k <= 90 ? -3 : k <= 96 ? -1.5 : -1;
      }
      var _ = d ? c * h * o.x : 2 * c * o.x, f = d ? u * h * o.y : u * o.y, y = this.$gantt.config.horizontal_scroll_key;
      if (y !== false && n.indexOf(y) >= 0 && (!a[y] || a.deltaX || a.wheelDeltaX || (_ = 2 * f, f = 0)), _ && Math.abs(_) > Math.abs(f)) {
        if (this._isVertical()) return;
        if (r.x || !this.$scroll_hor || !this.$scroll_hor.offsetWidth) return true;
        var v = _ / -40, b = this._oldLeft, m = b + 30 * v;
        if (this.scrollHorizontally(m), this.$scroll_hor.scrollLeft = m, b == this.$scroll_hor.scrollLeft) return true;
        this._oldLeft = this.$scroll_hor.scrollLeft;
      } else {
        if (this._isHorizontal()) return;
        if (r.y || !this.$scroll_ver || !this.$scroll_ver.offsetHeight) return true;
        v = f / -40, f === void 0 && (v = a.detail);
        var g = this._oldTop, p = this.$scroll_ver.scrollTop + 30 * v;
        if (this.scrollVertically(p), this.$scroll_ver.scrollTop = p, g == this.$scroll_ver.scrollTop) return true;
...
function wn(t) {
  var n = {}, e = {}, i = null, a = -1, s = null, r = /* @__PURE__ */ function(o) {
    var l = -1, d = -1;
  ...
  return { _resetTopPositionHeight: function() {
    ...
    s ? this.shouldClearHeightCache(s, l) && (s = l, i = null) : s = l, a = -1, r.resetCache();
  }, getRowTop: function(o) {
    if (r.canUseSimpleCalculation()) return r.getRowTop(o);
    var l = this.$config.rowStore;
    if (!l) return 0;
    if (e[o] !== void 0) return e[o];
    for (var d = l.getIndexRange(), c = 0, u = 0, h = 0; h < d.length; h++) e[h] = c, c += this.getItemHeight(d[h].id), h < o && (u = c);
    return u;
...
var Gt = function(t, n, e, i) {
  this.$config = R({}, n || {}), this.$scaleHelper = new Xt(i), this.$gantt = i, this._posFromDateCache = {}, this._posFromWorkTimeCache = {}, this._timelineDragScroll = null, R(this, wn(this)), lt(this);
};
Gt.prototype = { init: function(t) {
  ...
  if (this.isVisible()) {
    var e = false;
    this.$config.scrollTop = this.$config.scrollTop || 0, this.$config.scrollLeft = this.$config.scrollLeft || 0, 1 * n === n && (this.$config.scrollTop = n, this.$task_data.scrollTop = this.$config.scrollTop, e = true), 1 * t === t && (this.$task.scrollLeft = t, this.$config.scrollLeft = this.$task.scrollLeft, this._refreshScales(), e = true), e && this.callEvent("onScroll", [this.$config.scrollLeft, this.$config.scrollTop]);
  }
  ...
  this.$gantt;
  var e = [{ expose: true, renderer: this.$gantt.$ui.layers.taskBar(), container: this.$task_bars, filter: [n, function(i, a) {
    return !a.hide_bar;
  }] }];
  return e.push({ renderer: this.$gantt.$ui.layers.taskBg(), container: this.$task_bg, filter: [n] }), { tasks: e, links: [{ expose: true, renderer: this.$gantt.$ui.layers.link(), container: this.$task_links, filter: [n] }] };
  ...
  if (this.$config.bind) {
    ...
    for (var a = this.$config.layers, s = 0; a && s < a.length; s++) {
      ...
      var r = i.addLayer(d);
      this._taskLayers.push(r), d.expose && (this._taskRenderer = i.getLayer(r));
    }
  ...
  if (this.$config.bindLinks) {
    ...
    for (s = 0; l && s < l.length; s++) {
      ...
      var c = o.addLayer(d);
      this._taskLayers.push(c), l[s].expose && (this._linkRenderer = o.getLayer(c));
    }
  }
}, _initStaticBackgroundRender: function() {
  var t = this, n = wa(), e = t.$config.rowStore;
    ...
    if (i === null && t.isVisible()) {
      ...
      if (r.static_background || r.timeline_placeholder) {
        ...
        if (l || ((l = document.createElement("div")).className = "gantt_task_bg", t.$task_bg_static = l, t.$task_bg.nextSibling ? t.$task_data.insertBefore(l, t.$task_bg.nextSibling) : t.$task_data.appendChild(l)), o) {
          ...
          r.timeline_placeholder && (d = r.timeline_placeholder.height || t.$task_data.offsetHeight || 99999), n.render(l, r, t.getScale(), d, t.getItemHeight(a ? a.id : null));
        }
  ...
  if (this.isVisible()) {
    ...
    var l = s.prepareConfigs(r, t.min_column_width, o, i - 1, a.min_date, a.max_date, t.rtl), d = this._tasks = l[l.length - 1];
    if (this._scales = l, this._posFromDateCache = {}, this._posFromWorkTimeCache = {}, this._tasks.projection && ((c = this._tasks.projection) == null ? void 0 : c.source) === "fixedHours") {
      const u = "timescale-projection-calendar";
      gantt.getCalendar(u) && gantt.deleteCalendar(u);
      let { hours: h } = this._tasks.projection;
      gantt.addCalendar({ id: u, worktime: { hours: h || gantt.getCalendar("global")._worktime.hours.slice(), days: [1, 1, 1, 1, 1, 1, 1] } });
    }
  ...
  for (var i = [], a = this.$gantt.templates.scale_row_class, s = 0; s < t.length; s++) {
    ...
    o && (r += " " + o), i.push('<div class="' + r + '" style="height:' + t[s].height + "px;position:relative;line-height:" + t[s].height + 'px">' + this._prepareScaleHtml(t[s], n, e, s) + "</div>");
  }
  return i.join("");
  ...
  var c = 0, u = t.count;
  !a.smart_scales || isNaN(n) || isNaN(e) || (c = Tt(t.left, n), u = Tt(t.left, e) + 1), l = t.css || function() {
  ...
  for (var h = c; h < u && t.trace_x[h]; h++) {
    ...
    if (f) {
      ...
      if (k !== false && f > w || k === true) {
        if (y < p.x && y + f / 2 - w / 2 < p.x) x = ` style='position:absolute;left: ${p.x - y + 10}px;' `;
        else if (y + f / 2 + w / 2 > p.x_end && f > w) {
          let $ = p.x_end - y - 10, T = "-100%";
          $ < w && ($ = w, T = `-${$}px`), x = ` style='position:absolute;left: ${$}px;transform: translate(${T},0);' `;
        }
      }
      m = "gantt_scale_cell" + (h == t.count - 1 ? " gantt_last_cell" : ""), (b = l.call(this, o)) && (m += " " + b);
      var g = `<div class='${m}' ${this.$gantt._waiAria.getTimelineCellAttr(_)} style='${v}'><span ${x}>${_}</span></div>`;
      r.push(g);
    }
  }
  return r.join("");
  ...
  return n === "taskCalendar" ? t ? { calendar: gantt.getTaskCalendar(t) } : { calendar: gantt.getCalendar("global") } : n === "fixedHours" ? { calendar: gantt.getCalendar("timescale-projection-calendar") } : null;
}, dateFromPos: function(t, n) {
  var e = this._tasks;
  if (t < 0 || t > e.full_width || !e.full_width) return null;
  var i = Tt(this._tasks.left, t), a = this._tasks.left[i], s = e.width[i] || e.col_width, r = 0;
  s && (r = (t - a) / s, e.rtl && (r = 1 - r));
  const o = (n ? n.calendar : null) || null;
  var l = 0;
  r && (l = this._getColumnDuration(e, e.trace_x[i]));
  const d = e.trace_x[i], c = new Date(e.trace_x[i].valueOf() + Math.round(r * l));
  if (!o) return c;
  const { start: u, end: h, duration: _, intervals: f } = this._getWorkTrimForCell(d, o);
  if (_ <= 0) return c;
  const y = Math.round(r * _), v = d.valueOf() + 1e3 * (u + y);
  return new Date(v);
  ...
  var a = Math.floor(i), s = i % 1, r = this._tasks.left[Math.min(a, this._tasks.width.length - 1)];
  ...
  for (let o = new Date(t), l = 0; o < i; o = this.$gantt.date.add(o, 1, "day"), l++) {
    const d = n._getWorkHours(o) || [], c = Math.round((o - t) / 1e3);
    for (let u = 0; u < d.length; u++) {
      const h = c + d[u].start, _ = c + d[u].end;
  ...
  this.$gantt.assert(i >= 0, "Invalid day index");
  const a = Math.floor(i), s = a, r = this._tasks.trace_x[a];
  ...
  const c = (t - this._tasks.trace_x[a]) / 1e3;
  let u = 0;
  u = c <= o ? 0 : c >= l ? 1 : (c - o) / d, this._tasks.rtl && (u = 1 - u);
  ...
  var s = Tt(e, n), r = this._getClosestVisibleColumn(s, e, i), o = e[r], l = this._tasks.trace_index_transition;
  if (!o) return l ? l[0] : 0;
  var d = (t - e[r]) / this._getColumnDuration(this._tasks, e[r]);
  return l ? l[r] + (1 - d) : r + d;
}, getItemPosition: function(t, n, e) {
  var i, a, s;
  let r = n || t.start_date || t.$auto_start_date, o = e || t.end_date || t.$auto_end_date;
  const l = this._getPositioningContext(t);
  return l && l.calendar ? this._tasks.rtl ? (a = this.posFromWorkTime(r, l), i = this.posFromWorkTime(o, l)) : (i = this.posFromWorkTime(r, l), a = this.posFromWorkTime(o, l)) : this._tasks.rtl ? (a = this.posFromDate(r), i = this.posFromDate(o)) : (i = this.posFromDate(r), a = this.posFromDate(o)), s = Math.max(a - i, 0), { left: i, top: this.getItemTop(t.id), height: this.getBarHeight(t.id), width: s, rowHeight: this.getItemHeight(t.id) };
}, getBarHeight: function(t, n) {
  var e = this.$getConfig(), i = this.$config.rowStore.getItem(t), a = i.task_height || i.bar_height || e.bar_height || e.task_height, s = this.getItemHeight(t);
  return a == "full" && (a = s - (e.bar_height_padding || 3)), a = Math.min(a, s), n && (a = Math.round(a / Math.sqrt(2))), Math.max(a, 0);
}, getScale: function() {
  return this._tasks;
}, _getScales: function() {
...
var Sa = class {
  constructor(n) {
    ...
    this.$gantt = e, this.$grid = i, this._dnd = a, this.getCurrentX = s, this._scrollView = this.$gantt.$ui.getView(this.$grid.$config.scrollX), this.attachEvents();
  }
  attachEvents() {
    this.isScrollable() && (this._dnd.attachEvent("onDragMove", (n, e) => {
      const i = this.$grid.$grid.getBoundingClientRect(), a = i.right, s = i.left, r = this.getCurrentX(e.clientX);
      return r >= a - 20 && (this.autoscrollRight(), this.autoscrollStart()), r <= s + 20 && (this.autoscrollLeft(), this.autoscrollStart()), r < a - 20 && r > s + 20 && this.autoscrollStop(), true;
...
var Ta = class {
  ...
  init() {
    ...
    this._dnd = new n(this.$grid.$grid_scale, { updates_per_second: 60 }), this._scrollableGrid = new Sa({ gantt: this.$gantt, grid: this.$grid, dnd: this._dnd, getCurrentX: this.calculateCurrentPosition }), this.attachEvents();
  }
  attachEvents() {
    this._dnd.attachEvent("onBeforeDragStart", (n, e) => {
      ...
      const i = this.$grid.$getConfig().columns, a = this._draggedCell.getAttribute(Ge);
      let s, r;
      return i.map(function(o, l) {
        o.name === a && (s = o, r = l);
      }), this.$grid.callEvent("onBeforeColumnDragStart", [{ draggedColumn: s, draggedIndex: r }]) !== false && !(!this._draggedCell || !s) && (this._gridConfig = this.$grid.$getConfig(), this._originAutoscroll = this.$gantt.config.autoscroll, this.$gantt.config.autoscroll = false, true);
    }), this._dnd.attachEvent("onAfterDragStart", (n, e) => {
      this._draggedCell && (this._dnd.config.column = this._draggedCell.getAttribute(Ge), this._dnd.config.marker.innerHTML = this._draggedCell.outerHTML, this._dnd.config.marker.classList.add("gantt_column_drag_marker"), this._dnd.config.marker.style.height = this._gridConfig.scale_height + "px", this._dnd.config.marker.style.lineHeight = this._gridConfig.scale_height + "px", this._draggedCell.classList.add("gantt_grid_head_cell_dragged"));
      ...
      return this.setMarkerPosition(i), this.drawTargetMarker(a), true;
    }), this._dnd.attachEvent("onDragEnd", () => {
      if (!this._draggedCell) return;
      const n = this.findColumnsIndexes(), e = n.targetIndex, i = n.draggedIndex, a = this.$grid.$getConfig().columns, s = a[i], r = a[e];
      if (this.$grid.callEvent("onColumnDragMove", [{ draggedColumn: s, targetColumn: r, draggedIndex: i, targetIndex: e }]) === false) return this.cleanTargetMarker(), void this.$gantt.render();
  ...
  reorderColumns() {
    const { targetIndex: n, draggedIndex: e } = this.findColumnsIndexes(), i = this.$grid.$getConfig().columns, a = i[e], s = i[n];
    this.$grid.callEvent("onBeforeColumnReorder", [{ draggedColumn: a, targetColumn: s, draggedIndex: e, targetIndex: n }]) !== false && n !== e && (i.splice(e, 1), i.splice(n, 0, a), this.$gantt.render(), this.$grid.callEvent("onAfterColumnReorder", [{ draggedColumn: a, targetColumn: s, draggedIndex: e, targetIndex: n }]));
  }
  findColumnsIndexes() {
    ...
    this.$gantt.config.rtl && (d = e.length - 1, c = 0, u = (f, y) => f >= y, h = (f) => --f);
    const _ = this._dragX - this.$grid.$grid.getBoundingClientRect().left + this._scrollableGrid.getCorrection();
    for (let f = d; u(f, c) && (i === void 0 || a === void 0); f = h(f)) e[f].hide || (o.startX = o.endX, o.endX += e[f].width, _ >= o.startX && (_ <= o.endX || !u(h(f), c)) && (i = f, s = o.startX, r = o.endX, l = (_ - o.startX) / (o.endX - o.startX)), n === e[f].name && (a = f));
    return { targetIndex: i, draggedIndex: a, xBefore: s, xAfter: r, columnRelativePos: l };
  }
...
function Ae(t) {
  var n = [];
  return { delegate: function(e, i, a, s) {
    n.push([e, i, a, s]), t.$services.getService("mouseEvents").delegate(e, i, a, s);
  }, destructor: function() {
...
var te = function(t, n, e, i) {
  this.$config = R({}, n || {}), this.$gantt = i, this.$parent = t, lt(this), this.$state = {}, R(this, wn(this));
};
function he(t) {
...
te.prototype = { init: function(t) {
  var n = this.$gantt, e = n._waiAria.gridAttrString(), i = n._waiAria.gridDataAttrString(), a = this.$getConfig(), s = a.reorder_grid_columns || false;
  ...
  this._renderHeaderResizers = l.doOnRender, this._mouseDelegates = Ae(n);
  var d = function(c, u) {
    var h = { row_before_start: c.bind(function(_, f, y) {
      var v = u.$getConfig(), b = u.$config.rowStore;
      if (!it(y, v.task_grid_row_resizer_attribute)) return false;
      var m = this.locate(y, v.task_grid_row_resizer_attribute), g = b.getItem(m);
      return u.callEvent("onBeforeRowResize", [g]) !== false && void 0;
    }, c), row_after_start: c.bind(function(_, f, y) {
    ...
    }, c), row_drag_move: c.bind(function(_, f, y) {
      var v = u.$config.rowStore, b = u.$getConfig(), m = _.config, g = m.drag_id, p = u.getItemHeight(g), k = u.getItemTop(g) - f.scrollTop, x = Y(u.$grid_data), w = parseInt(m.marker.style.top, 10), $ = k + x.y, T = 0, S = b.min_task_grid_row_height;
      return (T = w - $) < S && (T = S), m.marker.style.left = x.x + "px", m.marker.style.top = $ - 1 + "px", m.marker.style.height = Math.abs(T) + 1 + "px", m.marker_height = T, u.callEvent("onRowResize", [g, v.getItem(g), T + p]), true;
    }, c), row_drag_end: c.bind(function(_, f, y) {
      var v = u.$config.rowStore, b = _.config, m = b.drag_id, g = v.getItem(m), p = u.getItemHeight(m), k = b.marker_height;
      u.callEvent("onBeforeRowResizeEnd", [m, g, k]) !== false && g.row_height != k && (g.row_height = k, v.updateItem(m), u.callEvent("onAfterRowResize", [m, g, p, k]), this.render());
    }, c) };
    return { init: function() {
      var _ = c.$services.getService("dnd"), f = u.$getConfig(), y = new _(u.$grid_data, { updates_per_second: 60 });
  ...
  d.init(), this._addLayers(this.$gantt), this._initEvents(), s && (this._columnDND = new Ta(n, this), this._columnDND.init()), this.callEvent("onReady", []);
}, _validateColumnWidth: function(t, n) {
  var e = t[n];
  if (e && e != "*") {
    var i = this.$gantt, a = 1 * e;
    isNaN(a) ? i.assert(false, "Wrong " + n + " value of column " + t.name) : t[n] = a;
  }
}, setSize: function(t, n) {
  this.$config.width = this.$state.width = t, this.$config.height = this.$state.height = n;
  for (var e, i = this.getGridColumns(), a = 0, s = (d = this.$getConfig()).grid_elastic_columns, r = 0, o = i.length; r < o; r++) this._validateColumnWidth(i[r], "min_width"), this._validateColumnWidth(i[r], "max_width"), this._validateColumnWidth(i[r], "width"), a += 1 * i[r].width;
  if (!isNaN(a) && this.$config.scrollable || (a = e = this._setColumnsWidth(t + 1)), this.$config.scrollable && s && !isNaN(a)) {
    let u = "width";
    s == "min_width" && (u = "min_width");
    let h = 0;
  ...
  if (this.isVisible()) {
    var e = false;
    this.$config.scrollTop = this.$config.scrollTop || 0, this.$config.scrollLeft = this.$config.scrollLeft || 0, 1 * t == t && (this.$config.scrollLeft = this.$state.scrollLeft = this.$grid.scrollLeft = t, e = true), 1 * n == n && (this.$config.scrollTop = this.$state.scrollTop = this.$grid_data.scrollTop = n, e = true), e && this.callEvent("onScroll", [this.$config.scrollLeft, this.$config.scrollTop]);
  }
  ...
  if (e && t === null && this.isVisible() && n.smart_rendering) {
    ...
    if (i || (i = e ? this.getTotalHeight() : 0), i) {
      ...
      s.style.visibility = "hidden", s.style.height = i + "px", s.style.width = "1px", this.$grid_data.appendChild(s);
    }
  }
}, _initSmartRenderingPlaceholder: function() {
  var t = this.$config.rowStore;
  t && (this._initSmartRenderingPlaceholder = function() {
  }, this._staticBgHandler = t.attachEvent("onStoreUpdated", B(this._refreshPlaceholderOnStoreUpdate, this)));
}, _initEvents: function() {
  var t = this.$gantt;
  this._mouseDelegates.delegate("click", "gantt_close", t.bind(function(n, e, i) {
    var a = this.$config.rowStore;
    if (!a) return true;
    var s = it(n, this.$config.item_attribute);
    return s && a.close(s.getAttribute(this.$config.item_attribute)), false;
  }, this), this.$grid), this._mouseDelegates.delegate("click", "gantt_open", t.bind(function(n, e, i) {
    var a = this.$config.rowStore;
    if (!a) return true;
    var s = it(n, this.$config.item_attribute);
    return s && a.open(s.getAttribute(this.$config.item_attribute)), false;
  }, this), this.$grid);
}, _clearLayers: function(t) {
  ...
  var e = this.$getConfig(), i = this.getGridColumns(), a = 0, s = t;
  n = window.isNaN(n) ? -1 : n;
  for (var r = 0, o = i.length; r < o; r++) a += 1 * i[r].width;
  if (window.isNaN(a))
    for (this._calculateGridWidth(), a = 0, r = 0, o = i.length; r < o; r++) a += 1 * i[r].width;
  var l = s - a, d = 0;
  for (r = 0; r < n + 1; r++) d += i[r].width;
  for (a -= d, r = n + 1; r < i.length; r++) {
    var c = i[r], u = Math.round(l * (c.width / a));
    l < 0 ? c.min_width && c.width + u < c.min_width ? u = c.min_width - c.width : !c.min_width && e.min_grid_column_width && c.width + u < e.min_grid_column_width && (u = e.min_grid_column_width - c.width) : c.max_width && c.width + u > c.max_width && (u = c.max_width - c.width), a -= c.width, c.width += u, l -= u;
  }
  for (var h = l > 0 ? 1 : -1; l > 0 && h === 1 || l < 0 && h === -1; ) {
    var _ = l;
    for (r = n + 1; r < i.length; r++) {
      var f;
      if ((f = i[r].width + h) == this._getColumnWidth(i[r], e, f) && (l -= h, i[r].width = f), !l) break;
    }
    if (_ == l) break;
  }
  ...
  for (var t = this.$getConfig(), n = this.getGridColumns(), e = 0, i = [], a = [], s = 0; s < n.length; s++) {
    ...
    window.isNaN(r) && (r = t.min_grid_column_width || 10, i.push(s)), a[s] = r, e += r;
  }
  ...
  if (t.autofit || i.length) {
    ...
    if (t.autofit && !t.grid_elastic_columns) for (s = 0; s < a.length; s++) {
      ...
      a[s] += d, (c = this._getColumnWidth(n[s], t, a[s])) != a[s] && (d = c - a[s], a[s] = c), l -= d;
    }
    else if (i.length) for (s = 0; s < i.length; s++) {
      d = Math.round(l / (i.length - s));
      var c, u = i[s];
      a[u] += d, (c = this._getColumnWidth(n[u], t, a[u])) != a[u] && (d = c - a[u], a[u] = c), l -= d;
    }
    for (s = 0; s < a.length; s++) n[s].width = a[s];
  } else {
    var h = o != e;
  ...
  n.rtl && (a = a.reverse());
  var s = [], r = 0, o = e.labels, l = n.scale_height - 1;
  const d = {};
  for (var c = 0; c < a.length; c++) {
    var u = c == a.length - 1, h = a[c];
    h.name || (h.name = t.uid() + "");
    var _ = 1 * h.width, f = this._getGridWidth();
    u && f > r + _ && (h.width = _ = f - r), r += _;
    var y = t._sort && h.name == t._sort.name ? `<div data-column-id="${h.name}" class="gantt_sort gantt_${t._sort.direction}"></div>` : "", v = ["gantt_grid_head_cell", "gantt_grid_head_" + h.name, u ? "gantt_last_cell" : "", i.grid_header_class(h.name, h)].join(" "), b = "width:" + (_ - (u ? 1 : 0)) + "px;", m = h.label || o["column_" + h.name] || o[h.name];
    typeof m == "function" && (m = m.call(t, h.name, h)), m = m || "";
    let p = false;
    t.config.external_render && t.config.external_render.isElement(m) && (p = true, d[h.name] = m);
    var g = "<div class='" + v + "' style='" + b + "' " + t._waiAria.gridScaleCellAttrString(h, m) + " data-column-id='" + h.name + "' column_id='" + h.name + "' data-column-name='" + h.name + "' data-column-index='" + c + "'>" + (p ? "<div data-component-container></div>" : m) + y + "</div>";
    s.push(g);
  }
  this.$grid_scale.style.height = n.scale_height + "px", this.$grid_scale.style.lineHeight = l + "px", this.$grid_scale.innerHTML = s.join("");
...
var Ca = function(t) {
  ...
  return F(n, t), R(n.prototype, { init: function(e) {
    const i = this.$gantt, a = i._waiAria.gridAttrString(), s = i._waiAria.gridDataAttrString(), r = this.$getConfig();
    ...
    let s = 0;
    for (let r = 0; r < a.length; r++) if (i && a[r].hide && s++, a[r].name == e) return r - s;
    return null;
  }, getGridColumns: function() {
    ...
    return [{ renderer: e.$ui.layers.gridLine(), container: this.$grid_data, filter: [function() {
      return i.isVisible();
    }] }, { renderer: e.$ui.layers.gridTaskRowResizer(), container: this.$grid_data, append: true, filter: [function() {
      return e.config.resize_rows;
    }] }];
  }, _renderGridHeader: function() {
    const e = this.$gantt, i = this._getResourceConfig(), a = this.$gantt.locale, s = this.$getTemplates();
    let r = this._getResourceColumns();
    i.rtl && (r = r.reverse()), i.scale_height || (i.scale_height = e.resource_table.scale_height);
    let o = [], l = 0, d = a.labels, c = i.scale_height - 1;
    for (let u = 0; u < r.length; u++) {
      let h = u == r.length - 1, _ = r[u];
      _.name || (_.name = e.uid() + "");
      let f = 1 * _.width, y = this._getGridWidth();
      h && y > l + f && (_.width = f = y - l), l += f;
      let v = e._sort && _.name == e._sort.name ? `<div data-column-id="${_.name}" class="gantt_sort gantt_${e._sort.direction}"></div>` : "", b = ["gantt_grid_head_cell", "gantt_grid_head_" + _.name, h ? "gantt_last_cell" : "", s.grid_header_class ? s.grid_header_class(_.name, _) : ""].join(" "), m = "width:" + (f - (h ? 1 : 0)) + "px;", g = _.label || d["column_" + _.name] || d[_.name];
      g = g || "";
      const p = "<div class='" + b + "' style='" + m + "' " + e._waiAria.gridScaleCellAttrString(_, g) + " data-column-id='" + _.name + "' column_id='" + _.name + "' data-column-name='" + _.name + "' data-column-index='" + u + "'>" + g + v + "</div>";
      o.push(p);
    }
    this.$grid_scale.style.height = i.scale_height + "px", this.$grid_scale.style.lineHeight = c + "px", this.$grid_scale.style.width = "inherit", this.$grid_scale.innerHTML = o.join("");
  }, isVisible: function() {
  ...
  } }, true), R(n.prototype, function(e) {
    var i = e.prototype.init, a = e.prototype.destructor;
    return { init: function() {
      i.apply(this, arguments), this._linkToTaskStore();
    }, destructor: function() {
      he(this), a.apply(this, arguments);
    }, previousDragId: null, relevantResources: null, _linkToTaskStore: function() {
      if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
        var s = this.$gantt.$data.tasksStore, r = this.$config.rowStore;
        he(this);
        var o = this, l = xe(function() {
          if (o.$gantt.getState().lightbox) l();
          else {
            const c = o.$config.rowStore, u = o._getRelevantResources();
            if (u && c.$config.name === o.$gantt.config.resource_store) {
              if (u == "nothing_to_repaint") return;
              c._quick_refresh = true, o.relevantResources.forEach(function(h) {
                c.refresh(h);
              }), c._quick_refresh = false;
            } else c.refresh();
          }
        }, 300);
        this._delayRender = l;
        var d = "_attached_" + r.$config.name;
        o[d] || (o[d] = s.attachEvent("onStoreUpdated", function() {
          if (!l.$pending && !this._skipResourceRepaint) {
            const c = o.$gantt.getState();
            if (c.drag_mode == "progress") return true;
            c.drag_mode && c.drag_id && (o.previousDragId = c.drag_id), l();
          }
          return true;
        })), this.$gantt.attachEvent("onDestroy", function() {
          return he(o), true;
        }), r.$attachedResourceViewHandler || (r.$attachedResourceViewHandler = r.attachEvent("onBeforeFilter", function() {
          return !o.$gantt.getState().lightbox && (l.$pending && l.$cancelTimeout(), o._updateNestedTasks(), true);
        }), r.$attachedTaskStoreHandler = s.attachEvent("onAfterDelete", function() {
          r._mark_recompute = true;
        }));
      }
    }, _getRelevantResources: function() {
      if (!this.$gantt.getTaskAssignments) return null;
      const s = this.$gantt.getState(), r = this.$config.rowStore;
      let o = [];
      if (s.drag_mode && s.drag_id && r.$config.name === this.$gantt.config.resource_store) if (this.previousDragId == s.drag_id) {
        if (this.relevantResources) return this.relevantResources;
        o = this._getIdsFromAssignments(this.previousDragId);
      } else this.previousDragId = s.drag_id, o = this._getIdsFromAssignments(this.previousDragId);
      else {
        if (!this.previousDragId) return null;
        o = this._getIdsFromAssignments(this.previousDragId), this.previousDragId = null;
      }
      return o.length ? (o.forEach(function(l) {
        r.eachParent && r.eachParent(function(d) {
          o.push(d.id);
        }, l);
      }), this.relevantResources = [...new Set(o)]) : this.relevantResources = "nothing_to_repaint";
    }, _getIdsFromAssignments: function(s) {
      const r = this.$gantt, o = [], l = r.getTask(s);
      return r.getTaskAssignments(s).forEach(function(d) {
        o.push(d.resource_id);
      }), r.isSummaryTask(l) && r.config.drag_project && r.eachTask(function(d) {
        r.getTaskAssignments(d.id).forEach(function(c) {
          o.push(c.resource_id);
        });
      }, s), r.config.drag_multiple && r.getSelectedTasks && r.getSelectedTasks().forEach(function(d) {
        r.getTaskAssignments(d).forEach(function(c) {
          o.push(c.resource_id);
        });
      }), o;
    }, _updateNestedTasks: function() {
      var s = this.$gantt, r = s.getDatastore(s.config.resource_store);
      r.$config.fetchTasks && r.silent(function() {
        var o = [], l = {}, d = {};
        for (var c in r.eachItem(function(u) {
          if (u.$role != "task") {
            var h = s.getResourceAssignments(u.id), _ = {};
            h.sort(function(f, y) {
              const v = r.pull, b = v[`${f.task_id}_${f.resource_id}`], m = v[`${y.task_id}_${y.resource_id}`];
              return b && m ? b.$local_index - m.$local_index : 0;
            }), h.forEach(function(f) {
              if (!_[f.task_id] && s.isTaskExists(f.task_id)) {
                _[f.task_id] = true;
                var y, v = s.getTask(f.task_id);
                (y = r.$config.copyOnParse ? s.copy(v) : Object.create(v)).id = v.id + "_" + u.id, y.$task_id = v.id, y.$resource_id = u.id, y[r.$parentProperty] = u.id, y.$role = "task", o.push(y), l[y.id] = true;
              }
            });
          } else d[u.id] = true;
        }), d) l[c] || r.removeItem(c);
        o.length && r.parse(o);
      });
    } };
  }(n), true), n;
}(te);
var Ea = { init: function(t, n) {
  var e = n.$gantt;
  e.attachEvent("onTaskClick", function(i, a) {
    if (e._is_icon_open_click(a)) return true;
    var s = t.getState(), r = t.locateCell(a.target);
    return !r || !t.getEditorConfig(r.columnName) || (t.isVisible() && s.id == r.id && s.columnName == r.columnName || t.startEdit(r.id, r.columnName), false);
  }), n.$config.id === "GridRL" && (e.event(e.getLightbox(), "click", function(i) {
    const a = e.utils.dom, s = t.getState(), r = t.locateCell(i.target);
    if (r && t.getEditorConfig(r.columnName)) {
      if (r.columnName == "duration" || r.columnName == "end") {
        ...
        if (o && !o.start_date) return e.message({ type: "warning", text: "Specify assignment start date" }), t.hide(), false;
      }
      return t.isVisible() && s.id == r.id && s.columnName == r.columnName || t.startEdit(r.id, r.columnName), t.isChanged() && t.save(), false;
    }
        ...
        e.confirm({ text: "Resource assignment will be deleted permanently, are you sure?", cancel: "No", ok: "Delete", callback: function(l) {
          if (l) {
            ...
            if (d.removeItem(o), d.getItems().length == 0) {
              const c = e.getLightboxSection(n.$config.sectionName), u = e.form_blocks.resource_selector, h = e._lightbox_root.querySelector("#" + c.section.id).nextSibling;
              u.set_value.call(e, h, [], {}, c.section, true);
            }
            e.refreshData();
          }
        } });
  ...
  if (i.ext && i.ext.keyboardNavigation && i.ext.keyboardNavigation.attachEvent("onKeyDown", function(a, s) {
    var r = i.constants.KEY_CODES, o = false;
    return s.keyCode === r.SPACE && t.isVisible() && (o = true), !o;
...
var Da = { init: function(t, n) {
  var e = t, i = n.$gantt, a = null, s = i.ext.keyboardNavigation;
  s.attachEvent("onBeforeFocus", function(r) {
    var o = t.locateCell(r);
    if (clearTimeout(a), o) {
      var l = o.columnName, d = o.id, c = e.getState();
      if (e.isVisible() && c.id == d && c.columnName === l) return false;
    }
    return true;
  }), s.attachEvent("onFocus", function(r) {
    var o = t.locateCell(r), l = t.getState();
    return clearTimeout(a), !o || o.id == l.id && o.columnName == l.columnName || e.isVisible() && e.save(), true;
    ...
    var l = t.locateCell(o.target), d = !!l && t.getEditorConfig(l.columnName), c = t.getState(), u = i.constants.KEY_CODES, h = o.keyCode, _ = false;
    switch (h) {
      case u.ENTER:
        t.isVisible() ? (t.save(), o.preventDefault(), _ = true) : d && !(o.ctrlKey || o.metaKey || o.shiftKey) && (e.startEdit(l.id, l.columnName), o.preventDefault(), _ = true);
        break;
      case u.ESC:
        t.isVisible() && (t.hide(), o.preventDefault(), _ = true);
        break;
      case u.UP:
      case u.DOWN:
        break;
      case u.LEFT:
      case u.RIGHT:
        (d && t.isVisible() || c.editorType === "date") && (_ = true);
        break;
      case u.SPACE:
        t.isVisible() && (_ = true), d && !t.isVisible() && (e.startEdit(l.id, l.columnName), o.preventDefault(), _ = true);
        break;
      case u.DELETE:
        d && !t.isVisible() ? (e.startEdit(l.id, l.columnName), _ = true) : d && t.isVisible() && (_ = true);
        break;
      case u.TAB:
        if (t.isVisible()) {
          o.shiftKey ? t.editPrevCell(true) : t.editNextCell(true);
          var f = t.getState();
          f.id && s.focus({ type: "taskCell", id: f.id, column: f.columnName }), o.preventDefault(), _ = true;
        }
        break;
      default:
        if (t.isVisible()) _ = true;
        else if (h >= 48 && h <= 57 || h > 95 && h < 112 || h >= 64 && h <= 91 || h > 185 && h < 193 || h > 218 && h < 223) {
          var y = r.modifiers, v = y.alt || y.ctrl || y.meta || y.shift;
          y.alt || v && s.getCommandHandler(r, "taskCell") || d && !t.isVisible() && (e.startEdit(l.id, l.columnName), _ = true);
        }
    }
    return !_;
  });
...
function Et(t) {
  ...
  return n.prototype = { show: function(e, i, a, s) {
  }, hide: function() {
...
function Aa(t) {
  ...
  return F(e, n), R(e.prototype, { show: function(i, a, s, r) {
...
function Ia(t) {
  ...
  return F(e, n), R(e.prototype, { show: function(i, a, s, r) {
    ...
    r.innerHTML = d, r.oninput = function(c) {
...
function Ma(t) {
  ...
  return F(e, n), R(e.prototype, { show: function(i, a, s, r) {
    for (var o = `<div role='cell'><select name='${a.name}' title='${a.name}'>`, l = [], d = s.options || [], c = 0; c < d.length; c++) l.push("<option value='" + s.options[c].key + "'>" + d[c].label + "</option>");
...
function Na(t) {
  var n = Et(), e = "%Y-%m-%d", i = null, a = null;
  function s() {
    return n.apply(this, arguments) || this;
  }
  return F(s, n), R(s.prototype, { show: function(r, o, l, d) {
    i || (i = t.date.date_to_str(e)), a || (a = t.date.str_to_date(e));
    var c = null, u = null;
    c = typeof l.min == "function" ? l.min(r, o) : l.min, u = typeof l.max == "function" ? l.max(r, o) : l.max;
    ...
    d.innerHTML = h, d.oninput = function(_) {
      _.target.value && (c || u) && (+t.date.str_to_date("%Y-%m-%d")(_.target.value) < +c && (_.target.value = t.date.date_to_str("%Y-%m-%d")(c)), +t.date.str_to_date("%Y-%m-%d")(_.target.value) > +u && (_.target.value = t.date.date_to_str("%Y-%m-%d")(u)));
    };
...
function La(t) {
  ...
  function o(l, d, c) {
    var u = function(v, b, m) {
      var g = [];
      return [...new Set(b)].forEach(function(p) {
        var k = i(m).parse(p);
        k && (k.target = v, k.id = "predecessor_generated", t.isLinkAllowed(k) && (k.id = void 0, g.push(k)));
      }), g;
    }(l.id, d, c), h = {};
  ...
  return F(e, n), R(e.prototype, { show: function(l, d, c, u) {
    ...
    var h = this.get_value(d, c, u), _ = a(s(l, c.editor, t), c.editor);
...
function Ra(t) {
  ...
  return F(e, n), R(e.prototype, { show: function(a, s, r, o) {
...
function Ha(t) {
  t.config.editor_types = { text: new (Aa())(), number: new (Ia())(), select: new (Ma())(), date: new (Na(t))(), predecessor: new (La(t))(), duration: new (Ra(t))() };
}
function Oa(t) {
  var n = /* @__PURE__ */ function(a) {
    ...
    return { setMapping: function(r) {
      ...
      return s || (a.config.keyboard_navigation_cells && a.ext.keyboardNavigation ? Da : Ea);
    } };
  }(t), e = {};
  lt(e);
  var i = { init: Ha, createEditors: function(a) {
    function s(u, h) {
      var _ = a.$getConfig(), f = function(b, m) {
        for (var g = a.$getConfig(), p = a.getItemTop(b), k = a.getItemHeight(b), x = a.getGridColumns(), w = 0, $ = 0, T = 0, S = 0; S < x.length; S++) {
          if (x[S].name == m) {
            T = x[S].width;
            break;
          }
          g.rtl ? $ += x[S].width : w += x[S].width;
        }
        return g.rtl ? { top: p, right: $, height: k, width: T } : { top: p, left: w, height: k, width: T };
      ...
      return y.setAttribute("data-column-index", v), t._waiAria.inlineEditorAttr(y), _.rtl ? y.style.cssText = ["top:" + f.top + "px", "right:" + f.right + "px", "width:" + f.width + "px", "height:" + f.height + "px"].join(";") : y.style.cssText = ["top:" + f.top + "px", "left:" + f.left + "px", "width:" + f.width + "px", "height:" + f.height + "px"].join(";"), y;
    }
    var r = Pa(t), o = [], l = [], d = null, c = { _itemId: null, _columnName: null, _editor: null, _editorType: null, _placeholder: null, locateCell: function(u) {
      if (!K(u, a.$grid)) return null;
      var h = it(u, a.$config.item_attribute), _ = it(u, "data-column-name");
      if (h && _) {
      ...
      var u = n.getMapping();
      u.init && u.init(this, a), !(d = a.$gantt.getDatastore(a.$config.bind)) && t.$data.tempAssignmentsStore && (d = t.$data.tempAssignmentsStore);
      var h = this;
      o.push(d.attachEvent("onIdChange", function(_, f) {
        ...
        h._editor && h._placeholder && !K(h._placeholder, t.$root) && a.$grid_data.appendChild(h._placeholder);
      })), this.init = function() {
      };
    }, getState: function() {
      ...
      if (t.isReadonly(d.getItem(u))) return void this.callEvent("onEditPrevent", [_]);
      if (this.callEvent("onBeforeEditStart", [_]) === false) return void this.callEvent("onEditPrevent", [_]);
      ...
      return t._lightbox_id ? !(!this._editor || !K(this._placeholder, t._lightbox)) : !(!this._editor || !K(this._placeholder, t.$root));
    }, show: function(u, h) {
      this.isVisible() && this.save();
      var _ = { id: u, columnName: h }, f = a.getColumn(_.columnName), y = this.getEditorConfig(f.name);
      if (!y) return;
      var v = a.$getConfig().editor_types[y.type], b = s(_.id, _.columnName);
      a.$grid_data.appendChild(b);
      const m = (function() {
        this._editor = v, this._placeholder = b, this._itemId = _.id, this._columnName = _.columnName, this._editorType = y.type;
        var p = n.getMapping();
        p.onShow && p.onShow(this, b, a), b._onReMount = (function() {
          this.setValue();
        }).bind(this);
      }).bind(this), g = v.show(_.id, f, y, b);
      if (g && g.then) return g.then(() => {
        m();
      });
      m();
    }, setValue: function() {
      var u, h = this.getState(), _ = h.id, f = h.columnName, y = a.getColumn(f), v = d.getItem(_), b = this.getEditorConfig(f);
      if (b) {
        if (t._lightbox_id) {
          let m = d.getItem(this._itemId);
          b.map_to === "text" ? u = t.getDatastore(t.config.resource_store).getItem(m.resource_id).text : u = b.map_to === "start_date" ? v.start_date === "" || v.start_date === null ? t.getTask(t._lightbox_id).start_date : v.start_date : v[b.map_to];
        } else u = v[b.map_to];
        b.map_to === "auto" && (u = d.getItem(_)), this._editor.set_value(u, _, y, this._placeholder), this.focus();
      }
    }, focus: function() {
      ...
      if (u) {
        ...
        if (t._lightbox_id) {
          ...
          u.type === "select" && u.map_to !== "mode" ? h = t.getDatastore(t.config.resource_store).getItem(_.resource_id).id : h = _[u.map_to];
        } else
          h = t.getTask(this._itemId)[u.map_to];
      ...
      if (this._itemId) {
        var u = this._itemId, h = this._columnName, _ = n.getMapping();
      ...
      if (this.isVisible() && d.exists(this._itemId) && this.isChanged()) {
        ...
        if (d.exists(u)) {
          var _ = d.getItem(u), f = this.getEditorConfig(h), y = { id: u, columnName: h, newValue: this.getValue(), oldValue: this._getItemValue() };
          if (this.callEvent("onBeforeSave", [y]) !== false && (!this._editor.is_valid || this._editor.is_valid(y.newValue, y.id, a.getColumn(h), this._placeholder))) {
            ...
            v != "auto" ? (_[v] = b, r(_, v, t.config.inline_editors_date_processing), d.updateItem(u)) : this._editor.save(u, a.getColumn(h), this._placeholder), this.callEvent("onSave", [y]);
          }
          t._lightbox_id || this.hide();
        }
      } else this.hide();
    }, _findEditableCell: function(u, h) {
      var _ = u, f = a.getGridColumns()[_], y = f ? f.name : null;
      if (y) {
...
function Ee(t, n, e, i, a) {
  ...
  if (s > n.y_end || s + r < n.y) return false;
  var o = e.posFromDate(t.start_date, e._getPositioningContext ? e._getPositioningContext(t) : null), l = e.posFromDate(t.end_date, e._getPositioningContext ? e._getPositioningContext(t) : null), d = Math.min(o, l) - 200, c = Math.max(o, l) + 200;
  return !(d > n.x_end || c < n.x);
}
function Sn(t) {
  function n(s, r, o) {
    if (t._isAllowedUnscheduledTask(s) || !t._isTaskInTimelineLimits(s)) return;
    var l = r.getItemPosition(s), d = o, c = r.$getTemplates(), u = t.getTaskType(s.type), h = r.getBarHeight(s.id, u == d.types.milestone), _ = 0;
    u == d.types.milestone && (_ = (h - l.height) / 2);
    var f = Math.floor((r.getItemHeight(s.id) - h) / 2);
    const y = t.config.baselines && s.baselines && s.baselines.length, v = t.config.baselines && (t.config.baselines.render_mode == "separateRow" || t.config.baselines.render_mode == "individualRow");
    if (y && v && s.bar_height !== "full" && s.bar_height < s.row_height) if (u === d.types.milestone) {
      let S = r.getBarHeight(s.id, true), C = Math.sqrt(2 * S * S);
    ...
    r.$config.item_attribute && (b.setAttribute(r.$config.item_attribute, s.id), b.setAttribute(r.$config.bind + "_id", s.id)), d.show_progress && u != d.types.milestone && function(S, C, E, D, A) {
      var M = 1 * S.progress || 0;
      E = Math.max(E, 0);
      var I = document.createElement("div"), N = Math.round(E * M);
      N = Math.min(E, N), I.style.width = N + "px", I.className = "gantt_task_progress", I.innerHTML = A.progress_text(S.start_date, S.end_date, S), D.rtl && (I.style.position = "absolute", I.style.right = "0px");
      var L = document.createElement("div");
      L.className = "gantt_task_progress_wrapper", L.appendChild(I), C.appendChild(L);
      const O = !t.isReadonly(S), z = t.ext.dragTimeline && t.ext.dragTimeline._isDragInProgress();
      if (t.config.drag_progress && (O || z)) {
        var H = document.createElement("div"), j = N;
        D.rtl && (j = E - N), H.style.left = j + "px", H.className = "gantt_task_progress_drag", H.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
<path d="M5.58397 1.52543C5.78189 1.22856 6.21811 1.22856 6.41602 1.52543L10.5475 7.72265C10.769 8.05493 10.5308 8.5 10.1315 8.5L1.86852 8.5C1.46917 8.5 1.23097 8.05493 1.45249 7.72265L5.58397 1.52543Z" fill="var(--dhx-gantt-progress-handle-background)" stroke="var(--dhx-gantt-progress-handle-border)"/>
</svg>`, I.appendChild(H), C.appendChild(H);
      }
    }(s, b, m, d, c);
    ...
    var p = function(S, C, E, D) {
      var A = D.$getConfig(), M = [S];
      C && M.push(C);
      var I = t.getState(), N = t.getTask(E);
      if (t.getTaskType(N.type) == A.types.milestone ? M.push("gantt_milestone") : t.getTaskType(N.type) == A.types.project && M.push("gantt_project"), M.push("gantt_bar_" + t.getTaskType(N.type)), t.isSummaryTask(N) && M.push("gantt_dependent_task"), t.isSplitTask(N) && (N.$inlineSplit && N.$inlineSplit.length || A.open_split_tasks && !N.$open && N.$inlineSplit && N.$inlineSplit.length || !A.open_split_tasks) && M.push("gantt_split_parent"), A.select_task && t.isSelectedTask(E) && M.push("gantt_selected"), E == I.drag_id && (M.push("gantt_drag_" + I.drag_mode), I.touch_drag && M.push("gantt_touch_" + I.drag_mode)), I.link_source_id == E && (M.push("gantt_link_source"), I.link_from_start ? M.push("gantt_link_from_start") : M.push("gantt_link_from_end")), I.link_target_id == E && M.push("gantt_link_target"), A.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(N) && M.push("gantt_critical_task"), I.link_landing_area && I.link_target_id && I.link_source_id && I.link_target_id != I.link_source_id && (I.link_target_id == E || I.link_source_id == E)) {
        var L = I.link_source_id, O = I.link_from_start, z = I.link_to_start, H = "";
        H = t.isLinkAllowed(L, E, O, z) ? z ? "link_start_allow" : "link_finish_allow" : z ? "link_start_deny" : "link_finish_deny", M.push(H);
      }
      return M.join(" ");
    }("gantt_task_line", c.task_class(s.start_date, s.end_date, s), s.id, r);
    (s.color || s.progressColor || s.textColor) && (p += " gantt_task_inline_color"), l.width < 20 && (p += " gantt_thin_task"), b.className = p;
    var k = ["left:" + l.left + "px", "top:" + (f + l.top) + "px", "height:" + h + "px", "line-height:" + Math.max(h < 30 ? h - 2 : h, 0) + "px", "width:" + m + "px"];
    ...
    var x = function(S, C, E, D) {
      var A = "gantt_left " + i(!C.rtl, S), M = null;
      return D && (M = { type: "marginRight", value: D }), e(S, E.leftside_text, A, M);
    }(s, d, c, _);
    x && b.appendChild(x), x = function(S, C, E, D) {
      var A = "gantt_right " + i(!!C.rtl, S), M = null;
      return D && (M = { type: "marginLeft", value: D }), e(S, E.rightside_text, A, M);
    }(s, d, c, _), x && b.appendChild(x), t._waiAria.setTaskBarAttr(s, b);
    var w = t.getState();
    const $ = !t.isReadonly(s), T = t.ext.dragTimeline && t.ext.dragTimeline._isDragInProgress();
    return ($ || T) && (d.drag_resize && !t.isSummaryTask(s) && u != d.types.milestone && a(b, "gantt_task_drag", s, function(S) {
      ...
      var D = false;
      return w.link_source_id && d.touch && (D = true), E.style.display = D ? "block" : "", C.appendChild(E), C;
    }, d, _)), b;
  }
  function e(s, r, o, l) {
    if (!r) return null;
  ...
  function i(s, r) {
    ...
    for (var l in o) for (var d = r[l], c = 0; c < d.length; c++) for (var u = t.getLink(d[c]), h = 0; h < o[l].length; h++) if (u.type == o[l][h]) return "gantt_link_crossing";
    return "";
  }
  function a(s, r, o, l, d, c) {
    var u, h = t.getState();
    +o.start_date >= +h.min_date && ((u = l([r, d.rtl ? "task_right" : "task_left", "task_start_date"].join(" "))).setAttribute("data-bind-property", "start_date"), c && (u.style.marginLeft = c + "px"), s.appendChild(u)), +o.end_date <= +h.max_date && ((u = l([r, d.rtl ? "task_left" : "task_right", "task_end_date"].join(" "))).setAttribute("data-bind-property", "end_date"), c && (u.style.marginRight = c + "px"), s.appendChild(u));
  }
  return function(s, r, o) {
    var l = (o = r.$getConfig()).type_renderers[t.getTaskType(s.type)], d = n;
    return l ? l.call(t, s, function(c) {
      return d.call(t, c, r, o);
    }, r) : d.call(t, s, r, o);
  };
}
function Ye(t) {
  return { render: Sn(t), update: null, isInViewPort: Ee, getVisibleRange: mt };
}
function It() {
...
function _e(t, n, e, i) {
  var a = n.width[t];
  if (a <= 0) return false;
  if (!i.config.smart_rendering || Rt(i)) return true;
  var s = n.left[t] - a, r = n.left[t] + a;
  return s <= e.x_end && r >= e.x;
}
function Ba(t, n) {
  var e = n.config.timeline_placeholder;
  if (t = t || [], e && t.filter((l) => l.id === "timeline_placeholder_task").length === 0) {
    var i = n.getState(), a = null, s = i.min_date, r = i.max_date;
    t.length && (a = t[t.length - 1].id);
    var o = { start_date: s, end_date: r, row_height: e.height || 0, id: "timeline_placeholder_task", unscheduled: true, lastTaskId: a, calendar_id: e.calendar || "global", $source: [], $target: [] };
    t.push(o);
  }
}
function za(t) {
  var n = { current_pos: null, dirs: { left: "left", right: "right", up: "up", down: "down" }, path: [], clear: function() {
    ...
    var r, o = s.$getConfig(), l = o.link_line_width, d = o.link_wrapper_width, c = a.size + l;
    switch (a.direction) {
      case this.dirs.left:
      case this.dirs.right:
        r = { height: l, width: c, marginTop: (d - l) / 2, marginLeft: (d - l) / 2 };
        break;
      case this.dirs.up:
      case this.dirs.down:
        r = { height: c, width: l, marginTop: (d - l) / 2, marginLeft: (d - l) / 2 };
    }
    return r;
    ...
    var c = this.get_line_sizes(a, r), u = document.createElement("div");
    ...
    let c, u;
    return d.classList.add("gantt_link_corner"), d.classList.add(`gantt_link_corner_${a.direction.from}_${a.direction.to}`), d.style.width = `${r}px`, d.style.height = `${r}px`, a.direction.from === "right" && a.direction.to === "down" ? (c = "Right", u = "Top", d.style.left = a.x - o.link_line_width / 2 + "px", d.style.top = `${a.y}px`) : a.direction.from === "down" && a.direction.to === "right" ? (c = "Left", u = "Bottom", d.style.left = a.x - o.link_line_width / 2 + "px", d.style.top = `${a.y}px`) : a.direction.from === "right" && a.direction.to === "up" ? (c = "Right", u = "Bottom", d.style.left = a.x - o.link_line_width / 2 + "px", d.style.top = a.y - r + "px") : a.direction.from === "up" && a.direction.to === "right" ? (c = "Left", u = "Top", d.style.left = a.x - o.link_line_width / 2 + "px", d.style.top = a.y - r + "px") : a.direction.from === "left" && a.direction.to === "down" ? (c = "Left", u = "Top", d.style.left = a.x - r - o.link_line_width / 2 + "px", d.style.top = `${a.y}px`) : a.direction.from === "down" && a.direction.to === "left" ? (c = "Right", u = "Bottom", d.style.left = a.x - r - o.link_line_width / 2 + "px", d.style.top = `${a.y}px`) : a.direction.from === "left" && a.direction.to === "up" ? (c = "Left", u = "Bottom", d.style.left = a.x - r - o.link_line_width / 2 + "px", d.style.top = a.y - r + "px") : a.direction.from === "up" && a.direction.to === "left" && (c = "Right", u = "Top", d.style.left = a.x - r - o.link_line_width / 2 + "px", d.style.top = a.y - r + "px"), d.style[`border${u}Width`] = `${l}px`, d.style[`border${c}Width`] = `${l}px`, d.style[`border${c}Style`] = "solid", d.style[`border${u}Style`] = "solid", d.style[`border${u}${c}Radius`] = `${r}px`, d;
  }, render_arrow(a, s) {
    ...
    return r.style.top = o + "px", r.style.left = l + "px", r.className = c, r;
    ...
    var l = this.get_endpoint(a, s, r, o), d = t.config, c = l.e_y - l.y, u = l.e_x - l.x, h = n.dirs, _ = s.getItemHeight(a.source);
    this.clear(), this.point({ x: l.x, y: l.y });
    var f = 2 * d.link_arrow_size, y = this.get_line_type(a, s.$getConfig()), v = l.e_x > l.x;
    if (y.from_start && y.to_start) this.point_to(h.left, f), v ? (this.point_to(h.down, c), this.point_to(h.right, u)) : (this.point_to(h.right, u), this.point_to(h.down, c)), this.point_to(h.right, f);
      ...
      u -= 2 * f;
      var b = c > 0 ? 1 : -1;
      this.point_to(h.down, b * (_ / 2)), this.point_to(h.right, u), this.point_to(h.down, b * (Math.abs(c) - _ / 2)), this.point_to(h.right, f);
    }
    else y.from_start || y.to_start ? y.from_start && !y.to_start && (c !== 0 && (v = l.e_x > l.x - 2 * f), this.point_to(h.left, f), v ? (u += 2 * f, b = c > 0 ? 1 : -1, this.point_to(h.down, b * (_ / 2)), this.point_to(h.right, u), this.point_to(h.down, b * (Math.abs(c) - _ / 2)), this.point_to(h.left, f)) : (u += f, this.point_to(h.down, c), this.point_to(h.right, u))) : (this.point_to(h.right, f), v ? (this.point_to(h.right, u), this.point_to(h.down, c)) : (this.point_to(h.down, c), this.point_to(h.right, u)), this.point_to(h.left, f));
    return this.path;
  }, get_line_type: function(a, s) {
    var r = s.links, o = false, l = false;
    return a.type == r.start_to_start ? o = l = true : a.type == r.finish_to_finish ? o = l = false : a.type == r.finish_to_start ? (o = false, l = true) : a.type == r.start_to_finish ? (o = true, l = false) : t.assert(false, "Invalid link type"), s.rtl && (o = !o, l = !l), { from_start: o, to_start: l };
  }, get_endpoint: function(a, s, r, o) {
    var l = s.$getConfig(), d = this.get_line_type(a, l), c = d.from_start, u = d.to_start, h = i(r, s, l), _ = i(o, s, l);
    return { x: c ? h.left : h.left + h.width, e_x: u ? _.left : _.left + _.width, y: h.top + h.rowHeight / 2 - 1, e_y: _.top + _.rowHeight / 2 - 1 };
  } };
  function i(a, s, r) {
    var o = s.getItemPosition(a);
    let l = function(f, y, v, b) {
      let m = b || y.$task_data.scrollHeight, g = false, p = false;
      return f.eachParent(function(k) {
        if (St(k)) {
          p = true;
          const x = y.getItemPosition(k).rowHeight;
          x < m && (m = x, g = true);
        }
      }, v.id), { maxHeight: m, shrinkHeight: g, splitChild: p };
    }(t, s, a), d = l.maxHeight, c = l.splitChild;
    ...
    if (_) {
      let f = s.getBarHeight(a.id, true);
      h = Math.sqrt(2 * f * f), l.shrinkHeight && d < f && (f = d, h = d), o.left -= h / 2, o.width = h;
    }
    if (c) if (d >= o.height) {
      const f = function(y, v) {
        let b = false;
        return y.eachTask(function(m) {
          b || (b = pn(y, m));
        }, v), b;
      }(t, a.parent);
      u || f ? _ ? (o.rowHeight = o.height + 4, o.left += (o.width - o.rowHeight + 4) / 2, o.width = o.rowHeight - 3) : o.rowHeight = o.height + 6 : _ && (o.left += (h - o.height) / 2);
  ...
  return { render: function(a, s, r) {
    ...
    var d = e.get_endpoint(a, s, o, l), c = d.e_y - d.y;
    if (!(d.e_x - d.x) && !c) return null;
    var u = e.get_points(a, s, o, l);
    const h = function(v, b) {
      const m = b.link_radius || 4, g = b.link_arrow_size || 6, p = [];
      for (let x = 0; x < v.length; x++) {
        const w = v[x], $ = v[x + 1];
        if (!$ || b.link_radius <= 1) p.push({ type: "line", data: w });
        else if (w.direction !== $.direction) {
          if (w.size < m || $.size < m) {
            p.push({ type: "line", data: w });
            continue;
          }
          w.size -= m, p.push({ type: "line", data: w });
          let T = w.x, S = w.y - b.link_line_width / 2;
          switch (w.direction) {
            case "right":
              T += w.size;
              break;
          ...
          const C = { x: T, y: S, direction: { from: w.direction, to: $.direction }, radius: m };
          switch (p.push({ type: "corner", data: C }), $.direction) {
            case "right":
              $.x += m, $.size -= m;
              break;
            case "left":
      ...
      if (k.direction === "right" || k.direction === "left") {
        k.size -= 3 * g / 4;
        let x = k.direction === "right" ? k.x + k.size : k.x - k.size - g / 2, w = k.y - b.link_line_width / 2 - g / 2 + 1;
        k.direction === "left" ? (w -= 1, x -= 2) : x -= 1;
        const $ = { x, y: w, size: g, direction: k.direction };
        p.push({ type: "line", data: k }), p.push({ type: "arrow", data: $ });
      } else p.push({ type: "line", data: k });
      return p;
    }(n.get_lines(u, s).filter((v) => v.size > 0), r), _ = function(v, b, m, g) {
      const p = document.createElement("div");
      return v.forEach((k) => {
        let x;
        k.type === "line" ? x = n.render_line(k.data, null, b, m.source) : k.type === "corner" ? x = n.render_corner(k.data, b) : k.type === "arrow" && (x = n.render_arrow(k.data, g)), p.appendChild(x);
      }), p;
    }(h, s, a, r);
    var f = "gantt_task_link";
    a.color && (f += " gantt_link_inline_color");
    var y = t.templates.link_class ? t.templates.link_class(a) : "";
    return y && (f += " " + y), r.highlight_critical_path && t.isCriticalLink && t.isCriticalLink(a) && (f += " gantt_critical_link"), _.className = f, s.$config.link_attribute && (_.setAttribute(s.$config.link_attribute, a.id), _.setAttribute("link_id", a.id)), a.color && _.style.setProperty("--dhx-gantt-link-background", a.color), t._waiAria.linkAttr(a, _), _;
  }, update: null, isInViewPort: xn, getVisibleRange: bn() };
}
function ja(t, n, e, i, a) {
...
function Wa(t) {
  ...
  return t.$data.tasksStore.attachEvent("onStoreUpdated", function() {
    ...
    let o;
    return o = n[r] ? n[r] : n[r] = function(l, d, c, u) {
      let h, _ = false, f = {};
      t.config.process_resource_assignments && d === t.config.resource_property ? (h = l.$role == "task" ? t.getResourceAssignments(l.$resource_id, l.$task_id) : t.getResourceAssignments(l.id), _ = true) : h = l.$role == "task" ? [] : t.getTaskBy(d, l.id), f = function($, T, S) {
        const C = T.unit, E = T.step, D = {}, A = {};
        for (let M = 0; M < $.length; M++) {
          const I = $[M];
          let N = I;
          if (S && (N = t.getTask(I.task_id)), N.unscheduled) continue;
          let L = I.start_date || N.start_date, O = I.end_date || N.end_date;
          S && (I.start_date && (L = new Date(Math.max(I.start_date.valueOf(), N.start_date.valueOf()))), I.end_date && (O = new Date(Math.min(I.end_date.valueOf(), N.end_date.valueOf()))), I.mode && I.mode == "fixedDates" && (L = I.start_date, O = I.end_date));
          let z = Tt(T.trace_x, L.valueOf()), H = new Date(T.trace_x[z] || t.date[C + "_start"](new Date(L))), j = new Date(Math.min(L.valueOf(), H.valueOf())), P = t.config.work_time ? t.getTaskCalendar(N) : t;
          for (A[P.id] = {}; j < O; ) {
            const V = A[P.id], W = j.valueOf();
            j = t.date.add(j, E, C), V[W] !== false && (D[W] || (D[W] = { tasks: [], assignments: [] }), D[W].tasks.push(N), S && D[W].assignments.push(I));
          }
        }
        return D;
      }(h, c, _);
      ...
      let m, g, p, k, x;
      const w = u.$getConfig();
      for (let $ = 0; $ < c.trace_x.length; $++) m = new Date(c.trace_x[$]), g = t.date.add(m, v, y), x = f[m.valueOf()] || {}, p = x.tasks || [], k = x.assignments || [], p.length || w.resource_render_empty_cells ? b.push({ start_date: m, end_date: g, tasks: p, assignments: k }) : b.push(null);
      return b;
    }(e, i, a, s), o;
  };
}
var Fa = { init: function(t, n) {
  ...
  if (n.$config.bind && t.getDatastore(n.$config.bind)) {
    ...
    t.defined(n.$getConfig().dnd_sensitivity) && (i.config.sensitivity = n.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
      var d = a(l);
      if (!d || (t.hideQuickInfo && t.hideQuickInfo(), ht(l.target, ".gantt_grid_editor_placeholder"))) return false;
      ...
      c && (c.style.position = "static"), i.config.id = d.getAttribute(n.$config.item_attribute);
      var u = s(), h = u.getItem(i.config.id);
      ...
      for (var l = null, d = s().getItems(), c = 0, u = d.length; c < u; c++) d[c].$level == o && (l = d[c]);
      return l ? l.id : null;
    }, i._getGridPos = t.bind(function(o) {
      var l = Y(n.$grid_data), d = l.x + n.$grid.scrollLeft, c = o.pos.y - 10, u = n.getItemHeight(i.config.id);
      c < l.y && (c = l.y);
      ...
      var l = Y(n.$grid_data), d = n.$state.scrollTop || 0, c = t.$grid_data.getBoundingClientRect().height + d, u = o.pageY - l.y + d;
      ...
      var d = t.$grid_data.getBoundingClientRect(), c = d.height + d.y + (n.$state.scrollTop || 0) + window.scrollY, u = i.config, h = i._getGridPos(l);
      t._waiAria.reorderMarkerAttr(u.marker);
      var _ = n.$getConfig(), f = s();
      ...
      var v = f.getItem(i.config.id), b = i._getTargetY(l), m = i._getTaskByY(b, f.getIndexById(v.id));
      function g(D, A) {
        return !f.isChildOf(p.id, A.id) && (D.$level == A.$level || _.order_branch_free);
      }
      if (f.exists(m) || (m = i.lastTaskOfLevel(_.order_branch_free ? v.$level : 0)) == i.config.id && (m = null), f.exists(m)) {
        var p = f.getItem(m), k = n.getItemTop(p.id), x = n.getItemHeight(p.id);
        if (k + x / 2 < b) {
          var w = f.getIndexById(p.id), $ = f.getNext(p.id), T = f.getItem($);
          if (r($)) {
            var S = f.getPrev(T.id);
            T = f.getItem(S);
          }
          if (T) {
            if (T.id == v.id) return _.order_branch_free && f.isChildOf(v.id, p.id) && f.getChildren(p.id).length == 1 ? void f.move(v.id, f.getBranchIndex(p.id) + 1, f.getParent(p.id)) : void 0;
            p = T;
          } else if ($ = f.getIdByIndex(w), T = f.getItem($), r($) && (S = f.getPrev(T.id), T = f.getItem(S)), g(T, v) && T.id != v.id) return void f.move(v.id, -1, f.getParent(T.id));
        } else if (_.order_branch_free && p.id != v.id && g(p, v) && !r(p.id)) {
          if (!f.hasChild(p.id)) return p.$open = true, void f.move(v.id, -1, p.id);
          if (f.getIndexById(p.id) || x / 3 < b) return;
        }
        w = f.getIndexById(p.id), S = f.getIdByIndex(w - 1);
        for (var C = f.getItem(S), E = 1; (!C || C.id == p.id) && w - E >= 0; ) S = f.getIdByIndex(w - E), C = f.getItem(S), E++;
        if (v.id == p.id || r(p.id)) return;
        g(p, v) && v.id != p.id ? f.move(v.id, 0, 0, p.id) : p.$level != v.$level - 1 || f.getChildren(p.id).length ? C && g(C, v) && v.id != C.id && f.move(v.id, -1, f.getParent(C.id)) : f.move(v.id, 0, p.id);
      }
      return true;
    }, t)), i.attachEvent("onDragEnd", t.bind(function() {
      var o = s(), l = o.getItem(i.config.id);
  ...
  function a(o) {
    return it(o, n.$config.item_attribute);
  }
  function s() {
...
var Z = { createDropTargetObject: function(t) {
  var n = { targetParent: null, targetIndex: 0, targetId: null, child: false, nextSibling: false, prevSibling: false };
  return t && R(n, t, true), n;
}, nextSiblingTarget: function(t, n, e) {
  var i = this.createDropTargetObject();
  return i.targetId = n, i.nextSibling = true, i.targetParent = e.getParent(i.targetId), i.targetIndex = e.getBranchIndex(i.targetId), (e.getParent(t) != i.targetParent || i.targetIndex < e.getBranchIndex(t)) && (i.targetIndex += 1), i;
}, prevSiblingTarget: function(t, n, e) {
  var i = this.createDropTargetObject();
  return i.targetId = n, i.prevSibling = true, i.targetParent = e.getParent(i.targetId), i.targetIndex = e.getBranchIndex(i.targetId), e.getParent(t) == i.targetParent && i.targetIndex > e.getBranchIndex(t) && (i.targetIndex -= 1), i;
}, firstChildTarget: function(t, n, e) {
  var i = this.createDropTargetObject();
  return i.targetId = n, i.targetParent = i.targetId, i.targetIndex = 0, i.child = true, i;
}, lastChildTarget: function(t, n, e) {
  var i = e.getChildren(n), a = this.createDropTargetObject();
  return a.targetId = i[i.length - 1], a.targetParent = n, a.targetIndex = i.length, a.nextSibling = true, a;
} };
function Tn(t, n, e, i, a) {
  for (var s = n; i.exists(s); ) {
    var r = i.calculateItemLevel(i.getItem(s));
    if ((r === e || r === e - 1) && i.getBranchIndex(s) > -1) break;
    s = a ? i.getPrev(s) : i.getNext(s);
  }
  return i.exists(s) ? i.calculateItemLevel(i.getItem(s)) === e ? a ? Z.nextSiblingTarget(t, s, i) : Z.prevSiblingTarget(t, s, i) : Z.firstChildTarget(t, s, i) : null;
}
function ge(t, n, e, i) {
  return Tn(t, n, e, i, true);
}
function Ke(t, n, e, i) {
  return Tn(t, n, e, i, false);
}
function Xe(t, n, e, i, a, s) {
  var r;
  if (n !== a.$getRootId()) {
    var o = a.getItem(n), l = a.calculateItemLevel(o);
    if (l === s) {
      var d = a.getPrevSibling(n);
      e < 0.5 && !d ? r = Z.prevSiblingTarget(t, n, a) : (e < 0.5 && (n = d), r = Z.nextSiblingTarget(t, n, a));
    } else if (l > s) a.eachParent(function(f) {
      a.calculateItemLevel(f) === s && (n = f.id);
    }, o), r = ge(t, n, s, a);
    else {
      var c = ge(t, n, s, a), u = Ke(t, n, s, a);
      r = e < 0.5 ? c : u;
    }
  } else {
    var h = a.$getRootId(), _ = a.getChildren(h);
    r = Z.createDropTargetObject(), r = _.length && i >= 0 ? ge(t, function(f) {
...
var Qe = { removeLineHighlight: function(t) {
  ...
  var i = function(s, r) {
    var o = Y(r.$grid_data), l = rt(s, r.$grid_data), d = o.x + r.$grid.scrollLeft, c = l.y - 10, u = r.getItemHeight(s.targetId);
    c < o.y && (c = o.y);
    var h = r.getTotalHeight();
    return c > o.y + h - u && (c = o.y + h - u), o.x = d, o.y = c, o.width = fe(r.$gantt, o.width, 9), o;
  }(t, e);
  ...
  a || ((a = document.createElement("div")).className = "gantt_drag_marker gantt_grid_dnd_marker", a.innerHTML = "<div class='gantt_grid_dnd_marker_line'></div>", a.style.pointerEvents = "none"), t.child ? function(s, r, o) {
    var l = s.targetParent, d = Ze({ x: 0, y: o.getItemTop(l) }, o), c = o.$grid_data.getBoundingClientRect().bottom + window.scrollY;
    let u = fe(o.$gantt, o.$grid_data.offsetWidth);
    r.innerHTML = "<div class='gantt_grid_dnd_marker_folder'></div>", r.style.width = u + "px", r.style.top = d.y + "px", r.style.left = d.x + "px", r.style.height = o.getItemHeight(l) + "px", d.y > c && (r.style.top = c + "px");
  }(t, a, e) : function(s, r, o) {
    var l = function(u, h) {
      var _ = h.$config.rowStore, f = { x: 0, y: 0 }, y = h.$grid_data.querySelector(".gantt_tree_indent"), v = 15, b = 0;
      y && (v = y.offsetWidth);
      var m = 40;
      if (u.targetId !== _.$getRootId()) {
        var g = h.getItemTop(u.targetId), p = h.getItemHeight(u.targetId);
        if (b = _.exists(u.targetId) ? _.calculateItemLevel(_.getItem(u.targetId)) : 0, u.prevSibling) f.y = g;
        else if (u.nextSibling) {
          var k = 0;
          _.eachItem(function(x) {
            _.getIndexById(x.id) !== -1 && k++;
          }, u.targetId), f.y = g + p + k * p;
        } else f.y = g + p, b += 1;
      }
      return f.x = m + b * v, f.width = fe(h.$gantt, Math.max(h.$grid_data.offsetWidth - f.x, 0), f.x), Ze(f, h);
    ...
    var c = l.y - 2;
    r.style.top = c + "px", r.style.width = l.width + "px", c > d && (r.style.top = d + "px");
  }(t, a, e), n.markerLine || (document.body.appendChild(a), n.markerLine = a);
} };
var Va = { init: function(t, n) {
  var e = t.$services.getService("dnd");
  if (n.$config.bind && t.getDatastore(n.$config.bind)) {
    var i = new e(n.$grid_data, { updates_per_second: 60 });
    t.defined(n.$getConfig().dnd_sensitivity) && (i.config.sensitivity = n.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
      var d = a(l);
      if (!d || (t.hideQuickInfo && t.hideQuickInfo(), ht(l.target, ".gantt_grid_editor_placeholder"))) return false;
      var c = d.getAttribute(n.$config.item_attribute), u = n.$config.rowStore.getItem(c);
      return !t.isReadonly(u) && !s(c) && (i.config.initial_open_state = u.$open, !!t.callEvent("onRowDragStart", [c, l.target || l.srcElement, l]) && void 0);
    }, t)), i.attachEvent("onAfterDragStart", t.bind(function(o, l) {
      var d = a(l);
      i.config.marker.innerHTML = d.outerHTML;
      var c = i.config.marker.firstChild;
      c && (i.config.marker.style.opacity = 0.4, c.style.position = "static", c.style.pointerEvents = "none"), i.config.id = d.getAttribute(n.$config.item_attribute);
      var u = n.$config.rowStore, h = u.getItem(i.config.id);
      i.config.level = u.calculateItemLevel(h), i.config.drop_target = Z.createDropTargetObject({ targetParent: u.getParent(h.id), targetIndex: u.getBranchIndex(h.id), targetId: h.id, nextSibling: true }), h.$open = false, h.$transparent = true, this.refreshData();
    }, t)), i.attachEvent("onDragMove", t.bind(function(o, l) {
      var d = r(l);
      return d && t.callEvent("onBeforeRowDragMove", [i.config.id, d.targetParent, d.targetIndex]) !== false || (d = Z.createDropTargetObject(i.config.drop_target)), Qe.highlightPosition(d, i.config, n), i.config.drop_target = d, t._waiAria.reorderMarkerAttr(i.config.marker), this.callEvent("onRowDragMove", [i.config.id, d.targetParent, d.targetIndex]), true;
    }, t)), i.attachEvent("onDragEnd", t.bind(function() {
      var o = n.$config.rowStore, l = o.getItem(i.config.id);
      Qe.removeLineHighlight(i.config), l.$transparent = false, l.$open = i.config.initial_open_state;
  ...
  function s(o) {
    return Ot(o, t, t.getDatastore(n.$config.bind));
  }
  function r(o) {
    var l, d = function(f) {
      var y = rt(f, n.$grid_data).y, v = n.$config.rowStore;
      ...
      var k = v.getIdByIndex(p), x = n.$state.scrollTop / n.getItemHeight(k), w = x - Math.floor(x);
      w > 0.1 && w < 0.9 && (m -= n.getItemHeight(k) * w, g += n.getItemHeight(k) * (1 - w));
      const $ = Y(n.$grid_data), T = $.y + $.height, S = i.config.marker.offsetHeight;
      y + S + window.scrollY >= m && (i.config.marker.style.top = T - S + "px"), y >= m ? y = m : y <= g && (y = g, i.config.marker.style.top = $.y + "px");
      var C = n.getItemIndexByTopPosition(y);
      if (C > v.countVisible() - 1 || C < 0) return v.$getRootId();
      var E = v.getIdByIndex(C);
      return s(E) ? v.getPrevSibling(E) : v.getIdByIndex(C);
    }(o), c = null, u = n.$config.rowStore, h = !n.$getConfig().order_branch_free, _ = rt(o, n.$grid_data).y;
    return document.doctype || (_ += window.scrollY), d !== u.$getRootId() && (c = (_ - n.getItemTop(d)) / n.getItemHeight(d)), h ? (l = Xe(i.config.id, d, c, _, u, i.config.level)) && l.targetParent && s(l.targetParent) && (d = u.getPrevSibling(l.targetParent), l = Xe(i.config.id, d, c, _, u, i.config.level)) : l = function(f, y, v, b, m) {
      var g;
      if (y !== m.$getRootId()) g = v < 0.25 ? Z.prevSiblingTarget(f, y, m) : !(v > 0.6) || m.hasChild(y) && m.getItem(y).$open ? Z.firstChildTarget(f, y, m) : Z.nextSiblingTarget(f, y, m);
      else {
        var p = m.$getRootId();
        g = m.hasChild(p) && b >= 0 ? Z.lastChildTarget(f, p, m) : Z.firstChildTarget(f, p, m);
      }
      return g;
    }(i.config.id, d, c, _, u), l;
  }
} };
var Ua = function(t) {
  return { onCreated: function(n) {
    n.$config = R(n.$config, { bind: "task" }), n.$config.id == "grid" && (this.extendGantt(n), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(n), t.ext.inlineEditors.init()), this._mouseDelegates = Ae(t);
  }, onInitialized: function(n) {
    var e = n.$getConfig();
    e.order_branch && (e.order_branch == "marker" ? Va.init(n.$gantt, n) : Fa.init(n.$gantt, n)), this.initEvents(n, t), n.$config.id == "grid" && this.extendDom(n);
    ...
    }, e), n.$grid), this._mouseDelegates.delegate("click", "gantt_grid_head_cell", e.bind(function(i, a, s) {
      var r = s.getAttribute("data-column-id");
      if (e.callEvent("onGridHeaderClick", [r, i])) {
        var o = n.$getConfig();
        if (r != "add") {
          if (o.sort && r) {
            for (var l, d = r, c = 0; c < o.columns.length; c++) if (o.columns[c].name == r) {
              l = o.columns[c];
              break;
            }
            if (l && l.sort !== void 0 && l.sort !== true && !(d = l.sort)) return;
            var u = this._sort && this._sort.direction && this._sort.name == r ? this._sort.direction : "desc";
            u = u == "desc" ? "asc" : "desc", this._sort = { name: r, direction: u }, this.sort(d, u == "desc");
          }
        } else e.$services.getService("mouseEvents").callHandler("click", "gantt_add", n.$grid, [i, o.root_id]);
      }
    }, e), n.$grid), this._mouseDelegates.delegate("click", "gantt_add", e.bind(function(i, a, s) {
      if (!n.$getConfig().readonly) return this.createTask({}, a || e.config.root_id), false;
    }, e), n.$grid);
  ...
  return { extend: function(n) {
    ...
    return t = function(i, a) {
      ...
      return { drag: null, dragMultiple: {}, _events: { before_start: {}, before_finish: {}, after_finish: {} }, _handlers: {}, init: function() {
        ...
        this.set_actions(), s.getService("state").registerProvider("tasksDnd", B(function() {
        ...
        var d = i.$getConfig(), c = this._drag_task_coords(r, l);
        l.left ? (r.start_date = a.dateFromPos(c.start + o, this._getPositioningContext(r)), r.start_date || (r.start_date = new Date(a.getState().min_date))) : (r.end_date = a.dateFromPos(c.end + o, this._getPositioningContext(r)), r.end_date || (r.end_date = new Date(a.getState().max_date)));
        var u = this._calculateMinDuration(d.min_duration, d.duration_unit);
        r.end_date - r.start_date < d.min_duration && (l.left ? r.start_date = a.calculateEndDate(r.end_date, -u, d.duration_unit, r) : r.end_date = a.calculateEndDate(r.start_date, u, d.duration_unit, r)), a._init_task_timing(r);
        ...
        var d = this._drag_task_coords(r, l), c = i.$getConfig().rtl ? d.start - l.pos.x : l.pos.x - d.start, u = Math.max(0, c);
        r.progress = Math.min(1, u / Math.abs(d.end - d.start));
      }, _find_max_shift: function(r, o) {
        var l;
        for (var d in r) {
          var c = r[d], u = a.getTask(c.id);
          if (!u.unscheduled) {
            var h = this._drag_task_coords(u, c), _ = a.posFromDate(new Date(a.getState().min_date), this._getPositioningContext(u)), f = a.posFromDate(new Date(a.getState().max_date), this._getPositioningContext(u));
            if (h.end + o > f) {
              var y = f - h.end;
              (y < l || l === void 0) && (l = y);
            } else if (h.start + o < _) {
        ...
        var c = this._drag_task_coords(r, l), u = null, h = null;
        ...
        if (this.drag.start_drag) {
          var o = rt(r, a.$task_data), l = this.drag.start_drag.start_x, d = this.drag.start_drag.start_y;
        ...
        if (this.drag.mode) {
          if (!_n(this, 40)) return;
          this._update_on_move(r);
        }
      }, _update_item_on_move: function(r, o, l, d, c, u) {
        var h = a.getTask(o), _ = a.mixin({}, h), f = a.mixin({}, h);
        this._handlers[l].apply(this, [f, r, d, u]), a.mixin(h, f, true), a.callEvent("onTaskDrag", [h.id, l, f, _, c]), a.mixin(h, f, true), a.refreshTask(o);
      }, _update_on_move: function(r) {
        var o = this.drag, l = i.$getConfig();
        if (o.mode) {
          var d = rt(r, i.$task_data);
          if (o.pos && o.pos.x == d.x) return;
          o.pos = d;
          const m = a.getTask(o.id);
          var c = a.dateFromPos(d.x, this._getPositioningContext(m));
          ...
          if (this._handlers[o.mode]) {
            if (o.mode === l.drag_mode.move) {
              ...
              if (a.isSummaryTask(m) && a.config.drag_project) {
                var f = {};
                f[o.id] = X(o), _ = true, h = R(f, this.dragMultiple);
              }
              var y = this._find_max_shift(h, u);
              let g;
              if (y !== void 0 && (u = y), this._update_item_on_move(u, o.id, o.mode, o, r), y === void 0) {
                ...
                if (o.handle_offset === void 0) {
                  const w = k - p, $ = o.start_x - p;
                  o.handle_offset = $ / w;
                }
                let x = p + Math.abs(k - p) * o.handle_offset;
                g = c - a.dateFromPos(x, this._getPositioningContext(o.obj));
              }
              for (var v in h) {
                var b = h[v];
                _ && b.id != o.id && (a._bulk_dnd = true), this._update_item_on_move(u, b.id, b.mode, b, r, g);
              }
              a._bulk_dnd = false;
            } else this._update_item_on_move(u, o.id, o.mode, o, r);
            a._update_parents(o.id);
          }
        }
      }, on_mouse_down: function(r, o) {
        if (r.button != 2 || r.button === void 0) {
          var l = i.$getConfig(), d = a.locate(r), c = null;
          if (a.isTaskExists(d) && (c = a.getTask(d)), !a.isReadonly(c) && !this.drag.mode) {
            this.clear_drag_state();
            var u = Q(o = o || r.target || r.srcElement), h = this._get_drag_mode(u, o);
            if (!u || !h) return o.parentNode ? this.on_mouse_down(r, o.parentNode) : void 0;
            if (h) if (h.mode && h.mode != l.drag_mode.ignore && l["drag_" + h.mode]) {
              ...
              h.id = d;
              var _ = rt(r, a.$task_data);
              h.start_x = _.x, h.start_y = _.y, h.obj = c, this.drag.start_drag = h, this.drag.timestamp = Date.now();
            } else this.clear_drag_state();
            else if (a.checkEvent("onMouseDown") && a.callEvent("onMouseDown", [u.split(" ")[0]]) && o.parentNode) return this.on_mouse_down(r, o.parentNode);
          }
        }
        ...
        o.mode == l.drag_mode.resize ? o.left ? (r.start_date = a.roundDate({ date: r.start_date, unit: d, step: c }), h && h.calendar && (r.start_date = h.calendar.getClosestWorkTime({ date: r.start_date, dir: "future" })), u(r)) : (r.end_date = a.roundDate({ date: r.end_date, unit: d, step: c }), h && h.calendar && (r.end_date = h.calendar.getClosestWorkTime({ date: r.end_date })), function(_) {
          if (a.config.correct_work_time) {
            var f = i.$getConfig();
        ...
        }(r)) : o.mode == l.drag_mode.move && (r.start_date = a.roundDate({ date: r.start_date, unit: d, step: c }), h && h.calendar && (r.start_date = h.calendar.getClosestWorkTime({ date: r.start_date, dir: "future" })), u(r), r.end_date = a.calculateEndDate(r));
        ...
        var c = a.getTask(r);
        if (o.work_time && o.correct_work_time && this._fix_working_times(c, l), this._fix_dnd_scale_time(c, l), this._fireEvent("before_finish", l.mode, [r, l.mode, a.copy(l.obj), d])) {
          var u = r;
          a._init_task_timing(c), this.clear_drag_state(), a.updateTask(c.id), this._fireEvent("after_finish", l.mode, [u, l.mode, d]);
        } else if (this.clear_drag_state(), r == l.id && (l.obj._dhx_changed = false, a.mixin(c, l.obj, true)), a.refreshTask(c.id), c.$level > 100) {
          let h = false;
          a.eachParent(function(_) {
            if (!h && _.type === a.config.types.project) {
              const f = { start_date: _.start_date, end_date: _.end_date };
              a.resetProjectDates(_), +f.start_date == +_.start_date && +f.end_date == +_.end_date || (h = true);
            }
        ...
        if (o.mode && o.id) {
          ...
          var _ = function() {
            if (u) for (var f in c) c[f].id != o.id && this._finalize_mouse_up(c[f].id, l, c[f], r);
        ...
        if (l["drag_" + o.mode] && a.callEvent("onBeforeDrag", [d, o.mode, r]) && this._fireEvent("before_start", o.mode, [d, o.mode, r])) {
          ...
          if (this._isMultiselect()) {
            ...
            u.indexOf(o.id) >= 0 && bt(u, a.bind(function(h) {
              var _ = a.getTask(h);
...
var Ga = function(t, n) {
  var e, i, a, s, r;
  function o() {
    return { link_source_id: s, link_target_id: i, link_from_start: r, link_to_start: a, link_landing_area: e };
  }
  var l = n.$services, d = l.getService("state"), c = l.getService("dnd");
  d.registerProvider("linksDnD", o);
  var u = "gantt_link_point", h = "gantt_link_control", _ = new c(t.$task_bars, { sensitivity: 0, updates_per_second: 60, mousemoveContainer: n.$root, selector: "." + u, preventDefault: true });
  function f(g, p) {
    var k, x = _.getPosition(g), w = function(A) {
      var M = 0, I = 0;
      return A && (M = A.offsetWidth || 0, I = A.offsetHeight || 0), { width: M, height: I };
    }(p), $ = { right: (k = n.$root).offsetWidth, bottom: k.offsetHeight }, T = n.config.tooltip_offset_x || 10, S = n.config.tooltip_offset_y || 10, C = n.config.scroll_size || 18, E = n.$container.getBoundingClientRect().y + window.scrollY, D = { y: x.y + S, x: x.x + T, bottom: x.y + w.height + S + C, right: x.x + w.width + T + C };
    return D.bottom > $.bottom + E && (D.y = $.bottom + E - w.height - S), D.right > $.right && (D.x = $.right - w.width - T), D;
  }
  function y(g) {
    var p = o();
  ...
  function b(g, p, k, x) {
    ...
    }(), $ = o(), T = ["gantt_link_direction"];
    n.templates.link_direction_class && T.push(n.templates.link_direction_class($.link_source_id, $.link_from_start, $.link_target_id, $.link_to_start));
    var S = Math.sqrt(Math.pow(k - g, 2) + Math.pow(x - p, 2));
    if (S = Math.max(0, S - 3)) {
      w.className = T.join(" ");
      var C = (x - p) / (k - g), E = Math.atan(C);
      m(g, k, p, x) == 2 ? E += Math.PI : m(g, k, p, x) == 3 && (E -= Math.PI);
      var D = Math.sin(E), A = Math.cos(E), M = Math.round(p), I = Math.round(g), N = ["-webkit-transform: rotate(" + E + "rad)", "-moz-transform: rotate(" + E + "rad)", "-ms-transform: rotate(" + E + "rad)", "-o-transform: rotate(" + E + "rad)", "transform: rotate(" + E + "rad)", "width:" + Math.round(S) + "px"];
      if (window.navigator.userAgent.indexOf("MSIE 8.0") != -1) {
        N.push('-ms-filter: "' + function(z, H) {
          return "progid:DXImageTransform.Microsoft.Matrix(M11 = " + H + ",M12 = -" + z + ",M21 = " + z + ",M22 = " + H + ",SizingMethod = 'auto expand')";
        }(D, A) + '"');
        var L = Math.abs(Math.round(g - k)), O = Math.abs(Math.round(x - p));
        switch (m(g, k, p, x)) {
          case 1:
            M -= O;
            break;
      ...
      N.push("top:" + M + "px"), N.push("left:" + I + "px"), w.style.cssText = N.join(";");
    }
  }
  function m(g, p, k, x) {
    return p >= g ? x <= k ? 1 : 4 : x <= k ? 2 : 3;
  }
  _.attachEvent("onBeforeDragStart", n.bind(function(g, p) {
    var k = p.target || p.srcElement;
    if (v(), n.getState("tasksDnd").drag_id) return false;
    if (vt(k, u)) {
      vt(k, "task_start_date") && (r = true);
      var x = n.locate(p);
      s = x;
      var w = n.getTask(x);
      return n.isReadonly(w) ? (v(), false) : (this._dir_start = { x: _.config.original_element_sizes.x + _.config.original_element_sizes.width / 2, y: _.config.original_element_sizes.y + _.config.original_element_sizes.height / 2 }, true);
    }
    return false;
  }, this)), _.attachEvent("onAfterDragStart", n.bind(function(g, p) {
    n.config.touch && n.refreshData(), y(_.config.marker);
  }, this)), _.attachEvent("onDragMove", n.bind(function(g, p) {
    var k = _.config, x = f(p, k.marker);
    (function(A, M) {
      A.style.left = M.x + "px", A.style.top = M.y + "px";
    })(k.marker, x);
    var w = !!vt(p, h), $ = i, T = e, S = a, C = n.locate(p), E = true;
    if (K(xt(p), n.$root) || (w = false, C = null), w && (E = !vt(p, "task_end_date"), w = !!C), i = C, e = w, a = E, w) {
      const A = vt(p, h).querySelector(`.${u}`);
      if (A) {
        const M = sn(A, t.$task_bg);
        this._dir_end = { x: M.x + A.offsetWidth / 2, y: M.y + A.offsetHeight / 2 };
      }
    } else this._dir_end = rt(p, t.$task_data), n.env.isEdge && (this._dir_end.y += window.scrollY);
    var D = !(T == w && $ == C && S == E);
    return D && ($ && n.refreshTask($, false), C && n.refreshTask(C, false)), D && y(k.marker), b(this._dir_start.x, this._dir_start.y, this._dir_end.x, this._dir_end.y), true;
  }, this)), _.attachEvent("onDragEnd", n.bind(function() {
    var g = o();
    if (g.link_source_id && g.link_target_id && g.link_source_id != g.link_target_id) {
      var p = n._get_link_type(g.link_from_start, g.link_to_start), k = { source: g.link_source_id, target: g.link_target_id, type: p };
      k.type && n.isLinkAllowed(k) && n.callEvent("onLinkCreated", [k]) && n.addLink(k);
    }
    v(), n.config.touch ? n.refreshData() : (g.link_source_id && n.refreshTask(g.link_source_id, false), g.link_target_id && n.refreshTask(g.link_target_id, false)), _._direction && (_._direction.parentNode && _._direction.parentNode.removeChild(_._direction), _._direction = null);
...
var Ja = function(t) {
  ...
  return { onCreated: function(e) {
    var i = e.$config;
    i.bind = q(i.bind) ? i.bind : "task", i.bindLinks = q(i.bindLinks) ? i.bindLinks : "link", e._linksDnD = Ya(), e._tasksDnD = qa.createTaskDND(), e._tasksDnD.extend(e), this._mouseDelegates = Ae(t);
    ...
    this._mouseDelegates.delegate("click", "gantt_task_link", e.bind(function(a, s) {
      ...
      var r = rt(a, e.$task_data), o = e.dateFromPos(r.x), l = Math.floor(e.columnIndexByDate(o)), d = e.getScale().trace_x[l];
      e.callEvent("onScaleClick", [a, d]);
    }, e), this.$task), this._mouseDelegates.delegate("doubleclick", "gantt_task_link", e.bind(function(a, s, r) {
      s = this.locate(a, e.config.link_attribute), i.call(this, s, a);
    }, e), this.$task), this._mouseDelegates.delegate("doubleclick", "gantt_link_point", e.bind(function(a, s, r) {
      s = this.locate(a);
      var o = this.getTask(s), l = null;
      return r.parentNode && Q(r.parentNode) && (l = Q(r.parentNode).indexOf("_left") > -1 ? o.$target[0] : o.$source[0]), l && i.call(this, l, a), false;
    }, e), this.$task);
...
var Ka = function(t) {
  return { getVerticalScrollbar: function() {
    ...
    for (var e = n.getCellsByType("resizer"), i = 0; i < e.length; i++) {
      var a = e[i], s = false, r = a.$parent.getPrevSibling(a.$id);
      if (r && r.$config && r.$config.id === "grid") s = true;
      else {
        var o = a.$parent.getNextSibling(a.$id);
        o && o.$config && o.$config.id === "grid" && (s = true);
      }
    ...
    this._legacyGridResizerClass(n), n.attachEvent("onBeforeResize", function() {
      ...
      if (a) {
        ...
        if (e && !r && s !== false && (t.config.grid_width = s), a.$config.hidden = a.$parent.$config.hidden = r, !a.$config.hidden) {
          ...
          if (o[0] && t.config.grid_width < o[0] && (t.config.grid_width = o[0]), o[1] && t.config.grid_width > o[1] && (t.config.grid_width = o[1]), i && t.config.show_chart) {
            ...
            if (e) a.$parent.$config.width = t.config.grid_width, a.$parent.$config.group && t.$layout._syncCellSizes(a.$parent.$config.group, { value: a.$parent.$config.width, isGravity: false });
            else if (i && !K(i.$task, n.$view)) {
          ...
          } else i && K(i.$task, n.$view) && (a.$config.original_grid_width = t.config.grid_width), e || (a.$parent.$config.width = 0);
        }
        e = false;
      }
    ...
    for (var i, a = n.getCellsByType("resizer"), s = true, r = 0; r < a.length; r++) {
      var o = a[r];
      o._getSiblings();
    ...
    if (i.resizer) {
      ...
      }), r.attachEvent("onResizeEnd", function(o, l, d, c) {
        var u = s ? o : l, h = s ? d : c, _ = t.$ui.getView("grid"), f = _ ? _.$parent : null;
...
var Xa = { init: function(t) {
  ...
  var e = pa(t);
  e.registerView("cell", Bt), e.registerView("resizer", null), e.registerView("scrollbar", $a), e.registerView("layout", $n, function(s) {
    (s.$config ? s.$config.id : null) === "main" && n(s, Ka);
  }), e.registerView("viewcell", xa), e.registerView("multiview", ba), e.registerView("timeline", Gt, function(s) {
    (s.$config ? s.$config.id : null) !== "timeline" && s.$config.bind != "task" || n(s, Ja);
  }), e.registerView("grid", te, function(s) {
    (s.$config ? s.$config.id : null) !== "grid" && s.$config.bind != "task" || n(s, Ua);
  }), e.registerView("resourceGrid", te), e.registerView("GridRL", Ca), e.registerView("resourceTimeline", Gt), e.registerView("resourceHistogram", Gt);
  var i = function(s) {
    var r = ka(s);
    return { getDataRender: function(o) {
      return s.$services.getService("layer:" + o) || null;
    }, createDataRender: function(o) {
      var l = o.name, d = o.defaultContainer, c = o.defaultContainerSibling, u = r.createGroup(d, c, function(h, _) {
        if (!u.filters) return true;
        for (var f = 0; f < u.filters.length; f++) if (u.filters[f](h, _) === false) return false;
      }, ya);
      ...
      return { addTaskLayer: function(d) {
        ...
        const c = bn();
        return typeof d == "function" ? d = { renderer: { render: d, getVisibleRange: c } } : d.renderer && !d.renderer.getVisibleRange && (d.renderer.getVisibleRange = c), d.view = "timeline", d && d.renderer && (d.renderer.getRectangle || d.renderer.isInViewPort || (d.renderer.isInViewPort = xn)), l.addLayer(d);
  ...
  return t.ext.inlineEditors = a, t.ext._inlineEditors = a, a.init(t), { factory: e, mouseEvents: va.init(t), layersApi: i.init(), render: { gridLine: function() {
    return /* @__PURE__ */ function(s) {
      return { render: function(r, o, l, d) {
        for (var c = o.getGridColumns(), u = o.$getTemplates(), h = o.$config.rowStore, _ = [], f = 0; f < c.length; f++) {
          var y, v, b, m = f == c.length - 1, g = c[f];
          g.name == "add" ? (v = "<div " + (T = s._waiAria.gridAddButtonAttrString(g)) + " class='gantt_add'></div>", b = "") : (et(v = g.template ? g.template(r) : r[g.name]) && (v = u.date_grid(v, r, g.name)), v == null && (v = ""), b = v, v = "<div class='gantt_tree_content'>" + v + "</div>");
          var p = "gantt_cell" + (m ? " gantt_last_cell" : ""), k = [];
          if (g.tree) {
            p += " gantt_cell_tree";
            for (var x = 0; x < r.$level; x++) k.push(u.grid_indent(r));
            !h.hasChild(r.id) || s.isSplitTask(r) && !s.config.open_split_tasks ? (k.push(u.grid_blank(r)), k.push(u.grid_file(r))) : (k.push(u.grid_open(r)), k.push(u.grid_folder(r)));
          }
          var w = "width:" + (g.width - (m ? 1 : 0)) + "px;";
          if (this.defined(g.align)) {
            var $ = { right: "flex-end", left: "flex-start", center: "center" }[g.align];
            w += "text-align:" + g.align + ";justify-content:" + $ + ";";
          }
          var T = s._waiAria.gridCellAttrString(g, b, r);
          k.push(v), y = "<div class='" + p + "' data-column-index='" + f + "' data-column-name='" + g.name + "' style='" + w + "' " + T + ">" + k.join("") + "</div>", _.push(y);
        }
        ...
        if (p += r.$transparent ? " gantt_transparent" : "", p += r.$dataprocessor_class ? " " + r.$dataprocessor_class : "", u.grid_row_class) {
          var S = u.grid_row_class.call(s, r.start_date, r.end_date, r);
          S && (p += " " + S);
        }
    ...
    return /* @__PURE__ */ function(s) {
      var r = {}, o = {};
      function l(_, f) {
        return !(!r[_.id][f] || !r[_.id][f].parentNode);
      }
      function d(_, f) {
        r[_] && r[_][f] && r[_][f].parentNode && r[_][f].parentNode.removeChild(r[_][f]);
      }
      function c(_) {
      ...
      function h(_, f, y, v, b, m, g, p) {
        var k = _.width[f], x = "";
        if (_e(f, _, v, s)) {
          var w = m(y, _.trace_x[f]), $ = "";
          if (g && ($ = g(y, _.trace_x[f])), p.static_background) {
            var T = !(!w && !$);
            if (!p.static_background_cells || !T) return null;
          }
          if (r[y.id][f]) return o[y.id][f] = f, r[y.id][f];
          var S = document.createElement("div");
          return S.style.width = k + "px", x = "gantt_task_cell" + (f == b - 1 ? " gantt_last_cell" : ""), w && (x += " " + w), S.className = x, $ && (S.innerHTML = $), S.style.position = "absolute", S.style.left = _.left[f] + "px", r[y.id][f] = S, o[y.id][f] = f, S;
        }
        return null;
      }
      return { render: function(_, f, y, v) {
        var b = f.$getTemplates(), m = f.getScale(), g = m.count;
        if (y.static_background && !y.static_background_cells) return null;
        var p, k = document.createElement("div"), x = c(f), w = u(f);
        if (p = v && y.smart_rendering && !Rt(s) ? Vt(m, v.x) : { start: 0, end: g - 1 }, y.show_task_cells) {
          r[_.id] = {}, o[_.id] = {};
          for (var $ = p.start; $ <= p.end; $++) {
            var T = h(m, $, _, v, g, x, w, y);
            T && k.appendChild(T);
          }
        }
        const S = f.$config.rowStore, C = S.getIndexById(_.id) % 2 != 0;
        var E = b.task_row_class(_.start_date, _.end_date, _), D = "gantt_task_row" + (C ? " odd" : "") + (E ? " " + E : "");
        if (S.isSelected(_.id) && (D += " gantt_selected"), k.className = D, y.smart_rendering ? (k.style.position = "absolute", k.style.top = f.getItemTop(_.id) + "px", k.style.width = "100%") : k.style.position = "relative", k.style.height = f.getItemHeight(_.id) + "px", _.id == "timeline_placeholder_task") {
          var A = 0;
          _.lastTaskId && (A = f.getItemTop(_.lastTaskId) + f.getItemHeight(_.lastTaskId));
          var M = (_.row_height || f.$task_data.offsetHeight) - A;
          M < 0 && (M = 0), y.smart_rendering && (k.style.top = A + "px"), k.style.height = M + "px";
        }
        return f.$config.item_attribute && (k.setAttribute(f.$config.item_attribute, _.id), k.setAttribute(f.$config.bind + "_id", _.id)), k;
      }, update: function(_, f, y, v, b) {
        var m = y.getScale(), g = m.count, p = c(y), k = u(y);
        if (v.show_task_cells) {
          r[_.id] || (r[_.id] = {}), o[_.id] || (o[_.id] = {});
          var x = Vt(m, b);
          for (var w in o[_.id]) {
            var $ = o[_.id][w];
            (Number($) < x.start || Number($) > x.end) && d(_.id, $);
          }
          o[_.id] = {};
          for (var T = x.start; T <= x.end; T++) {
            var S = h(m, T, _, b, g, p, k, v);
            !S && l(_, T) ? d(_.id, T) : S && !S.parentNode && f.appendChild(S);
          }
        }
      }, getRectangle: Je, getVisibleRange: mt, prepareData: Ba };
    }(t);
  }, taskBar: function() {
    return Ye(t);
    ...
    return function(s) {
      ...
      function l(u, h, _, f, y) {
        let v = true;
        return f.smart_rendering && (v = Ee(u, h, _)), v;
      }
      function d(u, h, _, f) {
        const y = s.copy(s.getTask(h.id));
        if (y.$rendered_at = u.id, s.callEvent("onBeforeRollupTaskDisplay", [y.id, y, u.id]) === false) return;
        const v = r(y, _);
        if (!v) return;
        const b = _.getBarHeight(u.id, h.type == s.config.types.milestone), m = Math.floor((_.getItemHeight(u.id) - b) / 2);
        return v.style.top = f.top + m + "px", v.classList.add("gantt_rollup_child"), v.setAttribute("data-rollup-parent-id", u.id), v;
      }
      function c(u, h) {
        return u + "_" + h;
      }
      return { render: function(u, h, _, f) {
        if (u.rollup !== false && u.$rollup && u.$rollup.length) {
          const y = document.createElement("div"), v = s.getTaskPosition(u);
          return f && (f.y = 0, f.y_end = s.$task_bg.scrollHeight), u.$rollup.forEach(function(b) {
            if (!s.isTaskExists(b)) return;
            const m = s.getTask(b);
            if (!l(m, f, h, _)) return;
            const g = d(u, m, h, v);
            g ? (o[c(m.id, u.id)] = g, y.appendChild(g)) : o[c(m.id, u.id)] = false;
          }), y;
        }
        return false;
      }, update: function(u, h, _, f, y) {
        const v = document.createElement("div"), b = s.getTaskPosition(u);
        y.y = 0, y.y_end = s.$task_bg.scrollHeight, u.$rollup.forEach(function(m) {
          const g = s.getTask(m), p = c(g.id, u.id);
          let k = l(g, y, _, f);
          if (k !== !!o[p]) if (k) {
            const x = d(u, g, _, b);
            o[p] = x || false;
      ...
      }, isInViewPort: Ee, getVisibleRange: mt };
    }(t);
    ...
    return function(s) {
      ...
      function l(c, u, h, _, f) {
        ...
        if (y || v) {
          var m = f.getItemPosition(c, u.start_date, u.end_date), g = document.createElement("div");
          return g.setAttribute(f.$config.item_attribute, c.id), g.className = ["gantt_resource_marker", y].join(" "), g.style.cssText = ["left:" + m.left + "px", "width:" + m.width + "px", "height:" + b + "px", "line-height:" + b + "px", "top:" + m.top + "px"].join(";"), v && (g.innerHTML = v), g;
        }
        return null;
      }
      function d(c, u) {
      ...
      return { render: function(c, u, h, _) {
        var f = u.$getTemplates(), y = u.getScale(), v = r(c, h.resource_property, u.getScale(), u), b = !!_, m = [];
        o[c.id] = {};
        for (var g = Vt(y, _), p = g.start; p <= g.end; p++) {
          var k = v[p];
          if (k && (!b || _e(p, y, _, s))) {
            var x = l(c, k, f, 0, u);
            x && (m.push(x), o[c.id][p] = x);
          }
        }
        var w = null;
        if (m.length) {
          w = document.createElement("div");
          for (var $ = 0; $ < m.length; $++) w.appendChild(m[$]);
        }
        return w;
      }, update: function(c, u, h, _, f) {
        var y = h.$getTemplates(), v = h.getScale(), b = r(c, _.resource_property, h.getScale(), h), m = Vt(v, f), g = {};
        if (o && o[c.id]) for (var p in o[c.id]) g[p] = p;
        for (var k = m.start; k <= m.end; k++) {
          var x = b[k];
          if (g[k] = false, x) if (_e(k, v, f, s)) if (o[c.id] && o[c.id][k]) o[c.id] && o[c.id][k] && !o[c.id][k].parentNode && u.appendChild(o[c.id][k]);
          else {
            var w = l(c, x, y, 0, h);
        ...
        for (var p in g) g[p] !== false && d(c.id, p);
      }, getRectangle: Je, getVisibleRange: mt };
    }(t);
    ...
    return /* @__PURE__ */ function(s) {
      return { render: function(r, o, l) {
        ...
        return c.className = "gantt_task_grid_row_resize_wrap", c.style.top = o.getItemTop(r.id) + o.getItemHeight(r.id) + "px", c.innerHTML = "<div class='gantt_task_grid_row_resize' role='cell'></div>", c.setAttribute(d.task_grid_row_resizer_attribute, r.id), s._waiAria.rowResizerAttr(c), c;
      }, update: null, getRectangle: Qt, getVisibleRange: mt };
    }(t);
...
function pe(t, n) {
  ...
  if (a) i = e;
    ...
    var s = n.skin;
    if (i = s, !s || t) for (var r = document.getElementsByTagName("link"), o = 0; o < r.length; o++) {
  ...
  for (c[1] && !n.defined(c[1].width) && (c[1].width = d._second_column_width), c[2] && !n.defined(c[2].width) && (c[2].width = d._third_column_width), o = 0; o < c.length; o++) {
    var u = c[o];
    u.name == "add" && (u.width || (u.width = 44), n.defined(u.min_width) && n.defined(u.max_width) || (u.min_width = u.min_width || u.width, u.max_width = u.max_width || u.width), u.min_width && (u.min_width = +u.min_width), u.max_width && (u.max_width = +u.max_width), u.width && (u.width = +u.width, u.width = u.min_width && u.min_width > u.width ? u.min_width : u.width, u.width = u.max_width && u.max_width < u.width ? u.max_width : u.width));
  }
...
function Za(t) {
  var n = null, e = false, i = null, a = { started: false }, s = {};
  function r(_) {
    return _ && K(_, t.$root) && _.offsetHeight;
  }
  function o() {
    var _ = !!document.querySelector(".gantt_drag_marker"), f = !!document.querySelector(".gantt_drag_marker.gantt_grid_resize_area") || !!document.querySelector(".gantt_drag_marker.gantt_row_grid_resize_area"), y = !!document.querySelector(".gantt_link_direction"), v = t.getState(), b = v.autoscroll;
  ...
  function d(_) {
    _ ? (l(true), a.started || (a.x = s.x, a.y = s.y, a.started = true)) : (n && (clearInterval(n), n = null), l(false), a.started = false);
  }
  function c(_) {
    var f = o();
    if (!n && !i || f || d(false), !t.config.autoscroll || !f) return false;
    s = { x: _.clientX, y: _.clientY }, _.type == "touchmove" && (s.x = _.targetTouches[0].clientX, s.y = _.targetTouches[0].clientY), !n && f && d(true);
  }
  function u() {
    if (!o()) return d(false), false;
    ...
    if (_) {
      ...
      var y = Y(_), v = s.x - y.x, b = s.y - y.y + window.scrollY, m = e ? 0 : h(v, y.width, a.x - y.x), g = h(b, y.height, a.y - y.y + window.scrollY), p = t.getScrollState(), k = p.y, x = p.inner_height, w = p.height, $ = p.x, T = p.inner_width, S = p.width;
      (g && !x || g < 0 && !k || g > 0 && k + x >= w + 2) && (g = 0), (m && !T || m < 0 && !$ || m > 0 && $ + T >= S) && (m = 0);
      var C = t.config.autoscroll_step;
      C && C < 2 && (C = 2), g *= C || 30, ((m *= C || 30) || g) && function(E, D) {
        var A = t.getScrollState(), M = null, I = null;
        E && (M = A.x + E, M = Math.min(A.width, M), M = Math.max(0, M)), D && (I = A.y + D, I = Math.min(A.height, I), I = Math.max(0, I)), t.scrollTo(M, I);
      }(m, g);
    }
  }
  function h(_, f, y) {
  ...
  t.attachEvent("onGanttReady", function() {
    if (!G(t)) {
      var _ = yt(t.$root) || document.body;
      t.eventRemove(_, "mousemove", c), t.event(_, "mousemove", c), t.eventRemove(_, "touchmove", c), t.event(_, "touchmove", c), t.eventRemove(_, "pointermove", c), t.event(_, "pointermove", c);
    }
  }), t.attachEvent("onDestroy", function() {
    d(false);
  });
...
var me;
var ve;
typeof window < "u" && window.jQuery && (me = window.jQuery, ve = [], me.fn.dhx_gantt = function(t) {
  ...
  if (ve[t]) return ve[t].apply(this, []);
  me.error("Method " + t + " does not exist on jQuery.dhx_gantt");
});
...
var Qa = ["ctrlKey", "altKey", "shiftKey", "metaKey"];
var ts = [[{ unit: "month", date: "%M", step: 1 }, { unit: "day", date: "%d", step: 1 }], [{ unit: "day", date: "%d %M", step: 1 }], [{ unit: "day", date: "%d %M", step: 1 }, { unit: "hour", date: "%H:00", step: 8 }], [{ unit: "day", date: "%d %M", step: 1 }, { unit: "hour", date: "%H:00", step: 1 }]];
var es = class {
  constructor(n) {
    this.zoomIn = () => {
      ...
      if (delete r.name, a.mixin(a.config, r, true), ["resourceTimeline", "resourceHistogram"].forEach(function(o) {
        const l = a.$ui.getView(o);
        if (l) {
          const d = l.$getConfig();
          d.fixed_scales || a.mixin(d, r, true);
        }
      }), a.$root && a.$task) {
        if (i) {
      ...
      let a;
      a = typeof e.element == "function" ? e.element() : e.element, a && this._domEvents.attach(a, i, this.$gantt.bind(function(s) {
        if (this._useKey && (Qa.indexOf(this._useKey) < 0 || !s[this._useKey]))
          return false;
        if (typeof this._handler == "function") return this._handler.apply(this, [s]), true;
      }, this), { passive: false });
    }, this._defaultHandler = (e) => {
      const i = this.$gantt.$task.getBoundingClientRect().x, a = e.clientX - i;
      let s = false;
      (this.$gantt.env.isFF ? -40 * e.deltaY : e.wheelDelta) > 0 && (s = true), e.preventDefault(), e.stopPropagation(), this._setScaleSettings(s, a);
    }, this._setScaleDates = () => {
...
function ns(t) {
  ...
  t.config.touch_drag = 75, t.config.touch = true, t.config.touch_feedback = true, t.config.touch_feedback_duration = 1, t._prevent_touch_scroll = false, t._touch_feedback = function() {
    ...
    t.$container && t.attachEvent("onGanttRender", n, { once: true });
  });
  var a = [];
  t._touch_events = function(s, r, o) {
    var l, d = 0, c = false, u = false, h = null, _ = null, f = null, y = null, v = [], b = null;
    let m = {};
    ...
    (a = []).push([t.$container, s[0], function(k) {
      ...
      if (!o(k) && c) {
        f && clearTimeout(f);
        var w = r(k);
        if (x && (x.drag.id || x.drag.start_drag)) return x.on_mouse_move(w), k.preventDefault && k.preventDefault(), k.cancelBubble = true, false;
        if (!t._prevent_touch_scroll) {
          if (w && h) {
            var $ = h.pageX - w.pageX, T = h.pageY - w.pageY;
            if (!u && (Math.abs($) > 5 || Math.abs(T) > 5) && (u = true, d = 0, l = b ? e(b) : t.getScrollState()), u) {
              var S, C = l.x + $, E = l.y + T;
              if (b ? (function(D, A, M) {
                var I = D.$config.scrollX ? t.$ui.getView(D.$config.scrollX) : null, N = D.$config.scrollY ? t.$ui.getView(D.$config.scrollY) : null;
                I && I.scrollTo(A, null), N && N.scrollTo(null, M);
              }(b, C, E), S = e(b)) : (t.scrollTo(C, E), S = t.getScrollState()), l.x != S.x && T > 2 * $ || l.y != S.y && $ > 2 * T) return p(k);
            }
          }
          return p(k);
        }
    ...
    for (a.push([this.$container, "contextmenu", function(k) {
      ...
      if (m = k.touches.length, document && document.body && document.body.classList.add("gantt_touch_active"), !o(k)) if (k.touches && k.touches.length > 1) c = false;
      else {
        h = r(k), b = function(w) {
          for (var $ = t.$layout.getCellsByType("viewCell"), T = 0; T < $.length; T++) {
            var S = $[T].$view.getBoundingClientRect();
            if (w.clientX >= S.left && w.clientX <= S.right && w.clientY <= S.bottom && w.clientY >= S.top) return $[T];
          }
        }(h), t._locate_css(h, "gantt_hor_scroll") || t._locate_css(h, "gantt_ver_scroll") || (c = true);
        var x = i();
        f = setTimeout(function() {
          var w = t.locate(h);
          x && w && !t._locate_css(h, "gantt_link_control") && !t._locate_css(h, "gantt_grid_data") && (x.on_mouse_down(h), x.drag && x.drag.start_drag && (function($) {
            const T = t._getTaskLayers();
            let S = t.getTask($);
            if (S) {
              let C = t.isTaskVisible($);
              if (C) {
                y = $;
                for (let E = 0; E < T.length; E++) if (S = T[E].rendered[$], S && S.getAttribute(t.config.task_attribute) && S.getAttribute(t.config.task_attribute) == $) {
                  const D = S.cloneNode(true);
                  v.push(S), T[E].rendered[$] = D, S.style.display = "none", D.className += " gantt_drag_move ", S.parentNode.appendChild(D);
                }
                ...
                for (let D = 0; D < T.length; D++) {
                  const A = T[D].rendered[E];
                  let M;
                  if (A && A.childNodes && (M = A.querySelector(`[${t.config.task_attribute}="${S.id}"]`)), M) {
                    const I = M.cloneNode(true);
                    M.parentNode.appendChild(I), t.$task_bars.appendChild(M), M.style.display = "none", v.push(M), M = null;
                  }
                }
              }
            }
          }(w), x._start_dnd(h), t._touch_drag = true, t.refreshTask(w), t._touch_feedback())), f = null;
        }, t.config.touch_drag);
      }
    }]), a.push([this.$container, s[2], function(k) {
      if (document && document.body && document.body.classList.remove("gantt_touch_active"), !o(k)) {
        f && clearTimeout(f), t._touch_drag = false, c = false;
        var x = r(k), w = i();
        if (w && w.on_mouse_up(x), y && t.isTaskExists(y) && (t.refreshTask(y), v.length && (v.forEach(function(T) {
          T.parentNode && T.parentNode.removeChild(T);
        }), t._touch_feedback())), c = u = false, v = [], y = null, h && d) {
          var $ = /* @__PURE__ */ new Date();
          const T = m <= 1, S = _ && _.target.innerHTML == h.target.innerHTML;
          $ - d < 500 && T && S ? (t.$services.getService("mouseEvents").onDoubleClick(h), p(k)) : (d = $, _ = h);
        } else d = /* @__PURE__ */ new Date();
      }
    }]), g = 0; g < a.length; g++) t.event(a[g][0], a[g][1], a[g][2]);
    function p(k) {
      return k && k.preventDefault && k.cancelable && k.preventDefault(), k.cancelBubble = true, false;
    }
  };
}
function Ut() {
...
Lt.prototype.render = Ut, Lt.prototype.set_value = Ut, Lt.prototype.get_value = Ut, Lt.prototype.focus = Ut;
var Cn = { getHtmlSelect: function(t, n, e) {
  var i = "", a = this;
  return bt(t = t || [], function(s) {
    var r = [{ key: "value", value: s.key }];
    e == s.key && (r[r.length] = { key: "selected", value: "selected" }), s.attributes && (r = r.concat(s.attributes)), i += a.getHtmlOption({ innerHTML: s.label }, r);
  }), Mt("select", { innerHTML: i }, n);
}, getHtmlOption: function(t, n) {
  return Mt("option", t, n);
}, getHtmlButton: function(t, n) {
  return Mt("button", t, n);
...
function Mt(t, n, e) {
  return n = n || [], "<" + t + En(e || []) + ">" + (n.innerHTML || "") + "</" + t + ">";
}
function En(t) {
  var n = "";
...
function Yt(t) {
  ...
  return F(e, n), e.prototype.render = function(i) {
    ...
    return s += Cn.getHtmlSelect(i.options, [{ key: "style", value: "width:100%;" }, { key: "title", value: i.name }]), s += "</div>", s;
  }, e.prototype.set_value = function(i, a, s, r) {
    var o = i.firstChild;
    !o._dhx_onchange && r.onchange && (o.onchange = r.onchange, o._dhx_onchange = true), a === void 0 && (a = (o.options[0] || {}).value), o.value = a || "";
...
function is(t) {
  ...
  function i(a, s) {
    var r = [], o = [];
    s && (r = t.getTaskByTime(), a.allow_root && r.unshift({ id: t.config.root_id, text: a.root_label || "" }), r = function(u, h, _) {
      ...
      for (var y = 0; y < u.length; y++) {
        var v = u[y];
        (v.id == _ || t.isChildOf(v.id, _) || f(v.id, v) === false) && (u.splice(y, 1), y--);
      }
      return u;
    }(r, a, s), a.sort && r.sort(a.sort));
    for (var l = a.template || t.templates.task_text, d = 0; d < r.length; d++) {
      var c = l.apply(t, [r[d].start_date, r[d].end_date, r[d]]);
      c === void 0 && (c = ""), o.push({ key: r[d].id, label: c });
    }
...
function as(t) {
  const n = ut(), e = { resourcesValues: {}, filter: {}, eventsInitialized: {}, gridID: null, resource_filter_value: null, initialValues: [], newValues: [] }, i = { type: "select", map_to: "resource_id", options: t.serverList("resourceOptions") }, a = t.date.date_to_str("%d-%m-%Y");
  function s() {
    return n.apply(this, arguments) || this;
  }
  function r(o) {
  ...
  return t.resource_table = { scale_height: 35, row_height: 35, columns: [{ name: "resource", label: "Resource", align: "center", width: 80, editor: i, template: function(o) {
    ...
    for (var o in e.filter) e.filter[o].input.value = "", e.filter[o].filterApplied = false;
    e.resourcesValues = {}, e.eventsInitialized = {}, e.resource_filter_value = null, e.gridID = null, e.initialValues = [], e.newValues = [];
  }), F(s, n), s.prototype.render = function(o) {
    let l;
    var d;
  ...
  }, s.prototype.button_click = function(o, l, d, c) {
    const u = d.getAttribute("data-section-name") || c.getAttribute("data-section-name"), h = document.querySelector("[data-resource-selector-section]"), _ = document.querySelector(".resources_section_placeholder"), f = document.querySelector(`.gantt_section_${u} .gantt_resource_selector_filter_wrapper`), y = document.querySelector(`.gantt_section_${u} .gantt_grid`);
    if (h.style.display = "none", t.callEvent("onSectionButton", [t._lightbox_id, d]) !== false && l.closest(".gantt_custom_button.gantt_add_resources")) {
      _.style.display = "none";
      const v = t.getDatastore("temp_resource_assignment_store");
      v && v.getItems().length == 0 && (f.style.display = "flex", y.style.display = "block"), function(b) {
        let m;
        const g = t.getTask(t._lightbox_id), p = t.getTaskAssignments(g.id);
        if (p.length) m = p[0].resource_id;
        else {
          const w = t.serverList("resourceOptions");
          if (!w.length) throw new Error(`There is no any resources in resource store, please check your data:
        ...
        k.addItem({ resource_id: m, task_id: g.id, duration: x.duration ?? t.calculateDuration(g), value: x.value, start_date: x.start_date ?? g.start_date, end_date: x.end_date ?? g.end_date, mode: x.mode }), t.refreshData();
      }(u), function(b) {
        const m = b.querySelectorAll(".gantt_row.gantt_row_task");
        if (m) {
          const g = m[m.length - 1].querySelector(".gantt_cell");
          if (g) {
            const { id: p, columnName: k } = t.ext.inlineEditorsLightbox.locateCell(g);
            p && k && t.ext.inlineEditorsLightbox.startEdit(p, k);
          }
        }
      }(c);
    }
  }, s.prototype.set_value = function(o, l, d, c, u) {
    ...
    if (function(y) {
      ...
      const v = t.$data.assignmentsStore.find(function(b) {
        return b.task_id == y.id;
      });
      for (let b = 0; b < v.length; b++) e.initialValues[b] = { resource_id: v[b].resource_id, value: v[b].value, id: v[b].id };
    }(d), !u) {
      (function(b, m, g, p) {
        if (t.$ui.getView("GridRL") && !e.gridID && t.$ui.getView("GridRL").destructor(), !e.gridID) {
          ...
          const x = t.createDatastore({ name: "temp_resource_assignment_store", initItem: function(D) {
            return D.id || (D.id = t.uid()), D;
          } });
          t.$data.tempAssignmentsStore = x;
          const w = { ...t.config.layout, id: "GridRL", sectionName: p.name }, $ = t.$ui.createView("GridRL", t.$root, w);
          $.init(k);
          const T = t._lightbox.offsetWidth - (t.config.wide_form ? 150 : 0);
          $.setSize(T, "auto"), t.ext.inlineEditorsLightbox = t.ext._inlineEditors.createEditors($), t.ext.inlineEditorsLightbox.init(), e.gridID = $.$id, b.appendChild(k);
        ...
        t.$data.tempAssignmentsStore.attachEvent("onFilterItem", function(k, x) {
          return x.task_id == g.id && (!e.resource_filter_value || t.getDatastore(t.config.resource_store).getItem(x.resource_id).text.toLowerCase().indexOf(e.resource_filter_value) > -1);
        }), t.refreshData();
      })(o, 0, d, c), function(b, m) {
        if (!e.filter[m.id]) {
          var g = b.querySelector(".gantt_resources_filter"), p = g.querySelector(".gantt_resources_filter_input");
          e.filter[m.id] = { container: g, input: p, filterApplied: false };
        }
        e.filter[m.id];
      }(o, c), function(b, m, g, p) {
        if (e.eventsInitialized[g.id]) return;
        var k = function(S) {
          var C, E, D;
          x(g, b);
          var A = r(g);
          D = A.input, E = D.value.trim(), e.resource_filter_value = E.toLowerCase(), A.filterApplied = !!E, t.getState().lightbox && (m = t.getLightboxValues()), C = function(I, N, L) {
            var O, z = t.copy(I);
            if (L === "") {
              z.resources = [];
              let H = e.newValues.map((j) => j.resource_id);
              if (H && H.length > 0) for (let j = 0; j < H.length; j++) {
                let P = t.getDatastore(t.config.resource_store).getItem(H[j]);
                P && z.resources.push(P);
              }
              return z;
            }
            return O = function(H) {
              if (H.text.toLowerCase().indexOf(L.toLowerCase()) >= 0) return H;
            }, z.resources = function(H) {
              let j = [];
              const P = t.getDatastore("temp_resource_assignment_store"), V = P.find(function(W) {
                return W.task_id == H.id;
              });
              for (let W = 0; W < V.length; W++) {
                let U = t.getDatastore(t.config.resource_store).getItem(V[W].resource_id);
                U && j.push(U);
              }
              return j;
            }(N, I.options), z.resources = function(H, j) {
              var P = [];
              if (H.filter) return H.filter(j);
              for (var V = 0; V < H.length; V++) j(H[V], V) && (P[P.length] = H[V]);
              return P;
            }(z.resources, O), z;
          }(g, m, E);
          var M = m[g.map_to];
          p.form_blocks.resource_selector.set_value(b, M, m, C);
        };
        function x(S, C) {
          var E = ".gantt_resource_amount_input", D = C.querySelectorAll(E);
          e.resourcesValues[S.id] = e.resourcesValues[S.id] || {};
          for (var A = 0; A < D.length; A++) {
            var M = D[A].getAttribute("data-item-id"), I = D[A].getAttribute("data-assignment-id");
            D[A].disabled ? delete e.resourcesValues[S.id][M] : e.resourcesValues[S.id][M] = { value: D[A].value, id: I };
          }
        }
        w = k, $ = 100, T = false, k = function() {
          T || (w.apply(null, arguments), T = true, setTimeout(function() {
            T = false;
          }, $));
        }, r(g).container.addEventListener("keyup", k), r(g).container.addEventListener("input", k, true), r(g).container.addEventListener("change", k, true), e.eventsInitialized[g.id] = true;
        var w, $, T;
      }(o, l, c, this), h.style.display = "none";
      let y = document.querySelector(`.gantt_section_${c.name} .gantt_grid`), v = document.querySelector(`.gantt_section_${c.name} .gantt_resource_selector_filter_wrapper`);
      y.style.display = "none", v.style.display = "none";
    }
    const f = t.getDatastore("temp_resource_assignment_store");
    if (f) {
      let y = document.querySelector(`.gantt_section_${c.name} .gantt_resource_selector_filter_wrapper`), v = document.querySelector(`.gantt_section_${c.name} .gantt_grid`);
      f.getItems().length == 0 ? (h.style.display == "none" && (h.style.display = "flex"), y.style.display = "none", v.style.display = "none", _.style.display = "block") : (y.style.display = "flex", v.style.display = "block", _.style.display = "none");
    }
    t._center_lightbox(t.getLightbox());
  }, s.prototype.get_value = function(o, l, d, c) {
    const u = t.getDatastore("temp_resource_assignment_store").find(function(h) {
      return h.task_id == l.id;
    });
    for (let h = 0; h < u.length; h++) e.newValues[h] = { resource_id: u[h].resource_id.toString(), value: u[h].value, id: u[h].id, start_date: u[h].start_date, end_date: u[h].end_date, duration: u[h].duration, mode: u[h].mode, delay: u[h].delay };
    return c == "save" ? e.newValues : e.initialValues;
  }, s;
}
function ss(t) {
  var n = function() {
    ...
    return F(p, g), p.prototype.render = function(k) {
    ...
    return F(k, p), k.prototype.render = function(x) {
      const w = (x.height || "130") + "px", $ = x.placeholder ? `placeholder='${x.placeholder}'` : "";
      return `<div class='gantt_cal_ltext gantt_section_${x.name}' style='height:${w};' ${$}><textarea></textarea></div>`;
    }, k.prototype.set_value = function(x, w) {
      g.form_blocks.textarea._get_input(x).value = w || "";
    }, k.prototype.get_value = function(x) {
      return g.form_blocks.textarea._get_input(x).value;
    }, k.prototype.focus = function(x) {
      var w = g.form_blocks.textarea._get_input(x);
      g._focus(w, true);
    ...
    return F(k, p), k.prototype.render = function(x) {
      var w = g.form_blocks.getTimePicker.call(this, x);
      let $ = "gantt_section_time";
      x.name !== "time" && ($ += " gantt_section_" + x.name);
      var T = "<div style='padding-top:0px;font-size:inherit;text-align:center;' class='" + $ + "'>";
      return T += w, x.single_date ? (w = g.form_blocks.getTimePicker.call(this, x, true), T += "<span></span>") : T += "<span class='gantt_section_time_spacer'> &nbsp;&ndash;&nbsp; </span>", (T += w) + "</div>";
      ...
      if (S.auto_end_date) for (var D = function() {
        I = new Date(C[E[2]].value, C[E[1]].value, C[E[0]].value, 0, 0), N = g.calculateEndDate({ start_date: I, duration: 1, task: $ }), g.form_blocks._fill_lightbox_select(C, E.size, N, E, S);
      }, A = 0; A < 4; A++) C[A].onchange = D;
      var M = g._resolve_default_mapping(T);
      typeof M == "string" && (M = { start_date: M });
      var I = $[M.start_date] || /* @__PURE__ */ new Date(), N = $[M.end_date] || g.calculateEndDate({ start_date: I, duration: 1, task: $ });
      g.form_blocks._fill_lightbox_select(C, 0, I, E, S), g.form_blocks._fill_lightbox_select(C, E.size, N, E, S);
    }, k.prototype.get_value = function(x, w, $) {
      var T, S = x.getElementsByTagName("select"), C = $._time_format_order;
      return T = g.form_blocks.getTimePickerValue(S, $), typeof g._resolve_default_mapping($) == "string" ? T : { start_date: T, end_date: function(E, D, A) {
        var M = g.form_blocks.getTimePickerValue(E, $, D.size);
        return M <= A && ($.autofix_end !== false || $.single_date) ? g.date.add(A, g._get_timepicker_step(), "minute") : M;
      }(S, C, T) };
    }, k.prototype.focus = function(x) {
      g._focus(x.getElementsByTagName("select")[0]);
    }, k;
  }(t), a = Yt(t), s = function(g) {
    var p = ut();
    function k() {
      return p.apply(this, arguments) || this;
    }
    return F(k, p), k.prototype.render = function(x) {
      const w = x.height ? `height:${x.height}px;` : "";
      let $ = `<div class='gantt_cal_ltext gantt_cal_lcheckbox gantt_section_${x.name}' ${w ? `style='${w}'` : ""}>`;
      if (x.options && x.options.length) for (var T = 0; T < x.options.length; T++) $ += "<label><input type='checkbox' value='" + x.options[T].key + "' name='" + x.name + "'>" + x.options[T].label + "</label>";
      else x.single_value = true, $ += "<label><input type='checkbox' name='" + x.name + "'></label>";
      return $ += "</div>", $;
    }, k.prototype.set_value = function(x, w, $, T) {
      var S = Array.prototype.slice.call(x.querySelectorAll("input[type=checkbox]"));
      !x._dhx_onchange && T.onchange && (x.onchange = T.onchange, x._dhx_onchange = true), T.single_value ? S[0].checked = !!w : bt(S, function(C) {
        C.checked = !!w && w.indexOf(C.value) >= 0;
      });
    }, k.prototype.get_value = function(x, w, $) {
      return $.single_value ? x.querySelector("input[type=checkbox]").checked : function(T, S) {
      ...
      g._focus(x.querySelector("input[type=checkbox]"));
    }, k;
  }(t), r = function(g) {
    const p = ut();
    function k() {
    ...
    return F(k, p), k.prototype.render = function(x) {
      const w = x.height ? `${x.height}px` : "";
      let $ = `<div class='gantt_cal_ltext gantt_cal_lradio gantt_section_${x.name}' ${w ? `style='height:${w};'` : ""}>`;
      if (x.options && x.options.length) for (var T = 0; T < x.options.length; T++) $ += "<label><input type='radio' value='" + x.options[T].key + "' name='" + x.name + "'>" + x.options[T].label + "</label>";
      return $ += "</div>", $;
    }, k.prototype.set_value = function(x, w, $, T) {
      var S;
      T.options && T.options.length && (S = x.querySelector("input[type=radio][value='" + w + "']") || x.querySelector("input[type=radio][value='" + T.default_value + "']")) && (!x._dhx_onchange && T.onchange && (x.onchange = T.onchange, x._dhx_onchange = true), S.checked = true);
    }, k.prototype.get_value = function(x, w) {
      var $ = x.querySelector("input[type=radio]:checked");
      return $ ? $.value : "";
    }, k.prototype.focus = function(x) {
      g._focus(x.querySelector("input[type=radio]"));
    }, k;
  }(t), o = function(g) {
    var p = ut();
    function k() {
    ...
    function x(T) {
      return T.formatter || new Ht();
    }
    function w(T, S) {
      var C = T.getElementsByTagName("select"), E = S._time_format_order, D = 0, A = 0;
      if (g.defined(E[3])) {
      ...
      return new Date(C[E[2]].value, C[E[1]].value, C[E[0]].value, D, A);
    }
    function $(T, S) {
    ...
    return F(k, p), k.prototype.render = function(T) {
      var S = "<div class='gantt_time_selects'>" + g.form_blocks.getTimePicker.call(this, T) + "</div>", C = " " + g.locale.labels[g.config.duration_unit + "s"] + " ", E = T.single_date ? " style='display:none'" : "", D = T.readonly ? " disabled='disabled'" : "", A = g._waiAria.lightboxDurationInputAttrString(T), M = "gantt_duration_value";
      T.formatter && (C = "", M += " gantt_duration_value_formatted");
      var I = "<div class='gantt_duration' " + E + "><div class='gantt_duration_inputs'><input type='button' class='gantt_duration_dec' value='−'" + D + "><input type='text' value='5days' class='" + M + "'" + D + " " + A + "><input type='button' class='gantt_duration_inc' value='+'" + D + "></div><div class='gantt_duration_end_date'>" + C + "<span></span></div></div></div>";
      let N = "gantt_section_time gantt_section_duration";
      return T.name !== "time" && (N += " gantt_section_" + T.name), "<div style='padding-top:0px;font-size:inherit;' class='" + N + "'>" + S + " " + I + "</div>";
    }, k.prototype.set_value = function(T, S, C, E) {
      var D, A, M, I, N = T.getElementsByTagName("select"), L = T.getElementsByTagName("input"), O = L[1], z = [L[0], L[2]], H = T.getElementsByTagName("span")[0], j = E._time_format_order;
      function P() {
        var W = w.call(g, T, E), U = $.call(g, T, E), ft = g.calculateEndDate({ start_date: W, duration: U, task: C }), Dt = g.templates.task_end_date || g.templates.task_date;
        H.innerHTML = Dt(ft);
      }
      function V(W) {
        var U = O.value;
        U = x(E).parse(U), window.isNaN(U) && (U = 0), (U += W) < 1 && (U = 1), O.value = x(E).format(U), P();
      }
      z[0].onclick = g.bind(function() {
        V(-1 * g.config.duration_step);
      }, this), z[1].onclick = g.bind(function() {
        V(1 * g.config.duration_step);
      }, this), N[0].onchange = P, N[1].onchange = P, N[2].onchange = P, N[3] && (N[3].onchange = P), O.onkeydown = g.bind(function(W) {
        var U;
        return (U = (W = W || window.event).charCode || W.keyCode || W.which) == g.constants.KEY_CODES.DOWN ? (V(-1 * g.config.duration_step), false) : U == g.constants.KEY_CODES.UP ? (V(1 * g.config.duration_step), false) : void window.setTimeout(P, 1);
      }, this), O.onchange = g.bind(P, this), typeof (D = g._resolve_default_mapping(E)) == "string" && (D = { start_date: D }), A = C[D.start_date] || /* @__PURE__ */ new Date(), M = C[D.end_date] || g.calculateEndDate({ start_date: A, duration: 1, task: C }), I = Math.round(C[D.duration]) || g.calculateDuration({ start_date: A, end_date: M, task: C }), I = x(E).format(I), g.form_blocks._fill_lightbox_select(N, 0, A, j, E), O.value = I, P();
    }, k.prototype.get_value = function(T, S, C) {
      var E = w(T, C), D = $(T, C), A = g.calculateEndDate({ start_date: E, duration: D, task: S });
      return typeof g._resolve_default_mapping(C) == "string" ? E : { start_date: E, end_date: A, duration: D };
    }, k.prototype.focus = function(T) {
      g._focus(T.getElementsByTagName("select")[0]);
    }, k;
  }(t), l = is(t), d = Yt(t), c = function(g) {
    var p = ut();
    function k() {
      return p.apply(this, arguments) || this;
    }
    ...
    function w($, T) {
      for (var S = x(T), C = 0; C < $.length; C++) $[C].disabled = S;
    }
    return F(k, p), k.prototype.render = function($) {
      const T = $.height ? `height:${$.height}px;` : "";
      let S = `<div class='gantt_cal_ltext gantt_section_${$.name}' ${T ? `style='${T}'` : ""}>`;
      var C = [];
      ...
      return $.options = $.options || C, S += "<span data-constraint-type-select>" + Cn.getHtmlSelect($.options, [{ key: "data-type", value: "constraint-type" }]) + "</span>", S += "<label data-constraint-time-select>" + (g.locale.labels.constraint_date || "Constraint date") + ": " + g.form_blocks.getTimePicker.call(this, $) + "</label>", S += "</div>", S;
    }, k.prototype.set_value = function($, T, S, C) {
      var E = $.querySelector("[data-constraint-type-select] select"), D = $.querySelectorAll("[data-constraint-time-select] select"), A = C._time_format_order, M = g._resolve_default_mapping(C);
      ...
      g.form_blocks._fill_lightbox_select(D, 0, I, A, C);
      var N = S[M.constraint_type] || g.getConstraintType(S);
      E.value = N, w(D, N);
    }, k.prototype.get_value = function($, T, S) {
      var C = $.querySelector("[data-constraint-type-select] select"), E = $.querySelectorAll("[data-constraint-time-select] select"), D = C.value, A = null;
      return x(D) || (A = g.form_blocks.getTimePickerValue(E, S)), { constraint_type: D, constraint_date: A };
    ...
    return F(k, p), k.prototype.render = function(x) {
      var w = g.config.types, $ = g.locale.labels, T = [], S = x.filter || function(D, A) {
        return !w.placeholder || A !== w.placeholder;
      };
      for (var C in w) !S(C, w[C]) == 0 && T.push({ key: w[C], label: $["type_" + C] });
      x.options = T;
      var E = x.onchange;
    ...
    function x(S) {
      return S.formatter || new Ht();
    }
    function w(S, C, E, D) {
      const A = "<div class='gantt_time_selects'>" + g.form_blocks.getTimePicker.call(g, D) + "</div>";
      let M = " " + g.locale.labels[g.config.duration_unit + "s"] + " ";
      const I = D.single_date ? " style='display:none'" : "", N = D.readonly ? " disabled='disabled'" : "", L = g._waiAria.lightboxDurationInputAttrString(D), O = g.locale.labels.baselines_remove_button;
      let z = "gantt_duration_value";
      D.formatter && (M = "", z += " gantt_duration_value_formatted");
      const H = "<div class='gantt_duration' " + I + "><div class='gantt_duration_inputs'><input type='button' class='gantt_duration_dec' value='-'" + N + "><input type='text' value='5days' class='" + z + "'" + N + " " + L + "><input type='button' class='gantt_duration_inc' value='+'" + N + "></div><div class='gantt_duration_end_date'>" + M + "<span></span></div></div></div>", j = `<div><div class='baseline_delete_button gantt_custom_button dhx_gantt_icon dhx_gantt_icon_delete' aria-label='${O}'></div></div>`, P = document.createElement("div");
      P.className = "gantt_section_time gantt_section_duration", P.setAttribute("data-baseline-id", C.id), P.innerHTML = A + H + j + "<br>", S.appendChild(P);
      var V, W, U, ft = P.getElementsByTagName("select"), Dt = P.getElementsByTagName("input"), At = Dt[1], Ie = [Dt[0], Dt[2]], Dn = P.getElementsByTagName("span")[0], An = D._time_format_order;
      function pt() {
        var _t = $.call(g, P, D), J = T.call(g, P, D), In = g.calculateEndDate({ start_date: _t, duration: J, task: E }), Mn = g.templates.task_end_date || g.templates.task_date;
        Dn.innerHTML = Mn(In);
      }
      function zt(_t) {
        var J = At.value;
        J = x(D).parse(J), window.isNaN(J) && (J = 0), (J += _t) < 1 && (J = 1), At.value = x(D).format(J), pt();
      }
      P.querySelector(".baseline_delete_button").onclick = function(_t) {
        const J = P.parentNode;
        P.innerHTML = "", P.remove(), J.innerHTML === "" && (J.innerHTML = g.locale.labels.baselines_section_placeholder);
      }, Ie[0].onclick = g.bind(function() {
        zt(-1 * g.config.duration_step);
      }, g), Ie[1].onclick = g.bind(function() {
        zt(1 * g.config.duration_step);
      }, g), ft[0].onchange = pt, ft[1].onchange = pt, ft[2].onchange = pt, ft[3] && (ft[3].onchange = pt), At.onkeydown = g.bind(function(_t) {
        var J;
        return (J = (_t = _t || window.event).charCode || _t.keyCode || _t.which) == g.constants.KEY_CODES.DOWN ? (zt(-1 * g.config.duration_step), false) : J == g.constants.KEY_CODES.UP ? (zt(1 * g.config.duration_step), false) : void window.setTimeout(pt, 1);
      }, g), At.onchange = g.bind(pt, g), g._resolve_default_mapping(D), V = C.start_date || /* @__PURE__ */ new Date(), W = C.end_date || g.calculateEndDate({ start_date: V, duration: 1, task: E }), U = g.calculateDuration({ start_date: V, end_date: W, task: E }), U = x(D).format(U), g.form_blocks._fill_lightbox_select(ft, 0, V, An, D), At.value = U, pt();
    }
    function $(S, C) {
      var E = S.getElementsByTagName("select"), D = C._time_format_order, A = 0, M = 0;
      if (g.defined(D[3])) {
        var I = E[D[3]], N = parseInt(I.value, 10);
        isNaN(N) && I.hasAttribute("data-value") && (N = parseInt(I.getAttribute("data-value"), 10)), A = Math.floor(N / 60), M = N % 60;
      }
      return new Date(E[D[2]].value, E[D[1]].value, E[D[0]].value, A, M);
    }
    function T(S, C) {
    ...
    }, k.prototype.set_value = function(S, C, E, D) {
      E.baselines ? (S.innerHTML = "", E.baselines.forEach((A) => {
        w(S, A, E, D);
      })) : S.innerHTML = g.locale.labels.baselines_section_placeholder;
    }, k.prototype.get_value = function(S, C, E) {
      const D = [];
      return S.querySelectorAll("[data-baseline-id]").forEach((A) => {
        const M = A.dataset.baselineId;
        let I, N = g.getDatastore("baselines").getItem(M);
        I = N ? g.copy(N) : { id: g.uid(), task_id: C.id, text: "Baseline 1" }, I.start_date = $(A, E), I.duration = T(A, E), I.end_date = g.calculateEndDate({ start_date: I.start_date, duration: I.duration, task: C }), D.push(I);
      }), D;
    }, k.prototype.button_click = function(S, C, E, D) {
      if (g.callEvent("onSectionButton", [g._lightbox_id, E]) !== false && (C.closest(".gantt_custom_button.gantt_remove_baselines") && (D.innerHTML = g.locale.labels.baselines_section_placeholder), C.closest(".gantt_custom_button.gantt_add_baselines"))) {
        D.innerHTML == g.locale.labels.baselines_section_placeholder && (D.innerHTML = "");
        const A = g.getTask(g._lightbox_id);
        w(D, { id: g.uid(), task_id: A.id, start_date: A.start_date, end_date: A.end_date }, A, g._get_typed_lightbox_config()[S]);
      }
...
<div class="gantt_cal_ltitle_controls">
    ...
    if (this.callEvent("onBeforeLightbox", [g])) {
      ...
      this.showCover(k), this._fill_lightbox(g, k), this._setLbPosition(k), this._waiAria.lightboxVisibleAttr(k), this.callEvent("onLightbox", [g]);
    ...
    if (this.config.round_dnd_dates) {
      ...
      if (function(k) {
        ...
        var p = t.getScale();
        g = qt(p.unit) * p.step / 60;
      }
      return (!g || g >= 1440) && (g = this.config.time_step), g;
    }
    return this.config.time_step;
  }, t.getLabel = function(g, p) {
    for (var k = this._get_typed_lightbox_config(), x = 0; x < k.length; x++) if (k[x].map_to == g) {
      for (var w = k[x].options, $ = 0; $ < w.length; $++) if (w[$].key == p) return w[$].label;
    }
    return "";
  }, t.updateCollection = function(g, p) {
    p = p.slice(0);
    var k = t.serverList(g);
    if (!k) return false;
    ...
    var p, k, x, w, $, T = "";
    if (t.config.csp === true || t.env.isSalesforce ? t._lightbox_root = t.$root : t._lightbox_root = document.body, g === void 0 && (g = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this.getTaskType(g)) {
      this._lightbox_type = this.getTaskType(g), p = document.createElement("div"), T = "gantt_cal_light", k = this._is_lightbox_timepicker(), t.config.wide_form && (T += " gantt_cal_light_wide"), k && (T += " gantt_cal_light_full"), p.className = T, p.style.visibility = "hidden", x = this._lightbox_template, x += "<div class='gantt_cal_lcontrols'>", x += v(this.config.buttons_left), x += "<div class='gantt_cal_lcontrols_push_right'></div>", x += v(this.config.buttons_right), x += "</div>", p.innerHTML = x, t._waiAria.lightboxAttr(p), t.config.drag_lightbox && (p.firstChild.onmousedown = t._ready_to_dnd, p.firstChild.addEventListener("touchstart", function(C) {
        t._ready_to_dnd(C.touches[0]);
      }), p.firstChild.onselectstart = function() {
        return false;
      }, p.firstChild.style.cursor = "pointer", t._init_dnd_events()), this._lightbox && this.resetLightbox(), f(), this._cover.insertBefore(p, this._cover.firstChild), this._lightbox = p, w = this._get_typed_lightbox_config(g), x = this._render_sections(w);
      var S = ($ = p.querySelector("div.gantt_cal_larea")).style.overflow;
      $.style.overflow = "hidden", $.innerHTML = x, function(C) {
        var E, D, A, M, I, N;
        for (N = 0; N < C.length; N++) E = C[N], A = t._lightbox_root.querySelector("#" + E.id), E.id && A && (D = A.querySelector("label"), (M = A.nextSibling) && (I = M.querySelector("input, select, textarea")) && (I.id = I.id || "input_" + t.uid(), E.inputId = I.id, D.setAttribute("for", E.inputId)));
  ...
  function v(g, p) {
    var k, x, w = "";
    for (x = 0; x < g.length; x++) k = t.config._migrate_buttons[g[x]] ? t.config._migrate_buttons[g[x]] : g[x], w += "<div " + t._waiAria.lightboxButtonAttrString(k) + " class='gantt_btn_set gantt_left_btn_set " + k + "_set'><div dhx_button='1' data-dhx-button='1' class='" + k + "'></div><div>" + t.locale.labels[k] + "</div></div>";
    return w;
  }
  function b(g) {
    var p, k;
    return g.time_format ? g.time_format : (k = ["%d", "%m", "%Y"], qt((p = t.getScale()) ? p.unit : t.config.duration_unit) < qt("day") && k.push("%H:%i"), k);
  }
  function m(g, p, k) {
    var x, w, $, T, S, C, E = "";
    switch (k.timeFormat[p]) {
      case "%Y":
        for (g._time_format_order[2] = p, g._time_format_order.size++, g.year_range && (isNaN(g.year_range) ? g.year_range.push && ($ = g.year_range[0], T = g.year_range[1]) : x = g.year_range), x = x || 10, w = w || Math.floor(x / 2), $ = $ || k.date.getFullYear() - w, T = T || t.getState().max_date.getFullYear() + w, S = $; S <= T; S++) E += "<option value='" + S + "'>" + S + "</option>";
        break;
      case "%m":
      ...
      case "%d":
        ...
        break;
      case "%H:%i":
        for (g._time_format_order[3] = p, g._time_format_order.size++, S = k.first, C = k.date.getDate(), g._time_values = []; S < k.last; ) E += "<option value='" + S + "'>" + t.templates.time_picker(k.date) + "</option>", g._time_values.push(S), k.date.setTime(k.date.valueOf() + 60 * t._get_timepicker_step() * 1e3), S = 24 * (k.date.getDate() != C ? 1 : 0) * 60 + 60 * k.date.getHours() + k.date.getMinutes();
    }
    return E;
  }
  t._init_lightbox_events = function() {
    t.lightbox_events = {}, t.lightbox_events.gantt_save_btn = function() {
      ...
      if (p.getAttribute("data-dhx-button")) t.callEvent("onLightboxButton", [p.className, p, g]);
        ...
        var k, x, w = Q(p);
        if (w.indexOf("gantt_custom_button") != -1) if (w.indexOf("gantt_custom_button_") != -1) for (k = p.parentNode.getAttribute("data-index"), x = p; x && Q(x).indexOf("gantt_cal_lsection") == -1; ) x = x.parentNode;
        else k = p.getAttribute("data-index"), x = p.closest(".gantt_cal_lsection"), p = p.firstChild;
        var $ = t._get_typed_lightbox_config();
        k && (k *= 1, t.form_blocks[$[1 * k].type].button_click(k, p, x, x.nextSibling));
      }
    }, this.event(t.getLightbox(), "click", function(g) {
      g.target.closest(".gantt_cal_ltitle_close_btn") && t._cancel_lightbox();
      var p = xt(g), k = Q(p);
      return k || (k = Q(p = p.previousSibling)), p && k && k.indexOf("gantt_btn_set") === 0 && (k = Q(p = p.firstChild)), !(!p || !k) && (t.defined(t.lightbox_events[p.className]) ? t.lightbox_events[p.className] : t.lightbox_events.default)(g, p);
    }), t.getLightbox().onkeydown = function(g) {
      var p = g || window.event, k = g.target || g.srcElement, x = Q(k).indexOf("gantt_btn_set") > -1;
      switch ((g || p).keyCode) {
    ...
    t._lightbox_current_type = null, this.callEvent("onLightboxSave", [this._lightbox_id, g, !!g.$new]) && (t.$data.tasksStore._skipTaskRecalculation = "lightbox", g.$new ? (delete g.$new, this.addTask(g, g.parent, this.getTaskIndex(g.id))) : this.isTaskExists(g.id) && (this.mixin(this.getTask(g.id), g, true), this.refreshTask(g.id), this.updateTask(g.id)), t.$data.tasksStore._skipTaskRecalculation = false, this.refreshData(), this.hideLightbox());
  }, t._resolve_default_mapping = function(g) {
    var p = g.map_to;
    return { time: true, time_optional: true, duration: true, duration_optional: true }[g.type] ? g.map_to == "auto" ? p = { start_date: "start_date", end_date: "end_date", duration: "duration" } : typeof g.map_to == "string" && (p = { start_date: g.map_to }) : g.type === "constraint" && (g.map_to && typeof g.map_to != "string" || (p = { constraint_type: "constraint_type", constraint_date: "constraint_date" })), p;
  }, t.getLightboxValues = function(g) {
    let p = {};
    t.isTaskExists(this._lightbox_id) && (p = this.mixin({}, this.getTask(this._lightbox_id)));
    const k = [...this._get_typed_lightbox_config()].sort((x, w) => x.name === "time" ? 1 : w.name === "time" ? -1 : 0);
    for (let x = 0; x < k.length; x++) {
      let w = t._lightbox_root.querySelector("#" + k[x].id);
      w = w && w.nextSibling;
      let $ = this.form_blocks[k[x].type];
      if (!$) continue;
      let T = $.get_value.call(this, w, p, k[x], g), S = t._resolve_default_mapping(k[x]);
    ...
    var k = g, x = p.getElementsByTagName("span"), w = [];
    t.templates.lightbox_header ? (w.push(""), w.push(t.templates.lightbox_header(k.start_date, k.end_date, k)), x[1].innerHTML = "", x[2].innerHTML = t.templates.lightbox_header(k.start_date, k.end_date, k)) : (w.push(this.templates.task_time(k.start_date, k.end_date, k)), w.push(String(this.templates.task_text(k.start_date, k.end_date, k) || "").substr(0, 70)), x[1].innerHTML = this.templates.task_time(k.start_date, k.end_date, k), x[2].innerHTML = String(this.templates.task_text(k.start_date, k.end_date, k) || "").substr(0, 70)), x[1].innerHTML = w[0], x[2].innerHTML = w[1], t._waiAria.lightboxHeader(p, w.join(" "));
    for (var $ = this._get_typed_lightbox_config(this.getLightboxType()), T = 0; T < $.length; T++) {
      var S = $[T];
      if (this.form_blocks[S.type]) {
        var C = t._lightbox_root.querySelector("#" + S.id).nextSibling, E = this.form_blocks[S.type], D = t._resolve_default_mapping($[T]), A = this.defined(k[D]) ? k[D] : S.default_value;
        E.set_value.call(t, C, A, k, S), S.focus && E.focus.call(t, C);
      }
    }
    t.isTaskExists(g.id) && (t._lightbox_id = g.id);
  }, t._fill_lightbox = function(g, p) {
    var k = this.getTask(g);
    this._set_lightbox_values(k, p);
  }, t.getLightboxSection = function(g) {
    for (var p = this._get_typed_lightbox_config(), k = 0; k < p.length && p[k].name != g; k++) ;
    var x = p[k];
    if (!x) return null;
    this._lightbox || this.getLightbox();
    var w = t._lightbox_root.querySelector("#" + x.id), $ = w.nextSibling, T = { section: x, header: w, node: $, getValue: function(C) {
      return t.form_blocks[x.type].get_value.call(t, $, C || {}, x);
    }, setValue: function(C, E) {
      return t.form_blocks[x.type].set_value.call(t, $, C, E || {}, x);
    ...
    if (t._dnd_start_lb) {
      ...
      var p = t.getLightbox(), k = [g.pageX, g.pageY];
    ...
    var k, x, w, $ = "", T = this.config, S = { first: 0, last: 1440, date: this.date.date_part(new Date(t._min_date.valueOf())), timeFormat: b(g) };
    for (g._time_format_order = { size: 0 }, t.config.limit_time_select && (S.first = 60 * T.first_hour, S.last = 60 * T.last_hour + 1, S.date.setHours(T.first_hour)), k = 0; k < S.timeFormat.length; k++) k > 0 && ($ += " "), (x = m(g, k, S)) && (w = t._waiAria.lightboxSelectAttrString(S.timeFormat[k]), $ += "<select " + (g.readonly ? "disabled='disabled'" : "") + (p ? " style='display:none' " : "") + w + ">" + x + "</select>");
    return $;
  }, getTimePickerValue: function(g, p, k) {
    var x, w = p._time_format_order, $ = 0, T = 0, S = k || 0;
    return t.defined(w[3]) && (x = parseInt(g[w[3] + S].value, 10), $ = Math.floor(x / 60), T = x % 60), new Date(g[w[2] + S].value, g[w[1] + S].value, g[w[0] + S].value, $, T);
  }, _fill_lightbox_select: function(g, p, k, x) {
    if (g[p + x[0]].value = k.getDate(), g[p + x[1]].value = k.getMonth(), g[p + x[2]].value = k.getFullYear(), t.defined(x[3])) {
      var w = 60 * k.getHours() + k.getMinutes();
      w = Math.round(w / t._get_timepicker_step()) * t._get_timepicker_step();
      var $ = g[p + x[3]];
      $.value = w, $.setAttribute("data-value", w);
    }
  }, template: new n(), textarea: new e(), select: new a(), time: new i(), duration: new o(), parent: new l(), radio: new r(), checkbox: new s(), resources: new d(), constraint: new c(), baselines: new h(), typeselect: new u(), resource_selector: new _() }, t._is_lightbox_timepicker = function() {
    for (var g = this._get_typed_lightbox_config(), p = 0; p < g.length; p++) if (g[p].name == "time" && g[p].type == "time") return true;
    return false;
  }, t._delete_task_confirm = function({ task: g, message: p, title: k, callback: x, ok: w }) {
    t._simple_confirm(p, k, x, w);
  }, t._delete_link_confirm = function({ link: g, message: p, title: k, callback: x, ok: w }) {
    t._simple_confirm(p, k, x, w);
  }, t._simple_confirm = function(g, p, k, x) {
    if (!g) return k();
    var w = { text: g };
    p && (w.title = p), x && (w.ok = x), k && (w.callback = function($) {
      $ && k();
    }), t.confirm(w);
    ...
    if (this.getState().lightbox) {
      var k = this.getState().lightbox, x = this.getLightboxValues(), w = this.copy(this.getTask(k));
      this.resetLightbox();
      var $ = this.mixin(w, x, true), T = this.getLightbox(g || void 0);
      this._set_lightbox_values($, T), this.showCover(T);
...
function rs(t) {
  if (!kt.isNode) {
    t.utils = { arrayFind: On, dom: ln };
    var n = ae();
    t.event = n.attach, t.eventRemove = n.detach, t._eventRemoveAll = n.detachAll, t._createDomEventScope = n.extend, R(t, ga(t));
    var e = Xa.init(t);
    t.$ui = e.factory, t.$ui.layers = e.render, t.$mouseEvents = e.mouseEvents, t.$services.setService("mouseEvents", function() {
    ...
    }), t.mixin(t, e.layersApi), function(i) {
      ...
      function r(u) {
        ...
        }), (h = _ ? a(u) : s(u)) ? l(u, h, "scrollY") : null;
      }
      function o(u) {
        var h = s(u);
      ...
      return { getColumnIndex: function(u) {
        ...
        var h = c.call(this, i, "posFromDate", Array.prototype.slice.call(arguments));
        return h === d ? 0 : h;
      }, getRowTop: function(u) {
        var h = this, _ = c.call(h, i, "getRowTop", [u], function() {
          return c.call(h, a, "getRowTop", [u]);
        });
        return _ === d ? 0 : _;
      }, getTaskTop: function(u) {
        var h = this, _ = c.call(h, i, "getItemTop", [u], function() {
        ...
        var _ = this, f = c.call(_, i, "getBarHeight", [u, h], function() {
          return c.call(_, a, "getItemHeight", [u]);
        });
        return f === d ? 0 : f;
      }, getTaskHeight: function(u) {
        var h = this, _ = c.call(h, i, "getItemHeight", [u], function() {
        ...
        var _ = r(this), f = o(this), y = { position: 0 }, v = { position: 0 };
        _ && (v = _.getScrollState()), f && (y = f.getScrollState());
        var b = f && 1 * u == u, m = _ && 1 * h == h;
        if (b && m) for (var g = _._getLinkedViews(), p = f._getLinkedViews(), k = [], x = 0; x < g.length; x++) for (var w = 0; w < p.length; w++) g[x].$config.id && p[w].$config.id && g[x].$config.id === p[w].$config.id && k.push(g[x].$config.id);
        b && (k && k.forEach((function(S) {
          this.$ui.getView(S).$config.$skipSmartRenderOnScroll = true;
        }).bind(this)), f.scroll(u), k && k.forEach((function(S) {
          this.$ui.getView(S).$config.$skipSmartRenderOnScroll = false;
        }).bind(this))), m && _.scroll(h);
        var $ = { position: 0 }, T = { position: 0 };
        _ && ($ = _.getScrollState()), f && (T = f.getScrollState()), this.callEvent("onGanttScroll", [y.position, v.position, T.position, $.position]);
      }, showDate: function(u) {
        ...
        var u = { x: false, y: false, x_pos: 0, y_pos: 0, scroll_size: this.config.scroll_size + 1, x_inner: 0, y_inner: 0 }, h = r(this), _ = o(this);
        if (_) {
      ...
      i.resetSkin || (i.resetSkin = function() {
        ...
        const o = this.skin !== r;
        this.skin = r, i._addThemeClass(), s(), i.$root && (pe(!o, i), this.render());
      };
      let a = null;
      function s() {
        const r = i.$root;
      ...
      i.ext || (i.ext = {});
      for (var a = [Za, null, null], s = 0; s < a.length; s++) a[s] && a[s](i);
      i.ext.zoom = new es(i);
    }(t), ns(t), ss(t), function(i) {
      i._extend_to_optional = function(a) {
        var s = a, r = { render: s.render, focus: s.focus, set_value: function(o, l, d, c) {
          ...
          if (!d[u.start_date] || u.start_date == "start_date" && this._isAllowedUnscheduledTask(d)) {
            ...
            return s.set_value.call(i, o, l, h, c);
          }
          return r.enable(o, c), s.set_value.call(i, o, l, d, c);
        }, get_value: function(o, l, d) {
          return d.disabled ? { start_date: null } : s.get_value.call(i, o, l, d);
      ...
      for (var d in i._waiAria = { getAttributeString: function(c) {
        ...
        c.start_date && c.end_date && (u.setAttribute("aria-label", r(i.templates.tooltip_text(c.start_date, c.end_date, c))), c.$dataprocessor_class && u.setAttribute("aria-busy", true));
        ...
        var h = i.config.links, _ = c.type == h.finish_to_start || c.type == h.start_to_start, f = c.type == h.start_to_start || c.type == h.start_to_finish, y = i.locale.labels.link + " " + i.templates.drag_link(c.source, f, c.target, _);
        u.setAttribute("role", "img"), u.setAttribute("aria-label", r(y));
        ...
        if (c.name == "add") h = this.getAttributeString({ role: "columnheader", "aria-label": i.locale.labels.new_task });
          ...
          i._sort && i._sort.name == c.name && (i._sort.direction == "asc" ? _["aria-sort"] = "ascending" : _["aria-sort"] = "descending"), h = this.getAttributeString(_);
        }
        return h;
        ...
        return c.editor && !i.isReadonly(h) || (_["aria-readonly"] = true), this.getAttributeString(_);
      ...
      var a = xt(i);
      if (ht(a, ".gantt_task_row")) return null;
      var s = arguments[1] || this.config.task_attribute, r = it(a, s);
      return r ? r.getAttribute(s) : null;
    }, t._locate_css = function(i, a, s) {
      return vt(i, a, s);
    }, t._locateHTML = function(i, a) {
      return it(i, a || this.config.task_attribute);
    };
  }
  t.attachEvent("onParse", function() {
    G(t) || t.attachEvent("onGanttRender", function() {
    ...
    this.config.scroll_size || (this.config.scroll_size = tn() || 15), G(t) || (this._eventRemoveAll(), this.$mouseEvents.reset(), this.resetLightbox());
  }), t.attachEvent("onGanttReady", function() {
    !G(t) && t.config.rtl && t.$layout.getCellsByType("viewCell").forEach(function(i) {
    ...
    if (!G(t)) {
      ...
      for (let s in a) a[s] && !i[s] && console.warn(`You connected the '${s}' extension via an obsolete file. 
...
var os = tt.gantt = function(t) {
  var n = _a(t);
  return n.env.isNode || (rs(n), function(e) {
    e.load = function(i, a, s) {
      this._load_url = i, this.assert(arguments.length, "Invalid load arguments");
      var r = "json", o = null;
      return arguments.length >= 3 ? (r = a, o = s) : typeof arguments[1] == "string" ? r = arguments[1] : typeof arguments[1] == "function" && (o = arguments[1]), this._load_type = r, this.callEvent("onLoadStart", [i, r]), this.ajax.get(i, e.bind(function(l) {
        this.on_load(l, r), this.callEvent("onLoadEnd", [i, r]), typeof o == "function" && o.call(this);
      }, this));
    };
  }(n)), n;
}(Yn);
...
dhtmlx-gantt/codebase/dhtmlxgantt.es.js:
  (** @license
  ...
  *)
*/
//# sourceMappingURL=dhtmlx-gantt.js.map
