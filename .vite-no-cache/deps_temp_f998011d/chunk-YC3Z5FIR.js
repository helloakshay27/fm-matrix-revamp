...
var useLocalizationContext = () => {
  const localization = React8.useContext(PickerAdapterContext);
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime3.jsxs)(React13.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime3.jsxs)(React13.Fragment, {
  children: [(0, import_jsx_runtime3.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime3.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const adapter = usePickerAdapter();
  const cleanDate = React14.useMemo(() => !adapter.isValid(date) ? null : date, [adapter, date]);
...
var PickerPopperPaperWrapper = React16.forwardRef((props, ref) => {
  const {
    PaperComponent,
    ownerState,
    children,
...
function PickerPopper(inProps) {
  ...
  const paperRef = React16.useRef(null);
  ...
  const ownerState = React16.useMemo(() => _extends({}, pickerOwnerState, {
...
function useOrientation(views, customOrientation) {
  const [orientation, setOrientation] = React18.useState(getOrientation);
  useEnhancedEffect_default(() => {
    const eventHandler = () => {
...
var useControlledValue = ({
  ...
  const inputTimezone = React19.useMemo(() => valueManager.getTimezone(adapter, valueWithInputTimezone), [adapter, valueManager, valueWithInputTimezone]);
  ...
  const timezoneToRender = React19.useMemo(() => {
    if (timezoneProp) {
      return timezoneProp;
    }
    if (inputTimezone) {
  ...
  const valueWithTimezoneToRender = React19.useMemo(() => valueManager.setTimezone(adapter, timezoneToRender, valueWithInputTimezone), [valueManager, adapter, timezoneToRender, valueWithInputTimezone]);
...
function useValueAndOpenStates(parameters) {
  ...
  } = React20.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React20.useRef(valueProp !== void 0);
  const {
  ...
  const viewValue = React20.useMemo(() => valueManager.cleanValue(adapter, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [adapter, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React21.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React21.useState(null);
  const popupRef = React21.useRef(null);
  const fieldRef = React21.useRef(null);
  const rootRefObject = React21.useRef(null);
  ...
  const {
    ...
    viewModeLookup,
    timeViewsCount
  } = React21.useMemo(() => views.reduce((acc, viewForReduce) => {
  ...
  const [popperView, setPopperView] = React21.useState(currentViewMode === "UI" ? view : null);
  ...
  const ownerState = React21.useMemo(() => ({
  ...
  const triggerStatus = React21.useMemo(() => {
  ...
  const contextValue = React21.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React21.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React21.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
...
var PickersActionBar = React22.memo(PickersActionBarComponent);
...
var usePickerLayout = (props) => {
  ...
  const ownerState = React24.useMemo(() => _extends({}, pickerOwnerState, {
...
var PickersLayout = React25.forwardRef(function PickersLayout2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersLayout"
  });
  ...
  return (0, import_jsx_runtime9.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime9.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime9.jsxs)(React25.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime9.jsxs)(React25.Fragment, {
...
function useFieldOwnerState(parameters) {
  ...
  const isRtl = useRtl();
  return React26.useMemo(() => _extends({}, pickerOwnerState, {
...
var _excluded8 = ["slots", "slotProps", "elements", "sectionListRef", "classes"];
...
var PickersSectionList = React27.forwardRef(function PickersSectionList2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersSectionList"
  });
  ...
  React27.useImperativeHandle(sectionListRef, () => ({
    getRoot() {
  ...
  return (0, import_jsx_runtime10.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime10.jsx)(React27.Fragment, {
...
var PickerTextFieldOwnerStateContext = React28.createContext(null);
if (true) PickerTextFieldOwnerStateContext.displayName = "PickerTextFieldOwnerStateContext";
var usePickerTextFieldOwnerState = () => {
  const value = React28.useContext(PickerTextFieldOwnerStateContext);
  if (value == null) {
...
var _excluded9 = ["elements", "areAllSectionsEmpty", "defaultValue", "label", "value", "onChange", "id", "autoFocus", "endAdornment", "startAdornment", "renderSuffix", "slots", "slotProps", "contentEditable", "tabIndex", "onInput", "onPaste", "onKeyDown", "fullWidth", "name", "readOnly", "inputProps", "inputRef", "sectionListRef", "onFocus", "onBlur", "classes", "ownerState"];
...
var PickersInputBase = React29.forwardRef(function PickersInputBase2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInputBase"
  });
  ...
  const activeBarRef = React29.useRef(null);
  const sectionOffsetsRef = React29.useRef([]);
  const handleRootRef = useForkRef(ref, rootRef);
...
var _excluded11 = ["label", "autoFocus", "ownerState", "classes", "notched"];
...
var PickersOutlinedInput = React31.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersOutlinedInput"
  });
  ...
  return (0, import_jsx_runtime13.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime13.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime13.jsxs)(React31.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
var _excluded12 = ["label", "autoFocus", "disableUnderline", "hiddenLabel", "classes"];
...
var useUtilityClasses8 = (classes, ownerState) => {
  const {
    inputHasUnderline
  } = ownerState;
  const slots = {
...
var PickersFilledInput = React32.forwardRef(function PickersFilledInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersFilledInput"
  });
  ...
  const classes = useUtilityClasses8(classesProp, ownerState);
...
var _excluded13 = ["label", "autoFocus", "disableUnderline", "ownerState", "classes"];
...
var PickersInput = React33.forwardRef(function PickersInput2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersInput"
  });
...
var PickersTextField = React34.forwardRef(function PickersTextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersTextField"
  });
  ...
  const ownerState = React34.useMemo(() => _extends({}, fieldOwnerState, {
...
var PickerFieldUIContext = React35.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
...
function PickerFieldUI(props) {
  ...
  const pickerFieldUIContext = React35.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
  ...
  if (!((_a = textFieldProps.InputProps) == null ? void 0 : _a.startAdornment) && (clearButtonPosition === "start" || openPickerButtonPosition === "start")) {
    textFieldProps.InputProps.startAdornment = (0, import_jsx_runtime17.jsxs)(InputAdornment, _extends({}, startInputAdornmentProps, {
  ...
  if (!((_b = textFieldProps.InputProps) == null ? void 0 : _b.endAdornment) && (clearButtonPosition === "end" || openPickerButtonPosition === "end")) {
    textFieldProps.InputProps.endAdornment = (0, import_jsx_runtime17.jsxs)(InputAdornment, _extends({}, endInputAdornmentProps, {
...
var useDesktopPicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime18.jsx)(PickerProvider, _extends({}, providerProps, {
    children: (0, import_jsx_runtime18.jsxs)(PickerFieldUIContextProvider, {
      slots,
      slotProps,
      inputRef,
      children: [(0, import_jsx_runtime18.jsx)(Field, _extends({}, fieldProps)), (0, import_jsx_runtime18.jsx)(PickerPopper, {
        slots,
        slotProps,
        children: (0, import_jsx_runtime18.jsx)(Layout, _extends({}, slotProps == null ? void 0 : slotProps.layout, {
          slots,
          slotProps,
...
var useIsDateDisabled = ({
  ...
  const adapter = usePickerAdapter();
  return React37.useCallback((day) => validateDate({
    adapter,
    value: day,
    timezone,
    props: {
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React38.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
  ...
  const [calendarState, dispatch] = React38.useReducer(reducerFn, {
    isMonthSwitchingAnimating: false,
  ...
  const onMonthSwitchingAnimationEnd = React38.useCallback(() => {
    dispatch({
...
function usePickerDayOwnerState(parameters) {
  ...
  return React40.useMemo(() => _extends({}, pickerOwnerState, {
    day,
...
var _excluded18 = ["autoFocus", "className", "classes", "hidden", "isAnimating", "onClick", "onDaySelect", "onFocus", "onBlur", "onKeyDown", "onMouseDown", "onMouseEnter", "children", "isFirstVisibleCell", "isLastVisibleCell", "day", "selected", "disabled", "today", "outsideCurrentMonth", "disableMargin", "disableHighlightToday", "showDaysOutsideCurrentMonth"];
...
var PickersDayRaw = React41.forwardRef(function PickersDay(inProps, forwardedRef) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersDay"
  });
...
true ? PickersDayRaw.propTypes = {
   ...
   * The date to show.
   */
  day: import_prop_types10.default.object.isRequired,
  /**
   ...
   * @default false
   */
  disableMargin: import_prop_types10.default.bool,
  /**
  ...
  isAnimating: import_prop_types10.default.bool,
  /**
   * If `true`, day is the first visible cell of the month.
   * Either the first day of the month or the first day of the week depending on `showDaysOutsideCurrentMonth`.
   */
  isFirstVisibleCell: import_prop_types10.default.bool.isRequired,
  /**
   * If `true`, day is the last visible cell of the month.
   * Either the last day of the month or the last day of the week depending on `showDaysOutsideCurrentMonth`.
   */
  isLastVisibleCell: import_prop_types10.default.bool.isRequired,
  onBlur: import_prop_types10.default.func,
  onDaySelect: import_prop_types10.default.func.isRequired,
  ...
  onMouseEnter: import_prop_types10.default.func,
  /**
   * If `true`, day is outside of month and will be hidden.
   */
  outsideCurrentMonth: import_prop_types10.default.bool.isRequired,
  /**
   ...
   * @default false
   */
  today: import_prop_types10.default.bool,
  /**
...
var PickersDay2 = React41.memo(PickersDayRaw);
...
var useNow = (timezone) => {
  const adapter = usePickerAdapter();
  const now = React42.useRef(void 0);
...
var _excluded19 = ["children", "className", "reduceAnimations", "slideDirection", "transKey", "classes"];
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime21.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React43.cloneElement(element, {
...
var _excluded20 = ["parentProps", "day", "focusedDay", "selectedDays", "isDateDisabled", "currentMonthNumber", "isViewFocused"];
var _excluded25 = ["ownerState"];
var useUtilityClasses14 = (classes) => {
  const slots = {
    root: ["root"],
    header: ["header"],
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React44.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const isOutsideCurrentMonth = React44.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
  ...
  const isFirstVisibleCell = React44.useMemo(() => {
  ...
  const isLastVisibleCell = React44.useMemo(() => {
...
function DayCalendar(inProps) {
  ...
  const now = useNow(timezone);
  const classes = useUtilityClasses14(classesProp);
  const isRtl = useRtl();
  const isDateDisabled = useIsDateDisabled({
    shouldDisableDate,
    shouldDisableMonth,
  ...
  const validSelectedDays = React44.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
  const transitionKey = `${currentYearNumber}-${currentMonthNumber}`;
  const slideNodeRef = React44.useMemo(() => React44.createRef(), [transitionKey]);
  const weeksToDisplay = React44.useMemo(() => {
  ...
  return (0, import_jsx_runtime22.jsxs)(PickersCalendarDayRoot, {
    ...
    children: [(0, import_jsx_runtime22.jsxs)(PickersCalendarDayHeader, {
      ...
      }), getWeekdays(adapter, now).map((weekday, i) => (0, import_jsx_runtime22.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
...
var _excluded21 = ["autoFocus", "classes", "disabled", "selected", "value", "onClick", "onKeyDown", "onFocus", "onBlur", "slots", "slotProps"];
...
var MonthCalendarButton = React45.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime23.jsx)(MonthButton, _extends({}, monthButtonProps));
});
...
function useApplyDefaultValuesToDateFieldInternalProps(internalProps) {
  ...
  return React46.useMemo(() => _extends({}, internalProps, validationProps, {
...
var _excluded26 = ["autoFocus", "className", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var MonthCalendar = React47.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React47.useMemo(() => adapter.getMonth(now), [adapter, now]);
  ...
  const [focusedMonth, setFocusedMonth] = React47.useState(() => selectedMonth || adapter.getMonth(referenceDate));
  ...
  return (0, import_jsx_runtime24.jsx)(MonthCalendarRoot, _extends({
    ...
    children: getMonthsInYear(adapter, value ?? referenceDate).map((month) => {
      ...
      return (0, import_jsx_runtime24.jsx)(MonthCalendarButton, {
        selected: isSelected,
        value: monthNumber,
...
true ? MonthCalendar.propTypes = {
  ...
  onMonthFocus: import_prop_types11.default.func,
  /**
...
var _excluded27 = ["autoFocus", "classes", "disabled", "selected", "value", "onClick", "onKeyDown", "onFocus", "onBlur", "slots", "slotProps"];
...
var YearCalendarButton = React48.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime25.jsx)(YearButton, _extends({}, yearButtonProps));
});
if (true) YearCalendarButton.displayName = "YearCalendarButton";

// node_modules/@mui/x-date-pickers/esm/YearCalendar/YearCalendar.js
var import_jsx_runtime26 = __toESM(require_jsx_runtime(), 1);
var _excluded28 = ["autoFocus", "className", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsOrder", "yearsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var YearCalendar = React49.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React49.useMemo(() => adapter.getYear(now), [adapter, now]);
  ...
  const [focusedYear, setFocusedYear] = React49.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  return (0, import_jsx_runtime26.jsxs)(YearCalendarRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: [yearRange.map((year) => {
      ...
      return (0, import_jsx_runtime26.jsx)(YearCalendarButton, {
        selected: isSelected,
        value: yearNumber,
      ...
      length: fillerAmount
    }, (_, index) => (0, import_jsx_runtime26.jsx)(YearCalendarButtonFiller, {}, index))]
  }));
});
...
true ? YearCalendar.propTypes = {
  ...
  onYearFocus: import_prop_types12.default.func,
  /**
   * If `true`, the component is read-only.
   * When read-only, the value cannot be changed but the user can interact with the interface.
   * @default false
...
var _excluded29 = ["children", "className", "slots", "slotProps", "isNextDisabled", "isNextHidden", "onGoToNext", "nextLabel", "isPreviousDisabled", "isPreviousHidden", "onGoToPrevious", "previousLabel", "labelId", "classes"];
...
var PickersArrowSwitcher = React50.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersArrowSwitcher"
...
var _excluded30 = ["slots", "slotProps", "currentMonth", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onMonthChange", "onViewChange", "view", "reduceAnimations", "views", "labelId", "className", "classes", "timezone", "format"];
...
true ? PickersCalendarHeader.propTypes = {
  ...
  currentMonth: import_prop_types13.default.object.isRequired,
  ...
  maxDate: import_prop_types13.default.object.isRequired,
  minDate: import_prop_types13.default.object.isRequired,
  onMonthChange: import_prop_types13.default.func.isRequired,
  onViewChange: import_prop_types13.default.func,
  reduceAnimations: import_prop_types13.default.bool.isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   */
  ...
  timezone: import_prop_types13.default.string.isRequired,
...
true ? DateCalendar.propTypes = {
   ...
   */
  focusedView: import_prop_types14.default.oneOf(["day", "month", "year"]),
  /**
...
var useMobilePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime32.jsx)(PickerProvider, _extends({}, providerProps, {
    children: (0, import_jsx_runtime32.jsxs)(PickerFieldUIContextProvider, {
      slots,
      slotProps,
      inputRef,
      children: [(0, import_jsx_runtime32.jsx)(Field, _extends({}, fieldProps)), (0, import_jsx_runtime32.jsx)(PickersModalDialog, {
        slots,
        slotProps,
        children: (0, import_jsx_runtime32.jsx)(Layout, _extends({}, slotProps == null ? void 0 : slotProps.layout, {
          slots,
          slotProps,
          children: renderCurrentView()
        }))
...
function useApplyDefaultValuesToDateTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React56.useMemo(() => internalProps.ampm ?? adapter.is12HourCycleInCurrentLocale(), [internalProps.ampm, adapter]);
  return React56.useMemo(() => _extends({}, internalProps, validationProps, {
...
var useFieldState = (parameters) => {
  ...
  const valueRef = React57.useRef(value);
  React57.useEffect(() => {
  ...
  const error = React57.useMemo(() => {
    if (errorProp !== void 0) {
      return errorProp;
    }
    return hasValidationError;
  }, [hasValidationError, errorProp]);
  const localizedDigits = React57.useMemo(() => getLocalizedDigits(adapter), [adapter]);
  const sectionsValueBoundaries = React57.useMemo(() => getSectionsBoundaries(adapter, localizedDigits, timezone), [adapter, localizedDigits, timezone]);
  const getSectionsFromValue = React57.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    adapter,
  ...
  const parsedSelectedSections = React57.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
  const activeSectionIndex = parsedSelectedSections === "all" ? 0 : parsedSelectedSections;
  const sectionOrder = React57.useMemo(() => getSectionOrder(state.sections, isRtl && !enableAccessibleFieldDOMStructure), [state.sections, isRtl, enableAccessibleFieldDOMStructure]);
  const areAllSectionsEmpty = React57.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  ...
  const sectionToUpdateOnNextInvalidDateRef = React57.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React58.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React58.useMemo(() => {
...
function useFieldHiddenInputProps(parameters) {
  ...
  const valueStr = React59.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  return {
    value: valueStr,
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React60.useCallback((sectionIndex) => (event) => {
    if (disabled || event.isDefaultPrevented()) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React60.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React61.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React61.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const sectionListRef = React62.useRef(null);
  const handleSectionListRef = useForkRef(sectionListRefProp, sectionListRef);
  const domGetters = React62.useMemo(() => ({
  ...
  React62.useImperativeHandle(unstableFieldRef, () => ({
...
var useFieldV6TextField = (parameters) => {
  ...
  const openPickerAriaLabel = useOpenPickerButtonAriaLabel3(value);
  const sections = React63.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const placeholder = React63.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React63.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React63.useEffect(() => {
  ...
  const inputMode = React63.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
  ...
  React63.useImperativeHandle(unstableFieldRef, () => ({
    getSections: () => state.sections,
...
//# sourceMappingURL=chunk-YC3Z5FIR.js.map
