import {
  _toConsumableArray
} from "./chunk-P7JAAH3L.js";
import {
  _defineProperty,
  init_defineProperty
} from "./chunk-5KBNSK64.js";
import "./chunk-S2APMLR4.js";
import "./chunk-TKC5NRBI.js";
import {
  require_react_dom
...
function createSubstyle(_ref) {
  ...
  var substyle = typeof style === "function" ? style : memoize_default(function(select, defaultStyle2) {
    ...
    return createSubstyle(_objectSpread2(_objectSpread2(_objectSpread2({}, (style || defaultStyle2) && {
      style: merge.apply(void 0, [{}].concat(_toConsumableArray(collectSelectedStyles(defaultStyle2)), _toConsumableArray(collectSelectedStyles(style))))
    }), derivedClassNames && {
...
function SuggestionsOverlay(_ref) {
  ...
  var renderSuggestions = function renderSuggestions2() {
    var suggestionsToRender = import_react3.default.createElement("ul", _extends({
      ...
      return [].concat(_toConsumableArray2(accResults), _toConsumableArray2(results.map(function(result, index) {
...
var MentionsInput = function(_React$Component) {
  ...
  function MentionsInput2(_props) {
    ...
    _defineProperty2(_assertThisInitialized(_this), "setContainerElement", function(el) {
      _this.containerElement = el;
    });
    _defineProperty2(_assertThisInitialized(_this), "getInputProps", function() {
    ...
    _defineProperty2(_assertThisInitialized(_this), "renderControl", function() {
    ...
    _defineProperty2(_assertThisInitialized(_this), "renderInput", function(props) {
      return import_react3.default.createElement("input", _extends({
        type: "text",
        ref: _this.setInputRef
      }, props));
    });
    _defineProperty2(_assertThisInitialized(_this), "renderTextarea", function(props) {
      return import_react3.default.createElement("textarea", _extends({
        ref: _this.setInputRef
      }, props));
    });
    _defineProperty2(_assertThisInitialized(_this), "setInputRef", function(el) {
    ...
    _defineProperty2(_assertThisInitialized(_this), "setSuggestionsElement", function(el) {
      _this.suggestionsElement = el;
    });
    _defineProperty2(_assertThisInitialized(_this), "renderSuggestionsOverlay", function() {
    ...
    _defineProperty2(_assertThisInitialized(_this), "renderHighlighter", function() {
    ...
    _defineProperty2(_assertThisInitialized(_this), "setHighlighterElement", function(el) {
      _this.highlighterElement = el;
    });
    _defineProperty2(_assertThisInitialized(_this), "handleCaretPositionChange", function(position) {
      _this.setState({
        caretPosition: position
      });
    });
    _defineProperty2(_assertThisInitialized(_this), "getPlainText", function() {
      return getPlainText(_this.props.value || "", readConfigFromChildren(_this.props.children));
    });
    _defineProperty2(_assertThisInitialized(_this), "executeOnChange", function(event) {
    ...
    _defineProperty2(_assertThisInitialized(_this), "handleChange", function(ev) {
      isComposing = false;
      if (isIE()) {
    ...
    _defineProperty2(_assertThisInitialized(_this), "handleSelect", function(ev) {
      _this.setState({
    ...
    _defineProperty2(_assertThisInitialized(_this), "handleKeyDown", function(ev) {
    ...
    _defineProperty2(_assertThisInitialized(_this), "shiftFocus", function(delta) {
      var suggestionsCount = countSuggestions(_this.state.suggestions);
      _this.setState({
    ...
    _defineProperty2(_assertThisInitialized(_this), "selectFocused", function() {
      ...
      var _Object$values$reduce = Object.values(suggestions).reduce(function(acc, _ref) {
        ...
        return [].concat(_toConsumableArray2(acc), _toConsumableArray2(results.map(function(result2) {
          return {
            result: result2,
    ...
    _defineProperty2(_assertThisInitialized(_this), "handleBlur", function(ev) {
    ...
    _defineProperty2(_assertThisInitialized(_this), "handleSuggestionsMouseDown", function(ev) {
      _this._suggestionsMouseDown = true;
    });
    _defineProperty2(_assertThisInitialized(_this), "handleSuggestionsMouseEnter", function(focusIndex) {
      _this.setState({
        focusIndex,
        scrollFocusedIntoView: false
      });
    });
    _defineProperty2(_assertThisInitialized(_this), "updateSuggestionsPosition", function() {
    ...
    _defineProperty2(_assertThisInitialized(_this), "updateHighlighterScroll", function() {
    ...
    _defineProperty2(_assertThisInitialized(_this), "handleCompositionStart", function() {
      isComposing = true;
    });
    _defineProperty2(_assertThisInitialized(_this), "handleCompositionEnd", function() {
      isComposing = false;
    });
    _defineProperty2(_assertThisInitialized(_this), "setSelection", function(selectionStart, selectionEnd) {
    ...
    _defineProperty2(_assertThisInitialized(_this), "updateMentionsQueries", function(plainTextValue, caretPosition) {
      _this._queryId++;
      _this.suggestions = {};
      _this.setState({
        suggestions: {}
    ...
    _defineProperty2(_assertThisInitialized(_this), "clearSuggestions", function() {
      _this._queryId++;
      _this.suggestions = {};
      _this.setState({
        suggestions: {},
    ...
    _defineProperty2(_assertThisInitialized(_this), "queryData", function(query, childIndex, querySequenceStart, querySequenceEnd, plainTextValue) {
    ...
    _defineProperty2(_assertThisInitialized(_this), "updateSuggestions", function(queryId, childIndex, query, querySequenceStart, querySequenceEnd, plainTextValue, results) {
      if (queryId !== _this._queryId) return;
      _this.suggestions = _objectSpread$1(_objectSpread$1({}, _this.suggestions), {}, _defineProperty2({}, childIndex, {
        queryInfo: {
          childIndex,
          query,
          querySequenceStart,
    ...
    _defineProperty2(_assertThisInitialized(_this), "addMention", function(_ref2, _ref3) {
    ...
    _defineProperty2(_assertThisInitialized(_this), "isLoading", function() {
      var isLoading = false;
    ...
    _defineProperty2(_assertThisInitialized(_this), "isOpened", function() {
      return isNumber(_this.state.selectionStart) && (countSuggestions(_this.state.suggestions) !== 0 || _this.isLoading());
    });
    _defineProperty2(_assertThisInitialized(_this), "_queryId", 0);
    _this.suggestions = {};
...
_defineProperty2(MentionsInput, "propTypes", propTypes);
_defineProperty2(MentionsInput, "defaultProps", {
  ignoreAccents: false,
  singleLine: false,
